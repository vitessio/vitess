...
public class VitessConnectionTest {
    ...
    @Test(expected = SQLException.class) public void testCreateStatementForClose() throws SQLException {
        VitessConnection vitessConnection = getVitessConnection();
    ...
    @Test(expected = SQLException.class) public void testCreatePreperedStatementForClose() throws SQLException {
        VitessConnection vitessConnection = getVitessConnection();
        vitessConnection.close();
        try{
            PreparedStatement preparedStatementstatement = vitessConnection.prepareStatement("query");
    ...
    @Test(expected = SQLException.class) public void testDefaultGetAutoCommitForClose() throws SQLException {
        VitessConnection vitessConnection = getVitessConnection();
        vitessConnection.close();
        try{
    ...
    @Test(expected = SQLException.class) public void testDefaultSetAutoCommitForClose() throws SQLException {
        VitessConnection vitessConnection = getVitessConnection();
        vitessConnection.close();
        try{
            boolean autoCommit = vitessConnection.getAutoCommit();
    ...
    @Test(expected = SQLException.class) public void testRollbackForException() throws SQLException {
        VitessConnection vitessConnection = getVitessConnection();
        vitessConnection.setAutoCommit(false);
        VTGateTx mockVtGateTx = PowerMockito.mock(VTGateTx.class);
        vitessConnection.setVtGateTx(mockVtGateTx);
