...
public class VitessResultSetMetadataTest {
    ...
    @Test public void testgetColumnTypeName() throws SQLException {
        ...
        List<Query.Field> fieldList = getFieldList();
        VitessResultSetMetaData vitessResultSetMetadata = new VitessResultSetMetaData(fieldList);
        Assert.assertEquals("INT8", vitessResultSetMetadata.getColumnTypeName(1));
        Assert.assertEquals("UINT8", vitessResultSetMetadata.getColumnTypeName(2));
        Assert.assertEquals("INT16", vitessResultSetMetadata.getColumnTypeName(3));
        Assert.assertEquals("UINT16", vitessResultSetMetadata.getColumnTypeName(4));
        Assert.assertEquals("INT24", vitessResultSetMetadata.getColumnTypeName(5));
        Assert.assertEquals("UINT24", vitessResultSetMetadata.getColumnTypeName(6));
        Assert.assertEquals("INT32", vitessResultSetMetadata.getColumnTypeName(7));
        Assert.assertEquals("UINT32", vitessResultSetMetadata.getColumnTypeName(8));
        Assert.assertEquals("INT64", vitessResultSetMetadata.getColumnTypeName(9));
        Assert.assertEquals("UINT64", vitessResultSetMetadata.getColumnTypeName(10));
        Assert.assertEquals("FLOAT32", vitessResultSetMetadata.getColumnTypeName(11));
        Assert.assertEquals("FLOAT64", vitessResultSetMetadata.getColumnTypeName(12));
    ...
    @Test public void testgetColumnType() throws SQLException {
        ...
        Assert.assertEquals(8, vitessResultSetMetadata.getColumnType(9));
        Assert.assertEquals(8, vitessResultSetMetadata.getColumnType(10));
