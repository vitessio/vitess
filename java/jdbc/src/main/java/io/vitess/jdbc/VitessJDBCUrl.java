...
/**
 * VitessJDBCUrl is responsible for parsing a driver URL and Properties object, returning a new
 * Properties object with configuration from the URL and passed in Properties merged.
 * <p>
 * Parameters passed in through the Properties object take precedence over the parameters in the
 * URL, where there are conflicts.
 * <p>
...
public class VitessJDBCUrl {
  ...
  */
   ...
   * <p>
   * <p>To indicate that SSL should be used, URL's follow the MySQL and MariaDB convention of
   * including the property <code>useSSL=true</code>.  To use a keyStore and trustStore other than
   * the JRE default, you can add the following URL properties:</p>
   * <p>
   * <p>
   * <ul>
