...
public class VitessResultSetMetaData implements ResultSetMetaData {
  ...
  public String getColumnClassName(int column) throws SQLException {
    ...
    return getClassNameForJavaType(field.getJavaType(), field.getVitessTypeValue(),
        field.isUnsigned(), field.isBinary() || field.isBlob(), field.isOpaqueBinary(),
        field.getConnectionProperties().getYearIsDateType());
  }
  ...
  private String getClassNameForJavaType(int javaType, int vitessType, boolean isUnsigned,
