...
public class VitessMySQLDatabaseMetadata extends VitessDatabaseMetaData implements
  ...
  static {
    ...
    String[] allMySQLKeywords = new String[]{"ACCESSIBLE", "ADD", "ALL", "ALTER", "ANALYZE", "AND",
        ...
        "OPTION", "OPTIONALLY", "OR", "ORDER", "OUT", "OUTER", "OUTFILE", "PARALLEL", "PRECISION", "PRIMARY",
        "PROCEDURE", "PURGE", "QUALIFY", "RANGE", "READ", "READS", "READ_ONLY", "READ_WRITE", "REAL",
        ...
        "SQL_SMALL_RESULT", "SSL", "STARTING", "STRAIGHT_JOIN", "TABLE", "TABLESAMPLE", "TERMINATED", "THEN",
