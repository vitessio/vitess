...
public class CharsetMapping {
  ...
  private static final String MYSQL_4_0_CHARSET_NAME_croat = "croat";        // 4.1 => 27
  // latin2  latin2_croatian_ci
  private static final String MYSQL_4_0_CHARSET_NAME_czech = "czech";        // 4.1 => 2 latin2
  //   latin2_czech_ci
  private static final String MYSQL_4_0_CHARSET_NAME_danish = "danish";        // 4.1 => 15
  // latin1  latin1_danish_ci
  private static final String MYSQL_4_0_CHARSET_NAME_dos = "dos";            // 4.1 => 4 cp850
  // cp850_general_ci
  private static final String MYSQL_4_0_CHARSET_NAME_estonia = "estonia";        // 4.1 => 20
  // latin7  latin7_estonian_ci
  private static final String MYSQL_4_0_CHARSET_NAME_euc_kr = "euc_kr";        // 4.1 => 19
  // euckr  euckr_korean_ci
  private static final String MYSQL_4_0_CHARSET_NAME_german1 = "german1";        // 4.1 => 5
  // latin1  latin1_german1_ci
  private static final String MYSQL_4_0_CHARSET_NAME_hungarian = "hungarian";    // 4.1 => 21
  // latin2  latin2_hungarian_ci
  private static final String MYSQL_4_0_CHARSET_NAME_koi8_ru = "koi8_ru";        // 4.1 => 7
  // koi8r  koi8r_general_ci
  private static final String MYSQL_4_0_CHARSET_NAME_koi8_ukr = "koi8_ukr";        // 4.1 => 22
  // koi8u  koi8u_ukrainian_ci
  private static final String MYSQL_4_0_CHARSET_NAME_latin1_de = "latin1_de";    // 4.1 => 31
  ...
  private static final String MYSQL_4_0_CHARSET_NAME_usa7 = "usa7";            // 4.1 => 11
  // ascii  ascii_general_ci
  private static final String MYSQL_4_0_CHARSET_NAME_win1250 = "win1250";        // 4.1 => 26
  // cp1250  cp1250_general_ci
  private static final String MYSQL_4_0_CHARSET_NAME_win1251 = "win1251";        // 4.1 => 17
  // (removed)
  private static final String MYSQL_4_0_CHARSET_NAME_win1251ukr = "win1251ukr";    // 4.1 => 23
  // cp1251  cp1251_ukrainian_ci

  private static final String NOT_USED = MYSQL_CHARSET_NAME_latin1; // punting for not-used
  // character sets
  ...
  static {
    ...
    MysqlCharset[] charset = new MysqlCharset[]{
        ...
        new MysqlCharset(MYSQL_CHARSET_NAME_sjis, 2, 0,
            new String[]{"SHIFT_JIS", "Cp943", "WINDOWS-31J"}),
        ...
        // MS932 is alias for WINDOWS-31J
        ...
        new MysqlCharset(MYSQL_CHARSET_NAME_eucjpms, 3, 0, new String[]{"EUC_JP_Solaris"}, 5, 0, 3),
        ...
        // was ISO8859_7, that's incorrect; also + "LATIN7 =  latin7," is wrong java encoding
        // name
        ...
        new MysqlCharset(MYSQL_4_0_CHARSET_NAME_estonia, 1, 1, new String[]{"ISO8859_13"}, 4, 0),
        //, "ISO8859_13"); // punting for "estonia";
        ...
        // new, Kamenicky encoding usually known as Cp895 but there is no official cp895
        // specification; close to Cp852, see http://ftp.muni
        // .cz/pub/localization/charsets/cs-encodings-faq
    ...
    HashMap<String, MysqlCharset> charsetNameToMysqlCharsetMap = new HashMap<String,
        MysqlCharset>();
    HashMap<String, List<MysqlCharset>> javaUcToMysqlCharsetMap = new HashMap<String,
        List<MysqlCharset>>();
    ...
    // complete list of mysql collations and their corresponding character sets each element of
    // collation[1]..collation[MAP_SIZE-1] must not be null
    ...
    collation[17] = new Collation(17, "latin1_german1_ci", 0,
        MYSQL_4_0_CHARSET_NAME_win1251);    // removed since 4.1
    ...
    for (int i = 1; i < MAP_SIZE; i++) {
      ...
      if (COLLATION_INDEX_TO_COLLATION_NAME[i] == null) {
        throw new RuntimeException(
            "Assertion failure: No mapping from charset index " + i + " to a Java character set");
      }
    }
  }
   ...
   * result should match to connection encoding, for example if connection encoding is Cp943 we must
  ...
  public static String getMysqlCharsetForJavaEncoding(String javaEncoding) {
    if (javaEncoding != null) {
      List<MysqlCharset> mysqlCharsets = CharsetMapping.JAVA_ENCODING_UC_TO_MYSQL_CHARSET
          .get(javaEncoding.toUpperCase(Locale.ENGLISH));
