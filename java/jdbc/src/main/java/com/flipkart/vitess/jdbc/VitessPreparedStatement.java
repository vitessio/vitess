...
public class VitessPreparedStatement extends VitessStatement implements PreparedStatement {
    ...
    public VitessPreparedStatement(VitessConnection vitessConnection, String sql, int autoGeneratedKeys) throws
        SQLException {
        this(vitessConnection, sql, ResultSet.TYPE_FORWARD_ONLY, ResultSet.CONCUR_READ_ONLY, autoGeneratedKeys);
    }
