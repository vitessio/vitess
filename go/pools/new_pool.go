...
// NewPool allows you to use a pool of resources.
type NewPool struct {
	sync.Mutex
...
// NewNewPool creates a new NewPool pool.
...
func (rp *NewPool) ensureMinimumActive() {
	rp.Lock()
...
func (rp *NewPool) SetIdleTimeout(idleTimeout time.Duration) {
	rp.Lock()
...
// and closes them.
func (rp *NewPool) closeIdleResources() {
