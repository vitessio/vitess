...
func registerCommands(root *cobra.Command) {
	...
	create.Flags().StringSliceVar(&createOptions.WorkflowOptions.Shards, "shards", nil, "Only create vreplication streams in these target shards. Ensure that that all rows on the source will route to the selected shards, as per your Vindex choice.")
