...
func init() {
	...
	ApplySchema.Flags().StringVar(&applySchemaOptions.MigrationContext, "migration-context", "", "For Only DDL, optionally supply a custom unique string used as context for the migration(s) in this command. By default a unique context is auto-generated by Vitess.") // (TODO:ajm188) should this read "for Online DDL" or "for Only DDL"?
