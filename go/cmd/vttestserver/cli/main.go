...
func New() (cmd *cobra.Command) {
	...
	utils.SetFlagBoolVar(cmd.Flags(), &config.NoCrossKeyspaceJoins, "no-cross-keyspace-joins", false, "when set to true, the planner will fail instead of producing a plan that includes cross-keyspace joins")
