...
func TestMainFlagRegistration(t *testing.T) {
	...
	t.Run("grpc tls flags are registered", func(t *testing.T) {
		...
		assert.Empty(t, certFlag.DefValue)
		...
		assert.Empty(t, serverNameFlag.DefValue)
	})
}
