...
func registerStreamLogFlags(fs *pflag.FlagSet) {
	...
	fs.BoolVar(&queryLogConfigInstance.EmitOnAnyConditionMet, "querylog-on-any-condition-met", queryLogConfigInstance.EmitOnAnyConditionMet, "logs queries on any condition met (time/row/filtertag)")
}
