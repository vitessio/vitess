...
func newSizegen(mod *packages.Module, sizes types.Sizes, named *types.Named) *astHelperGen {
	return &astHelperGen{
		DebugTypes: true,
		mod:        mod,
		sizes:      sizes,
...
func (sizegen *astHelperGen) getKnownType(named *types.Named) *typeState {
...
func (sizegen *astHelperGen) generateType(pkg *types.Package, file *codeFile, named *types.Named) {
...
func (sizegen *astHelperGen) generateKnownType(named *types.Named) {
...
func (sizegen *astHelperGen) generateKnownInterface(pkg *types.Package, iff *types.Interface) {
...
func (sizegen *astHelperGen) finalize() map[string]*jen.File {
	var complete bool
...
func (sizegen *astHelperGen) sizeImplForStruct(name *types.TypeName, st *types.Struct) (jen.Code, codeFlag) {
...
func (sizegen *astHelperGen) sizeStmtForMap(fieldName *jen.Statement, m *types.Map) []jen.Code {
	const bucketCnt = 8
...
func (sizegen *astHelperGen) sizeStmtForType(fieldName *jen.Statement, field types.Type, alloc bool) (jen.Code, codeFlag) {
...
func GenerateASTHelpers(packagePatterns []string, rootIface string) (map[string]*jen.File, error) {
	...
	generator := newSizegen(loaded[0].Module, loaded[0].TypesSizes, tt.Type().(*types.Named))
	//generator.generateKnownType(tt.Type().(*types.Named))

	return generator.finalize(), nil
}
