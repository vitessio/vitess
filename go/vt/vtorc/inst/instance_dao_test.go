...
func TestMkInsertOdkuSingle(t *testing.T) {
	...
	s1 := `INSERT ignore INTO database_instance
		...
		ON DUPLICATE KEY UPDATE
				...
				last_discovery_latency=VALUES(last_discovery_latency), stalled_disk=VALUES(stalled_disk), last_seen=VALUES(last_seen)
       `
	a1 := `zone1-i710, i710, 3306, 710, , 5.6.7, 5.6, MySQL, false, false, STATEMENT,
	FULL, false, false, , 0, , 0, 0, 0,
	false, false, 0, 0, false, false, false, , , , , , , false, false, , 0, mysql.000007, 10, , 0, , , {0 false}, {0 false}, 0, , , , 0, false, false, false, false, false, 0, 0, false, false, 0, false, 0, false,`
...
func TestMkInsertOdkuThree(t *testing.T) {
	...
	s3 := `INSERT  INTO database_instance
       ...
       `
	a3 := `
		zone1-i710, i710, 3306, 710, , 5.6.7, 5.6, MySQL, false, false, STATEMENT, FULL, false, false, , 0, , 0, 0, 0, false, false, 0, 0, false, false, false, , , , , , , false, false, , 0, mysql.000007, 10, , 0, , , {0 false}, {0 false}, 0, , , , 0, false, false, false, false, false, 0, 0, false, false, 0, false, 0, false,
		zone1-i720, i720, 3306, 720, , 5.6.7, 5.6, MySQL, false, false, STATEMENT, FULL, false, false, , 0, , 0, 0, 0, false, false, 0, 0, false, false, false, , , , , , , false, false, , 0, mysql.000007, 20, , 0, , , {0 false}, {0 false}, 0, , , , 0, false, false, false, false, false, 0, 0, false, false, 0, false, 0, false,
		zone1-i730, i730, 3306, 730, , 5.6.7, 5.6, MySQL, false, false, STATEMENT, FULL, false, false, , 0, , 0, 0, 0, false, false, 0, 0, false, false, false, , , , , , , false, false, , 0, mysql.000007, 30, , 0, , , {0 false}, {0 false}, 0, , , , 0, false, false, false, false, false, 0, 0, false, false, 0, false, 0, false,
		`
...
func TestUpdateInstanceLastChecked(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			stalledDisk:      false,
			conditionToCheck: "last_checked >= now() - interval 30 second and last_check_partial_success = false and stalled_disk = false",
		}, {
			name:             "Verify partial success",
			tabletAlias:      "zone1-0000000100",
			partialSuccess:   true,
			stalledDisk:      false,
			conditionToCheck: "last_checked >= now() - interval 30 second and last_check_partial_success = true and stalled_disk = false",
		}, {
			name:             "Verify stalled disk",
			tabletAlias:      "zone1-0000000100",
			partialSuccess:   false,
			stalledDisk:      true,
			conditionToCheck: "last_checked >= now() - interval 30 second and last_check_partial_success = false and stalled_disk = true",
		}, {
