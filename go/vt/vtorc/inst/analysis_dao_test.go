...
var initialSQL = []string{
	...
	`INSERT INTO vitess_keyspace VALUES('ks',0,'semi_sync',0,0);`,
}
	...
	tests := []struct {
		...
		},
		{
			...
			info: []*test.InfoForRecoveryAnalysis{{
				...
				DurabilityPolicy:              policy.DurabilitySemiSync,
				RdonlyReplicationSourcePolicy: topodatapb.ReplicationSourceConfig_RDONLY_REPLICATION_SOURCE_POLICY_REQUIRE_SEMI_SYNC_ACKER,
				LastCheckValid:                1,
				CountReplicas:                 2,
				CountValidReplicas:            2,
				CountValidReplicatingReplicas: 2,
				CountValidOracleGTIDReplicas:  2,
