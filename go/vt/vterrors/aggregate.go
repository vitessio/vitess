...
var errorPriorities = map[vtrpcpb.Code]int{
	...
	vtrpcpb.Code_MYSQL_DISK_FULL:              PriorityResourceExhausted,
	vtrpcpb.Code_MYSQL_OUT_OF_MEMORY:          PriorityResourceExhausted,
	vtrpcpb.Code_MYSQL_OUT_OF_SORT_MEMORY:     PriorityResourceExhausted,
	vtrpcpb.Code_MYSQL_CONNECTIONS_COUNT:      PriorityResourceExhausted,
	vtrpcpb.Code_MYSQL_OUT_OF_RESOURCES:       PriorityResourceExhausted,
	vtrpcpb.Code_MYSQL_RECORD_FILE_FULL:       PriorityResourceExhausted,
	vtrpcpb.Code_MYSQL_HOST_IS_BLOCKED:        PriorityResourceExhausted,
	vtrpcpb.Code_MYSQL_CREATE_THREAD_FAILED:   PriorityResourceExhausted,
	vtrpcpb.Code_MYSQL_DELAYED_THREADS_COUNT:  PriorityResourceExhausted,
	vtrpcpb.Code_MYSQL_NET_PACKET_TOO_LARGE:   PriorityResourceExhausted,
	vtrpcpb.Code_MYSQL_USER_CONNECTIONS_COUNT: PriorityResourceExhausted,
	vtrpcpb.Code_MYSQL_LOCK_TABLE_FULL:        PriorityResourceExhausted,
	vtrpcpb.Code_MYSQL_USER_LIMIT_REACHED:     PriorityResourceExhausted,
