...
var (
	...
	VT09033 = errorWithoutState("VT09033", vtrpcpb.Code_INVALID_ARGUMENT, "modification of internal table '%s' is not allowed", "Vitess does not allow modifications to internal Vitess tables.")
