...
var (
	...
	VT12002 = errorWithoutState("VT12002", vtrpcpb.Code_UNIMPLEMENTED, "unsupported cross-shard foreign keys", "Vitess does not support cross shard foreign key management.")
