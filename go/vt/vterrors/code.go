...
var (
	...
	VT09012 = errorWithoutState("VT09012", vtrpcpb.Code_FAILED_PRECONDITION, "%s statement with non primary target not allowed", "This type of statement is not allowed on a non primary target.")
