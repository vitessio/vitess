...
var (
	...
	VT03031 = errorWithoutState("VT03031", vtrpcpb.Code_INVALID_ARGUMENT, "use VExplain statement type for multi-keyspace query", "Refer the docs to see how VExplain works")
