...
// SubmitPrimaryToKvStores writes a cluster's primary (or all clusters primaries) to kv stores.
// This should generally only happen once in a lifetime of a cluster. Otherwise KV
// stores are updated via failovers.
func (this *HttpAPI) SubmitPrimaryToKvStores(params martini.Params, r render.Render, req *http.Request) {
