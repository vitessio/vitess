...
func registerBackupFlags(fs *pflag.FlagSet) {
	...
	_ = fs.MarkDeprecated("backup_storage_hook", "consider using one of the builtin compression algorithms or --external-compressor-cmd and --external-decompressor-cmd instead.")
