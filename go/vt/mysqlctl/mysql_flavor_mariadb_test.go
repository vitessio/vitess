...
func TestParseMariaGTID(t *testing.T) {
	input := "12-345-6789"
	want := mariaGTID{domain: 12, server: 345, sequence: 6789}

	got, err := (&mariaDB10{}).ParseGTID(input)
	if err != nil {
		t.Errorf("%v", err)
	}
	if got.(mariaGTID) != want {
...
func TestParseInvalidMariaGTID(t *testing.T) {
	...
	_, err := (&mariaDB10{}).ParseGTID(input)
	if err == nil {
...
func TestMariaGTIDString(t *testing.T) {
	input := mariaGTID{domain: 5, server: 4727, sequence: 1737373}
	want := "5-4727-1737373"
...
func TestMariaGTIDCompareGreater(t *testing.T) {
	input1 := mariaGTID{domain: 5, server: 4727, sequence: 9000}
	input2 := mariaGTID{domain: 5, server: 4727, sequence: 100}
...
func TestMariaGTIDCompareEqual(t *testing.T) {
	input1 := mariaGTID{domain: 5, server: 4727, sequence: 1234}
	input2 := mariaGTID{domain: 5, server: 4727, sequence: 1234}
...
func TestMariaGTIDCompareWrongDomain(t *testing.T) {
	input1 := mariaGTID{domain: 3, server: 4727, sequence: 1234}
	input2 := mariaGTID{domain: 5, server: 4727, sequence: 1234}
...
func TestMariaGTIDCompareWrongServer(t *testing.T) {
	input1 := mariaGTID{domain: 3, server: 4727, sequence: 1234}
	input2 := mariaGTID{domain: 3, server: 5555, sequence: 1234}
