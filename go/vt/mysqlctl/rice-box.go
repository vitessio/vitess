...
func init() {
	...
	file3 := &embedded.EmbeddedFile{
		...
		FileModTime: time.Unix(1656124078, 0),
	...
	file5 := &embedded.EmbeddedFile{
		...
		FileModTime: time.Unix(1656124092, 0),
	...
	fileb := &embedded.EmbeddedFile{
		...
		FileModTime: time.Unix(1653685036, 0),
	...
	dir1 := &embedded.EmbeddedDir{
		Filename:   "",
		DirModTime: time.Unix(1656124078, 0),
	...
	dir4 := &embedded.EmbeddedDir{
		Filename:   "mycnf",
		DirModTime: time.Unix(1656124092, 0),
		ChildFiles: []*embedded.EmbeddedFile{
