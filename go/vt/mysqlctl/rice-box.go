...
func init() {
	...
	file3 := &embedded.EmbeddedFile{
		...
		FileModTime: time.Unix(1659645294, 0),
	...
	file6 := &embedded.EmbeddedFile{
		...
		FileModTime: time.Unix(1659633476, 0),
	...
	dir1 := &embedded.EmbeddedDir{
		Filename:   "",
		DirModTime: time.Unix(1659645294, 0),
	...
	dirk := &embedded.EmbeddedDir{
		Filename:   "zkcfg",
		DirModTime: time.Unix(1659633476, 0),
		ChildFiles: []*embedded.EmbeddedFile{
			filel, // "zkcfg/zoo.cfg"
