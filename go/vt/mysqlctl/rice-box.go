...
func init() {
	...
	file5 := &embedded.EmbeddedFile{
		...
		FileModTime: time.Unix(1590017750, 0),
	...
	file6 := &embedded.EmbeddedFile{
		...
		FileModTime: time.Unix(1593393697, 0),
	...
	dir1 := &embedded.EmbeddedDir{
		Filename:   "",
		DirModTime: time.Unix(1593186461, 0),
		ChildFiles: []*embedded.EmbeddedFile{
			file2, // "gomysql.pc.tmpl"
			file3, // "init_db.sql"
			filei, // "zk-client-dev.json"

		},
	}
	dir4 := &embedded.EmbeddedDir{
		Filename:   "mycnf",
		DirModTime: time.Unix(1593393697, 0),
		ChildFiles: []*embedded.EmbeddedFile{
	...
	dirg := &embedded.EmbeddedDir{
		Filename:   "tablet",
		DirModTime: time.Unix(1590017750, 0),
		ChildFiles: []*embedded.EmbeddedFile{
			fileh, // "tablet/default.yaml"
	...
	embedded.RegisterEmbeddedBox(`../../../config`, &embedded.EmbeddedBox{
		...
		Files: map[string]*embedded.EmbeddedFile{
			...
			"mycnf/sbr.cnf":               filef,
			"tablet/default.yaml":         fileh,
			"zk-client-dev.json":          filei,
			"zkcfg/zoo.cfg":               filek,
		},
	})
}
