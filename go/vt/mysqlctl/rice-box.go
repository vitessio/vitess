...
func init() {
	...
	file3 := &embedded.EmbeddedFile{
		...
		FileModTime: time.Unix(1653192319, 0),
	...
	filec := &embedded.EmbeddedFile{
		...
		FileModTime: time.Unix(1650553622, 0),
	...
	dir1 := &embedded.EmbeddedDir{
		Filename:   "",
		DirModTime: time.Unix(1653192220, 0),
	...
	dir4 := &embedded.EmbeddedDir{
		Filename:   "mycnf",
		DirModTime: time.Unix(1650553622, 0),
		ChildFiles: []*embedded.EmbeddedFile{
