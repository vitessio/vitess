...
func init() {
	...
	file6 := &embedded.EmbeddedFile{
		...
		FileModTime: time.Unix(1658506955, 0),
	...
	dir1 := &embedded.EmbeddedDir{
		Filename:   "",
		DirModTime: time.Unix(1658489960, 0),
	...
	dir4 := &embedded.EmbeddedDir{
		Filename:   "mycnf",
		DirModTime: time.Unix(1658506955, 0),
		ChildFiles: []*embedded.EmbeddedFile{
	...
	dirf := &embedded.EmbeddedDir{
		...
		DirModTime: time.Unix(1647748756, 0),
		ChildFiles: []*embedded.EmbeddedFile{
