...
func init() {
	...
	dir1 := &embedded.EmbeddedDir{
		Filename:   "",
		DirModTime: time.Unix(1653772923, 0),
	...
	dirf := &embedded.EmbeddedDir{
		...
		DirModTime: time.Unix(1640048569, 0),
		ChildFiles: []*embedded.EmbeddedFile{
