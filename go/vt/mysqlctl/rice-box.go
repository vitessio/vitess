...
func init() {
	...
	file3 := &embedded.EmbeddedFile{
		...
		FileModTime: time.Unix(1656748611, 0),
	...
	fileb := &embedded.EmbeddedFile{
		...
		FileModTime: time.Unix(1656535530, 0),
	...
	dir1 := &embedded.EmbeddedDir{
		Filename:   "",
		DirModTime: time.Unix(1656748611, 0),
	...
	dir4 := &embedded.EmbeddedDir{
		Filename:   "mycnf",
		DirModTime: time.Unix(1656535530, 0),
		ChildFiles: []*embedded.EmbeddedFile{
