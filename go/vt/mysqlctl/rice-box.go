...
func init() {
	...
	file3 := &embedded.EmbeddedFile{
		...
		FileModTime: time.Unix(1649906373, 0),
	...
	filec := &embedded.EmbeddedFile{
		...
		FileModTime: time.Unix(1647620676, 0),
	...
	dir1 := &embedded.EmbeddedDir{
		Filename:   "",
		DirModTime: time.Unix(1649906373, 0),
	...
	dir4 := &embedded.EmbeddedDir{
		Filename:   "mycnf",
		DirModTime: time.Unix(1647620676, 0),
		ChildFiles: []*embedded.EmbeddedFile{
