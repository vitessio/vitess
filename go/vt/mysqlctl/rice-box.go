...
func init() {
	...
	file3 := &embedded.EmbeddedFile{
		...
		FileModTime: time.Unix(1692225889, 0),
	...
	filei := &embedded.EmbeddedFile{
		...
		FileModTime: time.Unix(1690404870, 0),
	...
	dir1 := &embedded.EmbeddedDir{
		Filename:   "",
		DirModTime: time.Unix(1692225889, 0),
	...
	dirh := &embedded.EmbeddedDir{
		Filename:   "tablet",
		DirModTime: time.Unix(1690404870, 0),
		ChildFiles: []*embedded.EmbeddedFile{
