...
func TestKeyRangeFilterPass(t *testing.T) {
	...
	f(&input)
	want := `statement: <6, "set1"> statement: <4, "insert into tbl(col1, col2) values(1, a) /* vtgate:: keyspace_id:02 */"> statement: <4, "insert into tbl(col1, col2, col3) values(1, 2, 3) /* vtgate:: keyspace_id:01 *///trailing_comments"> statement: <4, "insert into tbl(col1, col2, col3) values(4, 5, 6) /* vtgate:: keyspace_id:02 *///trailing_comments"> statement: <4, "insert into tbl(col1, col2, col3) values(1, 2, 3) /* vtgate:: keyspace_id:01 *///trailing_comments"> position: "MariaDB/0-41983-1" `
	if want != got {
