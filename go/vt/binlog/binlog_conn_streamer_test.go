...
func TestBinlogConnStreamerParseEventsOtherDBBegin(t *testing.T) {
	input := [][]byte{
		rotateEvent,
		formatEvent,
...
func TestBinlogConnStreamerParseEventsMariadbBeginGTID(t *testing.T) {
	input := [][]byte{
		mariadbRotateEvent,
		mariadbFormatEvent,
...
func TestBinlogConnStreamerParseEventsMariadbStandaloneGTID(t *testing.T) {
	input := [][]byte{
		mariadbRotateEvent,
		mariadbFormatEvent,
