...
type RealtimeStats struct {
	...
	// ThrottlerMetricError indicates failure in grabbing the throttler metrics. This does not necessarily mean
	// the tablet is in error.
	ThrottlerMetricError string `protobuf:"bytes,9,opt,name=throttler_metric_error,json=throttlerMetricError,proto3" json:"throttler_metric_error,omitempty"`
	// ThrottlerReplicationLagSeconds measures MySQL replication lag in subsecond precision,
	// and is used by the tablet throttler.
	// Reserved for future use.
	ThrottlerReplicationLagSeconds float64 `protobuf:"fixed64,10,opt,name=throttler_replication_lag_seconds,json=throttlerReplicationLagSeconds,proto3" json:"throttler_replication_lag_seconds,omitempty"`
	// ThrottlerMetric stores the result of a tablet throttler's "self" collected metric,
	// i.e. the metric collected from the throttler's tablet's mysqld
	ThrottlerMetric float64 `protobuf:"fixed64,11,opt,name=throttler_metric,json=throttlerMetric,proto3" json:"throttler_metric,omitempty"`
	// ThrottlerMetricCollected is a _temporary_ flag, always set to 'true', to help distinguish between `ThrottlerMetric==0` and
	// `ThrottlerMetric` not existing. It is useful in v17 because before v17 `ThrottlerMetric` does not exist. It can be removed in v18
	// because we can then expect it to always exist.
	ThrottlerMetricCollected bool `protobuf:"varint,12,opt,name=throttler_metric_collected,json=throttlerMetricCollected,proto3" json:"throttler_metric_collected,omitempty"`
}
...
func (x *RealtimeStats) GetThrottlerMetricError() string {
	if x != nil {
		return x.ThrottlerMetricError
	}
	return ""
}

func (x *RealtimeStats) GetThrottlerReplicationLagSeconds() float64 {
	if x != nil {
		return x.ThrottlerReplicationLagSeconds
	}
	return 0
}

func (x *RealtimeStats) GetThrottlerMetric() float64 {
	if x != nil {
		return x.ThrottlerMetric
	}
	return 0
}

func (x *RealtimeStats) GetThrottlerMetricCollected() bool {
	if x != nil {
		return x.ThrottlerMetricCollected
	}
	return false
}
...
var file_query_proto_rawDesc = []byte{
	...
	0x75, 0x65, 0x73, 0x74, 0x22, 0xe0, 0x04, 0x0a, 0x0d, 0x52, 0x65, 0x61, 0x6c, 0x74, 0x69, 0x6d,
	...
	,
