...
// InternalAPIRequest is the payload to InternalAPI
...
// InternalAPIResponse is the returned value from InternalAPI
...
func (x *InternalAPIResponse) GetResponse() string {
	if x != nil {
		return x.Response
	}
	return ""
