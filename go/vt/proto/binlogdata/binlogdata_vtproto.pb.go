...
func (m *DumpBinlogRequest) CloneVT() *DumpBinlogRequest {
	if m == nil {
		return (*DumpBinlogRequest)(nil)
	}
	r := new(DumpBinlogRequest)
	r.EffectiveCallerId = m.EffectiveCallerId.CloneVT()
	r.ImmediateCallerId = m.ImmediateCallerId.CloneVT()
	r.Target = m.Target.CloneVT()
	r.Gtid = m.Gtid
...
func (m *DumpBinlogRequest) CloneMessageVT() proto.Message {
	return m.CloneVT()
}

func (m *DumpBinlogResponse) CloneVT() *DumpBinlogResponse {
	if m == nil {
		return (*DumpBinlogResponse)(nil)
	}
	r := new(DumpBinlogResponse)
...
func (m *DumpBinlogResponse) CloneMessageVT() proto.Message {
	return m.CloneVT()
}
...
func (m *DumpBinlogRequest) MarshalVT() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *DumpBinlogRequest) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *DumpBinlogRequest) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
...
func (m *DumpBinlogResponse) MarshalVT() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *DumpBinlogResponse) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *DumpBinlogResponse) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
...
func (m *DumpBinlogRequest) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *DumpBinlogResponse) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *DumpBinlogRequest) UnmarshalVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: DumpBinlogRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: DumpBinlogRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *DumpBinlogResponse) UnmarshalVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: DumpBinlogResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: DumpBinlogResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
