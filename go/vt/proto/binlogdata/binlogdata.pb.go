...
var file_binlogdata_proto_rawDesc = []byte{
	...
	0x07, 0x6c, 0x61, 0x73, 0x74, 0x70, 0x6b, 0x73, 0x22, 0x98, 0x02, 0x0a, 0x13, 0x56, 0x53, 0x74,
	...
	0x62, 0x65, 0x61, 0x74, 0x12, 0x1d, 0x0a, 0x0a, 0x74, 0x61, 0x62, 0x6c, 0x65, 0x5f, 0x6e, 0x61,
	0x6d, 0x65, 0x18, 0x08, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x74, 0x61, 0x62, 0x6c, 0x65, 0x4e,
	0x61, 0x6d, 0x65, 0x22, 0x69, 0x0a, 0x0b, 0x4c, 0x61, 0x73, 0x74, 0x50, 0x4b, 0x45, 0x76, 0x65,
	...
	0x49, 0x4e, 0x45, 0x44, 0x44, 0x4c, 0x10, 0x05, 0x2a, 0xf9, 0x01, 0x0a, 0x0a, 0x56, 0x45, 0x76,
...
var file_binlogdata_proto_goTypes = []interface{}{
	...
	(*VStreamRowsParallelRequest)(nil),        // 29: binlogdata.VStreamRowsParallelRequest
...
var file_binlogdata_proto_depIdxs = []int32{
	...
	43, // 42: binlogdata.VStreamRowsParallelRequest.effective_caller_id:type_name -> vtrpc.CallerID
	44, // 43: binlogdata.VStreamRowsParallelRequest.immediate_caller_id:type_name -> query.VTGateCallerID
	45, // 44: binlogdata.VStreamRowsParallelRequest.target:type_name -> query.Target
	46, // 45: binlogdata.VStreamRowsParallelRequest.lastpks:type_name -> query.QueryResult
	42, // 46: binlogdata.VStreamRowsResponse.fields:type_name -> query.Field
	42, // 47: binlogdata.VStreamRowsResponse.pkfields:type_name -> query.Field
	41, // 48: binlogdata.VStreamRowsResponse.rows:type_name -> query.Row
	41, // 49: binlogdata.VStreamRowsResponse.lastpk:type_name -> query.Row
	32, // 50: binlogdata.LastPKEvent.table_last_p_k:type_name -> binlogdata.TableLastPK
	46, // 51: binlogdata.TableLastPK.lastpk:type_name -> query.QueryResult
	43, // 52: binlogdata.VStreamResultsRequest.effective_caller_id:type_name -> vtrpc.CallerID
	44, // 53: binlogdata.VStreamResultsRequest.immediate_caller_id:type_name -> query.VTGateCallerID
	45, // 54: binlogdata.VStreamResultsRequest.target:type_name -> query.Target
	42, // 55: binlogdata.VStreamResultsResponse.fields:type_name -> query.Field
	41, // 56: binlogdata.VStreamResultsResponse.rows:type_name -> query.Row
	4,  // 57: binlogdata.BinlogTransaction.Statement.category:type_name -> binlogdata.BinlogTransaction.Statement.Category
	6,  // 58: binlogdata.BinlogTransaction.Statement.charset:type_name -> binlogdata.Charset
	12, // 59: binlogdata.Rule.ConvertCharsetEntry.value:type_name -> binlogdata.CharsetConversion
