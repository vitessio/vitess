...
var file_binlogdata_proto_rawDesc = []byte{
	...
	0x74, 0x61, 0x62, 0x6c, 0x65, 0x73, 0x22, 0xff, 0x01, 0x0a, 0x0e, 0x56, 0x53, 0x74, 0x72, 0x65,
	...
	0x6f, 0x6e, 0x66, 0x69, 0x67, 0x4f, 0x76, 0x65, 0x72, 0x72, 0x69, 0x64, 0x65, 0x73, 0x12, 0x24,
	0x0a, 0x0e, 0x74, 0x61, 0x62, 0x6c, 0x65, 0x73, 0x5f, 0x74, 0x6f, 0x5f, 0x63, 0x6f, 0x70, 0x79,
	0x18, 0x03, 0x20, 0x03, 0x28, 0x09, 0x52, 0x0c, 0x74, 0x61, 0x62, 0x6c, 0x65, 0x73, 0x54, 0x6f,
	0x43, 0x6f, 0x70, 0x79, 0x1a, 0x42, 0x0a, 0x14, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x4f, 0x76,
...
var file_binlogdata_proto_depIdxs = []int32{
	...
	49, // 46: binlogdata.VStreamRowsResponse.fields:type_name -> query.Field
	49, // 47: binlogdata.VStreamRowsResponse.pkfields:type_name -> query.Field
	48, // 48: binlogdata.VStreamRowsResponse.rows:type_name -> query.Row
	48, // 49: binlogdata.VStreamRowsResponse.lastpk:type_name -> query.Row
	50, // 50: binlogdata.VStreamTablesRequest.effective_caller_id:type_name -> vtrpc.CallerID
	51, // 51: binlogdata.VStreamTablesRequest.immediate_caller_id:type_name -> query.VTGateCallerID
	52, // 52: binlogdata.VStreamTablesRequest.target:type_name -> query.Target
	49, // 53: binlogdata.VStreamTablesResponse.fields:type_name -> query.Field
	49, // 54: binlogdata.VStreamTablesResponse.pkfields:type_name -> query.Field
	48, // 55: binlogdata.VStreamTablesResponse.rows:type_name -> query.Row
	48, // 56: binlogdata.VStreamTablesResponse.lastpk:type_name -> query.Row
	36, // 57: binlogdata.LastPKEvent.table_last_p_k:type_name -> binlogdata.TableLastPK
	53, // 58: binlogdata.TableLastPK.lastpk:type_name -> query.QueryResult
	50, // 59: binlogdata.VStreamResultsRequest.effective_caller_id:type_name -> vtrpc.CallerID
	51, // 60: binlogdata.VStreamResultsRequest.immediate_caller_id:type_name -> query.VTGateCallerID
	52, // 61: binlogdata.VStreamResultsRequest.target:type_name -> query.Target
	49, // 62: binlogdata.VStreamResultsResponse.fields:type_name -> query.Field
	48, // 63: binlogdata.VStreamResultsResponse.rows:type_name -> query.Row
	6,  // 64: binlogdata.BinlogTransaction.Statement.category:type_name -> binlogdata.BinlogTransaction.Statement.Category
	8,  // 65: binlogdata.BinlogTransaction.Statement.charset:type_name -> binlogdata.Charset
	14, // 66: binlogdata.Rule.ConvertCharsetEntry.value:type_name -> binlogdata.CharsetConversion
