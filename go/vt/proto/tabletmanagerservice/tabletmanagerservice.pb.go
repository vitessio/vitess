...
type TabletManagerClient interface {
	...
	VReplicationCreate(ctx context.Context, in *tabletmanagerdata.VReplicationCreateRequest, opts ...grpc.CallOption) (*tabletmanagerdata.VReplicationCreateResponse, error)
...
func (c *tabletManagerClient) VReplicationCreate(ctx context.Context, in *tabletmanagerdata.VReplicationCreateRequest, opts ...grpc.CallOption) (*tabletmanagerdata.VReplicationCreateResponse, error) {
	out := new(tabletmanagerdata.VReplicationCreateResponse)
	err := grpc.Invoke(ctx, "/tabletmanagerservice.TabletManager/VReplicationCreate", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TabletManagerServer interface {
	...
	VReplicationCreate(context.Context, *tabletmanagerdata.VReplicationCreateRequest) (*tabletmanagerdata.VReplicationCreateResponse, error)
	// ResetReplication makes the target not replicating
...
func _TabletManager_VReplicationCreate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(tabletmanagerdata.VReplicationCreateRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TabletManagerServer).VReplicationCreate(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tabletmanagerservice.TabletManager/VReplicationCreate",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TabletManagerServer).VReplicationCreate(ctx, req.(*tabletmanagerdata.VReplicationCreateRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _TabletManager_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "VReplicationCreate",
			Handler:    _TabletManager_VReplicationCreate_Handler,
		},
		{
...
func init() {
	proto.RegisterFile("tabletmanagerservice.proto", fileDescriptor_tabletmanagerservice_8453648c6fd9e366)
}

var fileDescriptor_tabletmanagerservice_8453648c6fd9e366 = []byte{
	// 1016 bytes of a gzipped FileDescriptorProto
	,
}
