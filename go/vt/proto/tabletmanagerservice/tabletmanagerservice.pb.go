...
var file_tabletmanagerservice_proto_rawDesc = []byte{
	...
	0x72, 0x64, 0x61, 0x74, 0x61, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x32, 0xd4, 0x35, 0x0a, 0x0d,
	...
	0x00, 0x12, 0x73, 0x0a, 0x12, 0x4d, 0x79, 0x73, 0x71, 0x6c, 0x53, 0x79, 0x73, 0x74, 0x65, 0x6d,
	0x4d, 0x65, 0x74, 0x72, 0x69, 0x63, 0x73, 0x12, 0x2c, 0x2e, 0x74, 0x61, 0x62, 0x6c, 0x65, 0x74,
	0x6d, 0x61, 0x6e, 0x61, 0x67, 0x65, 0x72, 0x64, 0x61, 0x74, 0x61, 0x2e, 0x4d, 0x79, 0x73, 0x71,
	...
	0x6e, 0x61, 0x67, 0x65, 0x72, 0x64, 0x61, 0x74, 0x61, 0x2e, 0x4d, 0x79, 0x73, 0x71, 0x6c, 0x53,
...
var file_tabletmanagerservice_proto_goTypes = []any{
	...
	(*tabletmanagerdata.MysqlSystemMetricsRequest)(nil),           // 24: tabletmanagerdata.MysqlSystemMetricsRequest
	...
	(*tabletmanagerdata.VReplicationExecRequest)(nil),             // 39: tabletmanagerdata.VReplicationExecRequest
	(*tabletmanagerdata.VReplicationWaitForPosRequest)(nil),       // 40: tabletmanagerdata.VReplicationWaitForPosRequest
	...
	(*tabletmanagerdata.VDiffRequest)(nil),                        // 43: tabletmanagerdata.VDiffRequest
	(*tabletmanagerdata.ResetReplicationRequest)(nil),             // 44: tabletmanagerdata.ResetReplicationRequest
	(*tabletmanagerdata.InitPrimaryRequest)(nil),                  // 45: tabletmanagerdata.InitPrimaryRequest
	(*tabletmanagerdata.PopulateReparentJournalRequest)(nil),      // 46: tabletmanagerdata.PopulateReparentJournalRequest
	(*tabletmanagerdata.InitReplicaRequest)(nil),                  // 47: tabletmanagerdata.InitReplicaRequest
	(*tabletmanagerdata.DemotePrimaryRequest)(nil),                // 48: tabletmanagerdata.DemotePrimaryRequest
	(*tabletmanagerdata.UndoDemotePrimaryRequest)(nil),            // 49: tabletmanagerdata.UndoDemotePrimaryRequest
	(*tabletmanagerdata.ReplicaWasPromotedRequest)(nil),           // 50: tabletmanagerdata.ReplicaWasPromotedRequest
	(*tabletmanagerdata.ResetReplicationParametersRequest)(nil),   // 51: tabletmanagerdata.ResetReplicationParametersRequest
	(*tabletmanagerdata.FullStatusRequest)(nil),                   // 52: tabletmanagerdata.FullStatusRequest
	(*tabletmanagerdata.SetReplicationSourceRequest)(nil),         // 53: tabletmanagerdata.SetReplicationSourceRequest
	(*tabletmanagerdata.ReplicaWasRestartedRequest)(nil),          // 54: tabletmanagerdata.ReplicaWasRestartedRequest
	(*tabletmanagerdata.StopReplicationAndGetStatusRequest)(nil),  // 55: tabletmanagerdata.StopReplicationAndGetStatusRequest
	(*tabletmanagerdata.PromoteReplicaRequest)(nil),               // 56: tabletmanagerdata.PromoteReplicaRequest
	(*tabletmanagerdata.BackupRequest)(nil),                       // 57: tabletmanagerdata.BackupRequest
	(*tabletmanagerdata.RestoreFromBackupRequest)(nil),            // 58: tabletmanagerdata.RestoreFromBackupRequest
	(*tabletmanagerdata.CheckThrottlerRequest)(nil),               // 59: tabletmanagerdata.CheckThrottlerRequest
	(*tabletmanagerdata.GetThrottlerStatusRequest)(nil),           // 60: tabletmanagerdata.GetThrottlerStatusRequest
	(*tabletmanagerdata.PingResponse)(nil),                        // 61: tabletmanagerdata.PingResponse
	(*tabletmanagerdata.SleepResponse)(nil),                       // 62: tabletmanagerdata.SleepResponse
	(*tabletmanagerdata.ExecuteHookResponse)(nil),                 // 63: tabletmanagerdata.ExecuteHookResponse
	(*tabletmanagerdata.GetSchemaResponse)(nil),                   // 64: tabletmanagerdata.GetSchemaResponse
	(*tabletmanagerdata.GetPermissionsResponse)(nil),              // 65: tabletmanagerdata.GetPermissionsResponse
	(*tabletmanagerdata.GetGlobalStatusVarsResponse)(nil),         // 66: tabletmanagerdata.GetGlobalStatusVarsResponse
	(*tabletmanagerdata.SetReadOnlyResponse)(nil),                 // 67: tabletmanagerdata.SetReadOnlyResponse
	(*tabletmanagerdata.SetReadWriteResponse)(nil),                // 68: tabletmanagerdata.SetReadWriteResponse
	(*tabletmanagerdata.ChangeTypeResponse)(nil),                  // 69: tabletmanagerdata.ChangeTypeResponse
	(*tabletmanagerdata.RefreshStateResponse)(nil),                // 70: tabletmanagerdata.RefreshStateResponse
	(*tabletmanagerdata.RunHealthCheckResponse)(nil),              // 71: tabletmanagerdata.RunHealthCheckResponse
	(*tabletmanagerdata.ReloadSchemaResponse)(nil),                // 72: tabletmanagerdata.ReloadSchemaResponse
	(*tabletmanagerdata.PreflightSchemaResponse)(nil),             // 73: tabletmanagerdata.PreflightSchemaResponse
	(*tabletmanagerdata.ApplySchemaResponse)(nil),                 // 74: tabletmanagerdata.ApplySchemaResponse
	(*tabletmanagerdata.ResetSequencesResponse)(nil),              // 75: tabletmanagerdata.ResetSequencesResponse
	(*tabletmanagerdata.LockTablesResponse)(nil),                  // 76: tabletmanagerdata.LockTablesResponse
	(*tabletmanagerdata.UnlockTablesResponse)(nil),                // 77: tabletmanagerdata.UnlockTablesResponse
	(*tabletmanagerdata.ExecuteQueryResponse)(nil),                // 78: tabletmanagerdata.ExecuteQueryResponse
	(*tabletmanagerdata.ExecuteFetchAsDbaResponse)(nil),           // 79: tabletmanagerdata.ExecuteFetchAsDbaResponse
	(*tabletmanagerdata.ExecuteMultiFetchAsDbaResponse)(nil),      // 80: tabletmanagerdata.ExecuteMultiFetchAsDbaResponse
	(*tabletmanagerdata.ExecuteFetchAsAllPrivsResponse)(nil),      // 81: tabletmanagerdata.ExecuteFetchAsAllPrivsResponse
	(*tabletmanagerdata.ExecuteFetchAsAppResponse)(nil),           // 82: tabletmanagerdata.ExecuteFetchAsAppResponse
	(*tabletmanagerdata.GetUnresolvedTransactionsResponse)(nil),   // 83: tabletmanagerdata.GetUnresolvedTransactionsResponse
	(*tabletmanagerdata.ConcludeTransactionResponse)(nil),         // 84: tabletmanagerdata.ConcludeTransactionResponse
	(*tabletmanagerdata.MysqlSystemMetricsResponse)(nil),          // 85: tabletmanagerdata.MysqlSystemMetricsResponse
	(*tabletmanagerdata.ReplicationStatusResponse)(nil),           // 86: tabletmanagerdata.ReplicationStatusResponse
	(*tabletmanagerdata.PrimaryStatusResponse)(nil),               // 87: tabletmanagerdata.PrimaryStatusResponse
	(*tabletmanagerdata.PrimaryPositionResponse)(nil),             // 88: tabletmanagerdata.PrimaryPositionResponse
	(*tabletmanagerdata.WaitForPositionResponse)(nil),             // 89: tabletmanagerdata.WaitForPositionResponse
	(*tabletmanagerdata.StopReplicationResponse)(nil),             // 90: tabletmanagerdata.StopReplicationResponse
	(*tabletmanagerdata.StopReplicationMinimumResponse)(nil),      // 91: tabletmanagerdata.StopReplicationMinimumResponse
	(*tabletmanagerdata.StartReplicationResponse)(nil),            // 92: tabletmanagerdata.StartReplicationResponse
	(*tabletmanagerdata.StartReplicationUntilAfterResponse)(nil),  // 93: tabletmanagerdata.StartReplicationUntilAfterResponse
	(*tabletmanagerdata.GetReplicasResponse)(nil),                 // 94: tabletmanagerdata.GetReplicasResponse
	(*tabletmanagerdata.CreateVReplicationWorkflowResponse)(nil),  // 95: tabletmanagerdata.CreateVReplicationWorkflowResponse
	(*tabletmanagerdata.DeleteVReplicationWorkflowResponse)(nil),  // 96: tabletmanagerdata.DeleteVReplicationWorkflowResponse
	(*tabletmanagerdata.HasVReplicationWorkflowsResponse)(nil),    // 97: tabletmanagerdata.HasVReplicationWorkflowsResponse
	(*tabletmanagerdata.ReadVReplicationWorkflowResponse)(nil),    // 98: tabletmanagerdata.ReadVReplicationWorkflowResponse
	(*tabletmanagerdata.ReadVReplicationWorkflowsResponse)(nil),   // 99: tabletmanagerdata.ReadVReplicationWorkflowsResponse
	(*tabletmanagerdata.VReplicationExecResponse)(nil),            // 100: tabletmanagerdata.VReplicationExecResponse
	(*tabletmanagerdata.VReplicationWaitForPosResponse)(nil),      // 101: tabletmanagerdata.VReplicationWaitForPosResponse
	(*tabletmanagerdata.UpdateVReplicationWorkflowResponse)(nil),  // 102: tabletmanagerdata.UpdateVReplicationWorkflowResponse
	(*tabletmanagerdata.UpdateVReplicationWorkflowsResponse)(nil), // 103: tabletmanagerdata.UpdateVReplicationWorkflowsResponse
	(*tabletmanagerdata.VDiffResponse)(nil),                       // 104: tabletmanagerdata.VDiffResponse
	(*tabletmanagerdata.ResetReplicationResponse)(nil),            // 105: tabletmanagerdata.ResetReplicationResponse
	(*tabletmanagerdata.InitPrimaryResponse)(nil),                 // 106: tabletmanagerdata.InitPrimaryResponse
	(*tabletmanagerdata.PopulateReparentJournalResponse)(nil),     // 107: tabletmanagerdata.PopulateReparentJournalResponse
	(*tabletmanagerdata.InitReplicaResponse)(nil),                 // 108: tabletmanagerdata.InitReplicaResponse
	(*tabletmanagerdata.DemotePrimaryResponse)(nil),               // 109: tabletmanagerdata.DemotePrimaryResponse
	(*tabletmanagerdata.UndoDemotePrimaryResponse)(nil),           // 110: tabletmanagerdata.UndoDemotePrimaryResponse
	(*tabletmanagerdata.ReplicaWasPromotedResponse)(nil),          // 111: tabletmanagerdata.ReplicaWasPromotedResponse
	(*tabletmanagerdata.ResetReplicationParametersResponse)(nil),  // 112: tabletmanagerdata.ResetReplicationParametersResponse
	(*tabletmanagerdata.FullStatusResponse)(nil),                  // 113: tabletmanagerdata.FullStatusResponse
	(*tabletmanagerdata.SetReplicationSourceResponse)(nil),        // 114: tabletmanagerdata.SetReplicationSourceResponse
	(*tabletmanagerdata.ReplicaWasRestartedResponse)(nil),         // 115: tabletmanagerdata.ReplicaWasRestartedResponse
	(*tabletmanagerdata.StopReplicationAndGetStatusResponse)(nil), // 116: tabletmanagerdata.StopReplicationAndGetStatusResponse
	(*tabletmanagerdata.PromoteReplicaResponse)(nil),              // 117: tabletmanagerdata.PromoteReplicaResponse
	(*tabletmanagerdata.BackupResponse)(nil),                      // 118: tabletmanagerdata.BackupResponse
	(*tabletmanagerdata.RestoreFromBackupResponse)(nil),           // 119: tabletmanagerdata.RestoreFromBackupResponse
	(*tabletmanagerdata.CheckThrottlerResponse)(nil),              // 120: tabletmanagerdata.CheckThrottlerResponse
	(*tabletmanagerdata.GetThrottlerStatusResponse)(nil),          // 121: tabletmanagerdata.GetThrottlerStatusResponse
}
var file_tabletmanagerservice_proto_depIdxs = []int32{
	...
	24,  // 24: tabletmanagerservice.TabletManager.MysqlSystemMetrics:input_type -> tabletmanagerdata.MysqlSystemMetricsRequest
	...
	39,  // 39: tabletmanagerservice.TabletManager.VReplicationExec:input_type -> tabletmanagerdata.VReplicationExecRequest
	40,  // 40: tabletmanagerservice.TabletManager.VReplicationWaitForPos:input_type -> tabletmanagerdata.VReplicationWaitForPosRequest
	...
	43,  // 43: tabletmanagerservice.TabletManager.VDiff:input_type -> tabletmanagerdata.VDiffRequest
	44,  // 44: tabletmanagerservice.TabletManager.ResetReplication:input_type -> tabletmanagerdata.ResetReplicationRequest
	45,  // 45: tabletmanagerservice.TabletManager.InitPrimary:input_type -> tabletmanagerdata.InitPrimaryRequest
	46,  // 46: tabletmanagerservice.TabletManager.PopulateReparentJournal:input_type -> tabletmanagerdata.PopulateReparentJournalRequest
	47,  // 47: tabletmanagerservice.TabletManager.InitReplica:input_type -> tabletmanagerdata.InitReplicaRequest
	48,  // 48: tabletmanagerservice.TabletManager.DemotePrimary:input_type -> tabletmanagerdata.DemotePrimaryRequest
	49,  // 49: tabletmanagerservice.TabletManager.UndoDemotePrimary:input_type -> tabletmanagerdata.UndoDemotePrimaryRequest
	50,  // 50: tabletmanagerservice.TabletManager.ReplicaWasPromoted:input_type -> tabletmanagerdata.ReplicaWasPromotedRequest
	51,  // 51: tabletmanagerservice.TabletManager.ResetReplicationParameters:input_type -> tabletmanagerdata.ResetReplicationParametersRequest
	52,  // 52: tabletmanagerservice.TabletManager.FullStatus:input_type -> tabletmanagerdata.FullStatusRequest
	53,  // 53: tabletmanagerservice.TabletManager.SetReplicationSource:input_type -> tabletmanagerdata.SetReplicationSourceRequest
	54,  // 54: tabletmanagerservice.TabletManager.ReplicaWasRestarted:input_type -> tabletmanagerdata.ReplicaWasRestartedRequest
	55,  // 55: tabletmanagerservice.TabletManager.StopReplicationAndGetStatus:input_type -> tabletmanagerdata.StopReplicationAndGetStatusRequest
	56,  // 56: tabletmanagerservice.TabletManager.PromoteReplica:input_type -> tabletmanagerdata.PromoteReplicaRequest
	57,  // 57: tabletmanagerservice.TabletManager.Backup:input_type -> tabletmanagerdata.BackupRequest
	58,  // 58: tabletmanagerservice.TabletManager.RestoreFromBackup:input_type -> tabletmanagerdata.RestoreFromBackupRequest
	59,  // 59: tabletmanagerservice.TabletManager.CheckThrottler:input_type -> tabletmanagerdata.CheckThrottlerRequest
	60,  // 60: tabletmanagerservice.TabletManager.GetThrottlerStatus:input_type -> tabletmanagerdata.GetThrottlerStatusRequest
	61,  // 61: tabletmanagerservice.TabletManager.Ping:output_type -> tabletmanagerdata.PingResponse
	62,  // 62: tabletmanagerservice.TabletManager.Sleep:output_type -> tabletmanagerdata.SleepResponse
	63,  // 63: tabletmanagerservice.TabletManager.ExecuteHook:output_type -> tabletmanagerdata.ExecuteHookResponse
	64,  // 64: tabletmanagerservice.TabletManager.GetSchema:output_type -> tabletmanagerdata.GetSchemaResponse
	65,  // 65: tabletmanagerservice.TabletManager.GetPermissions:output_type -> tabletmanagerdata.GetPermissionsResponse
	66,  // 66: tabletmanagerservice.TabletManager.GetGlobalStatusVars:output_type -> tabletmanagerdata.GetGlobalStatusVarsResponse
	67,  // 67: tabletmanagerservice.TabletManager.SetReadOnly:output_type -> tabletmanagerdata.SetReadOnlyResponse
	68,  // 68: tabletmanagerservice.TabletManager.SetReadWrite:output_type -> tabletmanagerdata.SetReadWriteResponse
	69,  // 69: tabletmanagerservice.TabletManager.ChangeType:output_type -> tabletmanagerdata.ChangeTypeResponse
	70,  // 70: tabletmanagerservice.TabletManager.RefreshState:output_type -> tabletmanagerdata.RefreshStateResponse
	71,  // 71: tabletmanagerservice.TabletManager.RunHealthCheck:output_type -> tabletmanagerdata.RunHealthCheckResponse
	72,  // 72: tabletmanagerservice.TabletManager.ReloadSchema:output_type -> tabletmanagerdata.ReloadSchemaResponse
	73,  // 73: tabletmanagerservice.TabletManager.PreflightSchema:output_type -> tabletmanagerdata.PreflightSchemaResponse
	74,  // 74: tabletmanagerservice.TabletManager.ApplySchema:output_type -> tabletmanagerdata.ApplySchemaResponse
	75,  // 75: tabletmanagerservice.TabletManager.ResetSequences:output_type -> tabletmanagerdata.ResetSequencesResponse
	76,  // 76: tabletmanagerservice.TabletManager.LockTables:output_type -> tabletmanagerdata.LockTablesResponse
	77,  // 77: tabletmanagerservice.TabletManager.UnlockTables:output_type -> tabletmanagerdata.UnlockTablesResponse
	78,  // 78: tabletmanagerservice.TabletManager.ExecuteQuery:output_type -> tabletmanagerdata.ExecuteQueryResponse
	79,  // 79: tabletmanagerservice.TabletManager.ExecuteFetchAsDba:output_type -> tabletmanagerdata.ExecuteFetchAsDbaResponse
	80,  // 80: tabletmanagerservice.TabletManager.ExecuteMultiFetchAsDba:output_type -> tabletmanagerdata.ExecuteMultiFetchAsDbaResponse
	81,  // 81: tabletmanagerservice.TabletManager.ExecuteFetchAsAllPrivs:output_type -> tabletmanagerdata.ExecuteFetchAsAllPrivsResponse
	82,  // 82: tabletmanagerservice.TabletManager.ExecuteFetchAsApp:output_type -> tabletmanagerdata.ExecuteFetchAsAppResponse
	83,  // 83: tabletmanagerservice.TabletManager.GetUnresolvedTransactions:output_type -> tabletmanagerdata.GetUnresolvedTransactionsResponse
	84,  // 84: tabletmanagerservice.TabletManager.ConcludeTransaction:output_type -> tabletmanagerdata.ConcludeTransactionResponse
	85,  // 85: tabletmanagerservice.TabletManager.MysqlSystemMetrics:output_type -> tabletmanagerdata.MysqlSystemMetricsResponse
	86,  // 86: tabletmanagerservice.TabletManager.ReplicationStatus:output_type -> tabletmanagerdata.ReplicationStatusResponse
	87,  // 87: tabletmanagerservice.TabletManager.PrimaryStatus:output_type -> tabletmanagerdata.PrimaryStatusResponse
	88,  // 88: tabletmanagerservice.TabletManager.PrimaryPosition:output_type -> tabletmanagerdata.PrimaryPositionResponse
	89,  // 89: tabletmanagerservice.TabletManager.WaitForPosition:output_type -> tabletmanagerdata.WaitForPositionResponse
	90,  // 90: tabletmanagerservice.TabletManager.StopReplication:output_type -> tabletmanagerdata.StopReplicationResponse
	91,  // 91: tabletmanagerservice.TabletManager.StopReplicationMinimum:output_type -> tabletmanagerdata.StopReplicationMinimumResponse
	92,  // 92: tabletmanagerservice.TabletManager.StartReplication:output_type -> tabletmanagerdata.StartReplicationResponse
	93,  // 93: tabletmanagerservice.TabletManager.StartReplicationUntilAfter:output_type -> tabletmanagerdata.StartReplicationUntilAfterResponse
	94,  // 94: tabletmanagerservice.TabletManager.GetReplicas:output_type -> tabletmanagerdata.GetReplicasResponse
	95,  // 95: tabletmanagerservice.TabletManager.CreateVReplicationWorkflow:output_type -> tabletmanagerdata.CreateVReplicationWorkflowResponse
	96,  // 96: tabletmanagerservice.TabletManager.DeleteVReplicationWorkflow:output_type -> tabletmanagerdata.DeleteVReplicationWorkflowResponse
	97,  // 97: tabletmanagerservice.TabletManager.HasVReplicationWorkflows:output_type -> tabletmanagerdata.HasVReplicationWorkflowsResponse
	98,  // 98: tabletmanagerservice.TabletManager.ReadVReplicationWorkflow:output_type -> tabletmanagerdata.ReadVReplicationWorkflowResponse
	99,  // 99: tabletmanagerservice.TabletManager.ReadVReplicationWorkflows:output_type -> tabletmanagerdata.ReadVReplicationWorkflowsResponse
	100, // 100: tabletmanagerservice.TabletManager.VReplicationExec:output_type -> tabletmanagerdata.VReplicationExecResponse
	101, // 101: tabletmanagerservice.TabletManager.VReplicationWaitForPos:output_type -> tabletmanagerdata.VReplicationWaitForPosResponse
	102, // 102: tabletmanagerservice.TabletManager.UpdateVReplicationWorkflow:output_type -> tabletmanagerdata.UpdateVReplicationWorkflowResponse
	103, // 103: tabletmanagerservice.TabletManager.UpdateVReplicationWorkflows:output_type -> tabletmanagerdata.UpdateVReplicationWorkflowsResponse
	104, // 104: tabletmanagerservice.TabletManager.VDiff:output_type -> tabletmanagerdata.VDiffResponse
	105, // 105: tabletmanagerservice.TabletManager.ResetReplication:output_type -> tabletmanagerdata.ResetReplicationResponse
	106, // 106: tabletmanagerservice.TabletManager.InitPrimary:output_type -> tabletmanagerdata.InitPrimaryResponse
	107, // 107: tabletmanagerservice.TabletManager.PopulateReparentJournal:output_type -> tabletmanagerdata.PopulateReparentJournalResponse
	108, // 108: tabletmanagerservice.TabletManager.InitReplica:output_type -> tabletmanagerdata.InitReplicaResponse
	109, // 109: tabletmanagerservice.TabletManager.DemotePrimary:output_type -> tabletmanagerdata.DemotePrimaryResponse
	110, // 110: tabletmanagerservice.TabletManager.UndoDemotePrimary:output_type -> tabletmanagerdata.UndoDemotePrimaryResponse
	111, // 111: tabletmanagerservice.TabletManager.ReplicaWasPromoted:output_type -> tabletmanagerdata.ReplicaWasPromotedResponse
	112, // 112: tabletmanagerservice.TabletManager.ResetReplicationParameters:output_type -> tabletmanagerdata.ResetReplicationParametersResponse
	113, // 113: tabletmanagerservice.TabletManager.FullStatus:output_type -> tabletmanagerdata.FullStatusResponse
	114, // 114: tabletmanagerservice.TabletManager.SetReplicationSource:output_type -> tabletmanagerdata.SetReplicationSourceResponse
	115, // 115: tabletmanagerservice.TabletManager.ReplicaWasRestarted:output_type -> tabletmanagerdata.ReplicaWasRestartedResponse
	116, // 116: tabletmanagerservice.TabletManager.StopReplicationAndGetStatus:output_type -> tabletmanagerdata.StopReplicationAndGetStatusResponse
	117, // 117: tabletmanagerservice.TabletManager.PromoteReplica:output_type -> tabletmanagerdata.PromoteReplicaResponse
	118, // 118: tabletmanagerservice.TabletManager.Backup:output_type -> tabletmanagerdata.BackupResponse
	119, // 119: tabletmanagerservice.TabletManager.RestoreFromBackup:output_type -> tabletmanagerdata.RestoreFromBackupResponse
	120, // 120: tabletmanagerservice.TabletManager.CheckThrottler:output_type -> tabletmanagerdata.CheckThrottlerResponse
	121, // 121: tabletmanagerservice.TabletManager.GetThrottlerStatus:output_type -> tabletmanagerdata.GetThrottlerStatusResponse
