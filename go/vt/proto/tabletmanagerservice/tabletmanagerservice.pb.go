...
var file_tabletmanagerservice_proto_rawDesc = []byte{
	...
	0x72, 0x64, 0x61, 0x74, 0x61, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x32, 0xb9, 0x39, 0x0a, 0x0d,
	...
	0x22, 0x00, 0x12, 0x73, 0x0a, 0x12, 0x47, 0x65, 0x74, 0x54, 0x68, 0x72, 0x6f, 0x74, 0x74, 0x6c,
	0x65, 0x72, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x2c, 0x2e, 0x74, 0x61, 0x62, 0x6c, 0x65,
	0x74, 0x6d, 0x61, 0x6e, 0x61, 0x67, 0x65, 0x72, 0x64, 0x61, 0x74, 0x61, 0x2e, 0x47, 0x65, 0x74,
...
var file_tabletmanagerservice_proto_goTypes = []any{
	...
	(*tabletmanagerdata.ReadReparentJournalInfoRequest)(nil),          // 50: tabletmanagerdata.ReadReparentJournalInfoRequest
	...
	(*tabletmanagerdata.DeleteVReplicationWorkflowResponse)(nil),      // 102: tabletmanagerdata.DeleteVReplicationWorkflowResponse
	(*tabletmanagerdata.HasVReplicationWorkflowsResponse)(nil),        // 103: tabletmanagerdata.HasVReplicationWorkflowsResponse
	(*tabletmanagerdata.ReadVReplicationWorkflowResponse)(nil),        // 104: tabletmanagerdata.ReadVReplicationWorkflowResponse
	(*tabletmanagerdata.ReadVReplicationWorkflowsResponse)(nil),       // 105: tabletmanagerdata.ReadVReplicationWorkflowsResponse
	(*tabletmanagerdata.UpdateVReplicationWorkflowResponse)(nil),      // 106: tabletmanagerdata.UpdateVReplicationWorkflowResponse
	(*tabletmanagerdata.UpdateVReplicationWorkflowsResponse)(nil),     // 107: tabletmanagerdata.UpdateVReplicationWorkflowsResponse
	(*tabletmanagerdata.ValidateVReplicationPermissionsResponse)(nil), // 108: tabletmanagerdata.ValidateVReplicationPermissionsResponse
	(*tabletmanagerdata.VReplicationExecResponse)(nil),                // 109: tabletmanagerdata.VReplicationExecResponse
	(*tabletmanagerdata.VReplicationWaitForPosResponse)(nil),          // 110: tabletmanagerdata.VReplicationWaitForPosResponse
	(*tabletmanagerdata.VDiffResponse)(nil),                           // 111: tabletmanagerdata.VDiffResponse
	(*tabletmanagerdata.ResetReplicationResponse)(nil),                // 112: tabletmanagerdata.ResetReplicationResponse
	(*tabletmanagerdata.InitPrimaryResponse)(nil),                     // 113: tabletmanagerdata.InitPrimaryResponse
	(*tabletmanagerdata.PopulateReparentJournalResponse)(nil),         // 114: tabletmanagerdata.PopulateReparentJournalResponse
	(*tabletmanagerdata.ReadReparentJournalInfoResponse)(nil),         // 115: tabletmanagerdata.ReadReparentJournalInfoResponse
...
var file_tabletmanagerservice_proto_depIdxs = []int32{
	...
	50,  // 50: tabletmanagerservice.TabletManager.ReadReparentJournalInfo:input_type -> tabletmanagerdata.ReadReparentJournalInfoRequest
	...
	102, // 102: tabletmanagerservice.TabletManager.DeleteVReplicationWorkflow:output_type -> tabletmanagerdata.DeleteVReplicationWorkflowResponse
	103, // 103: tabletmanagerservice.TabletManager.HasVReplicationWorkflows:output_type -> tabletmanagerdata.HasVReplicationWorkflowsResponse
	104, // 104: tabletmanagerservice.TabletManager.ReadVReplicationWorkflow:output_type -> tabletmanagerdata.ReadVReplicationWorkflowResponse
	105, // 105: tabletmanagerservice.TabletManager.ReadVReplicationWorkflows:output_type -> tabletmanagerdata.ReadVReplicationWorkflowsResponse
	106, // 106: tabletmanagerservice.TabletManager.UpdateVReplicationWorkflow:output_type -> tabletmanagerdata.UpdateVReplicationWorkflowResponse
	107, // 107: tabletmanagerservice.TabletManager.UpdateVReplicationWorkflows:output_type -> tabletmanagerdata.UpdateVReplicationWorkflowsResponse
	108, // 108: tabletmanagerservice.TabletManager.ValidateVReplicationPermissions:output_type -> tabletmanagerdata.ValidateVReplicationPermissionsResponse
	109, // 109: tabletmanagerservice.TabletManager.VReplicationExec:output_type -> tabletmanagerdata.VReplicationExecResponse
	110, // 110: tabletmanagerservice.TabletManager.VReplicationWaitForPos:output_type -> tabletmanagerdata.VReplicationWaitForPosResponse
	111, // 111: tabletmanagerservice.TabletManager.VDiff:output_type -> tabletmanagerdata.VDiffResponse
	112, // 112: tabletmanagerservice.TabletManager.ResetReplication:output_type -> tabletmanagerdata.ResetReplicationResponse
	113, // 113: tabletmanagerservice.TabletManager.InitPrimary:output_type -> tabletmanagerdata.InitPrimaryResponse
	114, // 114: tabletmanagerservice.TabletManager.PopulateReparentJournal:output_type -> tabletmanagerdata.PopulateReparentJournalResponse
	115, // 115: tabletmanagerservice.TabletManager.ReadReparentJournalInfo:output_type -> tabletmanagerdata.ReadReparentJournalInfoResponse
