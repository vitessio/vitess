...
var file_vtadmin_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x09, 0x52, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x22, 0x5a, 0x0a, 0x10, 0x56,
	...
	0x72, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x32, 0xd6, 0x10, 0x0a, 0x07, 0x56, 0x54, 0x41,
	...
	0x62, 0x6c, 0x65, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x3b,
	...
	0x00, 0x12, 0x53, 0x0a, 0x0e, 0x52, 0x65, 0x70, 0x61, 0x72, 0x65, 0x6e, 0x74, 0x54, 0x61, 0x62,
	0x6c, 0x65, 0x74, 0x12, 0x1e, 0x2e, 0x76, 0x74, 0x61, 0x64, 0x6d, 0x69, 0x6e, 0x2e, 0x52, 0x65,
	0x70, 0x61, 0x72, 0x65, 0x6e, 0x74, 0x54, 0x61, 0x62, 0x6c, 0x65, 0x74, 0x52, 0x65, 0x71, 0x75,
	0x65, 0x73, 0x74, 0x1a, 0x1f, 0x2e, 0x76, 0x74, 0x61, 0x64, 0x6d, 0x69, 0x6e, 0x2e, 0x52, 0x65,
	...
	0x69, 0x6e, 0x2e, 0x52, 0x75, 0x6e, 0x48, 0x65, 0x61, 0x6c, 0x74, 0x68, 0x43, 0x68, 0x65, 0x63,
	0x6b, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x44, 0x0a, 0x09, 0x56,
...
var file_vtadmin_proto_msgTypes = make([]protoimpl.MessageInfo, 65)
var file_vtadmin_proto_goTypes = []interface{}{
	...
	(*VTExplainRequest)(nil),                            // 58: vtadmin.VTExplainRequest
	(*VTExplainResponse)(nil),                           // 59: vtadmin.VTExplainResponse
	nil,                                                 // 60: vtadmin.Keyspace.ShardsEntry
	nil,                                                 // 61: vtadmin.Schema.TableSizesEntry
	(*Schema_ShardTableSize)(nil),                       // 62: vtadmin.Schema.ShardTableSize
	(*Schema_TableSize)(nil),                            // 63: vtadmin.Schema.TableSize
	nil,                                                 // 64: vtadmin.Schema.TableSize.ByShardEntry
	nil,                                                 // 65: vtadmin.GetWorkflowsResponse.WorkflowsByClusterEntry
	(*mysqlctl.BackupInfo)(nil),                         // 66: mysqlctl.BackupInfo
	(*vtctldata.ShardReplicationPositionsResponse)(nil), // 67: vtctldata.ShardReplicationPositionsResponse
	(*vtctldata.Keyspace)(nil),                          // 68: vtctldata.Keyspace
	(*tabletmanagerdata.TableDefinition)(nil),           // 69: tabletmanagerdata.TableDefinition
	(*vschema.SrvVSchema)(nil),                          // 70: vschema.SrvVSchema
	(*topodata.Tablet)(nil),                             // 71: topodata.Tablet
	(*vschema.Keyspace)(nil),                            // 72: vschema.Keyspace
	(*vtctldata.Workflow)(nil),                          // 73: vtctldata.Workflow
	(*vtctldata.CreateKeyspaceRequest)(nil),             // 74: vtctldata.CreateKeyspaceRequest
	(*vtctldata.CreateShardRequest)(nil),                // 75: vtctldata.CreateShardRequest
	(*vtctldata.DeleteKeyspaceRequest)(nil),             // 76: vtctldata.DeleteKeyspaceRequest
	(*vtctldata.DeleteShardsRequest)(nil),               // 77: vtctldata.DeleteShardsRequest
	(*vtctldata.GetBackupsRequest)(nil),                 // 78: vtctldata.GetBackupsRequest
	(*vtctldata.Shard)(nil),                             // 79: vtctldata.Shard
...
var file_vtadmin_proto_depIdxs = []int32{
	...
	66, // 1: vtadmin.ClusterBackup.backup:type_name -> mysqlctl.BackupInfo
	1,  // 2: vtadmin.ClusterShardReplicationPosition.cluster:type_name -> vtadmin.Cluster
	67, // 3: vtadmin.ClusterShardReplicationPosition.position_info:type_name -> vtctldata.ShardReplicationPositionsResponse
	12, // 4: vtadmin.ClusterWorkflows.workflows:type_name -> vtadmin.Workflow
	1,  // 5: vtadmin.Keyspace.cluster:type_name -> vtadmin.Cluster
	68, // 6: vtadmin.Keyspace.keyspace:type_name -> vtctldata.Keyspace
	60, // 7: vtadmin.Keyspace.shards:type_name -> vtadmin.Keyspace.ShardsEntry
	1,  // 8: vtadmin.Schema.cluster:type_name -> vtadmin.Cluster
	69, // 9: vtadmin.Schema.table_definitions:type_name -> tabletmanagerdata.TableDefinition
	61, // 10: vtadmin.Schema.table_sizes:type_name -> vtadmin.Schema.TableSizesEntry
	1,  // 11: vtadmin.SrvVSchema.cluster:type_name -> vtadmin.Cluster
	70, // 12: vtadmin.SrvVSchema.srv_v_schema:type_name -> vschema.SrvVSchema
	1,  // 13: vtadmin.Tablet.cluster:type_name -> vtadmin.Cluster
	71, // 14: vtadmin.Tablet.tablet:type_name -> topodata.Tablet
	0,  // 15: vtadmin.Tablet.state:type_name -> vtadmin.Tablet.ServingState
	1,  // 16: vtadmin.VSchema.cluster:type_name -> vtadmin.Cluster
	72, // 17: vtadmin.VSchema.v_schema:type_name -> vschema.Keyspace
	...
	73, // 21: vtadmin.Workflow.workflow:type_name -> vtctldata.Workflow
	74, // 22: vtadmin.CreateKeyspaceRequest.options:type_name -> vtctldata.CreateKeyspaceRequest
	5,  // 23: vtadmin.CreateKeyspaceResponse.keyspace:type_name -> vtadmin.Keyspace
	75, // 24: vtadmin.CreateShardRequest.options:type_name -> vtctldata.CreateShardRequest
	76, // 25: vtadmin.DeleteKeyspaceRequest.options:type_name -> vtctldata.DeleteKeyspaceRequest
	77, // 26: vtadmin.DeleteShardsRequest.options:type_name -> vtctldata.DeleteShardsRequest
	38, // 27: vtadmin.FindSchemaRequest.table_size_options:type_name -> vtadmin.GetSchemaTableSizeOptions
	78, // 28: vtadmin.GetBackupsRequest.request_options:type_name -> vtctldata.GetBackupsRequest
	...
	65, // 41: vtadmin.GetWorkflowsResponse.workflows_by_cluster:type_name -> vtadmin.GetWorkflowsResponse.WorkflowsByClusterEntry
	79, // 42: vtadmin.Keyspace.ShardsEntry.value:type_name -> vtctldata.Shard
	63, // 43: vtadmin.Schema.TableSizesEntry.value:type_name -> vtadmin.Schema.TableSize
	64, // 44: vtadmin.Schema.TableSize.by_shard:type_name -> vtadmin.Schema.TableSize.ByShardEntry
	62, // 45: vtadmin.Schema.TableSize.ByShardEntry.value:type_name -> vtadmin.Schema.ShardTableSize
	...
	58, // 74: vtadmin.VTAdmin.VTExplain:input_type -> vtadmin.VTExplainRequest
	14, // 75: vtadmin.VTAdmin.CreateKeyspace:output_type -> vtadmin.CreateKeyspaceResponse
	80, // 76: vtadmin.VTAdmin.CreateShard:output_type -> vtctldata.CreateShardResponse
	81, // 77: vtadmin.VTAdmin.DeleteKeyspace:output_type -> vtctldata.DeleteKeyspaceResponse
	82, // 78: vtadmin.VTAdmin.DeleteShards:output_type -> vtctldata.DeleteShardsResponse
	19, // 79: vtadmin.VTAdmin.DeleteTablet:output_type -> vtadmin.DeleteTabletResponse
	6,  // 80: vtadmin.VTAdmin.FindSchema:output_type -> vtadmin.Schema
	22, // 81: vtadmin.VTAdmin.GetBackups:output_type -> vtadmin.GetBackupsResponse
	24, // 82: vtadmin.VTAdmin.GetClusters:output_type -> vtadmin.GetClustersResponse
	26, // 83: vtadmin.VTAdmin.GetGates:output_type -> vtadmin.GetGatesResponse
	5,  // 84: vtadmin.VTAdmin.GetKeyspace:output_type -> vtadmin.Keyspace
	29, // 85: vtadmin.VTAdmin.GetKeyspaces:output_type -> vtadmin.GetKeyspacesResponse
	6,  // 86: vtadmin.VTAdmin.GetSchema:output_type -> vtadmin.Schema
	32, // 87: vtadmin.VTAdmin.GetSchemas:output_type -> vtadmin.GetSchemasResponse
	34, // 88: vtadmin.VTAdmin.GetShardReplicationPositions:output_type -> vtadmin.GetShardReplicationPositionsResponse
	7,  // 89: vtadmin.VTAdmin.GetSrvVSchema:output_type -> vtadmin.SrvVSchema
	37, // 90: vtadmin.VTAdmin.GetSrvVSchemas:output_type -> vtadmin.GetSrvVSchemasResponse
	8,  // 91: vtadmin.VTAdmin.GetTablet:output_type -> vtadmin.Tablet
	41, // 92: vtadmin.VTAdmin.GetTablets:output_type -> vtadmin.GetTabletsResponse
	9,  // 93: vtadmin.VTAdmin.GetVSchema:output_type -> vtadmin.VSchema
	44, // 94: vtadmin.VTAdmin.GetVSchemas:output_type -> vtadmin.GetVSchemasResponse
	46, // 95: vtadmin.VTAdmin.GetVtctlds:output_type -> vtadmin.GetVtctldsResponse
	12, // 96: vtadmin.VTAdmin.GetWorkflow:output_type -> vtadmin.Workflow
	49, // 97: vtadmin.VTAdmin.GetWorkflows:output_type -> vtadmin.GetWorkflowsResponse
	51, // 98: vtadmin.VTAdmin.PingTablet:output_type -> vtadmin.PingTabletResponse
	53, // 99: vtadmin.VTAdmin.RefreshState:output_type -> vtadmin.RefreshStateResponse
	55, // 100: vtadmin.VTAdmin.ReparentTablet:output_type -> vtadmin.ReparentTabletResponse
	57, // 101: vtadmin.VTAdmin.RunHealthCheck:output_type -> vtadmin.RunHealthCheckResponse
	59, // 102: vtadmin.VTAdmin.VTExplain:output_type -> vtadmin.VTExplainResponse
