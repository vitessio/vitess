...
type Schema_ShardTableSize struct {
	...
	DataLength           int64    `protobuf:"varint,2,opt,name=data_length,json=dataLength,proto3" json:"data_length,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *Schema_ShardTableSize) GetRowCount() int64 {
	if m != nil {
		return m.RowCount
	}
	return 0
...
func (m *Schema_ShardTableSize) GetDataLength() int64 {
	if m != nil {
		return m.DataLength
	}
	return 0
...
func (m *Schema_TableSize) GetRowCount() int64 {
	if m != nil {
		return m.RowCount
	}
	return 0
...
func (m *Schema_TableSize) GetDataLength() int64 {
	if m != nil {
		return m.DataLength
	}
	return 0
...
var fileDescriptor_609739e22a0a50b3 = []byte{
	...
	0x14, 0xaf, 0x93, 0x36, 0x89, 0x4f, 0xb6, 0x26, 0xbd, 0xab, 0xb4, 0xd4, 0xed, 0xba, 0xea, 0x0a,
	...
	0xb8, 0x03, 0x84, 0x60, 0xd1, 0xb7, 0x0f, 0x9d, 0x46, 0x81, 0x5a, 0xe8, 0x33, 0xb6, 0xa0, 0xce,
	0xc3, 0x1f, 0x07, 0xe1, 0xb3, 0xa7, 0x5e, 0x30, 0x89, 0x50, 0x0b, 0xf4, 0x89, 0x58, 0x34, 0xb4,
	0xad, 0xe2, 0x76, 0xb5, 0xbd, 0xd2, 0x14, 0xb8, 0x45, 0x98, 0x99, 0xc4, 0x20, 0x03, 0x2a, 0x13,
	0x3b, 0xf4, 0x5d, 0x7f, 0x18, 0x35, 0x0a, 0x5b, 0xc5, 0x6d, 0xdd, 0x94, 0x6b, 0xfc, 0x8f, 0x06,
	0x95, 0x87, 0xce, 0x34, 0x1a, 0xd9, 0x7d, 0x07, 0xbd, 0x0d, 0xe5, 0x3e, 0xab, 0x46, 0x61, 0x55,
	0xdb, 0x75, 0x99, 0x97, 0xa3, 0x30, 0x45, 0x00, 0x6a, 0x41, 0xe5, 0x19, 0x7f, 0x8f, 0x22, 0xae,
	0xb6, 0xcf, 0x35, 0x93, 0xcd, 0x8a, 0x94, 0xa6, 0x0c, 0x42, 0xd7, 0xa0, 0x14, 0x1d, 0xd8, 0xe1,
	...
	0xfc, 0x88, 0x2e, 0xc1, 0xd2, 0xd8, 0xf6, 0x8e, 0x04, 0x8a, 0xba, 0x82, 0x82, 0xbe, 0x68, 0x32,
	0xf7, 0xfb, 0x85, 0xf7, 0x34, 0xfc, 0xef, 0x22, 0x94, 0x76, 0xe9, 0xf7, 0x39, 0xd5, 0x5e, 0x8d,
	...
	,
	...
	,
}
	...
	for iNdEx < l {
		...
		case 2:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.DataLength |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
