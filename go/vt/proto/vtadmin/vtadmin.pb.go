...
func file_vtadmin_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_vtadmin_proto_msgTypes[113].Exporter = func(v interface{}, i int) interface{} {
		...
		file_vtadmin_proto_msgTypes[115].Exporter = func(v interface{}, i int) interface{} {
		...
		file_vtadmin_proto_msgTypes[120].Exporter = func(v interface{}, i int) interface{} {
