...
var file_vtadmin_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x09, 0x52, 0x08, 0x72, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x32, 0x8d, 0x2a,
	...
	0x12, 0x59, 0x0a, 0x10, 0x4d, 0x6f, 0x76, 0x65, 0x54, 0x61, 0x62, 0x6c, 0x65, 0x73, 0x43, 0x72,
	0x65, 0x61, 0x74, 0x65, 0x12, 0x20, 0x2e, 0x76, 0x74, 0x61, 0x64, 0x6d, 0x69, 0x6e, 0x2e, 0x4d,
	...
	0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x47, 0x0a, 0x0a, 0x50,
...
var file_vtadmin_proto_goTypes = []any{
	...
	(*MoveTablesCreateRequest)(nil),                   // 75: vtadmin.MoveTablesCreateRequest
	...
	(*vtctldata.MoveTablesCreateRequest)(nil),           // 150: vtctldata.MoveTablesCreateRequest
	(*vtctldata.PlannedReparentShardRequest)(nil),       // 151: vtctldata.PlannedReparentShardRequest
	(*vtctldata.RetrySchemaMigrationRequest)(nil),       // 152: vtctldata.RetrySchemaMigrationRequest
	(*topodata.CellsAlias)(nil),                         // 153: topodata.CellsAlias
	(*vtctldata.GetSchemaMigrationsRequest)(nil),        // 154: vtctldata.GetSchemaMigrationsRequest
	(*vtctldata.GetSrvKeyspacesResponse)(nil),           // 155: vtctldata.GetSrvKeyspacesResponse
	(*vtctldata.ApplySchemaResponse)(nil),               // 156: vtctldata.ApplySchemaResponse
	(*vtctldata.CancelSchemaMigrationResponse)(nil),     // 157: vtctldata.CancelSchemaMigrationResponse
	(*vtctldata.CleanupSchemaMigrationResponse)(nil),    // 158: vtctldata.CleanupSchemaMigrationResponse
	(*vtctldata.CompleteSchemaMigrationResponse)(nil),   // 159: vtctldata.CompleteSchemaMigrationResponse
	(*vtctldata.CreateShardResponse)(nil),               // 160: vtctldata.CreateShardResponse
	...
	(*vtctldata.GetFullStatusResponse)(nil),             // 163: vtctldata.GetFullStatusResponse
...
var file_vtadmin_proto_depIdxs = []int32{
	...
	150, // 68: vtadmin.MoveTablesCreateRequest.request:type_name -> vtctldata.MoveTablesCreateRequest
	145, // 69: vtadmin.PingTabletRequest.alias:type_name -> topodata.TabletAlias
	1,   // 70: vtadmin.PingTabletResponse.cluster:type_name -> vtadmin.Cluster
	151, // 71: vtadmin.PlannedFailoverShardRequest.options:type_name -> vtctldata.PlannedReparentShardRequest
	1,   // 72: vtadmin.PlannedFailoverShardResponse.cluster:type_name -> vtadmin.Cluster
	145, // 73: vtadmin.PlannedFailoverShardResponse.promoted_primary:type_name -> topodata.TabletAlias
	147, // 74: vtadmin.PlannedFailoverShardResponse.events:type_name -> logutil.Event
	145, // 75: vtadmin.RefreshStateRequest.alias:type_name -> topodata.TabletAlias
	1,   // 76: vtadmin.RefreshStateResponse.cluster:type_name -> vtadmin.Cluster
	145, // 77: vtadmin.ReloadSchemasRequest.tablets:type_name -> topodata.TabletAlias
	123, // 78: vtadmin.ReloadSchemasResponse.keyspace_results:type_name -> vtadmin.ReloadSchemasResponse.KeyspaceResult
	124, // 79: vtadmin.ReloadSchemasResponse.shard_results:type_name -> vtadmin.ReloadSchemasResponse.ShardResult
	125, // 80: vtadmin.ReloadSchemasResponse.tablet_results:type_name -> vtadmin.ReloadSchemasResponse.TabletResult
	147, // 81: vtadmin.ReloadSchemaShardResponse.events:type_name -> logutil.Event
	145, // 82: vtadmin.RefreshTabletReplicationSourceRequest.alias:type_name -> topodata.TabletAlias
	145, // 83: vtadmin.RefreshTabletReplicationSourceResponse.primary:type_name -> topodata.TabletAlias
	1,   // 84: vtadmin.RefreshTabletReplicationSourceResponse.cluster:type_name -> vtadmin.Cluster
	152, // 85: vtadmin.RetrySchemaMigrationRequest.request:type_name -> vtctldata.RetrySchemaMigrationRequest
	145, // 86: vtadmin.RunHealthCheckRequest.alias:type_name -> topodata.TabletAlias
	1,   // 87: vtadmin.RunHealthCheckResponse.cluster:type_name -> vtadmin.Cluster
	145, // 88: vtadmin.SetReadOnlyRequest.alias:type_name -> topodata.TabletAlias
	145, // 89: vtadmin.SetReadWriteRequest.alias:type_name -> topodata.TabletAlias
	145, // 90: vtadmin.StartReplicationRequest.alias:type_name -> topodata.TabletAlias
	1,   // 91: vtadmin.StartReplicationResponse.cluster:type_name -> vtadmin.Cluster
	145, // 92: vtadmin.StopReplicationRequest.alias:type_name -> topodata.TabletAlias
	1,   // 93: vtadmin.StopReplicationResponse.cluster:type_name -> vtadmin.Cluster
	145, // 94: vtadmin.TabletExternallyPromotedRequest.alias:type_name -> topodata.TabletAlias
	1,   // 95: vtadmin.TabletExternallyPromotedResponse.cluster:type_name -> vtadmin.Cluster
	145, // 96: vtadmin.TabletExternallyPromotedResponse.new_primary:type_name -> topodata.TabletAlias
	145, // 97: vtadmin.TabletExternallyPromotedResponse.old_primary:type_name -> topodata.TabletAlias
	145, // 98: vtadmin.TabletExternallyReparentedRequest.alias:type_name -> topodata.TabletAlias
	153, // 99: vtadmin.ClusterCellsAliases.AliasesEntry.value:type_name -> topodata.CellsAlias
	132, // 100: vtadmin.Keyspace.ShardsEntry.value:type_name -> vtctldata.Shard
	118, // 101: vtadmin.Schema.TableSizesEntry.value:type_name -> vtadmin.Schema.TableSize
	119, // 102: vtadmin.Schema.TableSize.by_shard:type_name -> vtadmin.Schema.TableSize.ByShardEntry
	117, // 103: vtadmin.Schema.TableSize.ByShardEntry.value:type_name -> vtadmin.Schema.ShardTableSize
	154, // 104: vtadmin.GetSchemaMigrationsRequest.ClusterRequest.request:type_name -> vtctldata.GetSchemaMigrationsRequest
	155, // 105: vtadmin.GetSrvKeyspacesResponse.SrvKeyspacesEntry.value:type_name -> vtctldata.GetSrvKeyspacesResponse
	...
	147, // 108: vtadmin.ReloadSchemasResponse.KeyspaceResult.events:type_name -> logutil.Event
	10,  // 109: vtadmin.ReloadSchemasResponse.ShardResult.shard:type_name -> vtadmin.Shard
	147, // 110: vtadmin.ReloadSchemasResponse.ShardResult.events:type_name -> logutil.Event
	...
	63,  // 142: vtadmin.VTAdmin.GetVSchema:input_type -> vtadmin.GetVSchemaRequest
	64,  // 143: vtadmin.VTAdmin.GetVSchemas:input_type -> vtadmin.GetVSchemasRequest
	66,  // 144: vtadmin.VTAdmin.GetVtctlds:input_type -> vtadmin.GetVtctldsRequest
	68,  // 145: vtadmin.VTAdmin.GetWorkflow:input_type -> vtadmin.GetWorkflowRequest
	72,  // 146: vtadmin.VTAdmin.GetWorkflows:input_type -> vtadmin.GetWorkflowsRequest
	69,  // 147: vtadmin.VTAdmin.GetWorkflowStatus:input_type -> vtadmin.GetWorkflowStatusRequest
	70,  // 148: vtadmin.VTAdmin.StartWorkflow:input_type -> vtadmin.StartWorkflowRequest
	71,  // 149: vtadmin.VTAdmin.StopWorkflow:input_type -> vtadmin.StopWorkflowRequest
	74,  // 150: vtadmin.VTAdmin.LaunchSchemaMigration:input_type -> vtadmin.LaunchSchemaMigrationRequest
	75,  // 151: vtadmin.VTAdmin.MoveTablesCreate:input_type -> vtadmin.MoveTablesCreateRequest
	76,  // 152: vtadmin.VTAdmin.PingTablet:input_type -> vtadmin.PingTabletRequest
	78,  // 153: vtadmin.VTAdmin.PlannedFailoverShard:input_type -> vtadmin.PlannedFailoverShardRequest
	80,  // 154: vtadmin.VTAdmin.RebuildKeyspaceGraph:input_type -> vtadmin.RebuildKeyspaceGraphRequest
	82,  // 155: vtadmin.VTAdmin.RefreshState:input_type -> vtadmin.RefreshStateRequest
	88,  // 156: vtadmin.VTAdmin.RefreshTabletReplicationSource:input_type -> vtadmin.RefreshTabletReplicationSourceRequest
	84,  // 157: vtadmin.VTAdmin.ReloadSchemas:input_type -> vtadmin.ReloadSchemasRequest
	86,  // 158: vtadmin.VTAdmin.ReloadSchemaShard:input_type -> vtadmin.ReloadSchemaShardRequest
	90,  // 159: vtadmin.VTAdmin.RemoveKeyspaceCell:input_type -> vtadmin.RemoveKeyspaceCellRequest
	92,  // 160: vtadmin.VTAdmin.RetrySchemaMigration:input_type -> vtadmin.RetrySchemaMigrationRequest
	93,  // 161: vtadmin.VTAdmin.RunHealthCheck:input_type -> vtadmin.RunHealthCheckRequest
	95,  // 162: vtadmin.VTAdmin.SetReadOnly:input_type -> vtadmin.SetReadOnlyRequest
	97,  // 163: vtadmin.VTAdmin.SetReadWrite:input_type -> vtadmin.SetReadWriteRequest
	99,  // 164: vtadmin.VTAdmin.StartReplication:input_type -> vtadmin.StartReplicationRequest
	101, // 165: vtadmin.VTAdmin.StopReplication:input_type -> vtadmin.StopReplicationRequest
	103, // 166: vtadmin.VTAdmin.TabletExternallyPromoted:input_type -> vtadmin.TabletExternallyPromotedRequest
	106, // 167: vtadmin.VTAdmin.Validate:input_type -> vtadmin.ValidateRequest
	107, // 168: vtadmin.VTAdmin.ValidateKeyspace:input_type -> vtadmin.ValidateKeyspaceRequest
	108, // 169: vtadmin.VTAdmin.ValidateSchemaKeyspace:input_type -> vtadmin.ValidateSchemaKeyspaceRequest
	109, // 170: vtadmin.VTAdmin.ValidateShard:input_type -> vtadmin.ValidateShardRequest
	110, // 171: vtadmin.VTAdmin.ValidateVersionKeyspace:input_type -> vtadmin.ValidateVersionKeyspaceRequest
	111, // 172: vtadmin.VTAdmin.ValidateVersionShard:input_type -> vtadmin.ValidateVersionShardRequest
	112, // 173: vtadmin.VTAdmin.VTExplain:input_type -> vtadmin.VTExplainRequest
	156, // 174: vtadmin.VTAdmin.ApplySchema:output_type -> vtctldata.ApplySchemaResponse
	157, // 175: vtadmin.VTAdmin.CancelSchemaMigration:output_type -> vtctldata.CancelSchemaMigrationResponse
	158, // 176: vtadmin.VTAdmin.CleanupSchemaMigration:output_type -> vtctldata.CleanupSchemaMigrationResponse
	159, // 177: vtadmin.VTAdmin.CompleteSchemaMigration:output_type -> vtctldata.CompleteSchemaMigrationResponse
	22,  // 178: vtadmin.VTAdmin.CreateKeyspace:output_type -> vtadmin.CreateKeyspaceResponse
	160, // 179: vtadmin.VTAdmin.CreateShard:output_type -> vtctldata.CreateShardResponse
	161, // 180: vtadmin.VTAdmin.DeleteKeyspace:output_type -> vtctldata.DeleteKeyspaceResponse
	162, // 181: vtadmin.VTAdmin.DeleteShards:output_type -> vtctldata.DeleteShardsResponse
	27,  // 182: vtadmin.VTAdmin.DeleteTablet:output_type -> vtadmin.DeleteTabletResponse
	29,  // 183: vtadmin.VTAdmin.EmergencyFailoverShard:output_type -> vtadmin.EmergencyFailoverShardResponse
	8,   // 184: vtadmin.VTAdmin.FindSchema:output_type -> vtadmin.Schema
	32,  // 185: vtadmin.VTAdmin.GetBackups:output_type -> vtadmin.GetBackupsResponse
	34,  // 186: vtadmin.VTAdmin.GetCellInfos:output_type -> vtadmin.GetCellInfosResponse
	36,  // 187: vtadmin.VTAdmin.GetCellsAliases:output_type -> vtadmin.GetCellsAliasesResponse
	38,  // 188: vtadmin.VTAdmin.GetClusters:output_type -> vtadmin.GetClustersResponse
	163, // 189: vtadmin.VTAdmin.GetFullStatus:output_type -> vtctldata.GetFullStatusResponse
	41,  // 190: vtadmin.VTAdmin.GetGates:output_type -> vtadmin.GetGatesResponse
	7,   // 191: vtadmin.VTAdmin.GetKeyspace:output_type -> vtadmin.Keyspace
	44,  // 192: vtadmin.VTAdmin.GetKeyspaces:output_type -> vtadmin.GetKeyspacesResponse
	8,   // 193: vtadmin.VTAdmin.GetSchema:output_type -> vtadmin.Schema
	47,  // 194: vtadmin.VTAdmin.GetSchemas:output_type -> vtadmin.GetSchemasResponse
	49,  // 195: vtadmin.VTAdmin.GetSchemaMigrations:output_type -> vtadmin.GetSchemaMigrationsResponse
	51,  // 196: vtadmin.VTAdmin.GetShardReplicationPositions:output_type -> vtadmin.GetShardReplicationPositionsResponse
	155, // 197: vtadmin.VTAdmin.GetSrvKeyspace:output_type -> vtctldata.GetSrvKeyspacesResponse
	54,  // 198: vtadmin.VTAdmin.GetSrvKeyspaces:output_type -> vtadmin.GetSrvKeyspacesResponse
	11,  // 199: vtadmin.VTAdmin.GetSrvVSchema:output_type -> vtadmin.SrvVSchema
	57,  // 200: vtadmin.VTAdmin.GetSrvVSchemas:output_type -> vtadmin.GetSrvVSchemasResponse
	12,  // 201: vtadmin.VTAdmin.GetTablet:output_type -> vtadmin.Tablet
	61,  // 202: vtadmin.VTAdmin.GetTablets:output_type -> vtadmin.GetTabletsResponse
	164, // 203: vtadmin.VTAdmin.GetTopologyPath:output_type -> vtctldata.GetTopologyPathResponse
	13,  // 204: vtadmin.VTAdmin.GetVSchema:output_type -> vtadmin.VSchema
	65,  // 205: vtadmin.VTAdmin.GetVSchemas:output_type -> vtadmin.GetVSchemasResponse
	67,  // 206: vtadmin.VTAdmin.GetVtctlds:output_type -> vtadmin.GetVtctldsResponse
	16,  // 207: vtadmin.VTAdmin.GetWorkflow:output_type -> vtadmin.Workflow
	73,  // 208: vtadmin.VTAdmin.GetWorkflows:output_type -> vtadmin.GetWorkflowsResponse
	...
	165, // 213: vtadmin.VTAdmin.MoveTablesCreate:output_type -> vtctldata.WorkflowStatusResponse
	77,  // 214: vtadmin.VTAdmin.PingTablet:output_type -> vtadmin.PingTabletResponse
	79,  // 215: vtadmin.VTAdmin.PlannedFailoverShard:output_type -> vtadmin.PlannedFailoverShardResponse
	81,  // 216: vtadmin.VTAdmin.RebuildKeyspaceGraph:output_type -> vtadmin.RebuildKeyspaceGraphResponse
	83,  // 217: vtadmin.VTAdmin.RefreshState:output_type -> vtadmin.RefreshStateResponse
	89,  // 218: vtadmin.VTAdmin.RefreshTabletReplicationSource:output_type -> vtadmin.RefreshTabletReplicationSourceResponse
	85,  // 219: vtadmin.VTAdmin.ReloadSchemas:output_type -> vtadmin.ReloadSchemasResponse
	87,  // 220: vtadmin.VTAdmin.ReloadSchemaShard:output_type -> vtadmin.ReloadSchemaShardResponse
	91,  // 221: vtadmin.VTAdmin.RemoveKeyspaceCell:output_type -> vtadmin.RemoveKeyspaceCellResponse
	168, // 222: vtadmin.VTAdmin.RetrySchemaMigration:output_type -> vtctldata.RetrySchemaMigrationResponse
	94,  // 223: vtadmin.VTAdmin.RunHealthCheck:output_type -> vtadmin.RunHealthCheckResponse
	96,  // 224: vtadmin.VTAdmin.SetReadOnly:output_type -> vtadmin.SetReadOnlyResponse
	98,  // 225: vtadmin.VTAdmin.SetReadWrite:output_type -> vtadmin.SetReadWriteResponse
	100, // 226: vtadmin.VTAdmin.StartReplication:output_type -> vtadmin.StartReplicationResponse
	102, // 227: vtadmin.VTAdmin.StopReplication:output_type -> vtadmin.StopReplicationResponse
	104, // 228: vtadmin.VTAdmin.TabletExternallyPromoted:output_type -> vtadmin.TabletExternallyPromotedResponse
	169, // 229: vtadmin.VTAdmin.Validate:output_type -> vtctldata.ValidateResponse
	170, // 230: vtadmin.VTAdmin.ValidateKeyspace:output_type -> vtctldata.ValidateKeyspaceResponse
	171, // 231: vtadmin.VTAdmin.ValidateSchemaKeyspace:output_type -> vtctldata.ValidateSchemaKeyspaceResponse
	172, // 232: vtadmin.VTAdmin.ValidateShard:output_type -> vtctldata.ValidateShardResponse
	173, // 233: vtadmin.VTAdmin.ValidateVersionKeyspace:output_type -> vtctldata.ValidateVersionKeyspaceResponse
	174, // 234: vtadmin.VTAdmin.ValidateVersionShard:output_type -> vtctldata.ValidateVersionShardResponse
	113, // 235: vtadmin.VTAdmin.VTExplain:output_type -> vtadmin.VTExplainResponse
