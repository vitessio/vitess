...
var file_vtadmin_proto_rawDesc = []byte{
	...
	0x75, 0x72, 0x72, 0x65, 0x6e, 0x63, 0x79, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0b, 0x63,
	...
	0x79, 0x22, 0x77, 0x0a, 0x17, 0x56, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x65, 0x4b, 0x65, 0x79,
	...
	0x32, 0xb1, 0x1b, 0x0a, 0x07, 0x56, 0x54, 0x41, 0x64, 0x6d, 0x69, 0x6e, 0x12, 0x53, 0x0a, 0x0e,
	...
	0x72, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x41, 0x0a, 0x08,
	...
	,
...
var file_vtadmin_proto_goTypes = []interface{}{
	...
	(*ReloadSchemaShardRequest)(nil),                    // 67: vtadmin.ReloadSchemaShardRequest
	(*ReloadSchemaShardResponse)(nil),                   // 68: vtadmin.ReloadSchemaShardResponse
...
var file_vtadmin_proto_depIdxs = []int32{
	...
	114, // 69: vtadmin.ReloadSchemaShardResponse.events:type_name -> logutil.Event
	112, // 70: vtadmin.RefreshTabletReplicationSourceRequest.alias:type_name -> topodata.TabletAlias
	112, // 71: vtadmin.RefreshTabletReplicationSourceResponse.primary:type_name -> topodata.TabletAlias
	1,   // 72: vtadmin.RefreshTabletReplicationSourceResponse.cluster:type_name -> vtadmin.Cluster
	112, // 73: vtadmin.RunHealthCheckRequest.alias:type_name -> topodata.TabletAlias
	1,   // 74: vtadmin.RunHealthCheckResponse.cluster:type_name -> vtadmin.Cluster
	112, // 75: vtadmin.SetReadOnlyRequest.alias:type_name -> topodata.TabletAlias
	112, // 76: vtadmin.SetReadWriteRequest.alias:type_name -> topodata.TabletAlias
	112, // 77: vtadmin.StartReplicationRequest.alias:type_name -> topodata.TabletAlias
	1,   // 78: vtadmin.StartReplicationResponse.cluster:type_name -> vtadmin.Cluster
	112, // 79: vtadmin.StopReplicationRequest.alias:type_name -> topodata.TabletAlias
	1,   // 80: vtadmin.StopReplicationResponse.cluster:type_name -> vtadmin.Cluster
	112, // 81: vtadmin.TabletExternallyPromotedRequest.alias:type_name -> topodata.TabletAlias
	1,   // 82: vtadmin.TabletExternallyPromotedResponse.cluster:type_name -> vtadmin.Cluster
	112, // 83: vtadmin.TabletExternallyPromotedResponse.new_primary:type_name -> topodata.TabletAlias
	112, // 84: vtadmin.TabletExternallyPromotedResponse.old_primary:type_name -> topodata.TabletAlias
	117, // 85: vtadmin.ClusterCellsAliases.AliasesEntry.value:type_name -> topodata.CellsAlias
	103, // 86: vtadmin.Keyspace.ShardsEntry.value:type_name -> vtctldata.Shard
	92,  // 87: vtadmin.Schema.TableSizesEntry.value:type_name -> vtadmin.Schema.TableSize
	93,  // 88: vtadmin.Schema.TableSize.by_shard:type_name -> vtadmin.Schema.TableSize.ByShardEntry
	91,  // 89: vtadmin.Schema.TableSize.ByShardEntry.value:type_name -> vtadmin.Schema.ShardTableSize
	6,   // 90: vtadmin.GetWorkflowsResponse.WorkflowsByClusterEntry.value:type_name -> vtadmin.ClusterWorkflows
	7,   // 91: vtadmin.ReloadSchemasResponse.KeyspaceResult.keyspace:type_name -> vtadmin.Keyspace
	114, // 92: vtadmin.ReloadSchemasResponse.KeyspaceResult.events:type_name -> logutil.Event
	9,   // 93: vtadmin.ReloadSchemasResponse.ShardResult.shard:type_name -> vtadmin.Shard
	114, // 94: vtadmin.ReloadSchemasResponse.ShardResult.events:type_name -> logutil.Event
	11,  // 95: vtadmin.ReloadSchemasResponse.TabletResult.tablet:type_name -> vtadmin.Tablet
	16,  // 96: vtadmin.VTAdmin.CreateKeyspace:input_type -> vtadmin.CreateKeyspaceRequest
	18,  // 97: vtadmin.VTAdmin.CreateShard:input_type -> vtadmin.CreateShardRequest
	19,  // 98: vtadmin.VTAdmin.DeleteKeyspace:input_type -> vtadmin.DeleteKeyspaceRequest
	20,  // 99: vtadmin.VTAdmin.DeleteShards:input_type -> vtadmin.DeleteShardsRequest
	21,  // 100: vtadmin.VTAdmin.DeleteTablet:input_type -> vtadmin.DeleteTabletRequest
	23,  // 101: vtadmin.VTAdmin.EmergencyFailoverShard:input_type -> vtadmin.EmergencyFailoverShardRequest
	25,  // 102: vtadmin.VTAdmin.FindSchema:input_type -> vtadmin.FindSchemaRequest
	26,  // 103: vtadmin.VTAdmin.GetBackups:input_type -> vtadmin.GetBackupsRequest
	28,  // 104: vtadmin.VTAdmin.GetCellInfos:input_type -> vtadmin.GetCellInfosRequest
	30,  // 105: vtadmin.VTAdmin.GetCellsAliases:input_type -> vtadmin.GetCellsAliasesRequest
	32,  // 106: vtadmin.VTAdmin.GetClusters:input_type -> vtadmin.GetClustersRequest
	34,  // 107: vtadmin.VTAdmin.GetGates:input_type -> vtadmin.GetGatesRequest
	36,  // 108: vtadmin.VTAdmin.GetKeyspace:input_type -> vtadmin.GetKeyspaceRequest
	37,  // 109: vtadmin.VTAdmin.GetKeyspaces:input_type -> vtadmin.GetKeyspacesRequest
	39,  // 110: vtadmin.VTAdmin.GetSchema:input_type -> vtadmin.GetSchemaRequest
	40,  // 111: vtadmin.VTAdmin.GetSchemas:input_type -> vtadmin.GetSchemasRequest
	42,  // 112: vtadmin.VTAdmin.GetShardReplicationPositions:input_type -> vtadmin.GetShardReplicationPositionsRequest
	44,  // 113: vtadmin.VTAdmin.GetSrvVSchema:input_type -> vtadmin.GetSrvVSchemaRequest
	45,  // 114: vtadmin.VTAdmin.GetSrvVSchemas:input_type -> vtadmin.GetSrvVSchemasRequest
	48,  // 115: vtadmin.VTAdmin.GetTablet:input_type -> vtadmin.GetTabletRequest
	49,  // 116: vtadmin.VTAdmin.GetTablets:input_type -> vtadmin.GetTabletsRequest
	51,  // 117: vtadmin.VTAdmin.GetVSchema:input_type -> vtadmin.GetVSchemaRequest
	52,  // 118: vtadmin.VTAdmin.GetVSchemas:input_type -> vtadmin.GetVSchemasRequest
	54,  // 119: vtadmin.VTAdmin.GetVtctlds:input_type -> vtadmin.GetVtctldsRequest
	56,  // 120: vtadmin.VTAdmin.GetWorkflow:input_type -> vtadmin.GetWorkflowRequest
	57,  // 121: vtadmin.VTAdmin.GetWorkflows:input_type -> vtadmin.GetWorkflowsRequest
	59,  // 122: vtadmin.VTAdmin.PingTablet:input_type -> vtadmin.PingTabletRequest
	61,  // 123: vtadmin.VTAdmin.PlannedFailoverShard:input_type -> vtadmin.PlannedFailoverShardRequest
	63,  // 124: vtadmin.VTAdmin.RefreshState:input_type -> vtadmin.RefreshStateRequest
	69,  // 125: vtadmin.VTAdmin.RefreshTabletReplicationSource:input_type -> vtadmin.RefreshTabletReplicationSourceRequest
	65,  // 126: vtadmin.VTAdmin.ReloadSchemas:input_type -> vtadmin.ReloadSchemasRequest
	67,  // 127: vtadmin.VTAdmin.ReloadSchemaShard:input_type -> vtadmin.ReloadSchemaShardRequest
	71,  // 128: vtadmin.VTAdmin.RunHealthCheck:input_type -> vtadmin.RunHealthCheckRequest
	73,  // 129: vtadmin.VTAdmin.SetReadOnly:input_type -> vtadmin.SetReadOnlyRequest
	75,  // 130: vtadmin.VTAdmin.SetReadWrite:input_type -> vtadmin.SetReadWriteRequest
	77,  // 131: vtadmin.VTAdmin.StartReplication:input_type -> vtadmin.StartReplicationRequest
	79,  // 132: vtadmin.VTAdmin.StopReplication:input_type -> vtadmin.StopReplicationRequest
	81,  // 133: vtadmin.VTAdmin.TabletExternallyPromoted:input_type -> vtadmin.TabletExternallyPromotedRequest
	83,  // 134: vtadmin.VTAdmin.ValidateKeyspace:input_type -> vtadmin.ValidateKeyspaceRequest
	84,  // 135: vtadmin.VTAdmin.ValidateSchemaKeyspace:input_type -> vtadmin.ValidateSchemaKeyspaceRequest
	85,  // 136: vtadmin.VTAdmin.ValidateVersionKeyspace:input_type -> vtadmin.ValidateVersionKeyspaceRequest
	86,  // 137: vtadmin.VTAdmin.VTExplain:input_type -> vtadmin.VTExplainRequest
	17,  // 138: vtadmin.VTAdmin.CreateKeyspace:output_type -> vtadmin.CreateKeyspaceResponse
	118, // 139: vtadmin.VTAdmin.CreateShard:output_type -> vtctldata.CreateShardResponse
	119, // 140: vtadmin.VTAdmin.DeleteKeyspace:output_type -> vtctldata.DeleteKeyspaceResponse
	120, // 141: vtadmin.VTAdmin.DeleteShards:output_type -> vtctldata.DeleteShardsResponse
	...
	64,  // 166: vtadmin.VTAdmin.RefreshState:output_type -> vtadmin.RefreshStateResponse
	70,  // 167: vtadmin.VTAdmin.RefreshTabletReplicationSource:output_type -> vtadmin.RefreshTabletReplicationSourceResponse
	66,  // 168: vtadmin.VTAdmin.ReloadSchemas:output_type -> vtadmin.ReloadSchemasResponse
	68,  // 169: vtadmin.VTAdmin.ReloadSchemaShard:output_type -> vtadmin.ReloadSchemaShardResponse
	72,  // 170: vtadmin.VTAdmin.RunHealthCheck:output_type -> vtadmin.RunHealthCheckResponse
	74,  // 171: vtadmin.VTAdmin.SetReadOnly:output_type -> vtadmin.SetReadOnlyResponse
	76,  // 172: vtadmin.VTAdmin.SetReadWrite:output_type -> vtadmin.SetReadWriteResponse
	78,  // 173: vtadmin.VTAdmin.StartReplication:output_type -> vtadmin.StartReplicationResponse
	80,  // 174: vtadmin.VTAdmin.StopReplication:output_type -> vtadmin.StopReplicationResponse
	82,  // 175: vtadmin.VTAdmin.TabletExternallyPromoted:output_type -> vtadmin.TabletExternallyPromotedResponse
	121, // 176: vtadmin.VTAdmin.ValidateKeyspace:output_type -> vtctldata.ValidateKeyspaceResponse
	122, // 177: vtadmin.VTAdmin.ValidateSchemaKeyspace:output_type -> vtctldata.ValidateSchemaKeyspaceResponse
	123, // 178: vtadmin.VTAdmin.ValidateVersionKeyspace:output_type -> vtctldata.ValidateVersionKeyspaceResponse
	87,  // 179: vtadmin.VTAdmin.VTExplain:output_type -> vtadmin.VTExplainResponse
