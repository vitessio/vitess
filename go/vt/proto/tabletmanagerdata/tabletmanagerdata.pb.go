...
type MysqlSystemMetricsRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *MysqlSystemMetricsRequest) Reset() {
	*x = MysqlSystemMetricsRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *MysqlSystemMetricsRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MysqlSystemMetricsRequest) ProtoMessage() {}

func (x *MysqlSystemMetricsRequest) ProtoReflect() protoreflect.Message {
	mi := &file_tabletmanagerdata_proto_msgTypes[52]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use MysqlSystemMetricsRequest.ProtoReflect.Descriptor instead.
func (*MysqlSystemMetricsRequest) Descriptor() ([]byte, []int) {
	return file_tabletmanagerdata_proto_rawDescGZIP(), []int{52}
}

type MysqlSystemMetricsResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	SystemMetrics *mysqlctl.SystemMetricsResponse `protobuf:"bytes,1,opt,name=SystemMetrics,proto3" json:"SystemMetrics,omitempty"`
}

func (x *MysqlSystemMetricsResponse) Reset() {
	*x = MysqlSystemMetricsResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *MysqlSystemMetricsResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MysqlSystemMetricsResponse) ProtoMessage() {}

func (x *MysqlSystemMetricsResponse) ProtoReflect() protoreflect.Message {
	mi := &file_tabletmanagerdata_proto_msgTypes[53]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use MysqlSystemMetricsResponse.ProtoReflect.Descriptor instead.
func (*MysqlSystemMetricsResponse) Descriptor() ([]byte, []int) {
	return file_tabletmanagerdata_proto_rawDescGZIP(), []int{53}
}

func (x *MysqlSystemMetricsResponse) GetSystemMetrics() *mysqlctl.SystemMetricsResponse {
	if x != nil {
...
var file_tabletmanagerdata_proto_rawDesc = []byte{
	...
	,
	...
	0x79, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x6b, 0x65, 0x79, 0x12, 0x14, 0x0a, 0x05,
	0x76, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x76, 0x61, 0x6c,
	0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0xd7, 0x01, 0x0a, 0x0c, 0x56, 0x44, 0x69, 0x66, 0x66,
	...
	0x41, 0x70, 0x70, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x2a, 0x3e,
...
var file_tabletmanagerdata_proto_goTypes = []any{
	...
	(*MysqlSystemMetricsRequest)(nil),               // 54: tabletmanagerdata.MysqlSystemMetricsRequest
	(*MysqlSystemMetricsResponse)(nil),              // 55: tabletmanagerdata.MysqlSystemMetricsResponse
	...
	(*mysqlctl.SystemMetricsResponse)(nil),        // 157: mysqlctl.SystemMetricsResponse
	(*replicationdata.Status)(nil),                // 158: replicationdata.Status
	(*replicationdata.PrimaryStatus)(nil),         // 159: replicationdata.PrimaryStatus
	(*topodata.TabletAlias)(nil),                  // 160: topodata.TabletAlias
	(*replicationdata.FullStatus)(nil),            // 161: replicationdata.FullStatus
	(replicationdata.StopReplicationMode)(0),      // 162: replicationdata.StopReplicationMode
	(*replicationdata.StopReplicationStatus)(nil), // 163: replicationdata.StopReplicationStatus
	(*logutil.Event)(nil),                         // 164: logutil.Event
	(*vttime.Time)(nil),                           // 165: vttime.Time
	(*binlogdata.BinlogSource)(nil),               // 166: binlogdata.BinlogSource
	(binlogdata.VReplicationWorkflowType)(0),      // 167: binlogdata.VReplicationWorkflowType
	(binlogdata.VReplicationWorkflowSubType)(0),   // 168: binlogdata.VReplicationWorkflowSubType
	(binlogdata.VReplicationWorkflowState)(0),     // 169: binlogdata.VReplicationWorkflowState
	(binlogdata.OnDDLAction)(0),                   // 170: binlogdata.OnDDLAction
	(*topodata.ThrottledAppRule)(nil),             // 171: topodata.ThrottledAppRule
}
var file_tabletmanagerdata_proto_depIdxs = []int32{
	...
	157, // 25: tabletmanagerdata.MysqlSystemMetricsResponse.SystemMetrics:type_name -> mysqlctl.SystemMetricsResponse
	158, // 26: tabletmanagerdata.ReplicationStatusResponse.status:type_name -> replicationdata.Status
	159, // 27: tabletmanagerdata.PrimaryStatusResponse.status:type_name -> replicationdata.PrimaryStatus
	155, // 28: tabletmanagerdata.VReplicationExecResponse.result:type_name -> query.QueryResult
	160, // 29: tabletmanagerdata.PopulateReparentJournalRequest.primary_alias:type_name -> topodata.TabletAlias
	160, // 30: tabletmanagerdata.InitReplicaRequest.parent:type_name -> topodata.TabletAlias
	159, // 31: tabletmanagerdata.DemotePrimaryResponse.primary_status:type_name -> replicationdata.PrimaryStatus
	161, // 32: tabletmanagerdata.FullStatusResponse.status:type_name -> replicationdata.FullStatus
	160, // 33: tabletmanagerdata.SetReplicationSourceRequest.parent:type_name -> topodata.TabletAlias
	160, // 34: tabletmanagerdata.ReplicaWasRestartedRequest.parent:type_name -> topodata.TabletAlias
	162, // 35: tabletmanagerdata.StopReplicationAndGetStatusRequest.stop_replication_mode:type_name -> replicationdata.StopReplicationMode
	163, // 36: tabletmanagerdata.StopReplicationAndGetStatusResponse.status:type_name -> replicationdata.StopReplicationStatus
	164, // 37: tabletmanagerdata.BackupResponse.event:type_name -> logutil.Event
	165, // 38: tabletmanagerdata.RestoreFromBackupRequest.backup_time:type_name -> vttime.Time
	165, // 39: tabletmanagerdata.RestoreFromBackupRequest.restore_to_timestamp:type_name -> vttime.Time
	164, // 40: tabletmanagerdata.RestoreFromBackupResponse.event:type_name -> logutil.Event
	166, // 41: tabletmanagerdata.CreateVReplicationWorkflowRequest.binlog_source:type_name -> binlogdata.BinlogSource
	...
	167, // 44: tabletmanagerdata.CreateVReplicationWorkflowRequest.workflow_type:type_name -> binlogdata.VReplicationWorkflowType
	168, // 45: tabletmanagerdata.CreateVReplicationWorkflowRequest.workflow_sub_type:type_name -> binlogdata.VReplicationWorkflowSubType
	...
	169, // 48: tabletmanagerdata.ReadVReplicationWorkflowsRequest.include_states:type_name -> binlogdata.VReplicationWorkflowState
	169, // 49: tabletmanagerdata.ReadVReplicationWorkflowsRequest.exclude_states:type_name -> binlogdata.VReplicationWorkflowState
	...
	167, // 53: tabletmanagerdata.ReadVReplicationWorkflowResponse.workflow_type:type_name -> binlogdata.VReplicationWorkflowType
	168, // 54: tabletmanagerdata.ReadVReplicationWorkflowResponse.workflow_sub_type:type_name -> binlogdata.VReplicationWorkflowSubType
	...
	170, // 64: tabletmanagerdata.UpdateVReplicationWorkflowRequest.on_ddl:type_name -> binlogdata.OnDDLAction
	169, // 65: tabletmanagerdata.UpdateVReplicationWorkflowRequest.state:type_name -> binlogdata.VReplicationWorkflowState
	...
	169, // 68: tabletmanagerdata.UpdateVReplicationWorkflowsRequest.state:type_name -> binlogdata.VReplicationWorkflowState
	...
	166, // 78: tabletmanagerdata.ReadVReplicationWorkflowResponse.Stream.bls:type_name -> binlogdata.BinlogSource
	165, // 79: tabletmanagerdata.ReadVReplicationWorkflowResponse.Stream.time_updated:type_name -> vttime.Time
	165, // 80: tabletmanagerdata.ReadVReplicationWorkflowResponse.Stream.transaction_timestamp:type_name -> vttime.Time
	169, // 81: tabletmanagerdata.ReadVReplicationWorkflowResponse.Stream.state:type_name -> binlogdata.VReplicationWorkflowState
	165, // 82: tabletmanagerdata.ReadVReplicationWorkflowResponse.Stream.time_heartbeat:type_name -> vttime.Time
	165, // 83: tabletmanagerdata.ReadVReplicationWorkflowResponse.Stream.time_throttled:type_name -> vttime.Time
	...
	165, // 87: tabletmanagerdata.GetThrottlerStatusResponse.MetricHealth.last_healthy_at:type_name -> vttime.Time
	...
	171, // 89: tabletmanagerdata.GetThrottlerStatusResponse.ThrottledAppsEntry.value:type_name -> topodata.ThrottledAppRule
	165, // 90: tabletmanagerdata.GetThrottlerStatusResponse.RecentApp.checked_at:type_name -> vttime.Time
...
func file_tabletmanagerdata_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_tabletmanagerdata_proto_msgTypes[52].Exporter = func(v any, i int) any {
			switch v := v.(*MysqlSystemMetricsRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_tabletmanagerdata_proto_msgTypes[53].Exporter = func(v any, i int) any {
			switch v := v.(*MysqlSystemMetricsResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
