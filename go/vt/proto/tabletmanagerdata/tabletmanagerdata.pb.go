...
func file_tabletmanagerdata_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_tabletmanagerdata_proto_msgTypes[131].Exporter = func(v interface{}, i int) interface{} {
		...
		file_tabletmanagerdata_proto_msgTypes[136].Exporter = func(v interface{}, i int) interface{} {
		...
		file_tabletmanagerdata_proto_msgTypes[140].Exporter = func(v interface{}, i int) interface{} {
