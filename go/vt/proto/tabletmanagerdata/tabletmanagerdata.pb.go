...
type VDiffReportOptions struct {
	...
	MaxReportSampleRows int64  `protobuf:"varint,4,opt,name=max_report_sample_rows,json=maxReportSampleRows,proto3" json:"max_report_sample_rows,omitempty"`
}
...
func (x *VDiffReportOptions) GetMaxReportSampleRows() int64 {
	if x != nil {
...
var file_tabletmanagerdata_proto_rawDesc = []byte{
	...
	0x04, 0x20, 0x01, 0x28, 0x03, 0x52, 0x13, 0x6d, 0x61, 0x78, 0x52, 0x65, 0x70, 0x6f, 0x72, 0x74,
