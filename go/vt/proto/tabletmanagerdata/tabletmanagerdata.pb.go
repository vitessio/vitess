...
type OnlineDDL_Strategy int32

const (
	// OnlineDDL_VITESS uses vreplication to run the OnlineDDL migration. It is
	// the default strategy for OnlineDDL requests.option
	//
	// OnlineDDL_VITESS was also formerly called "ONLINE".
	OnlineDDL_VITESS OnlineDDL_Strategy = 0
	OnlineDDL_ONLINE OnlineDDL_Strategy = 0
	OnlineDDL_GHOST  OnlineDDL_Strategy = 1
	OnlineDDL_PTOSC  OnlineDDL_Strategy = 2
	// OnlineDDL_DIRECT runs the migration directly against MySQL (e.g. `ALTER TABLE ...`),
	// meaning it is not actually an "online" DDL migration.
	OnlineDDL_DIRECT OnlineDDL_Strategy = 3
	// OnlineDDL_MYSQL is a managed migration (queued and executed by the
	// scheduler) but runs through a MySQL `ALTER TABLE`.
	OnlineDDL_MYSQL OnlineDDL_Strategy = 4
)

// Enum value maps for OnlineDDL_Strategy.
var (
	OnlineDDL_Strategy_name = map[int32]string{
		0: "VITESS",
	...
	OnlineDDL_Strategy_value = map[string]int32{
		"VITESS": 0,
		"ONLINE": 0,
		"GHOST":  1,
		"PTOSC":  2,
...
func (x OnlineDDL_Strategy) Enum() *OnlineDDL_Strategy {
	p := new(OnlineDDL_Strategy)
	*p = x
	return p
}

func (x OnlineDDL_Strategy) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (OnlineDDL_Strategy) Descriptor() protoreflect.EnumDescriptor {
	return file_tabletmanagerdata_proto_enumTypes[1].Descriptor()
}

func (OnlineDDL_Strategy) Type() protoreflect.EnumType {
	return &file_tabletmanagerdata_proto_enumTypes[1]
}

func (x OnlineDDL_Strategy) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use OnlineDDL_Strategy.Descriptor instead.
func (OnlineDDL_Strategy) EnumDescriptor() ([]byte, []int) {
	return file_tabletmanagerdata_proto_rawDescGZIP(), []int{0, 0}
}

type OnlineDDL_Status int32

const (
	OnlineDDL_UNKNOWN   OnlineDDL_Status = 0
	OnlineDDL_REQUESTED OnlineDDL_Status = 1
	OnlineDDL_CANCELLED OnlineDDL_Status = 2
	OnlineDDL_QUEUED    OnlineDDL_Status = 3
	OnlineDDL_READY     OnlineDDL_Status = 4
	OnlineDDL_RUNNING   OnlineDDL_Status = 5
	OnlineDDL_COMPLETE  OnlineDDL_Status = 6
	OnlineDDL_FAILED    OnlineDDL_Status = 7
)

// Enum value maps for OnlineDDL_Status.
var (
	OnlineDDL_Status_name = map[int32]string{
		0: "UNKNOWN",
		1: "REQUESTED",
		2: "CANCELLED",
		3: "QUEUED",
	...
	OnlineDDL_Status_value = map[string]int32{
		"UNKNOWN":   0,
		"REQUESTED": 1,
		"CANCELLED": 2,
		"QUEUED":    3,
...
func (x OnlineDDL_Status) Enum() *OnlineDDL_Status {
	p := new(OnlineDDL_Status)
	*p = x
	return p
}

func (x OnlineDDL_Status) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (OnlineDDL_Status) Descriptor() protoreflect.EnumDescriptor {
	return file_tabletmanagerdata_proto_enumTypes[2].Descriptor()
}

func (OnlineDDL_Status) Type() protoreflect.EnumType {
	return &file_tabletmanagerdata_proto_enumTypes[2]
}

func (x OnlineDDL_Status) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use OnlineDDL_Status.Descriptor instead.
func (OnlineDDL_Status) EnumDescriptor() ([]byte, []int) {
	return file_tabletmanagerdata_proto_rawDescGZIP(), []int{0, 1}
}
...
type OnlineDDL struct {
	...
	Strategy         OnlineDDL_Strategy    `protobuf:"varint,6,opt,name=strategy,proto3,enum=tabletmanagerdata.OnlineDDL_Strategy" json:"strategy,omitempty"`
	Options          string                `protobuf:"bytes,7,opt,name=options,proto3" json:"options,omitempty"`
	RequestTime      *vttime.Time          `protobuf:"bytes,8,opt,name=request_time,json=requestTime,proto3" json:"request_time,omitempty"`
	MigrationContext string                `protobuf:"bytes,9,opt,name=migration_context,json=migrationContext,proto3" json:"migration_context,omitempty"`
	Status           OnlineDDL_Status      `protobuf:"varint,10,opt,name=status,proto3,enum=tabletmanagerdata.OnlineDDL_Status" json:"status,omitempty"`
	TabletAlias      *topodata.TabletAlias `protobuf:"bytes,11,opt,name=tablet_alias,json=tabletAlias,proto3" json:"tablet_alias,omitempty"`
	Retries          int64                 `protobuf:"varint,12,opt,name=retries,proto3" json:"retries,omitempty"`
	ReadyToComplete  bool                  `protobuf:"varint,13,opt,name=ready_to_complete,json=readyToComplete,proto3" json:"ready_to_complete,omitempty"`
}

func (x *OnlineDDL) Reset() {
	*x = OnlineDDL{}
...
func (x *OnlineDDL) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*OnlineDDL) ProtoMessage() {}

func (x *OnlineDDL) ProtoReflect() protoreflect.Message {
	mi := &file_tabletmanagerdata_proto_msgTypes[0]
...
// Deprecated: Use OnlineDDL.ProtoReflect.Descriptor instead.
func (*OnlineDDL) Descriptor() ([]byte, []int) {
	return file_tabletmanagerdata_proto_rawDescGZIP(), []int{0}
}

func (x *OnlineDDL) GetKeyspace() string {
	if x != nil {
		return x.Keyspace
	}
	return ""
...
func (x *OnlineDDL) GetTable() string {
	if x != nil {
		return x.Table
	}
	return ""
...
func (x *OnlineDDL) GetSchema() string {
	if x != nil {
		return x.Schema
	}
	return ""
...
func (x *OnlineDDL) GetSql() string {
	if x != nil {
		return x.Sql
	}
	return ""
...
func (x *OnlineDDL) GetUuid() string {
	if x != nil {
		return x.Uuid
	}
	return ""
...
func (x *OnlineDDL) GetStrategy() OnlineDDL_Strategy {
	if x != nil {
		return x.Strategy
	}
	return OnlineDDL_VITESS
}

func (x *OnlineDDL) GetOptions() string {
	if x != nil {
		return x.Options
	}
	return ""
...
func (x *OnlineDDL) GetRequestTime() *vttime.Time {
	if x != nil {
...
func (x *OnlineDDL) GetMigrationContext() string {
	if x != nil {
...
func (x *OnlineDDL) GetStatus() OnlineDDL_Status {
	if x != nil {
		return x.Status
	}
	return OnlineDDL_UNKNOWN
}

func (x *OnlineDDL) GetTabletAlias() *topodata.TabletAlias {
	if x != nil {
...
func (x *OnlineDDL) GetRetries() int64 {
	if x != nil {
		return x.Retries
	}
	return 0
...
func (x *OnlineDDL) GetReadyToComplete() bool {
	if x != nil {
...
func (*ReadVReplicationWorkflowResponse_Stream) Descriptor() ([]byte, []int) {
	return file_tabletmanagerdata_proto_rawDescGZIP(), []int{102, 0}
}
...
var file_tabletmanagerdata_proto_rawDesc = []byte{
	...
	0x0b, 0x76, 0x74, 0x72, 0x70, 0x63, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xbb, 0x05, 0x0a,
	0x09, 0x4f, 0x6e, 0x6c, 0x69, 0x6e, 0x65, 0x44, 0x44, 0x4c, 0x12, 0x1a, 0x0a, 0x08, 0x6b, 0x65,
	...
	,
	...
	0x69, 0x65, 0x6c, 0x64, 0x52, 0x06, 0x66, 0x69, 0x65, 0x6c, 0x64, 0x73, 0x22, 0x92, 0x01, 0x0a,
	...
	0x04, 0x22, 0xa6, 0x01, 0x0a, 0x12, 0x53, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x43, 0x68, 0x61, 0x6e,
	0x67, 0x65, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x12, 0x48, 0x0a, 0x0d, 0x62, 0x65, 0x66, 0x6f,
	...
	0x66, 0x74, 0x65, 0x72, 0x53, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x22, 0xf7, 0x01, 0x0a, 0x0e, 0x55,
	0x73, 0x65, 0x72, 0x50, 0x65, 0x72, 0x6d, 0x69, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x12, 0x12, 0x0a,
	...
	,
	...
	,
	...
	0x61, 0x79, 0x6c, 0x6f, 0x61, 0x64, 0x22, 0x2a, 0x0a, 0x0c, 0x53, 0x6c, 0x65, 0x65, 0x70, 0x52,
	...
	0x6f, 0x6e, 0x22, 0x0f, 0x0a, 0x0d, 0x53, 0x6c, 0x65, 0x65, 0x70, 0x52, 0x65, 0x73, 0x70, 0x6f,
	0x6e, 0x73, 0x65, 0x22, 0xd7, 0x01, 0x0a, 0x12, 0x45, 0x78, 0x65, 0x63, 0x75, 0x74, 0x65, 0x48,
	...
	0x28, 0x09, 0x52, 0x0a, 0x70, 0x61, 0x72, 0x61, 0x6d, 0x65, 0x74, 0x65, 0x72, 0x73, 0x12, 0x50,
	0x0a, 0x09, 0x65, 0x78, 0x74, 0x72, 0x61, 0x5f, 0x65, 0x6e, 0x76, 0x18, 0x03, 0x20, 0x03, 0x28,
	...
	0x6b, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x2e, 0x45, 0x78, 0x74, 0x72, 0x61, 0x45, 0x6e,
	0x76, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x52, 0x08, 0x65, 0x78, 0x74, 0x72, 0x61, 0x45, 0x6e, 0x76,
	0x1a, 0x3b, 0x0a, 0x0d, 0x45, 0x78, 0x74, 0x72, 0x61, 0x45, 0x6e, 0x76, 0x45, 0x6e, 0x74, 0x72,
	0x79, 0x12, 0x10, 0x0a, 0x03, 0x6b, 0x65, 0x79, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03,
	0x6b, 0x65, 0x79, 0x12, 0x14, 0x0a, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x02, 0x20, 0x01,
	...
	0x74, 0x75, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0a, 0x65, 0x78, 0x69, 0x74, 0x53,
	0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x16, 0x0a, 0x06, 0x73, 0x74, 0x64, 0x6f, 0x75, 0x74, 0x18,
	...
	0x74, 0x64, 0x65, 0x72, 0x72, 0x22, 0xa2, 0x01, 0x0a, 0x10, 0x47, 0x65, 0x74, 0x53, 0x63, 0x68,
	0x65, 0x6d, 0x61, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x16, 0x0a, 0x06, 0x74, 0x61,
	...
	,
	...
	,
	...
	0x0a, 0x08, 0x73, 0x65, 0x6d, 0x69, 0x53, 0x79, 0x6e, 0x63, 0x18, 0x02, 0x20, 0x01, 0x28, 0x08,
	0x52, 0x08, 0x73, 0x65, 0x6d, 0x69, 0x53, 0x79, 0x6e, 0x63, 0x22, 0x14, 0x0a, 0x12, 0x43, 0x68,
	...
	,
	...
	0x61, 0x2e, 0x53, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x52, 0x65,
	0x73, 0x75, 0x6c, 0x74, 0x52, 0x0d, 0x63, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x52, 0x65, 0x73, 0x75,
	0x6c, 0x74, 0x73, 0x22, 0x96, 0x02, 0x0a, 0x12, 0x41, 0x70, 0x70, 0x6c, 0x79, 0x53, 0x63, 0x68,
	0x65, 0x6d, 0x61, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x10, 0x0a, 0x03, 0x73, 0x71,
	...
	0x63, 0x65, 0x12, 0x2b, 0x0a, 0x11, 0x61, 0x6c, 0x6c, 0x6f, 0x77, 0x5f, 0x72, 0x65, 0x70, 0x6c,
	0x69, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x03, 0x20, 0x01, 0x28, 0x08, 0x52, 0x10, 0x61,
	0x6c, 0x6c, 0x6f, 0x77, 0x52, 0x65, 0x70, 0x6c, 0x69, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12,
	0x48, 0x0a, 0x0d, 0x62, 0x65, 0x66, 0x6f, 0x72, 0x65, 0x5f, 0x73, 0x63, 0x68, 0x65, 0x6d, 0x61,
	0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x23, 0x2e, 0x74, 0x61, 0x62, 0x6c, 0x65, 0x74, 0x6d,
	...
	,
	...
	0x52, 0x0c, 0x62, 0x65, 0x66, 0x6f, 0x72, 0x65, 0x53, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x12, 0x46,
	0x0a, 0x0c, 0x61, 0x66, 0x74, 0x65, 0x72, 0x5f, 0x73, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x18, 0x02,
	...
	0x22, 0x8d, 0x01, 0x0a, 0x13, 0x45, 0x78, 0x65, 0x63, 0x75, 0x74, 0x65, 0x51, 0x75, 0x65, 0x72,
	...
	0x77, 0x73, 0x12, 0x2c, 0x0a, 0x09, 0x63, 0x61, 0x6c, 0x6c, 0x65, 0x72, 0x5f, 0x69, 0x64, 0x18,
	0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0f, 0x2e, 0x76, 0x74, 0x72, 0x70, 0x63, 0x2e, 0x43, 0x61,
	0x6c, 0x6c, 0x65, 0x72, 0x49, 0x44, 0x52, 0x08, 0x63, 0x61, 0x6c, 0x6c, 0x65, 0x72, 0x49, 0x64,
	0x22, 0x42, 0x0a, 0x14, 0x45, 0x78, 0x65, 0x63, 0x75, 0x74, 0x65, 0x51, 0x75, 0x65, 0x72, 0x79,
	...
	0x73, 0x75, 0x6c, 0x74, 0x22, 0xb2, 0x01, 0x0a, 0x18, 0x45, 0x78, 0x65, 0x63, 0x75, 0x74, 0x65,
	0x46, 0x65, 0x74, 0x63, 0x68, 0x41, 0x73, 0x44, 0x62, 0x61, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73,
	...
	0x28, 0x04, 0x52, 0x07, 0x6d, 0x61, 0x78, 0x52, 0x6f, 0x77, 0x73, 0x12, 0x27, 0x0a, 0x0f, 0x64,
	...
	0x6c, 0x74, 0x22, 0x8e, 0x01, 0x0a, 0x1d, 0x45, 0x78, 0x65, 0x63, 0x75, 0x74, 0x65, 0x46, 0x65,
	...
	0x03, 0x20, 0x01, 0x28, 0x04, 0x52, 0x07, 0x6d, 0x61, 0x78, 0x52, 0x6f, 0x77, 0x73, 0x12, 0x23,
	0x0a, 0x0d, 0x72, 0x65, 0x6c, 0x6f, 0x61, 0x64, 0x5f, 0x73, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x18,
	0x04, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0c, 0x72, 0x65, 0x6c, 0x6f, 0x61, 0x64, 0x53, 0x63, 0x68,
	0x65, 0x6d, 0x61, 0x22, 0x4c, 0x0a, 0x1e, 0x45, 0x78, 0x65, 0x63, 0x75, 0x74, 0x65, 0x46, 0x65,
	...
	0x74, 0x22, 0x4b, 0x0a, 0x18, 0x45, 0x78, 0x65, 0x63, 0x75, 0x74, 0x65, 0x46, 0x65, 0x74, 0x63,
	0x68, 0x41, 0x73, 0x41, 0x70, 0x70, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x14, 0x0a,
	...
	0x02, 0x20, 0x01, 0x28, 0x04, 0x52, 0x07, 0x6d, 0x61, 0x78, 0x52, 0x6f, 0x77, 0x73, 0x22, 0x47,
	...
	0x06, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x22, 0x1a, 0x0a, 0x18, 0x52, 0x65, 0x70, 0x6c, 0x69,
	0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x52, 0x65, 0x71, 0x75,
	0x65, 0x73, 0x74, 0x22, 0x4c, 0x0a, 0x19, 0x52, 0x65, 0x70, 0x6c, 0x69, 0x63, 0x61, 0x74, 0x69,
	...
	0x73, 0x22, 0x16, 0x0a, 0x14, 0x50, 0x72, 0x69, 0x6d, 0x61, 0x72, 0x79, 0x53, 0x74, 0x61, 0x74,
	0x75, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0x4f, 0x0a, 0x15, 0x50, 0x72, 0x69,
	...
	0x75, 0x73, 0x52, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x22, 0x18, 0x0a, 0x16, 0x50, 0x72,
	0x69, 0x6d, 0x61, 0x72, 0x79, 0x50, 0x6f, 0x73, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x65, 0x71,
	0x75, 0x65, 0x73, 0x74, 0x22, 0x35, 0x0a, 0x17, 0x50, 0x72, 0x69, 0x6d, 0x61, 0x72, 0x79, 0x50,
	...
	0x09, 0x52, 0x08, 0x70, 0x6f, 0x73, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x34, 0x0a, 0x16, 0x57,
	...
	0x6e, 0x22, 0x19, 0x0a, 0x17, 0x57, 0x61, 0x69, 0x74, 0x46, 0x6f, 0x72, 0x50, 0x6f, 0x73, 0x69,
	...
	0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0x19, 0x0a, 0x17, 0x53, 0x74, 0x6f, 0x70, 0x52, 0x65,
	0x70, 0x6c, 0x69, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73,
	0x65, 0x22, 0x5e, 0x0a, 0x1d, 0x53, 0x74, 0x6f, 0x70, 0x52, 0x65, 0x70, 0x6c, 0x69, 0x63, 0x61,
	...
	0x74, 0x22, 0x3c, 0x0a, 0x1e, 0x53, 0x74, 0x6f, 0x70, 0x52, 0x65, 0x70, 0x6c, 0x69, 0x63, 0x61,
	...
	0x35, 0x0a, 0x17, 0x53, 0x74, 0x61, 0x72, 0x74, 0x52, 0x65, 0x70, 0x6c, 0x69, 0x63, 0x61, 0x74,
	...
	0x6d, 0x69, 0x53, 0x79, 0x6e, 0x63, 0x22, 0x1a, 0x0a, 0x18, 0x53, 0x74, 0x61, 0x72, 0x74, 0x52,
	0x65, 0x70, 0x6c, 0x69, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e,
	0x73, 0x65, 0x22, 0x62, 0x0a, 0x21, 0x53, 0x74, 0x61, 0x72, 0x74, 0x52, 0x65, 0x70, 0x6c, 0x69,
	...
	,
	...
	0x52, 0x05, 0x71, 0x75, 0x65, 0x72, 0x79, 0x22, 0x46, 0x0a, 0x18, 0x56, 0x52, 0x65, 0x70, 0x6c,
	...
	,
	...
	,
	...
	0x3a, 0x0a, 0x0d, 0x70, 0x72, 0x69, 0x6d, 0x61, 0x72, 0x79, 0x5f, 0x61, 0x6c, 0x69, 0x61, 0x73,
	0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x15, 0x2e, 0x74, 0x6f, 0x70, 0x6f, 0x64, 0x61, 0x74,
	0x61, 0x2e, 0x54, 0x61, 0x62, 0x6c, 0x65, 0x74, 0x41, 0x6c, 0x69, 0x61, 0x73, 0x52, 0x0c, 0x70,
	...
	,
	...
	0x72, 0x69, 0x6d, 0x61, 0x72, 0x79, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0x64, 0x0a,
	0x15, 0x44, 0x65, 0x6d, 0x6f, 0x74, 0x65, 0x50, 0x72, 0x69, 0x6d, 0x61, 0x72, 0x79, 0x52, 0x65,
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x45, 0x0a, 0x0e, 0x70, 0x72, 0x69, 0x6d, 0x61, 0x72,
	0x79, 0x5f, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1e,
	...
	0x70, 0x72, 0x69, 0x6d, 0x61, 0x72, 0x79, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x4a, 0x04, 0x08,
	0x01, 0x10, 0x02, 0x22, 0x36, 0x0a, 0x18, 0x55, 0x6e, 0x64, 0x6f, 0x44, 0x65, 0x6d, 0x6f, 0x74,
	...
	,
	...
	0x01, 0x0a, 0x1b, 0x53, 0x65, 0x74, 0x52, 0x65, 0x70, 0x6c, 0x69, 0x63, 0x61, 0x74, 0x69, 0x6f,
	0x6e, 0x53, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x2d,
	...
	0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x4d, 0x6f, 0x64, 0x65, 0x22, 0x6b, 0x0a, 0x23, 0x53, 0x74,
	0x6f, 0x70, 0x52, 0x65, 0x70, 0x6c, 0x69, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x41, 0x6e, 0x64,
	...
	0x73, 0x4a, 0x04, 0x08, 0x01, 0x10, 0x02, 0x22, 0x33, 0x0a, 0x15, 0x50, 0x72, 0x6f, 0x6d, 0x6f,
	...
	0x28, 0x08, 0x52, 0x08, 0x73, 0x65, 0x6d, 0x69, 0x53, 0x79, 0x6e, 0x63, 0x22, 0x34, 0x0a, 0x16,
	...
	0x6f, 0x6e, 0x22, 0xab, 0x01, 0x0a, 0x0d, 0x42, 0x61, 0x63, 0x6b, 0x75, 0x70, 0x52, 0x65, 0x71,
	...
	0x6c, 0x6c, 0x6f, 0x77, 0x50, 0x72, 0x69, 0x6d, 0x61, 0x72, 0x79, 0x12, 0x30, 0x0a, 0x14, 0x69,
	0x6e, 0x63, 0x72, 0x65, 0x6d, 0x65, 0x6e, 0x74, 0x61, 0x6c, 0x5f, 0x66, 0x72, 0x6f, 0x6d, 0x5f,
	0x70, 0x6f, 0x73, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x12, 0x69, 0x6e, 0x63, 0x72, 0x65,
	0x6d, 0x65, 0x6e, 0x74, 0x61, 0x6c, 0x46, 0x72, 0x6f, 0x6d, 0x50, 0x6f, 0x73, 0x12, 0x21, 0x0a,
	0x0c, 0x75, 0x70, 0x67, 0x72, 0x61, 0x64, 0x65, 0x5f, 0x73, 0x61, 0x66, 0x65, 0x18, 0x04, 0x20,
	0x01, 0x28, 0x08, 0x52, 0x0b, 0x75, 0x70, 0x67, 0x72, 0x61, 0x64, 0x65, 0x53, 0x61, 0x66, 0x65,
	0x22, 0x36, 0x0a, 0x0e, 0x42, 0x61, 0x63, 0x6b, 0x75, 0x70, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e,
	...
	0x74, 0x52, 0x05, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x22, 0xc8, 0x01, 0x0a, 0x18, 0x52, 0x65, 0x73,
	0x74, 0x6f, 0x72, 0x65, 0x46, 0x72, 0x6f, 0x6d, 0x42, 0x61, 0x63, 0x6b, 0x75, 0x70, 0x52, 0x65,
	0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x2d, 0x0a, 0x0b, 0x62, 0x61, 0x63, 0x6b, 0x75, 0x70, 0x5f,
	0x74, 0x69, 0x6d, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0c, 0x2e, 0x76, 0x74, 0x74,
	...
	0x74, 0x6f, 0x5f, 0x70, 0x6f, 0x73, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0c, 0x72, 0x65,
	...
	0x61, 0x6d, 0x70, 0x22, 0x41, 0x0a, 0x19, 0x52, 0x65, 0x73, 0x74, 0x6f, 0x72, 0x65, 0x46, 0x72,
	...
	0x05, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x22, 0xd4, 0x04, 0x0a, 0x21, 0x43, 0x72, 0x65, 0x61, 0x74,
	...
	0x77, 0x6f, 0x72, 0x6b, 0x66, 0x6c, 0x6f, 0x77, 0x12, 0x3d, 0x0a, 0x0d, 0x62, 0x69, 0x6e, 0x6c,
	0x6f, 0x67, 0x5f, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32,
	...
	0x67, 0x53, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x12, 0x14, 0x0a, 0x05, 0x63, 0x65, 0x6c, 0x6c, 0x73,
	...
	0x72, 0x65, 0x6e, 0x63, 0x65, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x2c, 0x2e, 0x74, 0x61,
	0x62, 0x6c, 0x65, 0x74, 0x6d, 0x61, 0x6e, 0x61, 0x67, 0x65, 0x72, 0x64, 0x61, 0x74, 0x61, 0x2e,
	...
	0x65, 0x6e, 0x63, 0x65, 0x12, 0x49, 0x0a, 0x0d, 0x77, 0x6f, 0x72, 0x6b, 0x66, 0x6c, 0x6f, 0x77,
	0x5f, 0x74, 0x79, 0x70, 0x65, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x24, 0x2e, 0x62, 0x69,
	...
	0x74, 0x79, 0x70, 0x65, 0x18, 0x07, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x27, 0x2e, 0x62, 0x69, 0x6e,
	...
	0x73, 0x74, 0x6f, 0x70, 0x41, 0x66, 0x74, 0x65, 0x72, 0x43, 0x6f, 0x70, 0x79, 0x22, 0x50, 0x0a,
	0x22, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x56, 0x52, 0x65, 0x70, 0x6c, 0x69, 0x63, 0x61, 0x74,
	0x69, 0x6f, 0x6e, 0x57, 0x6f, 0x72, 0x6b, 0x66, 0x6c, 0x6f, 0x77, 0x52, 0x65, 0x73, 0x70, 0x6f,
	0x6e, 0x73, 0x65, 0x12, 0x2a, 0x0a, 0x06, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x0b, 0x32, 0x12, 0x2e, 0x71, 0x75, 0x65, 0x72, 0x79, 0x2e, 0x51, 0x75, 0x65, 0x72,
	0x79, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x52, 0x06, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x22,
	0x3f, 0x0a, 0x21, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x56, 0x52, 0x65, 0x70, 0x6c, 0x69, 0x63,
	...
	0x22, 0x50, 0x0a, 0x22, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x56, 0x52, 0x65, 0x70, 0x6c, 0x69,
	0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x57, 0x6f, 0x72, 0x6b, 0x66, 0x6c, 0x6f, 0x77, 0x52, 0x65,
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x2a, 0x0a, 0x06, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x12, 0x2e, 0x71, 0x75, 0x65, 0x72, 0x79, 0x2e, 0x51,
	0x75, 0x65, 0x72, 0x79, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x52, 0x06, 0x72, 0x65, 0x73, 0x75,
	0x6c, 0x74, 0x22, 0x3d, 0x0a, 0x1f, 0x52, 0x65, 0x61, 0x64, 0x56, 0x52, 0x65, 0x70, 0x6c, 0x69,
	0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x57, 0x6f, 0x72, 0x6b, 0x66, 0x6c, 0x6f, 0x77, 0x52, 0x65,
	...
	0x77, 0x22, 0x94, 0x09, 0x0a, 0x20, 0x52, 0x65, 0x61, 0x64, 0x56, 0x52, 0x65, 0x70, 0x6c, 0x69,
	0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x57, 0x6f, 0x72, 0x6b, 0x66, 0x6c, 0x6f, 0x77, 0x52, 0x65,
	...
	0x65, 0x61, 0x6d, 0x73, 0x1a, 0xc1, 0x04, 0x0a, 0x06, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x12,
	...
	0x68, 0x72, 0x6f, 0x74, 0x74, 0x6c, 0x65, 0x64, 0x22, 0xd7, 0x01, 0x0a, 0x0c, 0x56, 0x44, 0x69,
	...
	0x70, 0x6f, 0x72, 0x74, 0x4f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x22, 0xe9, 0x02, 0x0a, 0x21,
	...
	0x50, 0x72, 0x65, 0x66, 0x65, 0x72, 0x65, 0x6e, 0x63, 0x65, 0x12, 0x2e, 0x0a, 0x06, 0x6f, 0x6e,
	...
	0x69, 0x6f, 0x6e, 0x52, 0x05, 0x6f, 0x6e, 0x44, 0x64, 0x6c, 0x12, 0x3b, 0x0a, 0x05, 0x73, 0x74,
	0x61, 0x74, 0x65, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x25, 0x2e, 0x62, 0x69, 0x6e, 0x6c,
	...
	0x52, 0x05, 0x73, 0x74, 0x61, 0x74, 0x65, 0x22, 0x50, 0x0a, 0x22, 0x55, 0x70, 0x64, 0x61, 0x74,
	0x65, 0x56, 0x52, 0x65, 0x70, 0x6c, 0x69, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x57, 0x6f, 0x72,
	...
	0x6b, 0x65, 0x64, 0x2a, 0x3e, 0x0a, 0x19, 0x54, 0x61, 0x62, 0x6c, 0x65, 0x74, 0x53, 0x65, 0x6c,
	...
	0x4e, 0x10, 0x03, 0x42, 0x30, 0x5a, 0x2e, 0x76, 0x69, 0x74, 0x65, 0x73, 0x73, 0x2e, 0x69, 0x6f,
...
var file_tabletmanagerdata_proto_enumTypes = make([]protoimpl.EnumInfo, 3)
var file_tabletmanagerdata_proto_msgTypes = make([]protoimpl.MessageInfo, 119)
var file_tabletmanagerdata_proto_goTypes = []interface{}{
	...
	(OnlineDDL_Strategy)(0),                         // 1: tabletmanagerdata.OnlineDDL.Strategy
	(OnlineDDL_Status)(0),                           // 2: tabletmanagerdata.OnlineDDL.Status
	(*OnlineDDL)(nil),                               // 3: tabletmanagerdata.OnlineDDL
	(*TableDefinition)(nil),                         // 4: tabletmanagerdata.TableDefinition
	(*SchemaDefinition)(nil),                        // 5: tabletmanagerdata.SchemaDefinition
	(*SchemaChangeResult)(nil),                      // 6: tabletmanagerdata.SchemaChangeResult
	(*UserPermission)(nil),                          // 7: tabletmanagerdata.UserPermission
	(*DbPermission)(nil),                            // 8: tabletmanagerdata.DbPermission
	(*Permissions)(nil),                             // 9: tabletmanagerdata.Permissions
	(*PingRequest)(nil),                             // 10: tabletmanagerdata.PingRequest
	(*PingResponse)(nil),                            // 11: tabletmanagerdata.PingResponse
	(*SleepRequest)(nil),                            // 12: tabletmanagerdata.SleepRequest
	(*SleepResponse)(nil),                           // 13: tabletmanagerdata.SleepResponse
	(*ExecuteHookRequest)(nil),                      // 14: tabletmanagerdata.ExecuteHookRequest
	(*ExecuteHookResponse)(nil),                     // 15: tabletmanagerdata.ExecuteHookResponse
	(*GetSchemaRequest)(nil),                        // 16: tabletmanagerdata.GetSchemaRequest
	(*GetSchemaResponse)(nil),                       // 17: tabletmanagerdata.GetSchemaResponse
	(*GetPermissionsRequest)(nil),                   // 18: tabletmanagerdata.GetPermissionsRequest
	(*GetPermissionsResponse)(nil),                  // 19: tabletmanagerdata.GetPermissionsResponse
	...
	(*ExecuteFetchAsAllPrivsRequest)(nil),           // 44: tabletmanagerdata.ExecuteFetchAsAllPrivsRequest
	(*ExecuteFetchAsAllPrivsResponse)(nil),          // 45: tabletmanagerdata.ExecuteFetchAsAllPrivsResponse
	(*ExecuteFetchAsAppRequest)(nil),                // 46: tabletmanagerdata.ExecuteFetchAsAppRequest
	(*ExecuteFetchAsAppResponse)(nil),               // 47: tabletmanagerdata.ExecuteFetchAsAppResponse
	(*ReplicationStatusRequest)(nil),                // 48: tabletmanagerdata.ReplicationStatusRequest
	(*ReplicationStatusResponse)(nil),               // 49: tabletmanagerdata.ReplicationStatusResponse
	(*PrimaryStatusRequest)(nil),                    // 50: tabletmanagerdata.PrimaryStatusRequest
	(*PrimaryStatusResponse)(nil),                   // 51: tabletmanagerdata.PrimaryStatusResponse
	(*PrimaryPositionRequest)(nil),                  // 52: tabletmanagerdata.PrimaryPositionRequest
	(*PrimaryPositionResponse)(nil),                 // 53: tabletmanagerdata.PrimaryPositionResponse
	(*WaitForPositionRequest)(nil),                  // 54: tabletmanagerdata.WaitForPositionRequest
	(*WaitForPositionResponse)(nil),                 // 55: tabletmanagerdata.WaitForPositionResponse
	(*StopReplicationRequest)(nil),                  // 56: tabletmanagerdata.StopReplicationRequest
	(*StopReplicationResponse)(nil),                 // 57: tabletmanagerdata.StopReplicationResponse
	(*StopReplicationMinimumRequest)(nil),           // 58: tabletmanagerdata.StopReplicationMinimumRequest
	(*StopReplicationMinimumResponse)(nil),          // 59: tabletmanagerdata.StopReplicationMinimumResponse
	(*StartReplicationRequest)(nil),                 // 60: tabletmanagerdata.StartReplicationRequest
	(*StartReplicationResponse)(nil),                // 61: tabletmanagerdata.StartReplicationResponse
	(*StartReplicationUntilAfterRequest)(nil),       // 62: tabletmanagerdata.StartReplicationUntilAfterRequest
	(*StartReplicationUntilAfterResponse)(nil),      // 63: tabletmanagerdata.StartReplicationUntilAfterResponse
	(*GetReplicasRequest)(nil),                      // 64: tabletmanagerdata.GetReplicasRequest
	(*GetReplicasResponse)(nil),                     // 65: tabletmanagerdata.GetReplicasResponse
	(*ResetReplicationRequest)(nil),                 // 66: tabletmanagerdata.ResetReplicationRequest
	(*ResetReplicationResponse)(nil),                // 67: tabletmanagerdata.ResetReplicationResponse
	(*VReplicationExecRequest)(nil),                 // 68: tabletmanagerdata.VReplicationExecRequest
	(*VReplicationExecResponse)(nil),                // 69: tabletmanagerdata.VReplicationExecResponse
	(*VReplicationWaitForPosRequest)(nil),           // 70: tabletmanagerdata.VReplicationWaitForPosRequest
	(*VReplicationWaitForPosResponse)(nil),          // 71: tabletmanagerdata.VReplicationWaitForPosResponse
	(*InitPrimaryRequest)(nil),                      // 72: tabletmanagerdata.InitPrimaryRequest
	(*InitPrimaryResponse)(nil),                     // 73: tabletmanagerdata.InitPrimaryResponse
	(*PopulateReparentJournalRequest)(nil),          // 74: tabletmanagerdata.PopulateReparentJournalRequest
	(*PopulateReparentJournalResponse)(nil),         // 75: tabletmanagerdata.PopulateReparentJournalResponse
	(*InitReplicaRequest)(nil),                      // 76: tabletmanagerdata.InitReplicaRequest
	(*InitReplicaResponse)(nil),                     // 77: tabletmanagerdata.InitReplicaResponse
	(*DemotePrimaryRequest)(nil),                    // 78: tabletmanagerdata.DemotePrimaryRequest
	(*DemotePrimaryResponse)(nil),                   // 79: tabletmanagerdata.DemotePrimaryResponse
	(*UndoDemotePrimaryRequest)(nil),                // 80: tabletmanagerdata.UndoDemotePrimaryRequest
	(*UndoDemotePrimaryResponse)(nil),               // 81: tabletmanagerdata.UndoDemotePrimaryResponse
	(*ReplicaWasPromotedRequest)(nil),               // 82: tabletmanagerdata.ReplicaWasPromotedRequest
	(*ReplicaWasPromotedResponse)(nil),              // 83: tabletmanagerdata.ReplicaWasPromotedResponse
	(*ResetReplicationParametersRequest)(nil),       // 84: tabletmanagerdata.ResetReplicationParametersRequest
	(*ResetReplicationParametersResponse)(nil),      // 85: tabletmanagerdata.ResetReplicationParametersResponse
	(*FullStatusRequest)(nil),                       // 86: tabletmanagerdata.FullStatusRequest
	(*FullStatusResponse)(nil),                      // 87: tabletmanagerdata.FullStatusResponse
	(*SetReplicationSourceRequest)(nil),             // 88: tabletmanagerdata.SetReplicationSourceRequest
	(*SetReplicationSourceResponse)(nil),            // 89: tabletmanagerdata.SetReplicationSourceResponse
	(*ReplicaWasRestartedRequest)(nil),              // 90: tabletmanagerdata.ReplicaWasRestartedRequest
	(*ReplicaWasRestartedResponse)(nil),             // 91: tabletmanagerdata.ReplicaWasRestartedResponse
	(*StopReplicationAndGetStatusRequest)(nil),      // 92: tabletmanagerdata.StopReplicationAndGetStatusRequest
	(*StopReplicationAndGetStatusResponse)(nil),     // 93: tabletmanagerdata.StopReplicationAndGetStatusResponse
	(*PromoteReplicaRequest)(nil),                   // 94: tabletmanagerdata.PromoteReplicaRequest
	(*PromoteReplicaResponse)(nil),                  // 95: tabletmanagerdata.PromoteReplicaResponse
	(*BackupRequest)(nil),                           // 96: tabletmanagerdata.BackupRequest
	(*BackupResponse)(nil),                          // 97: tabletmanagerdata.BackupResponse
	(*RestoreFromBackupRequest)(nil),                // 98: tabletmanagerdata.RestoreFromBackupRequest
	(*RestoreFromBackupResponse)(nil),               // 99: tabletmanagerdata.RestoreFromBackupResponse
	(*CreateVReplicationWorkflowRequest)(nil),       // 100: tabletmanagerdata.CreateVReplicationWorkflowRequest
	(*CreateVReplicationWorkflowResponse)(nil),      // 101: tabletmanagerdata.CreateVReplicationWorkflowResponse
	(*DeleteVReplicationWorkflowRequest)(nil),       // 102: tabletmanagerdata.DeleteVReplicationWorkflowRequest
	(*DeleteVReplicationWorkflowResponse)(nil),      // 103: tabletmanagerdata.DeleteVReplicationWorkflowResponse
	(*ReadVReplicationWorkflowRequest)(nil),         // 104: tabletmanagerdata.ReadVReplicationWorkflowRequest
	(*ReadVReplicationWorkflowResponse)(nil),        // 105: tabletmanagerdata.ReadVReplicationWorkflowResponse
	(*VDiffRequest)(nil),                            // 106: tabletmanagerdata.VDiffRequest
	(*VDiffResponse)(nil),                           // 107: tabletmanagerdata.VDiffResponse
	(*VDiffPickerOptions)(nil),                      // 108: tabletmanagerdata.VDiffPickerOptions
	(*VDiffReportOptions)(nil),                      // 109: tabletmanagerdata.VDiffReportOptions
	(*VDiffCoreOptions)(nil),                        // 110: tabletmanagerdata.VDiffCoreOptions
	(*VDiffOptions)(nil),                            // 111: tabletmanagerdata.VDiffOptions
	(*UpdateVReplicationWorkflowRequest)(nil),       // 112: tabletmanagerdata.UpdateVReplicationWorkflowRequest
	(*UpdateVReplicationWorkflowResponse)(nil),      // 113: tabletmanagerdata.UpdateVReplicationWorkflowResponse
	(*ResetSequencesRequest)(nil),                   // 114: tabletmanagerdata.ResetSequencesRequest
	(*ResetSequencesResponse)(nil),                  // 115: tabletmanagerdata.ResetSequencesResponse
	(*CheckThrottlerRequest)(nil),                   // 116: tabletmanagerdata.CheckThrottlerRequest
	(*CheckThrottlerResponse)(nil),                  // 117: tabletmanagerdata.CheckThrottlerResponse
	nil,                                             // 118: tabletmanagerdata.UserPermission.PrivilegesEntry
	nil,                                             // 119: tabletmanagerdata.DbPermission.PrivilegesEntry
	nil,                                             // 120: tabletmanagerdata.ExecuteHookRequest.ExtraEnvEntry
	(*ReadVReplicationWorkflowResponse_Stream)(nil), // 121: tabletmanagerdata.ReadVReplicationWorkflowResponse.Stream
	(*vttime.Time)(nil),                             // 122: vttime.Time
	(*topodata.TabletAlias)(nil),                    // 123: topodata.TabletAlias
	...
	(*replicationdata.FullStatus)(nil),              // 130: replicationdata.FullStatus
	(replicationdata.StopReplicationMode)(0),        // 131: replicationdata.StopReplicationMode
	(*replicationdata.StopReplicationStatus)(nil),   // 132: replicationdata.StopReplicationStatus
	(*logutil.Event)(nil),                           // 133: logutil.Event
	(*binlogdata.BinlogSource)(nil),                 // 134: binlogdata.BinlogSource
	(binlogdata.VReplicationWorkflowType)(0),        // 135: binlogdata.VReplicationWorkflowType
	(binlogdata.VReplicationWorkflowSubType)(0),     // 136: binlogdata.VReplicationWorkflowSubType
	(binlogdata.OnDDLAction)(0),                     // 137: binlogdata.OnDDLAction
	(binlogdata.VReplicationWorkflowState)(0),       // 138: binlogdata.VReplicationWorkflowState
}
var file_tabletmanagerdata_proto_depIdxs = []int32{
	1,   // 0: tabletmanagerdata.OnlineDDL.strategy:type_name -> tabletmanagerdata.OnlineDDL.Strategy
	122, // 1: tabletmanagerdata.OnlineDDL.request_time:type_name -> vttime.Time
	2,   // 2: tabletmanagerdata.OnlineDDL.status:type_name -> tabletmanagerdata.OnlineDDL.Status
	123, // 3: tabletmanagerdata.OnlineDDL.tablet_alias:type_name -> topodata.TabletAlias
	124, // 4: tabletmanagerdata.TableDefinition.fields:type_name -> query.Field
	4,   // 5: tabletmanagerdata.SchemaDefinition.table_definitions:type_name -> tabletmanagerdata.TableDefinition
	5,   // 6: tabletmanagerdata.SchemaChangeResult.before_schema:type_name -> tabletmanagerdata.SchemaDefinition
	5,   // 7: tabletmanagerdata.SchemaChangeResult.after_schema:type_name -> tabletmanagerdata.SchemaDefinition
	118, // 8: tabletmanagerdata.UserPermission.privileges:type_name -> tabletmanagerdata.UserPermission.PrivilegesEntry
	119, // 9: tabletmanagerdata.DbPermission.privileges:type_name -> tabletmanagerdata.DbPermission.PrivilegesEntry
	7,   // 10: tabletmanagerdata.Permissions.user_permissions:type_name -> tabletmanagerdata.UserPermission
	8,   // 11: tabletmanagerdata.Permissions.db_permissions:type_name -> tabletmanagerdata.DbPermission
	120, // 12: tabletmanagerdata.ExecuteHookRequest.extra_env:type_name -> tabletmanagerdata.ExecuteHookRequest.ExtraEnvEntry
	5,   // 13: tabletmanagerdata.GetSchemaResponse.schema_definition:type_name -> tabletmanagerdata.SchemaDefinition
	9,   // 14: tabletmanagerdata.GetPermissionsResponse.permissions:type_name -> tabletmanagerdata.Permissions
	125, // 15: tabletmanagerdata.ChangeTypeRequest.tablet_type:type_name -> topodata.TabletType
	6,   // 16: tabletmanagerdata.PreflightSchemaResponse.change_results:type_name -> tabletmanagerdata.SchemaChangeResult
	5,   // 17: tabletmanagerdata.ApplySchemaRequest.before_schema:type_name -> tabletmanagerdata.SchemaDefinition
	5,   // 18: tabletmanagerdata.ApplySchemaRequest.after_schema:type_name -> tabletmanagerdata.SchemaDefinition
	5,   // 19: tabletmanagerdata.ApplySchemaResponse.before_schema:type_name -> tabletmanagerdata.SchemaDefinition
	5,   // 20: tabletmanagerdata.ApplySchemaResponse.after_schema:type_name -> tabletmanagerdata.SchemaDefinition
	126, // 21: tabletmanagerdata.ExecuteQueryRequest.caller_id:type_name -> vtrpc.CallerID
	127, // 22: tabletmanagerdata.ExecuteQueryResponse.result:type_name -> query.QueryResult
	127, // 23: tabletmanagerdata.ExecuteFetchAsDbaResponse.result:type_name -> query.QueryResult
	127, // 24: tabletmanagerdata.ExecuteFetchAsAllPrivsResponse.result:type_name -> query.QueryResult
	127, // 25: tabletmanagerdata.ExecuteFetchAsAppResponse.result:type_name -> query.QueryResult
	128, // 26: tabletmanagerdata.ReplicationStatusResponse.status:type_name -> replicationdata.Status
	129, // 27: tabletmanagerdata.PrimaryStatusResponse.status:type_name -> replicationdata.PrimaryStatus
	127, // 28: tabletmanagerdata.VReplicationExecResponse.result:type_name -> query.QueryResult
	123, // 29: tabletmanagerdata.PopulateReparentJournalRequest.primary_alias:type_name -> topodata.TabletAlias
	123, // 30: tabletmanagerdata.InitReplicaRequest.parent:type_name -> topodata.TabletAlias
	129, // 31: tabletmanagerdata.DemotePrimaryResponse.primary_status:type_name -> replicationdata.PrimaryStatus
	130, // 32: tabletmanagerdata.FullStatusResponse.status:type_name -> replicationdata.FullStatus
	123, // 33: tabletmanagerdata.SetReplicationSourceRequest.parent:type_name -> topodata.TabletAlias
	123, // 34: tabletmanagerdata.ReplicaWasRestartedRequest.parent:type_name -> topodata.TabletAlias
	131, // 35: tabletmanagerdata.StopReplicationAndGetStatusRequest.stop_replication_mode:type_name -> replicationdata.StopReplicationMode
	132, // 36: tabletmanagerdata.StopReplicationAndGetStatusResponse.status:type_name -> replicationdata.StopReplicationStatus
	133, // 37: tabletmanagerdata.BackupResponse.event:type_name -> logutil.Event
	122, // 38: tabletmanagerdata.RestoreFromBackupRequest.backup_time:type_name -> vttime.Time
	122, // 39: tabletmanagerdata.RestoreFromBackupRequest.restore_to_timestamp:type_name -> vttime.Time
	133, // 40: tabletmanagerdata.RestoreFromBackupResponse.event:type_name -> logutil.Event
	134, // 41: tabletmanagerdata.CreateVReplicationWorkflowRequest.binlog_source:type_name -> binlogdata.BinlogSource
	125, // 42: tabletmanagerdata.CreateVReplicationWorkflowRequest.tablet_types:type_name -> topodata.TabletType
	...
	135, // 44: tabletmanagerdata.CreateVReplicationWorkflowRequest.workflow_type:type_name -> binlogdata.VReplicationWorkflowType
	136, // 45: tabletmanagerdata.CreateVReplicationWorkflowRequest.workflow_sub_type:type_name -> binlogdata.VReplicationWorkflowSubType
	127, // 46: tabletmanagerdata.CreateVReplicationWorkflowResponse.result:type_name -> query.QueryResult
	127, // 47: tabletmanagerdata.DeleteVReplicationWorkflowResponse.result:type_name -> query.QueryResult
	125, // 48: tabletmanagerdata.ReadVReplicationWorkflowResponse.tablet_types:type_name -> topodata.TabletType
	...
	135, // 50: tabletmanagerdata.ReadVReplicationWorkflowResponse.workflow_type:type_name -> binlogdata.VReplicationWorkflowType
	136, // 51: tabletmanagerdata.ReadVReplicationWorkflowResponse.workflow_sub_type:type_name -> binlogdata.VReplicationWorkflowSubType
	121, // 52: tabletmanagerdata.ReadVReplicationWorkflowResponse.streams:type_name -> tabletmanagerdata.ReadVReplicationWorkflowResponse.Stream
	111, // 53: tabletmanagerdata.VDiffRequest.options:type_name -> tabletmanagerdata.VDiffOptions
	127, // 54: tabletmanagerdata.VDiffResponse.output:type_name -> query.QueryResult
	108, // 55: tabletmanagerdata.VDiffOptions.picker_options:type_name -> tabletmanagerdata.VDiffPickerOptions
	110, // 56: tabletmanagerdata.VDiffOptions.core_options:type_name -> tabletmanagerdata.VDiffCoreOptions
	109, // 57: tabletmanagerdata.VDiffOptions.report_options:type_name -> tabletmanagerdata.VDiffReportOptions
	125, // 58: tabletmanagerdata.UpdateVReplicationWorkflowRequest.tablet_types:type_name -> topodata.TabletType
	...
	137, // 60: tabletmanagerdata.UpdateVReplicationWorkflowRequest.on_ddl:type_name -> binlogdata.OnDDLAction
	138, // 61: tabletmanagerdata.UpdateVReplicationWorkflowRequest.state:type_name -> binlogdata.VReplicationWorkflowState
	127, // 62: tabletmanagerdata.UpdateVReplicationWorkflowResponse.result:type_name -> query.QueryResult
	134, // 63: tabletmanagerdata.ReadVReplicationWorkflowResponse.Stream.bls:type_name -> binlogdata.BinlogSource
	122, // 64: tabletmanagerdata.ReadVReplicationWorkflowResponse.Stream.time_updated:type_name -> vttime.Time
	122, // 65: tabletmanagerdata.ReadVReplicationWorkflowResponse.Stream.transaction_timestamp:type_name -> vttime.Time
	138, // 66: tabletmanagerdata.ReadVReplicationWorkflowResponse.Stream.state:type_name -> binlogdata.VReplicationWorkflowState
	122, // 67: tabletmanagerdata.ReadVReplicationWorkflowResponse.Stream.time_heartbeat:type_name -> vttime.Time
	122, // 68: tabletmanagerdata.ReadVReplicationWorkflowResponse.Stream.time_throttled:type_name -> vttime.Time
