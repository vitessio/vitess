...
func (m *PopulateReparentJournalRequest) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.MasterAlias != nil {
		if marshalto, ok := interface{}(m.MasterAlias).(interface {
			MarshalToSizedBufferVT([]byte) (int, error)
		}); ok {
			size, err := marshalto.MarshalToSizedBufferVT(dAtA[:i])
			if err != nil {
			...
			encoded, err := proto.Marshal(m.MasterAlias)
			if err != nil {
				return 0, err
			}
			i -= len(encoded)
...
func (m *DemoteMasterResponse) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.MasterStatus != nil {
		if marshalto, ok := interface{}(m.MasterStatus).(interface {
			MarshalToSizedBufferVT([]byte) (int, error)
		}); ok {
			size, err := marshalto.MarshalToSizedBufferVT(dAtA[:i])
			if err != nil {
			...
			encoded, err := proto.Marshal(m.MasterStatus)
			if err != nil {
				return 0, err
			}
			i -= len(encoded)
...
func (m *PopulateReparentJournalRequest) SizeVT() (n int) {
	...
	if m.MasterAlias != nil {
		if size, ok := interface{}(m.MasterAlias).(interface {
			SizeVT() int
		}); ok {
			l = size.SizeVT()
		} else {
			l = proto.Size(m.MasterAlias)
		}
		n += 1 + l + sov(uint64(l))
	}
...
func (m *DemoteMasterResponse) SizeVT() (n int) {
	...
	if m.MasterStatus != nil {
		if size, ok := interface{}(m.MasterStatus).(interface {
			SizeVT() int
		}); ok {
			l = size.SizeVT()
		} else {
			l = proto.Size(m.MasterStatus)
		}
		n += 1 + l + sov(uint64(l))
	}
	if m.unknownFields != nil {
...
func (m *PopulateReparentJournalRequest) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			if unmarshal, ok := interface{}(m.MasterAlias).(interface {
				UnmarshalVT([]byte) error
			}); ok {
				if err := unmarshal.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
					return err
				...
				if err := proto.Unmarshal(dAtA[iNdEx:postIndex], m.MasterAlias); err != nil {
					return err
				}
			}
			iNdEx = postIndex
...
func (m *DemoteMasterResponse) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			if unmarshal, ok := interface{}(m.MasterStatus).(interface {
				UnmarshalVT([]byte) error
			}); ok {
				if err := unmarshal.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
					return err
				...
				if err := proto.Unmarshal(dAtA[iNdEx:postIndex], m.MasterStatus); err != nil {
					return err
				}
			}
			iNdEx = postIndex
