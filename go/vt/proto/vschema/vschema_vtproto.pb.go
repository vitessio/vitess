...
func (m *SrvVSchema) CloneVT() *SrvVSchema {
	...
	r := &SrvVSchema{
		...
		KeyspaceRoutingRulesCompressed: m.KeyspaceRoutingRulesCompressed.CloneVT(),
	}
...
func (m *KeyspaceRoutingRulesCompressed) CloneVT() *KeyspaceRoutingRulesCompressed {
	if m == nil {
		return (*KeyspaceRoutingRulesCompressed)(nil)
	}
	r := &KeyspaceRoutingRulesCompressed{
		CompressedRules: m.CompressedRules,
...
func (m *KeyspaceRoutingRulesCompressed) CloneMessageVT() proto.Message {
	return m.CloneVT()
}
...
func (m *SrvVSchema) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.KeyspaceRoutingRulesCompressed != nil {
		size, err := m.KeyspaceRoutingRulesCompressed.MarshalToSizedBufferVT(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *KeyspaceRoutingRulesCompressed) MarshalVT() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *KeyspaceRoutingRulesCompressed) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *KeyspaceRoutingRulesCompressed) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
	...
	if len(m.CompressedRules) > 0 {
		i -= len(m.CompressedRules)
		copy(dAtA[i:], m.CompressedRules)
		i = encodeVarint(dAtA, i, uint64(len(m.CompressedRules)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *SrvVSchema) SizeVT() (n int) {
	...
	if m.KeyspaceRoutingRulesCompressed != nil {
		l = m.KeyspaceRoutingRulesCompressed.SizeVT()
		n += 1 + l + sov(uint64(l))
	}
	n += len(m.unknownFields)
	return n
...
func (m *KeyspaceRoutingRulesCompressed) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	l = len(m.CompressedRules)
	if l > 0 {
		n += 1 + l + sov(uint64(l))
	}
	l = len(m.RulesHash)
...
func (m *SrvVSchema) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field KeyspaceRoutingRulesCompressed", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.KeyspaceRoutingRulesCompressed == nil {
				m.KeyspaceRoutingRulesCompressed = &KeyspaceRoutingRulesCompressed{}
			}
			if err := m.KeyspaceRoutingRulesCompressed.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *KeyspaceRoutingRulesCompressed) UnmarshalVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: KeyspaceRoutingRulesCompressed: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: KeyspaceRoutingRulesCompressed: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field CompressedRules", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.CompressedRules = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
