...
type Keyspace struct {
	...
	Views                  map[string]string `protobuf:"bytes,5,rep,name=views,proto3" json:"views,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
func (x *Keyspace) GetViews() map[string]string {
	if x != nil {
		return x.Views
	}
	return nil
...
var file_vschema_proto_rawDesc = []byte{
	...
	0x28, 0x09, 0x52, 0x08, 0x74, 0x6f, 0x54, 0x61, 0x62, 0x6c, 0x65, 0x73, 0x22, 0xd9, 0x03, 0x0a,
	...
	0x67, 0x12, 0x32, 0x0a, 0x05, 0x76, 0x69, 0x65, 0x77, 0x73, 0x18, 0x05, 0x20, 0x03, 0x28, 0x0b,
	0x32, 0x1c, 0x2e, 0x76, 0x73, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x2e, 0x4b, 0x65, 0x79, 0x73, 0x70,
	0x61, 0x63, 0x65, 0x2e, 0x56, 0x69, 0x65, 0x77, 0x73, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x52, 0x05,
	0x76, 0x69, 0x65, 0x77, 0x73, 0x1a, 0x4c, 0x0a, 0x0d, 0x56, 0x69, 0x6e, 0x64, 0x65, 0x78, 0x65,
	...
	0x02, 0x38, 0x01, 0x1a, 0x49, 0x0a, 0x0b, 0x54, 0x61, 0x62, 0x6c, 0x65, 0x73, 0x45, 0x6e, 0x74,
	0x72, 0x79, 0x12, 0x10, 0x0a, 0x03, 0x6b, 0x65, 0x79, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x03, 0x6b, 0x65, 0x79, 0x12, 0x24, 0x0a, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x02, 0x20,
	0x01, 0x28, 0x0b, 0x32, 0x0e, 0x2e, 0x76, 0x73, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x2e, 0x54, 0x61,
	0x62, 0x6c, 0x65, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x1a, 0x38,
	0x0a, 0x0a, 0x56, 0x69, 0x65, 0x77, 0x73, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x12, 0x10, 0x0a, 0x03,
	...
	0x01, 0x42, 0x26, 0x5a, 0x24, 0x76, 0x69, 0x74, 0x65, 0x73, 0x73, 0x2e, 0x69, 0x6f, 0x2f, 0x76,
...
var file_vschema_proto_msgTypes = make([]protoimpl.MessageInfo, 14)
var file_vschema_proto_goTypes = []interface{}{
	...
	nil,                   // 11: vschema.Keyspace.ViewsEntry
	nil,                   // 12: vschema.Vindex.ParamsEntry
	nil,                   // 13: vschema.SrvVSchema.KeyspacesEntry
	(query.Type)(0),       // 14: query.Type
}
var file_vschema_proto_depIdxs = []int32{
	...
	11, // 3: vschema.Keyspace.views:type_name -> vschema.Keyspace.ViewsEntry
	12, // 4: vschema.Vindex.params:type_name -> vschema.Vindex.ParamsEntry
	...
	14, // 8: vschema.Column.type:type_name -> query.Type
	13, // 9: vschema.SrvVSchema.keyspaces:type_name -> vschema.SrvVSchema.KeyspacesEntry
	0,  // 10: vschema.SrvVSchema.routing_rules:type_name -> vschema.RoutingRules
	3,  // 11: vschema.Keyspace.VindexesEntry.value:type_name -> vschema.Vindex
	4,  // 12: vschema.Keyspace.TablesEntry.value:type_name -> vschema.Table
	2,  // 13: vschema.SrvVSchema.KeyspacesEntry.value:type_name -> vschema.Keyspace
