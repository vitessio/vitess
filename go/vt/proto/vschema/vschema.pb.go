...
type SrvVSchema struct {
	...
	MirrorRules       *MirrorRules         `protobuf:"bytes,4,opt,name=mirror_rules,json=mirrorRules,proto3" json:"mirror_rules,omitempty"` // mirror rules
}
...
func (x *MirrorRule) GetFromKeyspace() string {
	if x != nil {
		return x.FromKeyspace
	}
	return ""
...
func (x *MirrorRule) GetToKeyspace() string {
	if x != nil {
		return x.ToKeyspace
	}
	return ""
...
var file_vschema_proto_rawDesc = []byte{
	...
	0x6c, 0x6c, 0x61, 0x62, 0x6c, 0x65, 0x22, 0xe0, 0x02, 0x0a, 0x0a, 0x53, 0x72, 0x76, 0x56, 0x53,
	...
	0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x14, 0x2e, 0x76, 0x73, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x2e,
	0x4d, 0x69, 0x72, 0x72, 0x6f, 0x72, 0x52, 0x75, 0x6c, 0x65, 0x73, 0x52, 0x0b, 0x6d, 0x69, 0x72,
	0x72, 0x6f, 0x72, 0x52, 0x75, 0x6c, 0x65, 0x73, 0x1a, 0x4f, 0x0a, 0x0e, 0x4b, 0x65, 0x79, 0x73,
	...
	0x38, 0x0a, 0x0b, 0x4d, 0x69, 0x72, 0x72, 0x6f, 0x72, 0x52, 0x75, 0x6c, 0x65, 0x73, 0x12, 0x29,
	...
	0x6c, 0x65, 0x52, 0x05, 0x72, 0x75, 0x6c, 0x65, 0x73, 0x22, 0x6c, 0x0a, 0x0a, 0x4d, 0x69, 0x72,
	0x72, 0x6f, 0x72, 0x52, 0x75, 0x6c, 0x65, 0x12, 0x23, 0x0a, 0x0d, 0x66, 0x72, 0x6f, 0x6d, 0x5f,
	...
	0x09, 0x52, 0x0a, 0x74, 0x6f, 0x4b, 0x65, 0x79, 0x73, 0x70, 0x61, 0x63, 0x65, 0x12, 0x18, 0x0a,
...
var file_vschema_proto_msgTypes = make([]protoimpl.MessageInfo, 17)
var file_vschema_proto_goTypes = []interface{}{
	...
	(*MirrorRules)(nil),          // 12: vschema.MirrorRules
	(*MirrorRule)(nil),           // 13: vschema.MirrorRule
...
var file_vschema_proto_depIdxs = []int32{
	...
	16, // 4: vschema.Vindex.params:type_name -> vschema.Vindex.ParamsEntry
	...
	18, // 8: vschema.Column.type:type_name -> query.Type
	17, // 9: vschema.SrvVSchema.keyspaces:type_name -> vschema.SrvVSchema.KeyspacesEntry
	...
	12, // 12: vschema.SrvVSchema.mirror_rules:type_name -> vschema.MirrorRules
	11, // 13: vschema.ShardRoutingRules.rules:type_name -> vschema.ShardRoutingRule
	13, // 14: vschema.MirrorRules.rules:type_name -> vschema.MirrorRule
