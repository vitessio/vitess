...
func (m *TableGroupSpec) CloneVT() *TableGroupSpec {
	...
	if rhs := m.TableNamesOrPrefixes; rhs != nil {
		...
		r.TableNamesOrPrefixes = tmpContainer
	}
	if rhs := m.Readers; rhs != nil {
		tmpContainer := make([]string, len(rhs))
		copy(tmpContainer, rhs)
		r.Readers = tmpContainer
	}
	if rhs := m.Writers; rhs != nil {
		tmpContainer := make([]string, len(rhs))
		copy(tmpContainer, rhs)
		r.Writers = tmpContainer
	}
	if rhs := m.Admins; rhs != nil {
		tmpContainer := make([]string, len(rhs))
		copy(tmpContainer, rhs)
		r.Admins = tmpContainer
	}
