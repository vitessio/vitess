...
type Session struct {
	...
	UserDefinedVariables map[string]*query.Value `protobuf:"bytes,13,rep,name=user_defined_variables,json=userDefinedVariables,proto3" json:"user_defined_variables,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
...
func (m *Session) GetUserDefinedVariables() map[string]*query.Value {
	if m != nil {
...
func init() {
	...
	proto.RegisterMapType((map[string]*query.Value)(nil), "vtgate.Session.UserDefinedVariablesEntry")
...
var fileDescriptor_aab96496ceaf1ebb = []byte{
	...
	,
}
