...
func (m *WorkflowMetadata) CloneVT() *WorkflowMetadata {
	if m == nil {
...
func (m *WorkflowMetadata) CloneMessageVT() proto.Message {
	return m.CloneVT()
}
...
func (m *Keyspace_ServedFrom) CloneMessageVT() proto.Message {
	return m.CloneVT()
}
...
func (m *Keyspace) CloneVT() *Keyspace {
	...
	if rhs := m.Workflows; rhs != nil {
		tmpContainer := make([]*WorkflowMetadata, len(rhs))
		for k, v := range rhs {
			tmpContainer[k] = v.CloneVT()
		}
...
func (m *SrvKeyspace_ServedFrom) CloneMessageVT() proto.Message {
	return m.CloneVT()
}
...
func (m *Keyspace) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 11:
			...
			m.Workflows = append(m.Workflows, &WorkflowMetadata{})
