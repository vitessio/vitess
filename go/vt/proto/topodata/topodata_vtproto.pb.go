...
func (m *TopoEvent_EmergencyReparent) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.IgnoreTablets) > 0 {
		for iNdEx := len(m.IgnoreTablets) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.IgnoreTablets[iNdEx])
			copy(dAtA[i:], m.IgnoreTablets[iNdEx])
			i = encodeVarint(dAtA, i, uint64(len(m.IgnoreTablets[iNdEx])))
			i--
			dAtA[i] = 0x1a
		}
	}
	if m.PrimaryElect != nil {
		size, err := m.PrimaryElect.MarshalToSizedBufferVT(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *TopoEvent_PlannedReparent) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.PrimaryAvoid != nil {
		size, err := m.PrimaryAvoid.MarshalToSizedBufferVT(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *TopoEvent_Reshard) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.Targets) > 0 {
		for iNdEx := len(m.Targets) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarint(dAtA, i, uint64(len(m.Targets[iNdEx])))
			i--
			dAtA[i] = 0x1a
		}
	}
...
func (m *TopoEvent) MarshalVT() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *TopoEvent) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *TopoEvent) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
...
func (m *TopoEvent_EmergencyReparent) SizeVT() (n int) {
	...
	if m.PrimaryElect != nil {
		l = m.PrimaryElect.SizeVT()
		n += 1 + l + sov(uint64(l))
	}
	if len(m.IgnoreTablets) > 0 {
		for _, s := range m.IgnoreTablets {
			l = len(s)
			n += 1 + l + sov(uint64(l))
		}
	}
...
func (m *TopoEvent_EmergencyReparent) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field PrimaryElect", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.PrimaryElect == nil {
				m.PrimaryElect = &TabletAlias{}
			}
			if err := m.PrimaryElect.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field IgnoreTablets", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.IgnoreTablets = append(m.IgnoreTablets, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skip(dAtA[iNdEx:])
...
func (m *TopoEvent_PlannedReparent) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field PrimaryAvoid", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.PrimaryAvoid == nil {
				m.PrimaryAvoid = &TabletAlias{}
			}
			if err := m.PrimaryAvoid.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *TopoEvent) UnmarshalVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: TopoEvent: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: TopoEvent: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
