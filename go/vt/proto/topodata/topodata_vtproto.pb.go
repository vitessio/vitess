...
func (m *ReplicationSourceConfig) CloneVT() *ReplicationSourceConfig {
	if m == nil {
		return (*ReplicationSourceConfig)(nil)
	}
	r := new(ReplicationSourceConfig)
	r.RdonlyPolicy = m.RdonlyPolicy
	if len(m.unknownFields) > 0 {
		r.unknownFields = make([]byte, len(m.unknownFields))
		copy(r.unknownFields, m.unknownFields)
	}
...
func (m *ReplicationSourceConfig) CloneMessageVT() proto.Message {
	return m.CloneVT()
}
...
func (m *Keyspace) CloneVT() *Keyspace {
	...
	r.ReplicationSourceConfig = m.ReplicationSourceConfig.CloneVT()
	if len(m.unknownFields) > 0 {
		r.unknownFields = make([]byte, len(m.unknownFields))
		copy(r.unknownFields, m.unknownFields)
	}
...
func (m *ReplicationSourceConfig) MarshalVT() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *ReplicationSourceConfig) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *ReplicationSourceConfig) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
	...
	if m.RdonlyPolicy != 0 {
		i = protohelpers.EncodeVarint(dAtA, i, uint64(m.RdonlyPolicy))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *Keyspace) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.ReplicationSourceConfig != nil {
		size, err := m.ReplicationSourceConfig.MarshalToSizedBufferVT(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *ReplicationSourceConfig) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.RdonlyPolicy != 0 {
		n += 1 + protohelpers.SizeOfVarint(uint64(m.RdonlyPolicy))
	}
	n += len(m.unknownFields)
	return n
}
...
func (m *Keyspace) SizeVT() (n int) {
	...
	if m.ReplicationSourceConfig != nil {
		l = m.ReplicationSourceConfig.SizeVT()
		n += 1 + l + protohelpers.SizeOfVarint(uint64(l))
	}
	n += len(m.unknownFields)
	return n
...
func (m *ReplicationSourceConfig) UnmarshalVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ReplicationSourceConfig: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ReplicationSourceConfig: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field RdonlyPolicy", wireType)
			}
			m.RdonlyPolicy = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.RdonlyPolicy |= ReplicationSourceConfig_RdonlyReplicationSourcePolicy(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *Keyspace) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 13:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ReplicationSourceConfig", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.ReplicationSourceConfig == nil {
				m.ReplicationSourceConfig = &ReplicationSourceConfig{}
			}
			if err := m.ReplicationSourceConfig.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
