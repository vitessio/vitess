...
// GossipConfig has the configuration for the gossip protocol
// used for liveness detection across vttablets and VTOrc.
// This is stored in the Keyspace record and propagated to
// SrvKeyspace for tablet consumption.
type GossipConfig struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// enabled controls whether gossip is active for this keyspace.
	Enabled bool `protobuf:"varint,1,opt,name=enabled,proto3" json:"enabled,omitempty"`
	// phi_threshold is the phi-accrual threshold for suspecting a peer.
	PhiThreshold float64 `protobuf:"fixed64,2,opt,name=phi_threshold,json=phiThreshold,proto3" json:"phi_threshold,omitempty"`
	// ping_interval is the gossip exchange interval (e.g. "1s").
	PingInterval string `protobuf:"bytes,3,opt,name=ping_interval,json=pingInterval,proto3" json:"ping_interval,omitempty"`
	// max_update_age is how long before a stale peer is marked down (e.g. "5s").
	MaxUpdateAge  string `protobuf:"bytes,4,opt,name=max_update_age,json=maxUpdateAge,proto3" json:"max_update_age,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *GossipConfig) GetEnabled() bool {
	if x != nil {
		return x.Enabled
	}
	return false
...
func (x *GossipConfig) GetPhiThreshold() float64 {
	if x != nil {
...
func (x *GossipConfig) GetPingInterval() string {
	if x != nil {
...
func (x *GossipConfig) GetMaxUpdateAge() string {
	if x != nil {
...
type Keyspace struct {
	...
	// GossipConfig has the configuration for the gossip protocol
	// used for liveness detection. Applies to the entire keyspace.
...
func (x *Keyspace) GetGossipConfig() *GossipConfig {
	if x != nil {
...
type SrvKeyspace struct {
	...
	// GossipConfig is copied from the global keyspace object.
	GossipConfig  *GossipConfig `protobuf:"bytes,8,opt,name=gossip_config,json=gossipConfig,proto3" json:"gossip_config,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *SrvKeyspace) GetGossipConfig() *GossipConfig {
	if x != nil {
		return x.GossipConfig
	}
	return nil
...
const file_topodata_proto_rawDesc = "" +
	...
	"\x06frozen\x18\x05 \x01(\bR\x06frozenJ\x04\b\x03\x10\x04J\x04\b\x03\x10\x04J\x04\b\x05\x10\x06\"\x98\x01\n" +
	"\fGossipConfig\x12\x18\n" +
	"\aenabled\x18\x01 \x01(\bR\aenabled\x12#\n" +
	"\rphi_threshold\x18\x02 \x01(\x01R\fphiThreshold\x12#\n" +
	"\rping_interval\x18\x03 \x01(\tR\fpingInterval\x12$\n" +
	"\x0emax_update_age\x18\x04 \x01(\tR\fmaxUpdateAge\"\x93\x04\n" +
	"\bKeyspace\x12;\n" +
	...
	"\rgossip_config\x18\r \x01(\v2\x16.topodata.GossipConfigR\fgossipConfigJ\x04\b\x01\x10\x02J\x04\b\x02\x10\x03J\x04\b\x03\x10\x04J\x04\b\x04\x10\x05\"\x8b\x01\n" +
	...
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\x01R\x05value:\x028\x01\"\xa3\x04\n" +
	"\vSrvKeyspace\x12G\n" +
	"\n" +
	...
	"\x16query_throttler_config\x18\a \x01(\v2\x16.querythrottler.ConfigR\x14queryThrottlerConfig\x12;\n" +
	"\rgossip_config\x18\b \x01(\v2\x16.topodata.GossipConfigR\fgossipConfig\x1a\xe1\x01\n" +
...
var file_topodata_proto_goTypes = []any{
	...
	(*GossipConfig)(nil),                  // 7: topodata.GossipConfig
...
var file_topodata_proto_depIdxs = []int32{
	...
	14, // 16: topodata.Keyspace.throttler_config:type_name -> topodata.ThrottlerConfig
	33, // 17: topodata.Keyspace.vtorc_state:type_name -> vtorcdata.Keyspace
	34, // 18: topodata.Keyspace.query_throttler_config:type_name -> querythrottler.Config
	7,  // 19: topodata.Keyspace.gossip_config:type_name -> topodata.GossipConfig
	25, // 20: topodata.ShardReplication.nodes:type_name -> topodata.ShardReplication.Node
	...
	31, // 25: topodata.ThrottledAppRule.expires_at:type_name -> vttime.Time
	26, // 26: topodata.ThrottlerConfig.throttled_apps:type_name -> topodata.ThrottlerConfig.ThrottledAppsEntry
	28, // 27: topodata.ThrottlerConfig.app_checked_metrics:type_name -> topodata.ThrottlerConfig.AppCheckedMetricsEntry
	29, // 28: topodata.ThrottlerConfig.metric_thresholds:type_name -> topodata.ThrottlerConfig.MetricThresholdsEntry
	30, // 29: topodata.SrvKeyspace.partitions:type_name -> topodata.SrvKeyspace.KeyspacePartition
	14, // 30: topodata.SrvKeyspace.throttler_config:type_name -> topodata.ThrottlerConfig
	34, // 31: topodata.SrvKeyspace.query_throttler_config:type_name -> querythrottler.Config
	7,  // 32: topodata.SrvKeyspace.gossip_config:type_name -> topodata.GossipConfig
	18, // 33: topodata.ExternalVitessCluster.topo_config:type_name -> topodata.TopoConfig
	19, // 34: topodata.ExternalClusters.vitess_cluster:type_name -> topodata.ExternalVitessCluster
	3,  // 35: topodata.Shard.SourceShard.key_range:type_name -> topodata.KeyRange
	1,  // 36: topodata.Shard.TabletControl.tablet_type:type_name -> topodata.TabletType
	4,  // 37: topodata.ShardReplication.Node.tablet_alias:type_name -> topodata.TabletAlias
	13, // 38: topodata.ThrottlerConfig.ThrottledAppsEntry.value:type_name -> topodata.ThrottledAppRule
	27, // 39: topodata.ThrottlerConfig.AppCheckedMetricsEntry.value:type_name -> topodata.ThrottlerConfig.MetricNames
	1,  // 40: topodata.SrvKeyspace.KeyspacePartition.served_type:type_name -> topodata.TabletType
	11, // 41: topodata.SrvKeyspace.KeyspacePartition.shard_references:type_name -> topodata.ShardReference
	12, // 42: topodata.SrvKeyspace.KeyspacePartition.shard_tablet_controls:type_name -> topodata.ShardTabletControl
