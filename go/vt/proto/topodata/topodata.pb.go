...
type Tablet struct {
	...
	// tablet_start_time is the Unix timestamp (seconds) when the vttablet process
	// started. Used by VTGate warming balancer to identify newly restored replicas.
	TabletStartTime int64 `protobuf:"varint,17,opt,name=tablet_start_time,json=tabletStartTime,proto3" json:"tablet_start_time,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
func (x *Tablet) GetTabletStartTime() int64 {
	if x != nil {
...
const file_topodata_proto_rawDesc = "" +
	...
	"\x03uid\x18\x02 \x01(\rR\x03uid\"\xe6\x05\n" +
	"\x06Tablet\x12+\n" +
	...
	"\x11tablet_start_time\x18\x11 \x01(\x03R\x0ftabletStartTime\x1a:\n" +
