...
type Shard struct {
	...
	// master_timestamp is the time at which master_alias was set
	MasterTimestamp      int64    `protobuf:"varint,8,opt,name=master_timestamp,json=masterTimestamp,proto3" json:"master_timestamp,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *Shard) GetMasterTimestamp() int64 {
	if m != nil {
		return m.MasterTimestamp
	}
	return 0
}
...
var fileDescriptor_52c350cb619f972e = []byte{
	...
	,
}
