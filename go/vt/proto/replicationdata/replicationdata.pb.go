...
func (StopReplicationMode) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_replicationdata_30c1987ac6484c81, []int{0}
}
...
func (*StopReplicationStatus) Descriptor() ([]byte, []int) {
	return fileDescriptor_replicationdata_30c1987ac6484c81, []int{1}
}
...
func (dst *StopReplicationStatus) XXX_Merge(src proto.Message) {
	xxx_messageInfo_StopReplicationStatus.Merge(dst, src)
}
...
func (*MasterStatus) Descriptor() ([]byte, []int) {
	return fileDescriptor_replicationdata_30c1987ac6484c81, []int{2}
}
...
func (dst *MasterStatus) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MasterStatus.Merge(dst, src)
}
...
func init() {
	proto.RegisterFile("replicationdata.proto", fileDescriptor_replicationdata_30c1987ac6484c81)
}

var fileDescriptor_replicationdata_30c1987ac6484c81 = []byte{
