...
type Status struct {
	...
	// IoThreadRunningState should be used instead of IoThreadRunning and correctly represents all three valid states from
	// IO_Thread_Running returned from calling SHOW REPLICA STATUS.
	IoThreadRunning     bool   `protobuf:"varint,2,opt,name=io_thread_running,json=ioThreadRunning,proto3" json:"io_thread_running,omitempty"` // Deprecated: Do not use.
...
var fileDescriptor_ee8ee22b8c4b9d06 = []byte{
	...
	,
}
