...
type Status struct {
	...
	SemiSyncPrimaryStatus                  bool   `protobuf:"varint,26,opt,name=semi_sync_primary_status,json=semiSyncPrimaryStatus,proto3" json:"semi_sync_primary_status,omitempty"`
	SemiSyncReplicaStatus                  bool   `protobuf:"varint,27,opt,name=semi_sync_replica_status,json=semiSyncReplicaStatus,proto3" json:"semi_sync_replica_status,omitempty"`
...
const file_replicationdata_proto_rawDesc = "" +
	"\n" +
	"\x15replicationdata.proto\x12\x0freplicationdata\x1a\x0etopodata.proto\"\xaf\b\n" +
	"\x06Status\x12\x1a\n" +
	...
	"\x0ebackup_running\x18\x19 \x01(\bR\rbackupRunning\x127\n" +
	"\x18semi_sync_primary_status\x18\x1a \x01(\bR\x15semiSyncPrimaryStatus\x127\n" +
	"\x18semi_sync_replica_status\x18\x1b \x01(\bR\x15semiSyncReplicaStatusJ\x04\b\x02\x10\x03J\x04\b\x03\x10\x04\"n\n" +
	"\rConfiguration\x12-\n" +
