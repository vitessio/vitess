...
var file_vtctlservice_proto_rawDesc = []byte{
	...
	0x73, 0x65, 0x22, 0x00, 0x30, 0x01, 0x32, 0x8b, 0x5b, 0x0a, 0x06, 0x56, 0x74, 0x63, 0x74, 0x6c,
	...
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x69, 0x0a, 0x14, 0x52, 0x65, 0x61, 0x64,
	0x54, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x53, 0x74, 0x61, 0x74, 0x65,
	0x12, 0x26, 0x2e, 0x76, 0x74, 0x63, 0x74, 0x6c, 0x64, 0x61, 0x74, 0x61, 0x2e, 0x52, 0x65, 0x61,
	...
	0x64, 0x61, 0x74, 0x61, 0x2e, 0x52, 0x65, 0x61, 0x64, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63,
...
var file_vtctlservice_proto_goTypes = []any{
	...
	(*vtctldata.ReadTransactionStateRequest)(nil),         // 74: vtctldata.ReadTransactionStateRequest
	...
	(*vtctldata.GetUnresolvedTransactionsResponse)(nil),   // 179: vtctldata.GetUnresolvedTransactionsResponse
	(*vtctldata.GetVersionResponse)(nil),                  // 180: vtctldata.GetVersionResponse
	(*vtctldata.GetVSchemaResponse)(nil),                  // 181: vtctldata.GetVSchemaResponse
	(*vtctldata.GetWorkflowsResponse)(nil),                // 182: vtctldata.GetWorkflowsResponse
	(*vtctldata.InitShardPrimaryResponse)(nil),            // 183: vtctldata.InitShardPrimaryResponse
	(*vtctldata.LaunchSchemaMigrationResponse)(nil),       // 184: vtctldata.LaunchSchemaMigrationResponse
	(*vtctldata.LookupVindexCreateResponse)(nil),          // 185: vtctldata.LookupVindexCreateResponse
	(*vtctldata.LookupVindexExternalizeResponse)(nil),     // 186: vtctldata.LookupVindexExternalizeResponse
	(*vtctldata.MaterializeCreateResponse)(nil),           // 187: vtctldata.MaterializeCreateResponse
	(*vtctldata.WorkflowStatusResponse)(nil),              // 188: vtctldata.WorkflowStatusResponse
	(*vtctldata.MountRegisterResponse)(nil),               // 189: vtctldata.MountRegisterResponse
	(*vtctldata.MountUnregisterResponse)(nil),             // 190: vtctldata.MountUnregisterResponse
	(*vtctldata.MountShowResponse)(nil),                   // 191: vtctldata.MountShowResponse
	(*vtctldata.MountListResponse)(nil),                   // 192: vtctldata.MountListResponse
	(*vtctldata.MoveTablesCompleteResponse)(nil),          // 193: vtctldata.MoveTablesCompleteResponse
	(*vtctldata.PingTabletResponse)(nil),                  // 194: vtctldata.PingTabletResponse
	(*vtctldata.PlannedReparentShardResponse)(nil),        // 195: vtctldata.PlannedReparentShardResponse
	(*vtctldata.ReadTransactionStateResponse)(nil),        // 196: vtctldata.ReadTransactionStateResponse
...
var file_vtctlservice_proto_depIdxs = []int32{
	...
	74,  // 74: vtctlservice.Vtctld.ReadTransactionState:input_type -> vtctldata.ReadTransactionStateRequest
	...
	179, // 180: vtctlservice.Vtctld.GetUnresolvedTransactions:output_type -> vtctldata.GetUnresolvedTransactionsResponse
	180, // 181: vtctlservice.Vtctld.GetVersion:output_type -> vtctldata.GetVersionResponse
	181, // 182: vtctlservice.Vtctld.GetVSchema:output_type -> vtctldata.GetVSchemaResponse
	182, // 183: vtctlservice.Vtctld.GetWorkflows:output_type -> vtctldata.GetWorkflowsResponse
	183, // 184: vtctlservice.Vtctld.InitShardPrimary:output_type -> vtctldata.InitShardPrimaryResponse
	184, // 185: vtctlservice.Vtctld.LaunchSchemaMigration:output_type -> vtctldata.LaunchSchemaMigrationResponse
	185, // 186: vtctlservice.Vtctld.LookupVindexCreate:output_type -> vtctldata.LookupVindexCreateResponse
	186, // 187: vtctlservice.Vtctld.LookupVindexExternalize:output_type -> vtctldata.LookupVindexExternalizeResponse
	187, // 188: vtctlservice.Vtctld.MaterializeCreate:output_type -> vtctldata.MaterializeCreateResponse
	188, // 189: vtctlservice.Vtctld.MigrateCreate:output_type -> vtctldata.WorkflowStatusResponse
	189, // 190: vtctlservice.Vtctld.MountRegister:output_type -> vtctldata.MountRegisterResponse
	190, // 191: vtctlservice.Vtctld.MountUnregister:output_type -> vtctldata.MountUnregisterResponse
	191, // 192: vtctlservice.Vtctld.MountShow:output_type -> vtctldata.MountShowResponse
	192, // 193: vtctlservice.Vtctld.MountList:output_type -> vtctldata.MountListResponse
	188, // 194: vtctlservice.Vtctld.MoveTablesCreate:output_type -> vtctldata.WorkflowStatusResponse
	193, // 195: vtctlservice.Vtctld.MoveTablesComplete:output_type -> vtctldata.MoveTablesCompleteResponse
	194, // 196: vtctlservice.Vtctld.PingTablet:output_type -> vtctldata.PingTabletResponse
	195, // 197: vtctlservice.Vtctld.PlannedReparentShard:output_type -> vtctldata.PlannedReparentShardResponse
	196, // 198: vtctlservice.Vtctld.ReadTransactionState:output_type -> vtctldata.ReadTransactionStateResponse
	...
	188, // 210: vtctlservice.Vtctld.ReshardCreate:output_type -> vtctldata.WorkflowStatusResponse
	...
	188, // 243: vtctlservice.Vtctld.WorkflowStatus:output_type -> vtctldata.WorkflowStatusResponse
