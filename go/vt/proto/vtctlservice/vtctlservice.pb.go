...
var file_vtctlservice_proto_goTypes = []interface{}{
	...
	(*vtctldata.ReshardCreateRequest)(nil),                // 67: vtctldata.ReshardCreateRequest
	(*vtctldata.RestoreFromBackupRequest)(nil),            // 68: vtctldata.RestoreFromBackupRequest
	(*vtctldata.RetrySchemaMigrationRequest)(nil),         // 69: vtctldata.RetrySchemaMigrationRequest
	(*vtctldata.RunHealthCheckRequest)(nil),               // 70: vtctldata.RunHealthCheckRequest
	(*vtctldata.SetKeyspaceDurabilityPolicyRequest)(nil),  // 71: vtctldata.SetKeyspaceDurabilityPolicyRequest
	(*vtctldata.SetShardIsPrimaryServingRequest)(nil),     // 72: vtctldata.SetShardIsPrimaryServingRequest
	(*vtctldata.SetShardTabletControlRequest)(nil),        // 73: vtctldata.SetShardTabletControlRequest
	(*vtctldata.SetWritableRequest)(nil),                  // 74: vtctldata.SetWritableRequest
	(*vtctldata.ShardReplicationAddRequest)(nil),          // 75: vtctldata.ShardReplicationAddRequest
	(*vtctldata.ShardReplicationFixRequest)(nil),          // 76: vtctldata.ShardReplicationFixRequest
	(*vtctldata.ShardReplicationPositionsRequest)(nil),    // 77: vtctldata.ShardReplicationPositionsRequest
	(*vtctldata.ShardReplicationRemoveRequest)(nil),       // 78: vtctldata.ShardReplicationRemoveRequest
	(*vtctldata.SleepTabletRequest)(nil),                  // 79: vtctldata.SleepTabletRequest
	(*vtctldata.SourceShardAddRequest)(nil),               // 80: vtctldata.SourceShardAddRequest
	(*vtctldata.SourceShardDeleteRequest)(nil),            // 81: vtctldata.SourceShardDeleteRequest
	(*vtctldata.StartReplicationRequest)(nil),             // 82: vtctldata.StartReplicationRequest
	(*vtctldata.StopReplicationRequest)(nil),              // 83: vtctldata.StopReplicationRequest
	(*vtctldata.TabletExternallyReparentedRequest)(nil),   // 84: vtctldata.TabletExternallyReparentedRequest
	(*vtctldata.UpdateCellInfoRequest)(nil),               // 85: vtctldata.UpdateCellInfoRequest
	(*vtctldata.UpdateCellsAliasRequest)(nil),             // 86: vtctldata.UpdateCellsAliasRequest
	(*vtctldata.ValidateRequest)(nil),                     // 87: vtctldata.ValidateRequest
	(*vtctldata.ValidateKeyspaceRequest)(nil),             // 88: vtctldata.ValidateKeyspaceRequest
	(*vtctldata.ValidateSchemaKeyspaceRequest)(nil),       // 89: vtctldata.ValidateSchemaKeyspaceRequest
	(*vtctldata.ValidateShardRequest)(nil),                // 90: vtctldata.ValidateShardRequest
...
var file_vtctlservice_proto_depIdxs = []int32{
	...
	67,  // 67: vtctlservice.Vtctld.ReshardCreate:input_type -> vtctldata.ReshardCreateRequest
	68,  // 68: vtctlservice.Vtctld.RestoreFromBackup:input_type -> vtctldata.RestoreFromBackupRequest
	69,  // 69: vtctlservice.Vtctld.RetrySchemaMigration:input_type -> vtctldata.RetrySchemaMigrationRequest
	70,  // 70: vtctlservice.Vtctld.RunHealthCheck:input_type -> vtctldata.RunHealthCheckRequest
	71,  // 71: vtctlservice.Vtctld.SetKeyspaceDurabilityPolicy:input_type -> vtctldata.SetKeyspaceDurabilityPolicyRequest
	72,  // 72: vtctlservice.Vtctld.SetShardIsPrimaryServing:input_type -> vtctldata.SetShardIsPrimaryServingRequest
	73,  // 73: vtctlservice.Vtctld.SetShardTabletControl:input_type -> vtctldata.SetShardTabletControlRequest
	74,  // 74: vtctlservice.Vtctld.SetWritable:input_type -> vtctldata.SetWritableRequest
	75,  // 75: vtctlservice.Vtctld.ShardReplicationAdd:input_type -> vtctldata.ShardReplicationAddRequest
	76,  // 76: vtctlservice.Vtctld.ShardReplicationFix:input_type -> vtctldata.ShardReplicationFixRequest
	77,  // 77: vtctlservice.Vtctld.ShardReplicationPositions:input_type -> vtctldata.ShardReplicationPositionsRequest
	78,  // 78: vtctlservice.Vtctld.ShardReplicationRemove:input_type -> vtctldata.ShardReplicationRemoveRequest
	79,  // 79: vtctlservice.Vtctld.SleepTablet:input_type -> vtctldata.SleepTabletRequest
	80,  // 80: vtctlservice.Vtctld.SourceShardAdd:input_type -> vtctldata.SourceShardAddRequest
	81,  // 81: vtctlservice.Vtctld.SourceShardDelete:input_type -> vtctldata.SourceShardDeleteRequest
	82,  // 82: vtctlservice.Vtctld.StartReplication:input_type -> vtctldata.StartReplicationRequest
	83,  // 83: vtctlservice.Vtctld.StopReplication:input_type -> vtctldata.StopReplicationRequest
	84,  // 84: vtctlservice.Vtctld.TabletExternallyReparented:input_type -> vtctldata.TabletExternallyReparentedRequest
	85,  // 85: vtctlservice.Vtctld.UpdateCellInfo:input_type -> vtctldata.UpdateCellInfoRequest
	86,  // 86: vtctlservice.Vtctld.UpdateCellsAlias:input_type -> vtctldata.UpdateCellsAliasRequest
	87,  // 87: vtctlservice.Vtctld.Validate:input_type -> vtctldata.ValidateRequest
	88,  // 88: vtctlservice.Vtctld.ValidateKeyspace:input_type -> vtctldata.ValidateKeyspaceRequest
	89,  // 89: vtctlservice.Vtctld.ValidateSchemaKeyspace:input_type -> vtctldata.ValidateSchemaKeyspaceRequest
	90,  // 90: vtctlservice.Vtctld.ValidateShard:input_type -> vtctldata.ValidateShardRequest
