...
type Workflow_Stream struct {
	...
	WorkflowType    binlogdata.VReplicationWorkflowType    `protobuf:"varint,16,opt,name=workflow_type,json=workflowType,proto3,enum=binlogdata.VReplicationWorkflowType" json:"workflow_type,omitempty"`
	WorkflowSubType binlogdata.VReplicationWorkflowSubType `protobuf:"varint,17,opt,name=workflow_sub_type,json=workflowSubType,proto3,enum=binlogdata.VReplicationWorkflowSubType" json:"workflow_sub_type,omitempty"`
}
...
func (x *Workflow_Stream) GetWorkflowType() binlogdata.VReplicationWorkflowType {
	if x != nil {
		return x.WorkflowType
	}
...
func (x *Workflow_Stream) GetWorkflowSubType() binlogdata.VReplicationWorkflowSubType {
	if x != nil {
		return x.WorkflowSubType
	}
...
var file_vtctldata_proto_rawDesc = []byte{
	...
	0x61, 0x72, 0x64, 0x22, 0xf2, 0x0d, 0x0a, 0x08, 0x57, 0x6f, 0x72, 0x6b, 0x66, 0x6c, 0x6f, 0x77,
	...
	0x96, 0x08, 0x0a, 0x06, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64,
	...
	0x74, 0x79, 0x70, 0x65, 0x18, 0x10, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x24, 0x2e, 0x62, 0x69, 0x6e,
	...
	0x79, 0x70, 0x65, 0x18, 0x11, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x27, 0x2e, 0x62, 0x69, 0x6e, 0x6c,
	...
	0x79, 0x70, 0x65, 0x1a, 0x3a, 0x0a, 0x09, 0x43, 0x6f, 0x70, 0x79, 0x53, 0x74, 0x61, 0x74, 0x65,
	...
	0x61, 0x73, 0x52, 0x07, 0x70, 0x72, 0x69, 0x6d, 0x61, 0x72, 0x79, 0x22, 0x83, 0x01, 0x0a, 0x18,
	...
	0x65, 0x22, 0xad, 0x01, 0x0a, 0x19, 0x52, 0x65, 0x73, 0x74, 0x6f, 0x72, 0x65, 0x46, 0x72, 0x6f,
...
var file_vtctldata_proto_goTypes = []interface{}{
	...
	(binlogdata.VReplicationWorkflowType)(0),      // 225: binlogdata.VReplicationWorkflowType
	(binlogdata.VReplicationWorkflowSubType)(0),   // 226: binlogdata.VReplicationWorkflowSubType
...
var file_vtctldata_proto_depIdxs = []int32{
	...
	225, // 131: vtctldata.Workflow.Stream.workflow_type:type_name -> binlogdata.VReplicationWorkflowType
	226, // 132: vtctldata.Workflow.Stream.workflow_sub_type:type_name -> binlogdata.VReplicationWorkflowSubType
	...
	227, // 138: vtctldata.GetSrvKeyspacesResponse.SrvKeyspacesEntry.value:type_name -> topodata.SrvKeyspace
	219, // 139: vtctldata.GetSrvVSchemasResponse.SrvVSchemasEntry.value:type_name -> vschema.SrvVSchema
	228, // 140: vtctldata.ShardReplicationPositionsResponse.ReplicationStatusesEntry.value:type_name -> replicationdata.Status
