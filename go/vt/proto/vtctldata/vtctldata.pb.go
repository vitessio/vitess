...
var file_vtctldata_proto_rawDesc = []byte{
	...
	0x65, 0x6d, 0x61, 0x22, 0x6f, 0x0a, 0x13, 0x47, 0x65, 0x74, 0x57, 0x6f, 0x72, 0x6b, 0x66, 0x6c,
	...
	0x4f, 0x6e, 0x6c, 0x79, 0x22, 0x49, 0x0a, 0x14, 0x47, 0x65, 0x74, 0x57, 0x6f, 0x72, 0x6b, 0x66,
	...
	0x6e, 0x73, 0x65, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0x86,
...
var file_vtctldata_proto_goTypes = []interface{}{
	...
	(*topodata.ThrottledAppRule)(nil),                 // 224: topodata.ThrottledAppRule
	(*vschema.SrvVSchema)(nil),                        // 225: vschema.SrvVSchema
	(*topodata.ShardReplicationError)(nil),            // 226: topodata.ShardReplicationError
	(*topodata.KeyRange)(nil),                         // 227: topodata.KeyRange
	(*topodata.CellsAlias)(nil),                       // 228: topodata.CellsAlias
	(*tabletmanagerdata.UpdateVRWorkflowRequest)(nil), // 229: tabletmanagerdata.UpdateVRWorkflowRequest
	(*topodata.Shard_TabletControl)(nil),              // 230: topodata.Shard.TabletControl
	(*binlogdata.BinlogSource)(nil),                   // 231: binlogdata.BinlogSource
	(*topodata.SrvKeyspace)(nil),                      // 232: topodata.SrvKeyspace
	(*replicationdata.Status)(nil),                    // 233: replicationdata.Status
}
var file_vtctldata_proto_depIdxs = []int32{
	...
	224, // 59: vtctldata.UpdateThrottlerConfigRequest.throttled_app:type_name -> topodata.ThrottledAppRule
	225, // 60: vtctldata.GetSrvVSchemaResponse.srv_v_schema:type_name -> vschema.SrvVSchema
	193, // 61: vtctldata.GetSrvVSchemasResponse.srv_v_schemas:type_name -> vtctldata.GetSrvVSchemasResponse.SrvVSchemasEntry
	211, // 62: vtctldata.GetTabletRequest.tablet_alias:type_name -> topodata.TabletAlias
	213, // 63: vtctldata.GetTabletResponse.tablet:type_name -> topodata.Tablet
	211, // 64: vtctldata.GetTabletsRequest.tablet_aliases:type_name -> topodata.TabletAlias
	212, // 65: vtctldata.GetTabletsRequest.tablet_type:type_name -> topodata.TabletType
	213, // 66: vtctldata.GetTabletsResponse.tablets:type_name -> topodata.Tablet
	91,  // 67: vtctldata.GetTopologyPathResponse.cell:type_name -> vtctldata.TopologyCell
	211, // 68: vtctldata.GetVersionRequest.tablet_alias:type_name -> topodata.TabletAlias
	210, // 69: vtctldata.GetVSchemaResponse.v_schema:type_name -> vschema.Keyspace
	7,   // 70: vtctldata.GetWorkflowsResponse.workflows:type_name -> vtctldata.Workflow
	211, // 71: vtctldata.InitShardPrimaryRequest.primary_elect_tablet_alias:type_name -> topodata.TabletAlias
	208, // 72: vtctldata.InitShardPrimaryRequest.wait_replicas_timeout:type_name -> vttime.Duration
	202, // 73: vtctldata.InitShardPrimaryResponse.events:type_name -> logutil.Event
	211, // 74: vtctldata.PingTabletRequest.tablet_alias:type_name -> topodata.TabletAlias
	211, // 75: vtctldata.PlannedReparentShardRequest.new_primary:type_name -> topodata.TabletAlias
	211, // 76: vtctldata.PlannedReparentShardRequest.avoid_primary:type_name -> topodata.TabletAlias
	208, // 77: vtctldata.PlannedReparentShardRequest.wait_replicas_timeout:type_name -> vttime.Duration
	211, // 78: vtctldata.PlannedReparentShardResponse.promoted_primary:type_name -> topodata.TabletAlias
	202, // 79: vtctldata.PlannedReparentShardResponse.events:type_name -> logutil.Event
	211, // 80: vtctldata.RefreshStateRequest.tablet_alias:type_name -> topodata.TabletAlias
	211, // 81: vtctldata.ReloadSchemaRequest.tablet_alias:type_name -> topodata.TabletAlias
	202, // 82: vtctldata.ReloadSchemaKeyspaceResponse.events:type_name -> logutil.Event
	202, // 83: vtctldata.ReloadSchemaShardResponse.events:type_name -> logutil.Event
	211, // 84: vtctldata.ReparentTabletRequest.tablet:type_name -> topodata.TabletAlias
	211, // 85: vtctldata.ReparentTabletResponse.primary:type_name -> topodata.TabletAlias
	211, // 86: vtctldata.RestoreFromBackupRequest.tablet_alias:type_name -> topodata.TabletAlias
	216, // 87: vtctldata.RestoreFromBackupRequest.backup_time:type_name -> vttime.Time
	...
	226, // 100: vtctldata.ShardReplicationFixResponse.error:type_name -> topodata.ShardReplicationError
	...
	227, // 106: vtctldata.SourceShardAddRequest.key_range:type_name -> topodata.KeyRange
	...
	228, // 116: vtctldata.UpdateCellsAliasRequest.cells_alias:type_name -> topodata.CellsAlias
	228, // 117: vtctldata.UpdateCellsAliasResponse.cells_alias:type_name -> topodata.CellsAlias
	...
	229, // 123: vtctldata.WorkflowUpdateRequest.tablet_request:type_name -> tabletmanagerdata.UpdateVRWorkflowRequest
	...
	230, // 127: vtctldata.Workflow.ShardStream.tablet_controls:type_name -> topodata.Shard.TabletControl
	211, // 128: vtctldata.Workflow.Stream.tablet:type_name -> topodata.TabletAlias
	231, // 129: vtctldata.Workflow.Stream.binlog_source:type_name -> binlogdata.BinlogSource
	...
	228, // 137: vtctldata.GetCellsAliasesResponse.AliasesEntry.value:type_name -> topodata.CellsAlias
	191, // 138: vtctldata.GetSrvKeyspaceNamesResponse.NamesEntry.value:type_name -> vtctldata.GetSrvKeyspaceNamesResponse.NameList
	232, // 139: vtctldata.GetSrvKeyspacesResponse.SrvKeyspacesEntry.value:type_name -> topodata.SrvKeyspace
	225, // 140: vtctldata.GetSrvVSchemasResponse.SrvVSchemasEntry.value:type_name -> vschema.SrvVSchema
	233, // 141: vtctldata.ShardReplicationPositionsResponse.ReplicationStatusesEntry.value:type_name -> replicationdata.Status
