...
var file_vtctldata_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x09, 0x52, 0x06, 0x6c, 0x61, 0x73, 0x74, 0x50, 0x6b, 0x22, 0x9b, 0x01, 0x0a, 0x17,
	...
	0x64, 0x79, 0x45, 0x78, 0x69, 0x73, 0x74, 0x73, 0x22, 0x51, 0x0a, 0x15, 0x44, 0x65, 0x6c, 0x65,
	...
	0x52, 0x09, 0x72, 0x65, 0x63, 0x75, 0x72, 0x73, 0x69, 0x76, 0x65, 0x22, 0x18, 0x0a, 0x16, 0x44,
	0x65, 0x6c, 0x65, 0x74, 0x65, 0x4b, 0x65, 0x79, 0x73, 0x70, 0x61, 0x63, 0x65, 0x52, 0x65, 0x73,
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x85, 0x01, 0x0a, 0x13, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65,
	...
	0x65, 0x76, 0x65, 0x6e, 0x49, 0x66, 0x53, 0x65, 0x72, 0x76, 0x69, 0x6e, 0x67, 0x22, 0x16, 0x0a,
	...
	0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x8f, 0x02, 0x0a, 0x1d, 0x45, 0x6d,
	...
	0x69, 0x63, 0x61, 0x73, 0x54, 0x69, 0x6d, 0x65, 0x6f, 0x75, 0x74, 0x22, 0xbc, 0x01, 0x0a, 0x1e,
	...
	0x6e, 0x74, 0x52, 0x06, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x73, 0x22, 0x3c, 0x0a, 0x1e, 0x46, 0x69,
	...
	0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0x45, 0x0a, 0x11, 0x47, 0x65, 0x74,
	...
	0x74, 0x6f, 0x70, 0x6f, 0x64, 0x61, 0x74, 0x61, 0x2e, 0x54, 0x61, 0x62, 0x6c, 0x65, 0x74, 0x41,
	0x6c, 0x69, 0x61, 0x73, 0x52, 0x07, 0x70, 0x72, 0x69, 0x6d, 0x61, 0x72, 0x79, 0x22, 0x54, 0x0a,
	...
	0x6f, 0x64, 0x61, 0x74, 0x61, 0x2e, 0x54, 0x61, 0x62, 0x6c, 0x65, 0x74, 0x41, 0x6c, 0x69, 0x61,
	0x73, 0x52, 0x0a, 0x6f, 0x6c, 0x64, 0x50, 0x72, 0x69, 0x6d, 0x61, 0x72, 0x79, 0x42, 0x28, 0x5a,
...
var file_vtctldata_proto_msgTypes = make([]protoimpl.MessageInfo, 75)
var file_vtctldata_proto_goTypes = []interface{}{
	...
	(*GetWorkflowsRequest)(nil),                // 49: vtctldata.GetWorkflowsRequest
	(*GetWorkflowsResponse)(nil),               // 50: vtctldata.GetWorkflowsResponse
	(*InitShardPrimaryRequest)(nil),            // 51: vtctldata.InitShardPrimaryRequest
	(*InitShardPrimaryResponse)(nil),           // 52: vtctldata.InitShardPrimaryResponse
	(*PlannedReparentShardRequest)(nil),        // 53: vtctldata.PlannedReparentShardRequest
	(*PlannedReparentShardResponse)(nil),       // 54: vtctldata.PlannedReparentShardResponse
	(*RemoveKeyspaceCellRequest)(nil),          // 55: vtctldata.RemoveKeyspaceCellRequest
	(*RemoveKeyspaceCellResponse)(nil),         // 56: vtctldata.RemoveKeyspaceCellResponse
	(*RemoveShardCellRequest)(nil),             // 57: vtctldata.RemoveShardCellRequest
	(*RemoveShardCellResponse)(nil),            // 58: vtctldata.RemoveShardCellResponse
	(*ReparentTabletRequest)(nil),              // 59: vtctldata.ReparentTabletRequest
	(*ReparentTabletResponse)(nil),             // 60: vtctldata.ReparentTabletResponse
	(*ShardReplicationPositionsRequest)(nil),   // 61: vtctldata.ShardReplicationPositionsRequest
	(*ShardReplicationPositionsResponse)(nil),  // 62: vtctldata.ShardReplicationPositionsResponse
	(*TabletExternallyReparentedRequest)(nil),  // 63: vtctldata.TabletExternallyReparentedRequest
	(*TabletExternallyReparentedResponse)(nil), // 64: vtctldata.TabletExternallyReparentedResponse
	nil,                                  // 65: vtctldata.Workflow.ShardStreamsEntry
	(*Workflow_ReplicationLocation)(nil), // 66: vtctldata.Workflow.ReplicationLocation
	(*Workflow_ShardStream)(nil),         // 67: vtctldata.Workflow.ShardStream
	(*Workflow_Stream)(nil),              // 68: vtctldata.Workflow.Stream
	(*Workflow_Stream_CopyState)(nil),    // 69: vtctldata.Workflow.Stream.CopyState
	nil,                                  // 70: vtctldata.FindAllShardsInKeyspaceResponse.ShardsEntry
	nil,                                  // 71: vtctldata.GetCellsAliasesResponse.AliasesEntry
	nil,                                  // 72: vtctldata.GetSrvKeyspacesResponse.SrvKeyspacesEntry
	nil,                                  // 73: vtctldata.ShardReplicationPositionsResponse.ReplicationStatusesEntry
	nil,                                  // 74: vtctldata.ShardReplicationPositionsResponse.TabletMapEntry
	(*logutil.Event)(nil),                // 75: logutil.Event
	(*topodata.Keyspace)(nil),            // 76: topodata.Keyspace
	(*topodata.Shard)(nil),               // 77: topodata.Shard
	...
	(topodata.KeyspaceIdType)(0),         // 81: topodata.KeyspaceIdType
	(*topodata.Keyspace_ServedFrom)(nil), // 82: topodata.Keyspace.ServedFrom
	(topodata.KeyspaceType)(0),           // 83: topodata.KeyspaceType
	(*vttime.Time)(nil),                  // 84: vttime.Time
	(*vttime.Duration)(nil),              // 85: vttime.Duration
	(*mysqlctl.BackupInfo)(nil),          // 86: mysqlctl.BackupInfo
	(*topodata.CellInfo)(nil),            // 87: topodata.CellInfo
	(*tabletmanagerdata.SchemaDefinition)(nil), // 88: tabletmanagerdata.SchemaDefinition
	(*vschema.SrvVSchema)(nil),                 // 89: vschema.SrvVSchema
	(*vschema.Keyspace)(nil),                   // 90: vschema.Keyspace
	(*topodata.Shard_TabletControl)(nil),       // 91: topodata.Shard.TabletControl
	(*binlogdata.BinlogSource)(nil),            // 92: binlogdata.BinlogSource
	(*topodata.CellsAlias)(nil),                // 93: topodata.CellsAlias
	(*topodata.SrvKeyspace)(nil),               // 94: topodata.SrvKeyspace
	(*replicationdata.Status)(nil),             // 95: replicationdata.Status
}
var file_vtctldata_proto_depIdxs = []int32{
	75, // 0: vtctldata.ExecuteVtctlCommandResponse.event:type_name -> logutil.Event
	2,  // 1: vtctldata.MaterializeSettings.table_settings:type_name -> vtctldata.TableMaterializeSettings
	76, // 2: vtctldata.Keyspace.keyspace:type_name -> topodata.Keyspace
	77, // 3: vtctldata.Shard.shard:type_name -> topodata.Shard
	66, // 4: vtctldata.Workflow.source:type_name -> vtctldata.Workflow.ReplicationLocation
	66, // 5: vtctldata.Workflow.target:type_name -> vtctldata.Workflow.ReplicationLocation
	65, // 6: vtctldata.Workflow.shard_streams:type_name -> vtctldata.Workflow.ShardStreamsEntry
	78, // 7: vtctldata.ChangeTabletTypeRequest.tablet_alias:type_name -> topodata.TabletAlias
	79, // 8: vtctldata.ChangeTabletTypeRequest.db_type:type_name -> topodata.TabletType
	80, // 9: vtctldata.ChangeTabletTypeResponse.before_tablet:type_name -> topodata.Tablet
	80, // 10: vtctldata.ChangeTabletTypeResponse.after_tablet:type_name -> topodata.Tablet
	81, // 11: vtctldata.CreateKeyspaceRequest.sharding_column_type:type_name -> topodata.KeyspaceIdType
	82, // 12: vtctldata.CreateKeyspaceRequest.served_froms:type_name -> topodata.Keyspace.ServedFrom
	83, // 13: vtctldata.CreateKeyspaceRequest.type:type_name -> topodata.KeyspaceType
	84, // 14: vtctldata.CreateKeyspaceRequest.snapshot_time:type_name -> vttime.Time
	...
	78, // 19: vtctldata.DeleteTabletsRequest.tablet_aliases:type_name -> topodata.TabletAlias
	78, // 20: vtctldata.EmergencyReparentShardRequest.new_primary:type_name -> topodata.TabletAlias
	78, // 21: vtctldata.EmergencyReparentShardRequest.ignore_replicas:type_name -> topodata.TabletAlias
	85, // 22: vtctldata.EmergencyReparentShardRequest.wait_replicas_timeout:type_name -> vttime.Duration
	78, // 23: vtctldata.EmergencyReparentShardResponse.promoted_primary:type_name -> topodata.TabletAlias
	75, // 24: vtctldata.EmergencyReparentShardResponse.events:type_name -> logutil.Event
	70, // 25: vtctldata.FindAllShardsInKeyspaceResponse.shards:type_name -> vtctldata.FindAllShardsInKeyspaceResponse.ShardsEntry
	86, // 26: vtctldata.GetBackupsResponse.backups:type_name -> mysqlctl.BackupInfo
	87, // 27: vtctldata.GetCellInfoResponse.cell_info:type_name -> topodata.CellInfo
	71, // 28: vtctldata.GetCellsAliasesResponse.aliases:type_name -> vtctldata.GetCellsAliasesResponse.AliasesEntry
	...
	78, // 31: vtctldata.GetSchemaRequest.tablet_alias:type_name -> topodata.TabletAlias
	88, // 32: vtctldata.GetSchemaResponse.schema:type_name -> tabletmanagerdata.SchemaDefinition
	5,  // 33: vtctldata.GetShardResponse.shard:type_name -> vtctldata.Shard
	72, // 34: vtctldata.GetSrvKeyspacesResponse.srv_keyspaces:type_name -> vtctldata.GetSrvKeyspacesResponse.SrvKeyspacesEntry
	89, // 35: vtctldata.GetSrvVSchemaResponse.srv_v_schema:type_name -> vschema.SrvVSchema
	78, // 36: vtctldata.GetTabletRequest.tablet_alias:type_name -> topodata.TabletAlias
	80, // 37: vtctldata.GetTabletResponse.tablet:type_name -> topodata.Tablet
	78, // 38: vtctldata.GetTabletsRequest.tablet_aliases:type_name -> topodata.TabletAlias
	80, // 39: vtctldata.GetTabletsResponse.tablets:type_name -> topodata.Tablet
	90, // 40: vtctldata.GetVSchemaResponse.v_schema:type_name -> vschema.Keyspace
	6,  // 41: vtctldata.GetWorkflowsResponse.workflows:type_name -> vtctldata.Workflow
	78, // 42: vtctldata.InitShardPrimaryRequest.primary_elect_tablet_alias:type_name -> topodata.TabletAlias
	85, // 43: vtctldata.InitShardPrimaryRequest.wait_replicas_timeout:type_name -> vttime.Duration
	75, // 44: vtctldata.InitShardPrimaryResponse.events:type_name -> logutil.Event
	78, // 45: vtctldata.PlannedReparentShardRequest.new_primary:type_name -> topodata.TabletAlias
	78, // 46: vtctldata.PlannedReparentShardRequest.avoid_primary:type_name -> topodata.TabletAlias
	85, // 47: vtctldata.PlannedReparentShardRequest.wait_replicas_timeout:type_name -> vttime.Duration
	78, // 48: vtctldata.PlannedReparentShardResponse.promoted_primary:type_name -> topodata.TabletAlias
	75, // 49: vtctldata.PlannedReparentShardResponse.events:type_name -> logutil.Event
	78, // 50: vtctldata.ReparentTabletRequest.tablet:type_name -> topodata.TabletAlias
	78, // 51: vtctldata.ReparentTabletResponse.primary:type_name -> topodata.TabletAlias
	73, // 52: vtctldata.ShardReplicationPositionsResponse.replication_statuses:type_name -> vtctldata.ShardReplicationPositionsResponse.ReplicationStatusesEntry
	74, // 53: vtctldata.ShardReplicationPositionsResponse.tablet_map:type_name -> vtctldata.ShardReplicationPositionsResponse.TabletMapEntry
	78, // 54: vtctldata.TabletExternallyReparentedRequest.tablet:type_name -> topodata.TabletAlias
	78, // 55: vtctldata.TabletExternallyReparentedResponse.new_primary:type_name -> topodata.TabletAlias
	78, // 56: vtctldata.TabletExternallyReparentedResponse.old_primary:type_name -> topodata.TabletAlias
	67, // 57: vtctldata.Workflow.ShardStreamsEntry.value:type_name -> vtctldata.Workflow.ShardStream
	68, // 58: vtctldata.Workflow.ShardStream.streams:type_name -> vtctldata.Workflow.Stream
	91, // 59: vtctldata.Workflow.ShardStream.tablet_controls:type_name -> topodata.Shard.TabletControl
	78, // 60: vtctldata.Workflow.Stream.tablet:type_name -> topodata.TabletAlias
	92, // 61: vtctldata.Workflow.Stream.binlog_source:type_name -> binlogdata.BinlogSource
	84, // 62: vtctldata.Workflow.Stream.transaction_timestamp:type_name -> vttime.Time
	84, // 63: vtctldata.Workflow.Stream.time_updated:type_name -> vttime.Time
	69, // 64: vtctldata.Workflow.Stream.copy_states:type_name -> vtctldata.Workflow.Stream.CopyState
	5,  // 65: vtctldata.FindAllShardsInKeyspaceResponse.ShardsEntry.value:type_name -> vtctldata.Shard
	93, // 66: vtctldata.GetCellsAliasesResponse.AliasesEntry.value:type_name -> topodata.CellsAlias
	94, // 67: vtctldata.GetSrvKeyspacesResponse.SrvKeyspacesEntry.value:type_name -> topodata.SrvKeyspace
	95, // 68: vtctldata.ShardReplicationPositionsResponse.ReplicationStatusesEntry.value:type_name -> replicationdata.Status
	80, // 69: vtctldata.ShardReplicationPositionsResponse.TabletMapEntry.value:type_name -> topodata.Tablet
