...
var file_vtctldata_proto_rawDesc = []byte{
	...
	0x20, 0x01, 0x28, 0x08, 0x52, 0x07, 0x63, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x64, 0x22, 0x9a, 0x01,
	0x0a, 0x17, 0x41, 0x70, 0x70, 0x6c, 0x79, 0x4d, 0x69, 0x72, 0x72, 0x6f, 0x72, 0x52, 0x75, 0x6c,
	0x65, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x37, 0x0a, 0x0c, 0x6d, 0x69, 0x72,
	...
	0x62, 0x75, 0x69, 0x6c, 0x64, 0x43, 0x65, 0x6c, 0x6c, 0x73, 0x22, 0x1a, 0x0a, 0x18, 0x41, 0x70,
	0x70, 0x6c, 0x79, 0x4d, 0x69, 0x72, 0x72, 0x6f, 0x72, 0x52, 0x75, 0x6c, 0x65, 0x73, 0x52, 0x65,
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x17, 0x0a, 0x15, 0x47, 0x65, 0x74, 0x4d, 0x69, 0x72,
...
var file_vtctldata_proto_goTypes = []any{
	...
	(*ApplyMirrorRulesRequest)(nil),              // 249: vtctldata.ApplyMirrorRulesRequest
	(*ApplyMirrorRulesResponse)(nil),             // 250: vtctldata.ApplyMirrorRulesResponse
	...
	(*CheckThrottlerResponse_Metric)(nil),        // 266: vtctldata.CheckThrottlerResponse.Metric
	nil,                                          // 267: vtctldata.CheckThrottlerResponse.MetricsEntry
	...
	(*GetThrottlerStatusResponse_MetricResult)(nil), // 278: vtctldata.GetThrottlerStatusResponse.MetricResult
	nil, // 279: vtctldata.GetThrottlerStatusResponse.AggregatedMetricsEntry
	nil, // 280: vtctldata.GetThrottlerStatusResponse.MetricThresholdsEntry
	(*GetThrottlerStatusResponse_MetricHealth)(nil), // 281: vtctldata.GetThrottlerStatusResponse.MetricHealth
	nil, // 282: vtctldata.GetThrottlerStatusResponse.MetricsHealthEntry
	nil, // 283: vtctldata.GetThrottlerStatusResponse.ThrottledAppsEntry
	nil, // 284: vtctldata.GetThrottlerStatusResponse.AppCheckedMetricsEntry
	(*GetThrottlerStatusResponse_RecentApp)(nil), // 285: vtctldata.GetThrottlerStatusResponse.RecentApp
	nil, // 286: vtctldata.GetThrottlerStatusResponse.RecentAppsEntry
	nil, // 287: vtctldata.LaunchSchemaMigrationResponse.RowsAffectedByShardEntry
	(*MoveTablesCreateResponse_TabletInfo)(nil), // 288: vtctldata.MoveTablesCreateResponse.TabletInfo
	nil, // 289: vtctldata.RetrySchemaMigrationResponse.RowsAffectedByShardEntry
	nil, // 290: vtctldata.ShardReplicationPositionsResponse.ReplicationStatusesEntry
	nil, // 291: vtctldata.ShardReplicationPositionsResponse.TabletMapEntry
	nil, // 292: vtctldata.ValidateResponse.ResultsByKeyspaceEntry
	nil, // 293: vtctldata.ValidateKeyspaceResponse.ResultsByShardEntry
	nil, // 294: vtctldata.ValidateSchemaKeyspaceResponse.ResultsByShardEntry
	nil, // 295: vtctldata.ValidateVersionKeyspaceResponse.ResultsByShardEntry
	nil, // 296: vtctldata.ValidateVSchemaResponse.ResultsByShardEntry
	nil, // 297: vtctldata.VDiffShowResponse.TabletResponsesEntry
	(*WorkflowDeleteResponse_TabletInfo)(nil),       // 298: vtctldata.WorkflowDeleteResponse.TabletInfo
	(*WorkflowStatusResponse_TableCopyState)(nil),   // 299: vtctldata.WorkflowStatusResponse.TableCopyState
	(*WorkflowStatusResponse_ShardStreamState)(nil), // 300: vtctldata.WorkflowStatusResponse.ShardStreamState
	(*WorkflowStatusResponse_ShardStreams)(nil),     // 301: vtctldata.WorkflowStatusResponse.ShardStreams
	nil, // 302: vtctldata.WorkflowStatusResponse.TableCopyStateEntry
	nil, // 303: vtctldata.WorkflowStatusResponse.ShardStreamsEntry
	(*WorkflowUpdateResponse_TabletInfo)(nil),                   // 304: vtctldata.WorkflowUpdateResponse.TabletInfo
	(*logutil.Event)(nil),                                       // 305: logutil.Event
	(tabletmanagerdata.TabletSelectionPreference)(0),            // 306: tabletmanagerdata.TabletSelectionPreference
	(*topodata.Keyspace)(nil),                                   // 307: topodata.Keyspace
	(*vttime.Time)(nil),                                         // 308: vttime.Time
	(*topodata.TabletAlias)(nil),                                // 309: topodata.TabletAlias
	(*vttime.Duration)(nil),                                     // 310: vttime.Duration
	(*topodata.Shard)(nil),                                      // 311: topodata.Shard
	(*topodata.CellInfo)(nil),                                   // 312: topodata.CellInfo
	(*vschema.KeyspaceRoutingRules)(nil),                        // 313: vschema.KeyspaceRoutingRules
	(*vschema.RoutingRules)(nil),                                // 314: vschema.RoutingRules
	(*vschema.ShardRoutingRules)(nil),                           // 315: vschema.ShardRoutingRules
	(*vtrpc.CallerID)(nil),                                      // 316: vtrpc.CallerID
	(*vschema.Keyspace)(nil),                                    // 317: vschema.Keyspace
	(topodata.TabletType)(0),                                    // 318: topodata.TabletType
	(*topodata.Tablet)(nil),                                     // 319: topodata.Tablet
	(topodata.KeyspaceType)(0),                                  // 320: topodata.KeyspaceType
	(*query.QueryResult)(nil),                                   // 321: query.QueryResult
	(*tabletmanagerdata.ExecuteHookRequest)(nil),                // 322: tabletmanagerdata.ExecuteHookRequest
	(*tabletmanagerdata.ExecuteHookResponse)(nil),               // 323: tabletmanagerdata.ExecuteHookResponse
	(*mysqlctl.BackupInfo)(nil),                                 // 324: mysqlctl.BackupInfo
	(*replicationdata.FullStatus)(nil),                          // 325: replicationdata.FullStatus
	(*tabletmanagerdata.Permissions)(nil),                       // 326: tabletmanagerdata.Permissions
	(*tabletmanagerdata.SchemaDefinition)(nil),                  // 327: tabletmanagerdata.SchemaDefinition
	(*topodata.ThrottledAppRule)(nil),                           // 328: topodata.ThrottledAppRule
	(*vschema.SrvVSchema)(nil),                                  // 329: vschema.SrvVSchema
	(*topodata.ShardReplicationError)(nil),                      // 330: topodata.ShardReplicationError
	(*topodata.KeyRange)(nil),                                   // 331: topodata.KeyRange
	(*topodata.CellsAlias)(nil),                                 // 332: topodata.CellsAlias
	(*tabletmanagerdata.UpdateVReplicationWorkflowRequest)(nil), // 333: tabletmanagerdata.UpdateVReplicationWorkflowRequest
	(*vschema.MirrorRules)(nil),                                 // 334: vschema.MirrorRules
	(*topodata.Shard_TabletControl)(nil),                        // 335: topodata.Shard.TabletControl
	(*binlogdata.BinlogSource)(nil),                             // 336: binlogdata.BinlogSource
	(*topodata.ShardReplication)(nil),                           // 337: topodata.ShardReplication
	(*topodata.SrvKeyspace)(nil),                                // 338: topodata.SrvKeyspace
	(*replicationdata.Status)(nil),                              // 339: replicationdata.Status
	(*tabletmanagerdata.VDiffResponse)(nil),                     // 340: tabletmanagerdata.VDiffResponse
}
var file_vtctldata_proto_depIdxs = []int32{
	305, // 0: vtctldata.ExecuteVtctlCommandResponse.event:type_name -> logutil.Event
	...
	306, // 3: vtctldata.MaterializeSettings.tablet_selection_preference:type_name -> tabletmanagerdata.TabletSelectionPreference
	11,  // 4: vtctldata.MaterializeSettings.workflow_options:type_name -> vtctldata.WorkflowOptions
	307, // 5: vtctldata.Keyspace.keyspace:type_name -> topodata.Keyspace
	2,   // 6: vtctldata.SchemaMigration.strategy:type_name -> vtctldata.SchemaMigration.Strategy
	308, // 7: vtctldata.SchemaMigration.added_at:type_name -> vttime.Time
	...
	308, // 13: vtctldata.SchemaMigration.cleaned_up_at:type_name -> vttime.Time
	3,   // 14: vtctldata.SchemaMigration.status:type_name -> vtctldata.SchemaMigration.Status
	309, // 15: vtctldata.SchemaMigration.tablet:type_name -> topodata.TabletAlias
	310, // 16: vtctldata.SchemaMigration.artifact_retention:type_name -> vttime.Duration
	308, // 17: vtctldata.SchemaMigration.last_throttled_at:type_name -> vttime.Time
	308, // 18: vtctldata.SchemaMigration.cancelled_at:type_name -> vttime.Time
	308, // 19: vtctldata.SchemaMigration.reviewed_at:type_name -> vttime.Time
	308, // 20: vtctldata.SchemaMigration.ready_to_complete_at:type_name -> vttime.Time
	311, // 21: vtctldata.Shard.shard:type_name -> topodata.Shard
	...
	312, // 26: vtctldata.AddCellInfoRequest.cell_info:type_name -> topodata.CellInfo
	313, // 27: vtctldata.ApplyKeyspaceRoutingRulesRequest.keyspace_routing_rules:type_name -> vschema.KeyspaceRoutingRules
	313, // 28: vtctldata.ApplyKeyspaceRoutingRulesResponse.keyspace_routing_rules:type_name -> vschema.KeyspaceRoutingRules
	314, // 29: vtctldata.ApplyRoutingRulesRequest.routing_rules:type_name -> vschema.RoutingRules
	315, // 30: vtctldata.ApplyShardRoutingRulesRequest.shard_routing_rules:type_name -> vschema.ShardRoutingRules
	310, // 31: vtctldata.ApplySchemaRequest.wait_replicas_timeout:type_name -> vttime.Duration
	316, // 32: vtctldata.ApplySchemaRequest.caller_id:type_name -> vtrpc.CallerID
	...
	317, // 34: vtctldata.ApplyVSchemaRequest.v_schema:type_name -> vschema.Keyspace
	317, // 35: vtctldata.ApplyVSchemaResponse.v_schema:type_name -> vschema.Keyspace
	...
	309, // 37: vtctldata.BackupRequest.tablet_alias:type_name -> topodata.TabletAlias
	309, // 38: vtctldata.BackupResponse.tablet_alias:type_name -> topodata.TabletAlias
	305, // 39: vtctldata.BackupResponse.event:type_name -> logutil.Event
	...
	309, // 41: vtctldata.ChangeTabletTypeRequest.tablet_alias:type_name -> topodata.TabletAlias
	318, // 42: vtctldata.ChangeTabletTypeRequest.db_type:type_name -> topodata.TabletType
	319, // 43: vtctldata.ChangeTabletTypeResponse.before_tablet:type_name -> topodata.Tablet
	319, // 44: vtctldata.ChangeTabletTypeResponse.after_tablet:type_name -> topodata.Tablet
	309, // 45: vtctldata.CheckThrottlerRequest.tablet_alias:type_name -> topodata.TabletAlias
	267, // 46: vtctldata.CheckThrottlerResponse.metrics:type_name -> vtctldata.CheckThrottlerResponse.MetricsEntry
	268, // 47: vtctldata.CleanupSchemaMigrationResponse.rows_affected_by_shard:type_name -> vtctldata.CleanupSchemaMigrationResponse.RowsAffectedByShardEntry
	269, // 48: vtctldata.CompleteSchemaMigrationResponse.rows_affected_by_shard:type_name -> vtctldata.CompleteSchemaMigrationResponse.RowsAffectedByShardEntry
	320, // 49: vtctldata.CreateKeyspaceRequest.type:type_name -> topodata.KeyspaceType
	308, // 50: vtctldata.CreateKeyspaceRequest.snapshot_time:type_name -> vttime.Time
	...
	309, // 55: vtctldata.DeleteTabletsRequest.tablet_aliases:type_name -> topodata.TabletAlias
	309, // 56: vtctldata.EmergencyReparentShardRequest.new_primary:type_name -> topodata.TabletAlias
	309, // 57: vtctldata.EmergencyReparentShardRequest.ignore_replicas:type_name -> topodata.TabletAlias
	310, // 58: vtctldata.EmergencyReparentShardRequest.wait_replicas_timeout:type_name -> vttime.Duration
	309, // 59: vtctldata.EmergencyReparentShardResponse.promoted_primary:type_name -> topodata.TabletAlias
	305, // 60: vtctldata.EmergencyReparentShardResponse.events:type_name -> logutil.Event
	309, // 61: vtctldata.ExecuteFetchAsAppRequest.tablet_alias:type_name -> topodata.TabletAlias
	321, // 62: vtctldata.ExecuteFetchAsAppResponse.result:type_name -> query.QueryResult
	309, // 63: vtctldata.ExecuteFetchAsDBARequest.tablet_alias:type_name -> topodata.TabletAlias
	321, // 64: vtctldata.ExecuteFetchAsDBAResponse.result:type_name -> query.QueryResult
	309, // 65: vtctldata.ExecuteHookRequest.tablet_alias:type_name -> topodata.TabletAlias
	322, // 66: vtctldata.ExecuteHookRequest.tablet_hook_request:type_name -> tabletmanagerdata.ExecuteHookRequest
	323, // 67: vtctldata.ExecuteHookResponse.hook_result:type_name -> tabletmanagerdata.ExecuteHookResponse
	309, // 68: vtctldata.ExecuteMultiFetchAsDBARequest.tablet_alias:type_name -> topodata.TabletAlias
	321, // 69: vtctldata.ExecuteMultiFetchAsDBAResponse.results:type_name -> query.QueryResult
	270, // 70: vtctldata.FindAllShardsInKeyspaceResponse.shards:type_name -> vtctldata.FindAllShardsInKeyspaceResponse.ShardsEntry
	271, // 71: vtctldata.ForceCutOverSchemaMigrationResponse.rows_affected_by_shard:type_name -> vtctldata.ForceCutOverSchemaMigrationResponse.RowsAffectedByShardEntry
	324, // 72: vtctldata.GetBackupsResponse.backups:type_name -> mysqlctl.BackupInfo
	312, // 73: vtctldata.GetCellInfoResponse.cell_info:type_name -> topodata.CellInfo
	272, // 74: vtctldata.GetCellsAliasesResponse.aliases:type_name -> vtctldata.GetCellsAliasesResponse.AliasesEntry
	309, // 75: vtctldata.GetFullStatusRequest.tablet_alias:type_name -> topodata.TabletAlias
	325, // 76: vtctldata.GetFullStatusResponse.status:type_name -> replicationdata.FullStatus
	...
	309, // 79: vtctldata.GetPermissionsRequest.tablet_alias:type_name -> topodata.TabletAlias
	326, // 80: vtctldata.GetPermissionsResponse.permissions:type_name -> tabletmanagerdata.Permissions
	313, // 81: vtctldata.GetKeyspaceRoutingRulesResponse.keyspace_routing_rules:type_name -> vschema.KeyspaceRoutingRules
	314, // 82: vtctldata.GetRoutingRulesResponse.routing_rules:type_name -> vschema.RoutingRules
	309, // 83: vtctldata.GetSchemaRequest.tablet_alias:type_name -> topodata.TabletAlias
	327, // 84: vtctldata.GetSchemaResponse.schema:type_name -> tabletmanagerdata.SchemaDefinition
	3,   // 85: vtctldata.GetSchemaMigrationsRequest.status:type_name -> vtctldata.SchemaMigration.Status
	310, // 86: vtctldata.GetSchemaMigrationsRequest.recent:type_name -> vttime.Duration
	...
	273, // 89: vtctldata.GetShardReplicationResponse.shard_replication_by_cell:type_name -> vtctldata.GetShardReplicationResponse.ShardReplicationByCellEntry
	10,  // 90: vtctldata.GetShardResponse.shard:type_name -> vtctldata.Shard
	315, // 91: vtctldata.GetShardRoutingRulesResponse.shard_routing_rules:type_name -> vschema.ShardRoutingRules
	274, // 92: vtctldata.GetSrvKeyspaceNamesResponse.names:type_name -> vtctldata.GetSrvKeyspaceNamesResponse.NamesEntry
	276, // 93: vtctldata.GetSrvKeyspacesResponse.srv_keyspaces:type_name -> vtctldata.GetSrvKeyspacesResponse.SrvKeyspacesEntry
	328, // 94: vtctldata.UpdateThrottlerConfigRequest.throttled_app:type_name -> topodata.ThrottledAppRule
	329, // 95: vtctldata.GetSrvVSchemaResponse.srv_v_schema:type_name -> vschema.SrvVSchema
	277, // 96: vtctldata.GetSrvVSchemasResponse.srv_v_schemas:type_name -> vtctldata.GetSrvVSchemasResponse.SrvVSchemasEntry
	309, // 97: vtctldata.GetTabletRequest.tablet_alias:type_name -> topodata.TabletAlias
	319, // 98: vtctldata.GetTabletResponse.tablet:type_name -> topodata.Tablet
	309, // 99: vtctldata.GetTabletsRequest.tablet_aliases:type_name -> topodata.TabletAlias
	318, // 100: vtctldata.GetTabletsRequest.tablet_type:type_name -> topodata.TabletType
	319, // 101: vtctldata.GetTabletsResponse.tablets:type_name -> topodata.Tablet
	309, // 102: vtctldata.GetThrottlerStatusRequest.tablet_alias:type_name -> topodata.TabletAlias
	279, // 103: vtctldata.GetThrottlerStatusResponse.aggregated_metrics:type_name -> vtctldata.GetThrottlerStatusResponse.AggregatedMetricsEntry
	280, // 104: vtctldata.GetThrottlerStatusResponse.metric_thresholds:type_name -> vtctldata.GetThrottlerStatusResponse.MetricThresholdsEntry
	282, // 105: vtctldata.GetThrottlerStatusResponse.metrics_health:type_name -> vtctldata.GetThrottlerStatusResponse.MetricsHealthEntry
	283, // 106: vtctldata.GetThrottlerStatusResponse.throttled_apps:type_name -> vtctldata.GetThrottlerStatusResponse.ThrottledAppsEntry
	284, // 107: vtctldata.GetThrottlerStatusResponse.app_checked_metrics:type_name -> vtctldata.GetThrottlerStatusResponse.AppCheckedMetricsEntry
	286, // 108: vtctldata.GetThrottlerStatusResponse.recent_apps:type_name -> vtctldata.GetThrottlerStatusResponse.RecentAppsEntry
	118, // 109: vtctldata.GetTopologyPathResponse.cell:type_name -> vtctldata.TopologyCell
	309, // 110: vtctldata.GetVersionRequest.tablet_alias:type_name -> topodata.TabletAlias
	317, // 111: vtctldata.GetVSchemaResponse.v_schema:type_name -> vschema.Keyspace
	12,  // 112: vtctldata.GetWorkflowsResponse.workflows:type_name -> vtctldata.Workflow
	309, // 113: vtctldata.InitShardPrimaryRequest.primary_elect_tablet_alias:type_name -> topodata.TabletAlias
	310, // 114: vtctldata.InitShardPrimaryRequest.wait_replicas_timeout:type_name -> vttime.Duration
	305, // 115: vtctldata.InitShardPrimaryResponse.events:type_name -> logutil.Event
	287, // 116: vtctldata.LaunchSchemaMigrationResponse.rows_affected_by_shard:type_name -> vtctldata.LaunchSchemaMigrationResponse.RowsAffectedByShardEntry
	317, // 117: vtctldata.LookupVindexCreateRequest.vindex:type_name -> vschema.Keyspace
	318, // 118: vtctldata.LookupVindexCreateRequest.tablet_types:type_name -> topodata.TabletType
	306, // 119: vtctldata.LookupVindexCreateRequest.tablet_selection_preference:type_name -> tabletmanagerdata.TabletSelectionPreference
	7,   // 120: vtctldata.MaterializeCreateRequest.settings:type_name -> vtctldata.MaterializeSettings
	318, // 121: vtctldata.MigrateCreateRequest.tablet_types:type_name -> topodata.TabletType
	306, // 122: vtctldata.MigrateCreateRequest.tablet_selection_preference:type_name -> tabletmanagerdata.TabletSelectionPreference
	318, // 123: vtctldata.MoveTablesCreateRequest.tablet_types:type_name -> topodata.TabletType
	306, // 124: vtctldata.MoveTablesCreateRequest.tablet_selection_preference:type_name -> tabletmanagerdata.TabletSelectionPreference
	11,  // 125: vtctldata.MoveTablesCreateRequest.workflow_options:type_name -> vtctldata.WorkflowOptions
	288, // 126: vtctldata.MoveTablesCreateResponse.details:type_name -> vtctldata.MoveTablesCreateResponse.TabletInfo
	309, // 127: vtctldata.PingTabletRequest.tablet_alias:type_name -> topodata.TabletAlias
	309, // 128: vtctldata.PlannedReparentShardRequest.new_primary:type_name -> topodata.TabletAlias
	309, // 129: vtctldata.PlannedReparentShardRequest.avoid_primary:type_name -> topodata.TabletAlias
	310, // 130: vtctldata.PlannedReparentShardRequest.wait_replicas_timeout:type_name -> vttime.Duration
	310, // 131: vtctldata.PlannedReparentShardRequest.tolerable_replication_lag:type_name -> vttime.Duration
	309, // 132: vtctldata.PlannedReparentShardResponse.promoted_primary:type_name -> topodata.TabletAlias
	305, // 133: vtctldata.PlannedReparentShardResponse.events:type_name -> logutil.Event
	309, // 134: vtctldata.RefreshStateRequest.tablet_alias:type_name -> topodata.TabletAlias
	309, // 135: vtctldata.ReloadSchemaRequest.tablet_alias:type_name -> topodata.TabletAlias
	305, // 136: vtctldata.ReloadSchemaKeyspaceResponse.events:type_name -> logutil.Event
	305, // 137: vtctldata.ReloadSchemaShardResponse.events:type_name -> logutil.Event
	309, // 138: vtctldata.ReparentTabletRequest.tablet:type_name -> topodata.TabletAlias
	309, // 139: vtctldata.ReparentTabletResponse.primary:type_name -> topodata.TabletAlias
	318, // 140: vtctldata.ReshardCreateRequest.tablet_types:type_name -> topodata.TabletType
	306, // 141: vtctldata.ReshardCreateRequest.tablet_selection_preference:type_name -> tabletmanagerdata.TabletSelectionPreference
	309, // 142: vtctldata.RestoreFromBackupRequest.tablet_alias:type_name -> topodata.TabletAlias
	308, // 143: vtctldata.RestoreFromBackupRequest.backup_time:type_name -> vttime.Time
	308, // 144: vtctldata.RestoreFromBackupRequest.restore_to_timestamp:type_name -> vttime.Time
	309, // 145: vtctldata.RestoreFromBackupResponse.tablet_alias:type_name -> topodata.TabletAlias
	305, // 146: vtctldata.RestoreFromBackupResponse.event:type_name -> logutil.Event
	289, // 147: vtctldata.RetrySchemaMigrationResponse.rows_affected_by_shard:type_name -> vtctldata.RetrySchemaMigrationResponse.RowsAffectedByShardEntry
	309, // 148: vtctldata.RunHealthCheckRequest.tablet_alias:type_name -> topodata.TabletAlias
	307, // 149: vtctldata.SetKeyspaceDurabilityPolicyResponse.keyspace:type_name -> topodata.Keyspace
	307, // 150: vtctldata.SetKeyspaceShardingInfoResponse.keyspace:type_name -> topodata.Keyspace
	311, // 151: vtctldata.SetShardIsPrimaryServingResponse.shard:type_name -> topodata.Shard
	318, // 152: vtctldata.SetShardTabletControlRequest.tablet_type:type_name -> topodata.TabletType
	311, // 153: vtctldata.SetShardTabletControlResponse.shard:type_name -> topodata.Shard
	309, // 154: vtctldata.SetWritableRequest.tablet_alias:type_name -> topodata.TabletAlias
	309, // 155: vtctldata.ShardReplicationAddRequest.tablet_alias:type_name -> topodata.TabletAlias
	330, // 156: vtctldata.ShardReplicationFixResponse.error:type_name -> topodata.ShardReplicationError
	290, // 157: vtctldata.ShardReplicationPositionsResponse.replication_statuses:type_name -> vtctldata.ShardReplicationPositionsResponse.ReplicationStatusesEntry
	291, // 158: vtctldata.ShardReplicationPositionsResponse.tablet_map:type_name -> vtctldata.ShardReplicationPositionsResponse.TabletMapEntry
	309, // 159: vtctldata.ShardReplicationRemoveRequest.tablet_alias:type_name -> topodata.TabletAlias
	309, // 160: vtctldata.SleepTabletRequest.tablet_alias:type_name -> topodata.TabletAlias
	310, // 161: vtctldata.SleepTabletRequest.duration:type_name -> vttime.Duration
	331, // 162: vtctldata.SourceShardAddRequest.key_range:type_name -> topodata.KeyRange
	311, // 163: vtctldata.SourceShardAddResponse.shard:type_name -> topodata.Shard
	311, // 164: vtctldata.SourceShardDeleteResponse.shard:type_name -> topodata.Shard
	309, // 165: vtctldata.StartReplicationRequest.tablet_alias:type_name -> topodata.TabletAlias
	309, // 166: vtctldata.StopReplicationRequest.tablet_alias:type_name -> topodata.TabletAlias
	309, // 167: vtctldata.TabletExternallyReparentedRequest.tablet:type_name -> topodata.TabletAlias
	309, // 168: vtctldata.TabletExternallyReparentedResponse.new_primary:type_name -> topodata.TabletAlias
	309, // 169: vtctldata.TabletExternallyReparentedResponse.old_primary:type_name -> topodata.TabletAlias
	312, // 170: vtctldata.UpdateCellInfoRequest.cell_info:type_name -> topodata.CellInfo
	312, // 171: vtctldata.UpdateCellInfoResponse.cell_info:type_name -> topodata.CellInfo
	332, // 172: vtctldata.UpdateCellsAliasRequest.cells_alias:type_name -> topodata.CellsAlias
	332, // 173: vtctldata.UpdateCellsAliasResponse.cells_alias:type_name -> topodata.CellsAlias
	292, // 174: vtctldata.ValidateResponse.results_by_keyspace:type_name -> vtctldata.ValidateResponse.ResultsByKeyspaceEntry
	293, // 175: vtctldata.ValidateKeyspaceResponse.results_by_shard:type_name -> vtctldata.ValidateKeyspaceResponse.ResultsByShardEntry
	294, // 176: vtctldata.ValidateSchemaKeyspaceResponse.results_by_shard:type_name -> vtctldata.ValidateSchemaKeyspaceResponse.ResultsByShardEntry
	295, // 177: vtctldata.ValidateVersionKeyspaceResponse.results_by_shard:type_name -> vtctldata.ValidateVersionKeyspaceResponse.ResultsByShardEntry
	296, // 178: vtctldata.ValidateVSchemaResponse.results_by_shard:type_name -> vtctldata.ValidateVSchemaResponse.ResultsByShardEntry
	318, // 179: vtctldata.VDiffCreateRequest.tablet_types:type_name -> topodata.TabletType
	306, // 180: vtctldata.VDiffCreateRequest.tablet_selection_preference:type_name -> tabletmanagerdata.TabletSelectionPreference
	310, // 181: vtctldata.VDiffCreateRequest.filtered_replication_wait_time:type_name -> vttime.Duration
	310, // 182: vtctldata.VDiffCreateRequest.wait_update_interval:type_name -> vttime.Duration
	310, // 183: vtctldata.VDiffCreateRequest.max_diff_duration:type_name -> vttime.Duration
	297, // 184: vtctldata.VDiffShowResponse.tablet_responses:type_name -> vtctldata.VDiffShowResponse.TabletResponsesEntry
	298, // 185: vtctldata.WorkflowDeleteResponse.details:type_name -> vtctldata.WorkflowDeleteResponse.TabletInfo
	302, // 186: vtctldata.WorkflowStatusResponse.table_copy_state:type_name -> vtctldata.WorkflowStatusResponse.TableCopyStateEntry
	303, // 187: vtctldata.WorkflowStatusResponse.shard_streams:type_name -> vtctldata.WorkflowStatusResponse.ShardStreamsEntry
	318, // 188: vtctldata.WorkflowSwitchTrafficRequest.tablet_types:type_name -> topodata.TabletType
	310, // 189: vtctldata.WorkflowSwitchTrafficRequest.max_replication_lag_allowed:type_name -> vttime.Duration
	310, // 190: vtctldata.WorkflowSwitchTrafficRequest.timeout:type_name -> vttime.Duration
	333, // 191: vtctldata.WorkflowUpdateRequest.tablet_request:type_name -> tabletmanagerdata.UpdateVReplicationWorkflowRequest
	304, // 192: vtctldata.WorkflowUpdateResponse.details:type_name -> vtctldata.WorkflowUpdateResponse.TabletInfo
	334, // 193: vtctldata.ApplyMirrorRulesRequest.mirror_rules:type_name -> vschema.MirrorRules
	334, // 194: vtctldata.GetMirrorRulesResponse.mirror_rules:type_name -> vschema.MirrorRules
	318, // 195: vtctldata.WorkflowMirrorTrafficRequest.tablet_types:type_name -> topodata.TabletType
	257, // 196: vtctldata.Workflow.ShardStreamsEntry.value:type_name -> vtctldata.Workflow.ShardStream
	258, // 197: vtctldata.Workflow.ShardStream.streams:type_name -> vtctldata.Workflow.Stream
	335, // 198: vtctldata.Workflow.ShardStream.tablet_controls:type_name -> topodata.Shard.TabletControl
	309, // 199: vtctldata.Workflow.Stream.tablet:type_name -> topodata.TabletAlias
	336, // 200: vtctldata.Workflow.Stream.binlog_source:type_name -> binlogdata.BinlogSource
	308, // 201: vtctldata.Workflow.Stream.transaction_timestamp:type_name -> vttime.Time
	308, // 202: vtctldata.Workflow.Stream.time_updated:type_name -> vttime.Time
	259, // 203: vtctldata.Workflow.Stream.copy_states:type_name -> vtctldata.Workflow.Stream.CopyState
	260, // 204: vtctldata.Workflow.Stream.logs:type_name -> vtctldata.Workflow.Stream.Log
	261, // 205: vtctldata.Workflow.Stream.throttler_status:type_name -> vtctldata.Workflow.Stream.ThrottlerStatus
	318, // 206: vtctldata.Workflow.Stream.tablet_types:type_name -> topodata.TabletType
	306, // 207: vtctldata.Workflow.Stream.tablet_selection_preference:type_name -> tabletmanagerdata.TabletSelectionPreference
	308, // 208: vtctldata.Workflow.Stream.Log.created_at:type_name -> vttime.Time
	308, // 209: vtctldata.Workflow.Stream.Log.updated_at:type_name -> vttime.Time
	308, // 210: vtctldata.Workflow.Stream.ThrottlerStatus.time_throttled:type_name -> vttime.Time
	264, // 211: vtctldata.ApplyVSchemaResponse.UnknownVindexParamsEntry.value:type_name -> vtctldata.ApplyVSchemaResponse.ParamList
	266, // 212: vtctldata.CheckThrottlerResponse.MetricsEntry.value:type_name -> vtctldata.CheckThrottlerResponse.Metric
	10,  // 213: vtctldata.FindAllShardsInKeyspaceResponse.ShardsEntry.value:type_name -> vtctldata.Shard
	332, // 214: vtctldata.GetCellsAliasesResponse.AliasesEntry.value:type_name -> topodata.CellsAlias
	337, // 215: vtctldata.GetShardReplicationResponse.ShardReplicationByCellEntry.value:type_name -> topodata.ShardReplication
	275, // 216: vtctldata.GetSrvKeyspaceNamesResponse.NamesEntry.value:type_name -> vtctldata.GetSrvKeyspaceNamesResponse.NameList
	338, // 217: vtctldata.GetSrvKeyspacesResponse.SrvKeyspacesEntry.value:type_name -> topodata.SrvKeyspace
	329, // 218: vtctldata.GetSrvVSchemasResponse.SrvVSchemasEntry.value:type_name -> vschema.SrvVSchema
	278, // 219: vtctldata.GetThrottlerStatusResponse.AggregatedMetricsEntry.value:type_name -> vtctldata.GetThrottlerStatusResponse.MetricResult
	308, // 220: vtctldata.GetThrottlerStatusResponse.MetricHealth.last_healthy_at:type_name -> vttime.Time
	281, // 221: vtctldata.GetThrottlerStatusResponse.MetricsHealthEntry.value:type_name -> vtctldata.GetThrottlerStatusResponse.MetricHealth
	328, // 222: vtctldata.GetThrottlerStatusResponse.ThrottledAppsEntry.value:type_name -> topodata.ThrottledAppRule
	308, // 223: vtctldata.GetThrottlerStatusResponse.RecentApp.checked_at:type_name -> vttime.Time
	285, // 224: vtctldata.GetThrottlerStatusResponse.RecentAppsEntry.value:type_name -> vtctldata.GetThrottlerStatusResponse.RecentApp
	309, // 225: vtctldata.MoveTablesCreateResponse.TabletInfo.tablet:type_name -> topodata.TabletAlias
	339, // 226: vtctldata.ShardReplicationPositionsResponse.ReplicationStatusesEntry.value:type_name -> replicationdata.Status
	319, // 227: vtctldata.ShardReplicationPositionsResponse.TabletMapEntry.value:type_name -> topodata.Tablet
	220, // 228: vtctldata.ValidateResponse.ResultsByKeyspaceEntry.value:type_name -> vtctldata.ValidateKeyspaceResponse
	224, // 229: vtctldata.ValidateKeyspaceResponse.ResultsByShardEntry.value:type_name -> vtctldata.ValidateShardResponse
	224, // 230: vtctldata.ValidateSchemaKeyspaceResponse.ResultsByShardEntry.value:type_name -> vtctldata.ValidateShardResponse
	224, // 231: vtctldata.ValidateVersionKeyspaceResponse.ResultsByShardEntry.value:type_name -> vtctldata.ValidateShardResponse
	224, // 232: vtctldata.ValidateVSchemaResponse.ResultsByShardEntry.value:type_name -> vtctldata.ValidateShardResponse
	340, // 233: vtctldata.VDiffShowResponse.TabletResponsesEntry.value:type_name -> tabletmanagerdata.VDiffResponse
	309, // 234: vtctldata.WorkflowDeleteResponse.TabletInfo.tablet:type_name -> topodata.TabletAlias
	309, // 235: vtctldata.WorkflowStatusResponse.ShardStreamState.tablet:type_name -> topodata.TabletAlias
	300, // 236: vtctldata.WorkflowStatusResponse.ShardStreams.streams:type_name -> vtctldata.WorkflowStatusResponse.ShardStreamState
	299, // 237: vtctldata.WorkflowStatusResponse.TableCopyStateEntry.value:type_name -> vtctldata.WorkflowStatusResponse.TableCopyState
	301, // 238: vtctldata.WorkflowStatusResponse.ShardStreamsEntry.value:type_name -> vtctldata.WorkflowStatusResponse.ShardStreams
	309, // 239: vtctldata.WorkflowUpdateResponse.TabletInfo.tablet:type_name -> topodata.TabletAlias
