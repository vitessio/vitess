...
type LookupVindexExternalizeRequest struct {
	...
	Keyspace string            `protobuf:"bytes,1,opt,name=keyspace,proto3" json:"keyspace,omitempty"`
	Workflow string            `protobuf:"bytes,2,opt,name=workflow,proto3" json:"workflow,omitempty"`
	Vindex   *vschema.Keyspace `protobuf:"bytes,3,opt,name=vindex,proto3" json:"vindex,omitempty"`
}
...
func (x *LookupVindexExternalizeRequest) GetVindex() *vschema.Keyspace {
	if x != nil {
		return x.Vindex
	}
	return nil
...
var file_vtctldata_proto_rawDesc = []byte{
	...
	0x6f, 0x6e, 0x73, 0x65, 0x22, 0x83, 0x01, 0x0a, 0x1e, 0x4c, 0x6f, 0x6f, 0x6b, 0x75, 0x70, 0x56,
	...
	0x29, 0x0a, 0x06, 0x76, 0x69, 0x6e, 0x64, 0x65, 0x78, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32,
	0x11, 0x2e, 0x76, 0x73, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x2e, 0x4b, 0x65, 0x79, 0x73, 0x70, 0x61,
	0x63, 0x65, 0x52, 0x06, 0x76, 0x69, 0x6e, 0x64, 0x65, 0x78, 0x22, 0x3b, 0x0a, 0x1f, 0x4c, 0x6f,
	...
	0x64, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x64, 0x22, 0xbb, 0x06, 0x0a, 0x17, 0x4d, 0x6f, 0x76, 0x65,
	...
	0x63, 0x43, 0x6f, 0x70, 0x79, 0x22, 0xd5, 0x01, 0x0a, 0x18, 0x4d, 0x6f, 0x76, 0x65, 0x54, 0x61,
	...
	0x54, 0x61, 0x62, 0x6c, 0x65, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x89,
	...
	0x75, 0x72, 0x72, 0x65, 0x6e, 0x63, 0x79, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0b, 0x63,
	...
	0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0x95, 0x06, 0x0a, 0x12, 0x56, 0x44, 0x69, 0x66,
	...
	0x18, 0x12, 0x20, 0x01, 0x28, 0x08, 0x52, 0x07, 0x76, 0x65, 0x72, 0x62, 0x6f, 0x73, 0x65, 0x22,
	...
	0x74, 0x6f, 0x70, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x9a, 0x01, 0x0a, 0x15,
...
var file_vtctldata_proto_depIdxs = []int32{
	...
	268, // 102: vtctldata.LookupVindexExternalizeRequest.vindex:type_name -> vschema.Keyspace
	269, // 103: vtctldata.MoveTablesCreateRequest.tablet_types:type_name -> topodata.TabletType
	258, // 104: vtctldata.MoveTablesCreateRequest.tablet_selection_preference:type_name -> tabletmanagerdata.TabletSelectionPreference
	240, // 105: vtctldata.MoveTablesCreateResponse.details:type_name -> vtctldata.MoveTablesCreateResponse.TabletInfo
	261, // 106: vtctldata.PingTabletRequest.tablet_alias:type_name -> topodata.TabletAlias
	261, // 107: vtctldata.PlannedReparentShardRequest.new_primary:type_name -> topodata.TabletAlias
	261, // 108: vtctldata.PlannedReparentShardRequest.avoid_primary:type_name -> topodata.TabletAlias
	262, // 109: vtctldata.PlannedReparentShardRequest.wait_replicas_timeout:type_name -> vttime.Duration
	261, // 110: vtctldata.PlannedReparentShardResponse.promoted_primary:type_name -> topodata.TabletAlias
	257, // 111: vtctldata.PlannedReparentShardResponse.events:type_name -> logutil.Event
	261, // 112: vtctldata.RefreshStateRequest.tablet_alias:type_name -> topodata.TabletAlias
	261, // 113: vtctldata.ReloadSchemaRequest.tablet_alias:type_name -> topodata.TabletAlias
	257, // 114: vtctldata.ReloadSchemaKeyspaceResponse.events:type_name -> logutil.Event
	257, // 115: vtctldata.ReloadSchemaShardResponse.events:type_name -> logutil.Event
	261, // 116: vtctldata.ReparentTabletRequest.tablet:type_name -> topodata.TabletAlias
	261, // 117: vtctldata.ReparentTabletResponse.primary:type_name -> topodata.TabletAlias
	269, // 118: vtctldata.ReshardCreateRequest.tablet_types:type_name -> topodata.TabletType
	258, // 119: vtctldata.ReshardCreateRequest.tablet_selection_preference:type_name -> tabletmanagerdata.TabletSelectionPreference
	261, // 120: vtctldata.RestoreFromBackupRequest.tablet_alias:type_name -> topodata.TabletAlias
	260, // 121: vtctldata.RestoreFromBackupRequest.backup_time:type_name -> vttime.Time
	260, // 122: vtctldata.RestoreFromBackupRequest.restore_to_timestamp:type_name -> vttime.Time
	261, // 123: vtctldata.RestoreFromBackupResponse.tablet_alias:type_name -> topodata.TabletAlias
	257, // 124: vtctldata.RestoreFromBackupResponse.event:type_name -> logutil.Event
	241, // 125: vtctldata.RetrySchemaMigrationResponse.rows_affected_by_shard:type_name -> vtctldata.RetrySchemaMigrationResponse.RowsAffectedByShardEntry
	261, // 126: vtctldata.RunHealthCheckRequest.tablet_alias:type_name -> topodata.TabletAlias
	259, // 127: vtctldata.SetKeyspaceDurabilityPolicyResponse.keyspace:type_name -> topodata.Keyspace
	269, // 128: vtctldata.SetKeyspaceServedFromRequest.tablet_type:type_name -> topodata.TabletType
	259, // 129: vtctldata.SetKeyspaceServedFromResponse.keyspace:type_name -> topodata.Keyspace
	259, // 130: vtctldata.SetKeyspaceShardingInfoResponse.keyspace:type_name -> topodata.Keyspace
	263, // 131: vtctldata.SetShardIsPrimaryServingResponse.shard:type_name -> topodata.Shard
	269, // 132: vtctldata.SetShardTabletControlRequest.tablet_type:type_name -> topodata.TabletType
	263, // 133: vtctldata.SetShardTabletControlResponse.shard:type_name -> topodata.Shard
	261, // 134: vtctldata.SetWritableRequest.tablet_alias:type_name -> topodata.TabletAlias
	261, // 135: vtctldata.ShardReplicationAddRequest.tablet_alias:type_name -> topodata.TabletAlias
	282, // 136: vtctldata.ShardReplicationFixResponse.error:type_name -> topodata.ShardReplicationError
	242, // 137: vtctldata.ShardReplicationPositionsResponse.replication_statuses:type_name -> vtctldata.ShardReplicationPositionsResponse.ReplicationStatusesEntry
	243, // 138: vtctldata.ShardReplicationPositionsResponse.tablet_map:type_name -> vtctldata.ShardReplicationPositionsResponse.TabletMapEntry
	261, // 139: vtctldata.ShardReplicationRemoveRequest.tablet_alias:type_name -> topodata.TabletAlias
	261, // 140: vtctldata.SleepTabletRequest.tablet_alias:type_name -> topodata.TabletAlias
	262, // 141: vtctldata.SleepTabletRequest.duration:type_name -> vttime.Duration
	283, // 142: vtctldata.SourceShardAddRequest.key_range:type_name -> topodata.KeyRange
	263, // 143: vtctldata.SourceShardAddResponse.shard:type_name -> topodata.Shard
	263, // 144: vtctldata.SourceShardDeleteResponse.shard:type_name -> topodata.Shard
	261, // 145: vtctldata.StartReplicationRequest.tablet_alias:type_name -> topodata.TabletAlias
	261, // 146: vtctldata.StopReplicationRequest.tablet_alias:type_name -> topodata.TabletAlias
	261, // 147: vtctldata.TabletExternallyReparentedRequest.tablet:type_name -> topodata.TabletAlias
	261, // 148: vtctldata.TabletExternallyReparentedResponse.new_primary:type_name -> topodata.TabletAlias
	261, // 149: vtctldata.TabletExternallyReparentedResponse.old_primary:type_name -> topodata.TabletAlias
	264, // 150: vtctldata.UpdateCellInfoRequest.cell_info:type_name -> topodata.CellInfo
	264, // 151: vtctldata.UpdateCellInfoResponse.cell_info:type_name -> topodata.CellInfo
	284, // 152: vtctldata.UpdateCellsAliasRequest.cells_alias:type_name -> topodata.CellsAlias
	284, // 153: vtctldata.UpdateCellsAliasResponse.cells_alias:type_name -> topodata.CellsAlias
	244, // 154: vtctldata.ValidateResponse.results_by_keyspace:type_name -> vtctldata.ValidateResponse.ResultsByKeyspaceEntry
	245, // 155: vtctldata.ValidateKeyspaceResponse.results_by_shard:type_name -> vtctldata.ValidateKeyspaceResponse.ResultsByShardEntry
	246, // 156: vtctldata.ValidateSchemaKeyspaceResponse.results_by_shard:type_name -> vtctldata.ValidateSchemaKeyspaceResponse.ResultsByShardEntry
	247, // 157: vtctldata.ValidateVersionKeyspaceResponse.results_by_shard:type_name -> vtctldata.ValidateVersionKeyspaceResponse.ResultsByShardEntry
	248, // 158: vtctldata.ValidateVSchemaResponse.results_by_shard:type_name -> vtctldata.ValidateVSchemaResponse.ResultsByShardEntry
	269, // 159: vtctldata.VDiffCreateRequest.tablet_types:type_name -> topodata.TabletType
	258, // 160: vtctldata.VDiffCreateRequest.tablet_selection_preference:type_name -> tabletmanagerdata.TabletSelectionPreference
	262, // 161: vtctldata.VDiffCreateRequest.filtered_replication_wait_time:type_name -> vttime.Duration
	262, // 162: vtctldata.VDiffCreateRequest.wait_update_interval:type_name -> vttime.Duration
	249, // 163: vtctldata.VDiffShowResponse.tablet_responses:type_name -> vtctldata.VDiffShowResponse.TabletResponsesEntry
	250, // 164: vtctldata.WorkflowDeleteResponse.details:type_name -> vtctldata.WorkflowDeleteResponse.TabletInfo
	254, // 165: vtctldata.WorkflowStatusResponse.table_copy_state:type_name -> vtctldata.WorkflowStatusResponse.TableCopyStateEntry
	255, // 166: vtctldata.WorkflowStatusResponse.shard_streams:type_name -> vtctldata.WorkflowStatusResponse.ShardStreamsEntry
	269, // 167: vtctldata.WorkflowSwitchTrafficRequest.tablet_types:type_name -> topodata.TabletType
	262, // 168: vtctldata.WorkflowSwitchTrafficRequest.max_replication_lag_allowed:type_name -> vttime.Duration
	262, // 169: vtctldata.WorkflowSwitchTrafficRequest.timeout:type_name -> vttime.Duration
	285, // 170: vtctldata.WorkflowUpdateRequest.tablet_request:type_name -> tabletmanagerdata.UpdateVReplicationWorkflowRequest
	256, // 171: vtctldata.WorkflowUpdateResponse.details:type_name -> vtctldata.WorkflowUpdateResponse.TabletInfo
	225, // 172: vtctldata.Workflow.ShardStreamsEntry.value:type_name -> vtctldata.Workflow.ShardStream
	226, // 173: vtctldata.Workflow.ShardStream.streams:type_name -> vtctldata.Workflow.Stream
	286, // 174: vtctldata.Workflow.ShardStream.tablet_controls:type_name -> topodata.Shard.TabletControl
	261, // 175: vtctldata.Workflow.Stream.tablet:type_name -> topodata.TabletAlias
	287, // 176: vtctldata.Workflow.Stream.binlog_source:type_name -> binlogdata.BinlogSource
	260, // 177: vtctldata.Workflow.Stream.transaction_timestamp:type_name -> vttime.Time
	260, // 178: vtctldata.Workflow.Stream.time_updated:type_name -> vttime.Time
	227, // 179: vtctldata.Workflow.Stream.copy_states:type_name -> vtctldata.Workflow.Stream.CopyState
	228, // 180: vtctldata.Workflow.Stream.logs:type_name -> vtctldata.Workflow.Stream.Log
	260, // 181: vtctldata.Workflow.Stream.Log.created_at:type_name -> vttime.Time
	260, // 182: vtctldata.Workflow.Stream.Log.updated_at:type_name -> vttime.Time
	10,  // 183: vtctldata.FindAllShardsInKeyspaceResponse.ShardsEntry.value:type_name -> vtctldata.Shard
	284, // 184: vtctldata.GetCellsAliasesResponse.AliasesEntry.value:type_name -> topodata.CellsAlias
	236, // 185: vtctldata.GetSrvKeyspaceNamesResponse.NamesEntry.value:type_name -> vtctldata.GetSrvKeyspaceNamesResponse.NameList
	288, // 186: vtctldata.GetSrvKeyspacesResponse.SrvKeyspacesEntry.value:type_name -> topodata.SrvKeyspace
	281, // 187: vtctldata.GetSrvVSchemasResponse.SrvVSchemasEntry.value:type_name -> vschema.SrvVSchema
	261, // 188: vtctldata.MoveTablesCreateResponse.TabletInfo.tablet:type_name -> topodata.TabletAlias
	289, // 189: vtctldata.ShardReplicationPositionsResponse.ReplicationStatusesEntry.value:type_name -> replicationdata.Status
	270, // 190: vtctldata.ShardReplicationPositionsResponse.TabletMapEntry.value:type_name -> topodata.Tablet
	194, // 191: vtctldata.ValidateResponse.ResultsByKeyspaceEntry.value:type_name -> vtctldata.ValidateKeyspaceResponse
	198, // 192: vtctldata.ValidateKeyspaceResponse.ResultsByShardEntry.value:type_name -> vtctldata.ValidateShardResponse
	198, // 193: vtctldata.ValidateSchemaKeyspaceResponse.ResultsByShardEntry.value:type_name -> vtctldata.ValidateShardResponse
	198, // 194: vtctldata.ValidateVersionKeyspaceResponse.ResultsByShardEntry.value:type_name -> vtctldata.ValidateShardResponse
	198, // 195: vtctldata.ValidateVSchemaResponse.ResultsByShardEntry.value:type_name -> vtctldata.ValidateShardResponse
	290, // 196: vtctldata.VDiffShowResponse.TabletResponsesEntry.value:type_name -> tabletmanagerdata.VDiffResponse
	261, // 197: vtctldata.WorkflowDeleteResponse.TabletInfo.tablet:type_name -> topodata.TabletAlias
	261, // 198: vtctldata.WorkflowStatusResponse.ShardStreamState.tablet:type_name -> topodata.TabletAlias
	252, // 199: vtctldata.WorkflowStatusResponse.ShardStreams.streams:type_name -> vtctldata.WorkflowStatusResponse.ShardStreamState
	251, // 200: vtctldata.WorkflowStatusResponse.TableCopyStateEntry.value:type_name -> vtctldata.WorkflowStatusResponse.TableCopyState
	253, // 201: vtctldata.WorkflowStatusResponse.ShardStreamsEntry.value:type_name -> vtctldata.WorkflowStatusResponse.ShardStreams
	261, // 202: vtctldata.WorkflowUpdateResponse.TabletInfo.tablet:type_name -> topodata.TabletAlias
