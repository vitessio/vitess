...
var file_vtctldata_proto_rawDesc = []byte{
	...
	0x65, 0x64, 0x50, 0x72, 0x69, 0x6d, 0x61, 0x72, 0x79, 0x22, 0xbc, 0x01, 0x0a, 0x1e, 0x45, 0x6d,
	...
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0xd6, 0x03, 0x0a, 0x1b, 0x50, 0x6c, 0x61, 0x6e, 0x6e,
	...
	0x43, 0x65, 0x6c, 0x6c, 0x50, 0x72, 0x6f, 0x6d, 0x6f, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x40, 0x0a,
	...
	0x70, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x22, 0xb8, 0x02, 0x0a, 0x18, 0x52, 0x65, 0x73, 0x74, 0x6f,
...
var file_vtctldata_proto_depIdxs = []int32{
	...
	301, // 61: vtctldata.EmergencyReparentShardRequest.expected_primary:type_name -> topodata.TabletAlias
	301, // 62: vtctldata.EmergencyReparentShardResponse.promoted_primary:type_name -> topodata.TabletAlias
	297, // 63: vtctldata.EmergencyReparentShardResponse.events:type_name -> logutil.Event
	301, // 64: vtctldata.ExecuteFetchAsAppRequest.tablet_alias:type_name -> topodata.TabletAlias
	314, // 65: vtctldata.ExecuteFetchAsAppResponse.result:type_name -> query.QueryResult
	301, // 66: vtctldata.ExecuteFetchAsDBARequest.tablet_alias:type_name -> topodata.TabletAlias
	314, // 67: vtctldata.ExecuteFetchAsDBAResponse.result:type_name -> query.QueryResult
	301, // 68: vtctldata.ExecuteHookRequest.tablet_alias:type_name -> topodata.TabletAlias
	315, // 69: vtctldata.ExecuteHookRequest.tablet_hook_request:type_name -> tabletmanagerdata.ExecuteHookRequest
	316, // 70: vtctldata.ExecuteHookResponse.hook_result:type_name -> tabletmanagerdata.ExecuteHookResponse
	301, // 71: vtctldata.ExecuteMultiFetchAsDBARequest.tablet_alias:type_name -> topodata.TabletAlias
	314, // 72: vtctldata.ExecuteMultiFetchAsDBAResponse.results:type_name -> query.QueryResult
	271, // 73: vtctldata.FindAllShardsInKeyspaceResponse.shards:type_name -> vtctldata.FindAllShardsInKeyspaceResponse.ShardsEntry
	272, // 74: vtctldata.ForceCutOverSchemaMigrationResponse.rows_affected_by_shard:type_name -> vtctldata.ForceCutOverSchemaMigrationResponse.RowsAffectedByShardEntry
	317, // 75: vtctldata.GetBackupsResponse.backups:type_name -> mysqlctl.BackupInfo
	304, // 76: vtctldata.GetCellInfoResponse.cell_info:type_name -> topodata.CellInfo
	273, // 77: vtctldata.GetCellsAliasesResponse.aliases:type_name -> vtctldata.GetCellsAliasesResponse.AliasesEntry
	301, // 78: vtctldata.GetFullStatusRequest.tablet_alias:type_name -> topodata.TabletAlias
	318, // 79: vtctldata.GetFullStatusResponse.status:type_name -> replicationdata.FullStatus
	8,   // 80: vtctldata.GetKeyspacesResponse.keyspaces:type_name -> vtctldata.Keyspace
	8,   // 81: vtctldata.GetKeyspaceResponse.keyspace:type_name -> vtctldata.Keyspace
	301, // 82: vtctldata.GetPermissionsRequest.tablet_alias:type_name -> topodata.TabletAlias
	319, // 83: vtctldata.GetPermissionsResponse.permissions:type_name -> tabletmanagerdata.Permissions
	305, // 84: vtctldata.GetKeyspaceRoutingRulesResponse.keyspace_routing_rules:type_name -> vschema.KeyspaceRoutingRules
	306, // 85: vtctldata.GetRoutingRulesResponse.routing_rules:type_name -> vschema.RoutingRules
	301, // 86: vtctldata.GetSchemaRequest.tablet_alias:type_name -> topodata.TabletAlias
	320, // 87: vtctldata.GetSchemaResponse.schema:type_name -> tabletmanagerdata.SchemaDefinition
	3,   // 88: vtctldata.GetSchemaMigrationsRequest.status:type_name -> vtctldata.SchemaMigration.Status
	302, // 89: vtctldata.GetSchemaMigrationsRequest.recent:type_name -> vttime.Duration
	1,   // 90: vtctldata.GetSchemaMigrationsRequest.order:type_name -> vtctldata.QueryOrdering
	9,   // 91: vtctldata.GetSchemaMigrationsResponse.migrations:type_name -> vtctldata.SchemaMigration
	274, // 92: vtctldata.GetShardReplicationResponse.shard_replication_by_cell:type_name -> vtctldata.GetShardReplicationResponse.ShardReplicationByCellEntry
	10,  // 93: vtctldata.GetShardResponse.shard:type_name -> vtctldata.Shard
	307, // 94: vtctldata.GetShardRoutingRulesResponse.shard_routing_rules:type_name -> vschema.ShardRoutingRules
	275, // 95: vtctldata.GetSrvKeyspaceNamesResponse.names:type_name -> vtctldata.GetSrvKeyspaceNamesResponse.NamesEntry
	277, // 96: vtctldata.GetSrvKeyspacesResponse.srv_keyspaces:type_name -> vtctldata.GetSrvKeyspacesResponse.SrvKeyspacesEntry
	321, // 97: vtctldata.UpdateThrottlerConfigRequest.throttled_app:type_name -> topodata.ThrottledAppRule
	322, // 98: vtctldata.GetSrvVSchemaResponse.srv_v_schema:type_name -> vschema.SrvVSchema
	278, // 99: vtctldata.GetSrvVSchemasResponse.srv_v_schemas:type_name -> vtctldata.GetSrvVSchemasResponse.SrvVSchemasEntry
	301, // 100: vtctldata.GetTabletRequest.tablet_alias:type_name -> topodata.TabletAlias
	311, // 101: vtctldata.GetTabletResponse.tablet:type_name -> topodata.Tablet
	301, // 102: vtctldata.GetTabletsRequest.tablet_aliases:type_name -> topodata.TabletAlias
	310, // 103: vtctldata.GetTabletsRequest.tablet_type:type_name -> topodata.TabletType
	311, // 104: vtctldata.GetTabletsResponse.tablets:type_name -> topodata.Tablet
	301, // 105: vtctldata.GetThrottlerStatusRequest.tablet_alias:type_name -> topodata.TabletAlias
	323, // 106: vtctldata.GetThrottlerStatusResponse.status:type_name -> tabletmanagerdata.GetThrottlerStatusResponse
	118, // 107: vtctldata.GetTopologyPathResponse.cell:type_name -> vtctldata.TopologyCell
	324, // 108: vtctldata.GetUnresolvedTransactionsResponse.transactions:type_name -> query.TransactionMetadata
	325, // 109: vtctldata.ConcludeTransactionRequest.participants:type_name -> query.Target
	301, // 110: vtctldata.GetVersionRequest.tablet_alias:type_name -> topodata.TabletAlias
	309, // 111: vtctldata.GetVSchemaResponse.v_schema:type_name -> vschema.Keyspace
	12,  // 112: vtctldata.GetWorkflowsResponse.workflows:type_name -> vtctldata.Workflow
	301, // 113: vtctldata.InitShardPrimaryRequest.primary_elect_tablet_alias:type_name -> topodata.TabletAlias
	302, // 114: vtctldata.InitShardPrimaryRequest.wait_replicas_timeout:type_name -> vttime.Duration
	297, // 115: vtctldata.InitShardPrimaryResponse.events:type_name -> logutil.Event
	279, // 116: vtctldata.LaunchSchemaMigrationResponse.rows_affected_by_shard:type_name -> vtctldata.LaunchSchemaMigrationResponse.RowsAffectedByShardEntry
	309, // 117: vtctldata.LookupVindexCreateRequest.vindex:type_name -> vschema.Keyspace
	310, // 118: vtctldata.LookupVindexCreateRequest.tablet_types:type_name -> topodata.TabletType
	298, // 119: vtctldata.LookupVindexCreateRequest.tablet_selection_preference:type_name -> tabletmanagerdata.TabletSelectionPreference
	7,   // 120: vtctldata.MaterializeCreateRequest.settings:type_name -> vtctldata.MaterializeSettings
	310, // 121: vtctldata.MigrateCreateRequest.tablet_types:type_name -> topodata.TabletType
	298, // 122: vtctldata.MigrateCreateRequest.tablet_selection_preference:type_name -> tabletmanagerdata.TabletSelectionPreference
	310, // 123: vtctldata.MoveTablesCreateRequest.tablet_types:type_name -> topodata.TabletType
	298, // 124: vtctldata.MoveTablesCreateRequest.tablet_selection_preference:type_name -> tabletmanagerdata.TabletSelectionPreference
	11,  // 125: vtctldata.MoveTablesCreateRequest.workflow_options:type_name -> vtctldata.WorkflowOptions
	280, // 126: vtctldata.MoveTablesCreateResponse.details:type_name -> vtctldata.MoveTablesCreateResponse.TabletInfo
	301, // 127: vtctldata.PingTabletRequest.tablet_alias:type_name -> topodata.TabletAlias
	301, // 128: vtctldata.PlannedReparentShardRequest.new_primary:type_name -> topodata.TabletAlias
	301, // 129: vtctldata.PlannedReparentShardRequest.avoid_primary:type_name -> topodata.TabletAlias
	302, // 130: vtctldata.PlannedReparentShardRequest.wait_replicas_timeout:type_name -> vttime.Duration
	302, // 131: vtctldata.PlannedReparentShardRequest.tolerable_replication_lag:type_name -> vttime.Duration
	301, // 132: vtctldata.PlannedReparentShardRequest.expected_primary:type_name -> topodata.TabletAlias
	301, // 133: vtctldata.PlannedReparentShardResponse.promoted_primary:type_name -> topodata.TabletAlias
	297, // 134: vtctldata.PlannedReparentShardResponse.events:type_name -> logutil.Event
	301, // 135: vtctldata.RefreshStateRequest.tablet_alias:type_name -> topodata.TabletAlias
	301, // 136: vtctldata.ReloadSchemaRequest.tablet_alias:type_name -> topodata.TabletAlias
	297, // 137: vtctldata.ReloadSchemaKeyspaceResponse.events:type_name -> logutil.Event
	297, // 138: vtctldata.ReloadSchemaShardResponse.events:type_name -> logutil.Event
	301, // 139: vtctldata.ReparentTabletRequest.tablet:type_name -> topodata.TabletAlias
	301, // 140: vtctldata.ReparentTabletResponse.primary:type_name -> topodata.TabletAlias
	310, // 141: vtctldata.ReshardCreateRequest.tablet_types:type_name -> topodata.TabletType
	298, // 142: vtctldata.ReshardCreateRequest.tablet_selection_preference:type_name -> tabletmanagerdata.TabletSelectionPreference
	11,  // 143: vtctldata.ReshardCreateRequest.workflow_options:type_name -> vtctldata.WorkflowOptions
	301, // 144: vtctldata.RestoreFromBackupRequest.tablet_alias:type_name -> topodata.TabletAlias
	300, // 145: vtctldata.RestoreFromBackupRequest.backup_time:type_name -> vttime.Time
	300, // 146: vtctldata.RestoreFromBackupRequest.restore_to_timestamp:type_name -> vttime.Time
	301, // 147: vtctldata.RestoreFromBackupResponse.tablet_alias:type_name -> topodata.TabletAlias
	297, // 148: vtctldata.RestoreFromBackupResponse.event:type_name -> logutil.Event
	281, // 149: vtctldata.RetrySchemaMigrationResponse.rows_affected_by_shard:type_name -> vtctldata.RetrySchemaMigrationResponse.RowsAffectedByShardEntry
	301, // 150: vtctldata.RunHealthCheckRequest.tablet_alias:type_name -> topodata.TabletAlias
	299, // 151: vtctldata.SetKeyspaceDurabilityPolicyResponse.keyspace:type_name -> topodata.Keyspace
	299, // 152: vtctldata.SetKeyspaceShardingInfoResponse.keyspace:type_name -> topodata.Keyspace
	303, // 153: vtctldata.SetShardIsPrimaryServingResponse.shard:type_name -> topodata.Shard
	310, // 154: vtctldata.SetShardTabletControlRequest.tablet_type:type_name -> topodata.TabletType
	303, // 155: vtctldata.SetShardTabletControlResponse.shard:type_name -> topodata.Shard
	301, // 156: vtctldata.SetWritableRequest.tablet_alias:type_name -> topodata.TabletAlias
	301, // 157: vtctldata.ShardReplicationAddRequest.tablet_alias:type_name -> topodata.TabletAlias
	326, // 158: vtctldata.ShardReplicationFixResponse.error:type_name -> topodata.ShardReplicationError
	282, // 159: vtctldata.ShardReplicationPositionsResponse.replication_statuses:type_name -> vtctldata.ShardReplicationPositionsResponse.ReplicationStatusesEntry
	283, // 160: vtctldata.ShardReplicationPositionsResponse.tablet_map:type_name -> vtctldata.ShardReplicationPositionsResponse.TabletMapEntry
	301, // 161: vtctldata.ShardReplicationRemoveRequest.tablet_alias:type_name -> topodata.TabletAlias
	301, // 162: vtctldata.SleepTabletRequest.tablet_alias:type_name -> topodata.TabletAlias
	302, // 163: vtctldata.SleepTabletRequest.duration:type_name -> vttime.Duration
	327, // 164: vtctldata.SourceShardAddRequest.key_range:type_name -> topodata.KeyRange
	303, // 165: vtctldata.SourceShardAddResponse.shard:type_name -> topodata.Shard
	303, // 166: vtctldata.SourceShardDeleteResponse.shard:type_name -> topodata.Shard
	301, // 167: vtctldata.StartReplicationRequest.tablet_alias:type_name -> topodata.TabletAlias
	301, // 168: vtctldata.StopReplicationRequest.tablet_alias:type_name -> topodata.TabletAlias
	301, // 169: vtctldata.TabletExternallyReparentedRequest.tablet:type_name -> topodata.TabletAlias
	301, // 170: vtctldata.TabletExternallyReparentedResponse.new_primary:type_name -> topodata.TabletAlias
	301, // 171: vtctldata.TabletExternallyReparentedResponse.old_primary:type_name -> topodata.TabletAlias
	304, // 172: vtctldata.UpdateCellInfoRequest.cell_info:type_name -> topodata.CellInfo
	304, // 173: vtctldata.UpdateCellInfoResponse.cell_info:type_name -> topodata.CellInfo
	328, // 174: vtctldata.UpdateCellsAliasRequest.cells_alias:type_name -> topodata.CellsAlias
	328, // 175: vtctldata.UpdateCellsAliasResponse.cells_alias:type_name -> topodata.CellsAlias
	284, // 176: vtctldata.ValidateResponse.results_by_keyspace:type_name -> vtctldata.ValidateResponse.ResultsByKeyspaceEntry
	285, // 177: vtctldata.ValidateKeyspaceResponse.results_by_shard:type_name -> vtctldata.ValidateKeyspaceResponse.ResultsByShardEntry
	286, // 178: vtctldata.ValidateSchemaKeyspaceResponse.results_by_shard:type_name -> vtctldata.ValidateSchemaKeyspaceResponse.ResultsByShardEntry
	287, // 179: vtctldata.ValidateVersionKeyspaceResponse.results_by_shard:type_name -> vtctldata.ValidateVersionKeyspaceResponse.ResultsByShardEntry
	288, // 180: vtctldata.ValidateVSchemaResponse.results_by_shard:type_name -> vtctldata.ValidateVSchemaResponse.ResultsByShardEntry
	310, // 181: vtctldata.VDiffCreateRequest.tablet_types:type_name -> topodata.TabletType
	298, // 182: vtctldata.VDiffCreateRequest.tablet_selection_preference:type_name -> tabletmanagerdata.TabletSelectionPreference
	302, // 183: vtctldata.VDiffCreateRequest.filtered_replication_wait_time:type_name -> vttime.Duration
	302, // 184: vtctldata.VDiffCreateRequest.wait_update_interval:type_name -> vttime.Duration
	302, // 185: vtctldata.VDiffCreateRequest.max_diff_duration:type_name -> vttime.Duration
	289, // 186: vtctldata.VDiffShowResponse.tablet_responses:type_name -> vtctldata.VDiffShowResponse.TabletResponsesEntry
	290, // 187: vtctldata.WorkflowDeleteResponse.details:type_name -> vtctldata.WorkflowDeleteResponse.TabletInfo
	294, // 188: vtctldata.WorkflowStatusResponse.table_copy_state:type_name -> vtctldata.WorkflowStatusResponse.TableCopyStateEntry
	295, // 189: vtctldata.WorkflowStatusResponse.shard_streams:type_name -> vtctldata.WorkflowStatusResponse.ShardStreamsEntry
	310, // 190: vtctldata.WorkflowSwitchTrafficRequest.tablet_types:type_name -> topodata.TabletType
	302, // 191: vtctldata.WorkflowSwitchTrafficRequest.max_replication_lag_allowed:type_name -> vttime.Duration
	302, // 192: vtctldata.WorkflowSwitchTrafficRequest.timeout:type_name -> vttime.Duration
	329, // 193: vtctldata.WorkflowUpdateRequest.tablet_request:type_name -> tabletmanagerdata.UpdateVReplicationWorkflowRequest
	296, // 194: vtctldata.WorkflowUpdateResponse.details:type_name -> vtctldata.WorkflowUpdateResponse.TabletInfo
	330, // 195: vtctldata.GetMirrorRulesResponse.mirror_rules:type_name -> vschema.MirrorRules
	310, // 196: vtctldata.WorkflowMirrorTrafficRequest.tablet_types:type_name -> topodata.TabletType
	260, // 197: vtctldata.Workflow.ShardStreamsEntry.value:type_name -> vtctldata.Workflow.ShardStream
	261, // 198: vtctldata.Workflow.ShardStream.streams:type_name -> vtctldata.Workflow.Stream
	331, // 199: vtctldata.Workflow.ShardStream.tablet_controls:type_name -> topodata.Shard.TabletControl
	301, // 200: vtctldata.Workflow.Stream.tablet:type_name -> topodata.TabletAlias
	332, // 201: vtctldata.Workflow.Stream.binlog_source:type_name -> binlogdata.BinlogSource
	300, // 202: vtctldata.Workflow.Stream.transaction_timestamp:type_name -> vttime.Time
	300, // 203: vtctldata.Workflow.Stream.time_updated:type_name -> vttime.Time
	262, // 204: vtctldata.Workflow.Stream.copy_states:type_name -> vtctldata.Workflow.Stream.CopyState
	263, // 205: vtctldata.Workflow.Stream.logs:type_name -> vtctldata.Workflow.Stream.Log
	264, // 206: vtctldata.Workflow.Stream.throttler_status:type_name -> vtctldata.Workflow.Stream.ThrottlerStatus
	310, // 207: vtctldata.Workflow.Stream.tablet_types:type_name -> topodata.TabletType
	298, // 208: vtctldata.Workflow.Stream.tablet_selection_preference:type_name -> tabletmanagerdata.TabletSelectionPreference
	300, // 209: vtctldata.Workflow.Stream.Log.created_at:type_name -> vttime.Time
	300, // 210: vtctldata.Workflow.Stream.Log.updated_at:type_name -> vttime.Time
	300, // 211: vtctldata.Workflow.Stream.ThrottlerStatus.time_throttled:type_name -> vttime.Time
	267, // 212: vtctldata.ApplyVSchemaResponse.UnknownVindexParamsEntry.value:type_name -> vtctldata.ApplyVSchemaResponse.ParamList
	10,  // 213: vtctldata.FindAllShardsInKeyspaceResponse.ShardsEntry.value:type_name -> vtctldata.Shard
	328, // 214: vtctldata.GetCellsAliasesResponse.AliasesEntry.value:type_name -> topodata.CellsAlias
	333, // 215: vtctldata.GetShardReplicationResponse.ShardReplicationByCellEntry.value:type_name -> topodata.ShardReplication
	276, // 216: vtctldata.GetSrvKeyspaceNamesResponse.NamesEntry.value:type_name -> vtctldata.GetSrvKeyspaceNamesResponse.NameList
	334, // 217: vtctldata.GetSrvKeyspacesResponse.SrvKeyspacesEntry.value:type_name -> topodata.SrvKeyspace
	322, // 218: vtctldata.GetSrvVSchemasResponse.SrvVSchemasEntry.value:type_name -> vschema.SrvVSchema
	301, // 219: vtctldata.MoveTablesCreateResponse.TabletInfo.tablet:type_name -> topodata.TabletAlias
	335, // 220: vtctldata.ShardReplicationPositionsResponse.ReplicationStatusesEntry.value:type_name -> replicationdata.Status
	311, // 221: vtctldata.ShardReplicationPositionsResponse.TabletMapEntry.value:type_name -> topodata.Tablet
	224, // 222: vtctldata.ValidateResponse.ResultsByKeyspaceEntry.value:type_name -> vtctldata.ValidateKeyspaceResponse
	228, // 223: vtctldata.ValidateKeyspaceResponse.ResultsByShardEntry.value:type_name -> vtctldata.ValidateShardResponse
	228, // 224: vtctldata.ValidateSchemaKeyspaceResponse.ResultsByShardEntry.value:type_name -> vtctldata.ValidateShardResponse
	228, // 225: vtctldata.ValidateVersionKeyspaceResponse.ResultsByShardEntry.value:type_name -> vtctldata.ValidateShardResponse
	228, // 226: vtctldata.ValidateVSchemaResponse.ResultsByShardEntry.value:type_name -> vtctldata.ValidateShardResponse
	336, // 227: vtctldata.VDiffShowResponse.TabletResponsesEntry.value:type_name -> tabletmanagerdata.VDiffResponse
