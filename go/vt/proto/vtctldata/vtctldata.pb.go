...
func (*ExecuteVtctlCommandRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_vtctldata_afde12806774fb0f, []int{0}
}
...
func (*ExecuteVtctlCommandResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_vtctldata_afde12806774fb0f, []int{1}
}
...
func (*TableMaterializeSettings) Descriptor() ([]byte, []int) {
	return fileDescriptor_vtctldata_afde12806774fb0f, []int{2}
}
...
func (dst *TableMaterializeSettings) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TableMaterializeSettings.Merge(dst, src)
}
...
func (*MaterializeSettings) Descriptor() ([]byte, []int) {
	return fileDescriptor_vtctldata_afde12806774fb0f, []int{3}
}
...
func (dst *MaterializeSettings) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MaterializeSettings.Merge(dst, src)
}
...
func init() { proto.RegisterFile("vtctldata.proto", fileDescriptor_vtctldata_afde12806774fb0f) }

var fileDescriptor_vtctldata_afde12806774fb0f = []byte{
