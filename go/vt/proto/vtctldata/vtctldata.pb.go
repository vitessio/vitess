...
type ExecuteMultiFetchAsDBAResponse struct {
	...
	// Errors is a list of errors encountered while executing the queries.
	// It is either nil/empty, or maps 1:1 to the results.
...
func (x *ExecuteMultiFetchAsDBAResponse) GetErrors() []string {
	if x != nil {
		return x.Errors
	}
	return nil
...
var file_vtctldata_proto_rawDesc = []byte{
	...
	0x67, 0x73, 0x12, 0x23, 0x0a, 0x0d, 0x72, 0x65, 0x6c, 0x6f, 0x61, 0x64, 0x5f, 0x73, 0x63, 0x68,
	0x65, 0x6d, 0x61, 0x18, 0x05, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0c, 0x72, 0x65, 0x6c, 0x6f, 0x61,
	0x64, 0x53, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x22, 0x66, 0x0a, 0x1e, 0x45, 0x78, 0x65, 0x63, 0x75,
