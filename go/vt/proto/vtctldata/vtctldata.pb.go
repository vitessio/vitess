...
type WorkflowDeleteRequest struct {
	...
	DeleteBatchSize int32 `protobuf:"varint,6,opt,name=delete_batch_size,json=deleteBatchSize,proto3" json:"delete_batch_size,omitempty"`
}
...
func (x *WorkflowDeleteRequest) GetDeleteBatchSize() int32 {
	if x != nil {
...
var file_vtctldata_proto_rawDesc = []byte{
	...
	0x65, 0x18, 0x06, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0f, 0x64, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x42,
