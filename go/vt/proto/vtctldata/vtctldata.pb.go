...
var file_vtctldata_proto_rawDesc = []byte{
	...
	0x95, 0x06, 0x0a, 0x12, 0x56, 0x44, 0x69, 0x66, 0x66, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x52,
	...
	0x43, 0x65, 0x6c, 0x6c, 0x73, 0x12, 0x37, 0x0a, 0x0c, 0x74, 0x61, 0x62, 0x6c, 0x65, 0x74, 0x5f,
	...
	0x01, 0x28, 0x03, 0x52, 0x05, 0x6c, 0x69, 0x6d, 0x69, 0x74, 0x12, 0x55, 0x0a, 0x1e, 0x66, 0x69,
	...
	0x20, 0x01, 0x28, 0x08, 0x52, 0x04, 0x77, 0x61, 0x69, 0x74, 0x12, 0x42, 0x0a, 0x14, 0x77, 0x61,
	0x69, 0x74, 0x5f, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x5f, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x76,
	0x61, 0x6c, 0x18, 0x10, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x10, 0x2e, 0x76, 0x74, 0x74, 0x69, 0x6d,
	0x65, 0x2e, 0x44, 0x75, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x12, 0x77, 0x61, 0x69, 0x74,
	...
	0x76, 0x65, 0x72, 0x62, 0x6f, 0x73, 0x65, 0x22, 0x29, 0x0a, 0x13, 0x56, 0x44, 0x69, 0x66, 0x66,
	...
	0x6e, 0x73, 0x65, 0x22, 0x9a, 0x01, 0x0a, 0x15, 0x57, 0x6f, 0x72, 0x6b, 0x66, 0x6c, 0x6f, 0x77,
...
var file_vtctldata_proto_msgTypes = make([]protoimpl.MessageInfo, 266)
var file_vtctldata_proto_goTypes = []interface{}{
	...
	nil,                                          // 242: vtctldata.ApplySchemaResponse.RowsAffectedByShardEntry
	nil,                                          // 243: vtctldata.CancelSchemaMigrationResponse.RowsAffectedByShardEntry
	nil,                                          // 244: vtctldata.CleanupSchemaMigrationResponse.RowsAffectedByShardEntry
	nil,                                          // 245: vtctldata.CompleteSchemaMigrationResponse.RowsAffectedByShardEntry
	nil,                                          // 246: vtctldata.FindAllShardsInKeyspaceResponse.ShardsEntry
	nil,                                          // 247: vtctldata.GetCellsAliasesResponse.AliasesEntry
	nil,                                          // 248: vtctldata.GetSrvKeyspaceNamesResponse.NamesEntry
	(*GetSrvKeyspaceNamesResponse_NameList)(nil), // 249: vtctldata.GetSrvKeyspaceNamesResponse.NameList
	nil, // 250: vtctldata.GetSrvKeyspacesResponse.SrvKeyspacesEntry
	nil, // 251: vtctldata.GetSrvVSchemasResponse.SrvVSchemasEntry
	nil, // 252: vtctldata.LaunchSchemaMigrationResponse.RowsAffectedByShardEntry
	(*MoveTablesCreateResponse_TabletInfo)(nil), // 253: vtctldata.MoveTablesCreateResponse.TabletInfo
	nil, // 254: vtctldata.RetrySchemaMigrationResponse.RowsAffectedByShardEntry
	nil, // 255: vtctldata.ShardReplicationPositionsResponse.ReplicationStatusesEntry
	nil, // 256: vtctldata.ShardReplicationPositionsResponse.TabletMapEntry
	nil, // 257: vtctldata.ValidateResponse.ResultsByKeyspaceEntry
	nil, // 258: vtctldata.ValidateKeyspaceResponse.ResultsByShardEntry
	nil, // 259: vtctldata.ValidateSchemaKeyspaceResponse.ResultsByShardEntry
	nil, // 260: vtctldata.ValidateVersionKeyspaceResponse.ResultsByShardEntry
	nil, // 261: vtctldata.ValidateVSchemaResponse.ResultsByShardEntry
	nil, // 262: vtctldata.VDiffShowResponse.TabletResponsesEntry
	(*WorkflowDeleteResponse_TabletInfo)(nil),       // 263: vtctldata.WorkflowDeleteResponse.TabletInfo
	(*WorkflowStatusResponse_TableCopyState)(nil),   // 264: vtctldata.WorkflowStatusResponse.TableCopyState
	(*WorkflowStatusResponse_ShardStreamState)(nil), // 265: vtctldata.WorkflowStatusResponse.ShardStreamState
	(*WorkflowStatusResponse_ShardStreams)(nil),     // 266: vtctldata.WorkflowStatusResponse.ShardStreams
	nil, // 267: vtctldata.WorkflowStatusResponse.TableCopyStateEntry
	nil, // 268: vtctldata.WorkflowStatusResponse.ShardStreamsEntry
	(*WorkflowUpdateResponse_TabletInfo)(nil),                   // 269: vtctldata.WorkflowUpdateResponse.TabletInfo
	(*logutil.Event)(nil),                                       // 270: logutil.Event
	(tabletmanagerdata.TabletSelectionPreference)(0),            // 271: tabletmanagerdata.TabletSelectionPreference
	(*topodata.Keyspace)(nil),                                   // 272: topodata.Keyspace
	(*vttime.Time)(nil),                                         // 273: vttime.Time
	(*topodata.TabletAlias)(nil),                                // 274: topodata.TabletAlias
	(*vttime.Duration)(nil),                                     // 275: vttime.Duration
	(*topodata.Shard)(nil),                                      // 276: topodata.Shard
	(*topodata.CellInfo)(nil),                                   // 277: topodata.CellInfo
	(*vschema.RoutingRules)(nil),                                // 278: vschema.RoutingRules
	(*vschema.ShardRoutingRules)(nil),                           // 279: vschema.ShardRoutingRules
	(*vtrpc.CallerID)(nil),                                      // 280: vtrpc.CallerID
	(*vschema.Keyspace)(nil),                                    // 281: vschema.Keyspace
	(topodata.TabletType)(0),                                    // 282: topodata.TabletType
	(*topodata.Tablet)(nil),                                     // 283: topodata.Tablet
	(*topodata.Keyspace_ServedFrom)(nil),                        // 284: topodata.Keyspace.ServedFrom
	(topodata.KeyspaceType)(0),                                  // 285: topodata.KeyspaceType
	(*query.QueryResult)(nil),                                   // 286: query.QueryResult
	(*tabletmanagerdata.ExecuteHookRequest)(nil),                // 287: tabletmanagerdata.ExecuteHookRequest
	(*tabletmanagerdata.ExecuteHookResponse)(nil),               // 288: tabletmanagerdata.ExecuteHookResponse
	(*mysqlctl.BackupInfo)(nil),                                 // 289: mysqlctl.BackupInfo
	(*replicationdata.FullStatus)(nil),                          // 290: replicationdata.FullStatus
	(*tabletmanagerdata.Permissions)(nil),                       // 291: tabletmanagerdata.Permissions
	(*tabletmanagerdata.SchemaDefinition)(nil),                  // 292: tabletmanagerdata.SchemaDefinition
	(*topodata.ThrottledAppRule)(nil),                           // 293: topodata.ThrottledAppRule
	(*vschema.SrvVSchema)(nil),                                  // 294: vschema.SrvVSchema
	(*topodata.ShardReplicationError)(nil),                      // 295: topodata.ShardReplicationError
	(*topodata.KeyRange)(nil),                                   // 296: topodata.KeyRange
	(*topodata.CellsAlias)(nil),                                 // 297: topodata.CellsAlias
	(*tabletmanagerdata.UpdateVReplicationWorkflowRequest)(nil), // 298: tabletmanagerdata.UpdateVReplicationWorkflowRequest
	(*topodata.Shard_TabletControl)(nil),                        // 299: topodata.Shard.TabletControl
	(*binlogdata.BinlogSource)(nil),                             // 300: binlogdata.BinlogSource
	(*topodata.SrvKeyspace)(nil),                                // 301: topodata.SrvKeyspace
	(*replicationdata.Status)(nil),                              // 302: replicationdata.Status
	(*tabletmanagerdata.VDiffResponse)(nil),                     // 303: tabletmanagerdata.VDiffResponse
}
var file_vtctldata_proto_depIdxs = []int32{
	270, // 0: vtctldata.ExecuteVtctlCommandResponse.event:type_name -> logutil.Event
	...
	271, // 3: vtctldata.MaterializeSettings.tablet_selection_preference:type_name -> tabletmanagerdata.TabletSelectionPreference
	272, // 4: vtctldata.Keyspace.keyspace:type_name -> topodata.Keyspace
	2,   // 5: vtctldata.SchemaMigration.strategy:type_name -> vtctldata.SchemaMigration.Strategy
	273, // 6: vtctldata.SchemaMigration.added_at:type_name -> vttime.Time
	273, // 7: vtctldata.SchemaMigration.requested_at:type_name -> vttime.Time
	273, // 8: vtctldata.SchemaMigration.ready_at:type_name -> vttime.Time
	273, // 9: vtctldata.SchemaMigration.started_at:type_name -> vttime.Time
	273, // 10: vtctldata.SchemaMigration.liveness_timestamp:type_name -> vttime.Time
	273, // 11: vtctldata.SchemaMigration.completed_at:type_name -> vttime.Time
	273, // 12: vtctldata.SchemaMigration.cleaned_up_at:type_name -> vttime.Time
	3,   // 13: vtctldata.SchemaMigration.status:type_name -> vtctldata.SchemaMigration.Status
	274, // 14: vtctldata.SchemaMigration.tablet:type_name -> topodata.TabletAlias
	275, // 15: vtctldata.SchemaMigration.artifact_retention:type_name -> vttime.Duration
	273, // 16: vtctldata.SchemaMigration.last_throttled_at:type_name -> vttime.Time
	273, // 17: vtctldata.SchemaMigration.cancelled_at:type_name -> vttime.Time
	273, // 18: vtctldata.SchemaMigration.reviewed_at:type_name -> vttime.Time
	273, // 19: vtctldata.SchemaMigration.ready_to_complete_at:type_name -> vttime.Time
	276, // 20: vtctldata.Shard.shard:type_name -> topodata.Shard
	...
	277, // 24: vtctldata.AddCellInfoRequest.cell_info:type_name -> topodata.CellInfo
	278, // 25: vtctldata.ApplyRoutingRulesRequest.routing_rules:type_name -> vschema.RoutingRules
	279, // 26: vtctldata.ApplyShardRoutingRulesRequest.shard_routing_rules:type_name -> vschema.ShardRoutingRules
	275, // 27: vtctldata.ApplySchemaRequest.wait_replicas_timeout:type_name -> vttime.Duration
	280, // 28: vtctldata.ApplySchemaRequest.caller_id:type_name -> vtrpc.CallerID
	242, // 29: vtctldata.ApplySchemaResponse.rows_affected_by_shard:type_name -> vtctldata.ApplySchemaResponse.RowsAffectedByShardEntry
	281, // 30: vtctldata.ApplyVSchemaRequest.v_schema:type_name -> vschema.Keyspace
	281, // 31: vtctldata.ApplyVSchemaResponse.v_schema:type_name -> vschema.Keyspace
	274, // 32: vtctldata.BackupRequest.tablet_alias:type_name -> topodata.TabletAlias
	274, // 33: vtctldata.BackupResponse.tablet_alias:type_name -> topodata.TabletAlias
	270, // 34: vtctldata.BackupResponse.event:type_name -> logutil.Event
	243, // 35: vtctldata.CancelSchemaMigrationResponse.rows_affected_by_shard:type_name -> vtctldata.CancelSchemaMigrationResponse.RowsAffectedByShardEntry
	274, // 36: vtctldata.ChangeTabletTypeRequest.tablet_alias:type_name -> topodata.TabletAlias
	282, // 37: vtctldata.ChangeTabletTypeRequest.db_type:type_name -> topodata.TabletType
	283, // 38: vtctldata.ChangeTabletTypeResponse.before_tablet:type_name -> topodata.Tablet
	283, // 39: vtctldata.ChangeTabletTypeResponse.after_tablet:type_name -> topodata.Tablet
	244, // 40: vtctldata.CleanupSchemaMigrationResponse.rows_affected_by_shard:type_name -> vtctldata.CleanupSchemaMigrationResponse.RowsAffectedByShardEntry
	245, // 41: vtctldata.CompleteSchemaMigrationResponse.rows_affected_by_shard:type_name -> vtctldata.CompleteSchemaMigrationResponse.RowsAffectedByShardEntry
	284, // 42: vtctldata.CreateKeyspaceRequest.served_froms:type_name -> topodata.Keyspace.ServedFrom
	285, // 43: vtctldata.CreateKeyspaceRequest.type:type_name -> topodata.KeyspaceType
	273, // 44: vtctldata.CreateKeyspaceRequest.snapshot_time:type_name -> vttime.Time
	...
	274, // 49: vtctldata.DeleteTabletsRequest.tablet_aliases:type_name -> topodata.TabletAlias
	274, // 50: vtctldata.EmergencyReparentShardRequest.new_primary:type_name -> topodata.TabletAlias
	274, // 51: vtctldata.EmergencyReparentShardRequest.ignore_replicas:type_name -> topodata.TabletAlias
	275, // 52: vtctldata.EmergencyReparentShardRequest.wait_replicas_timeout:type_name -> vttime.Duration
	274, // 53: vtctldata.EmergencyReparentShardResponse.promoted_primary:type_name -> topodata.TabletAlias
	270, // 54: vtctldata.EmergencyReparentShardResponse.events:type_name -> logutil.Event
	274, // 55: vtctldata.ExecuteFetchAsAppRequest.tablet_alias:type_name -> topodata.TabletAlias
	286, // 56: vtctldata.ExecuteFetchAsAppResponse.result:type_name -> query.QueryResult
	274, // 57: vtctldata.ExecuteFetchAsDBARequest.tablet_alias:type_name -> topodata.TabletAlias
	286, // 58: vtctldata.ExecuteFetchAsDBAResponse.result:type_name -> query.QueryResult
	274, // 59: vtctldata.ExecuteHookRequest.tablet_alias:type_name -> topodata.TabletAlias
	287, // 60: vtctldata.ExecuteHookRequest.tablet_hook_request:type_name -> tabletmanagerdata.ExecuteHookRequest
	288, // 61: vtctldata.ExecuteHookResponse.hook_result:type_name -> tabletmanagerdata.ExecuteHookResponse
	246, // 62: vtctldata.FindAllShardsInKeyspaceResponse.shards:type_name -> vtctldata.FindAllShardsInKeyspaceResponse.ShardsEntry
	289, // 63: vtctldata.GetBackupsResponse.backups:type_name -> mysqlctl.BackupInfo
	277, // 64: vtctldata.GetCellInfoResponse.cell_info:type_name -> topodata.CellInfo
	247, // 65: vtctldata.GetCellsAliasesResponse.aliases:type_name -> vtctldata.GetCellsAliasesResponse.AliasesEntry
	274, // 66: vtctldata.GetFullStatusRequest.tablet_alias:type_name -> topodata.TabletAlias
	290, // 67: vtctldata.GetFullStatusResponse.status:type_name -> replicationdata.FullStatus
	...
	274, // 70: vtctldata.GetPermissionsRequest.tablet_alias:type_name -> topodata.TabletAlias
	291, // 71: vtctldata.GetPermissionsResponse.permissions:type_name -> tabletmanagerdata.Permissions
	278, // 72: vtctldata.GetRoutingRulesResponse.routing_rules:type_name -> vschema.RoutingRules
	274, // 73: vtctldata.GetSchemaRequest.tablet_alias:type_name -> topodata.TabletAlias
	292, // 74: vtctldata.GetSchemaResponse.schema:type_name -> tabletmanagerdata.SchemaDefinition
	3,   // 75: vtctldata.GetSchemaMigrationsRequest.status:type_name -> vtctldata.SchemaMigration.Status
	275, // 76: vtctldata.GetSchemaMigrationsRequest.recent:type_name -> vttime.Duration
	...
	279, // 80: vtctldata.GetShardRoutingRulesResponse.shard_routing_rules:type_name -> vschema.ShardRoutingRules
	248, // 81: vtctldata.GetSrvKeyspaceNamesResponse.names:type_name -> vtctldata.GetSrvKeyspaceNamesResponse.NamesEntry
	250, // 82: vtctldata.GetSrvKeyspacesResponse.srv_keyspaces:type_name -> vtctldata.GetSrvKeyspacesResponse.SrvKeyspacesEntry
	293, // 83: vtctldata.UpdateThrottlerConfigRequest.throttled_app:type_name -> topodata.ThrottledAppRule
	294, // 84: vtctldata.GetSrvVSchemaResponse.srv_v_schema:type_name -> vschema.SrvVSchema
	251, // 85: vtctldata.GetSrvVSchemasResponse.srv_v_schemas:type_name -> vtctldata.GetSrvVSchemasResponse.SrvVSchemasEntry
	274, // 86: vtctldata.GetTabletRequest.tablet_alias:type_name -> topodata.TabletAlias
	283, // 87: vtctldata.GetTabletResponse.tablet:type_name -> topodata.Tablet
	274, // 88: vtctldata.GetTabletsRequest.tablet_aliases:type_name -> topodata.TabletAlias
	282, // 89: vtctldata.GetTabletsRequest.tablet_type:type_name -> topodata.TabletType
	283, // 90: vtctldata.GetTabletsResponse.tablets:type_name -> topodata.Tablet
	103, // 91: vtctldata.GetTopologyPathResponse.cell:type_name -> vtctldata.TopologyCell
	274, // 92: vtctldata.GetVersionRequest.tablet_alias:type_name -> topodata.TabletAlias
	281, // 93: vtctldata.GetVSchemaResponse.v_schema:type_name -> vschema.Keyspace
	11,  // 94: vtctldata.GetWorkflowsResponse.workflows:type_name -> vtctldata.Workflow
	274, // 95: vtctldata.InitShardPrimaryRequest.primary_elect_tablet_alias:type_name -> topodata.TabletAlias
	275, // 96: vtctldata.InitShardPrimaryRequest.wait_replicas_timeout:type_name -> vttime.Duration
	270, // 97: vtctldata.InitShardPrimaryResponse.events:type_name -> logutil.Event
	252, // 98: vtctldata.LaunchSchemaMigrationResponse.rows_affected_by_shard:type_name -> vtctldata.LaunchSchemaMigrationResponse.RowsAffectedByShardEntry
	281, // 99: vtctldata.LookupVindexCreateRequest.vindex:type_name -> vschema.Keyspace
	282, // 100: vtctldata.LookupVindexCreateRequest.tablet_types:type_name -> topodata.TabletType
	271, // 101: vtctldata.LookupVindexCreateRequest.tablet_selection_preference:type_name -> tabletmanagerdata.TabletSelectionPreference
	7,   // 102: vtctldata.MaterializeCreateRequest.settings:type_name -> vtctldata.MaterializeSettings
	282, // 103: vtctldata.MigrateCreateRequest.tablet_types:type_name -> topodata.TabletType
	271, // 104: vtctldata.MigrateCreateRequest.tablet_selection_preference:type_name -> tabletmanagerdata.TabletSelectionPreference
	282, // 105: vtctldata.MoveTablesCreateRequest.tablet_types:type_name -> topodata.TabletType
	271, // 106: vtctldata.MoveTablesCreateRequest.tablet_selection_preference:type_name -> tabletmanagerdata.TabletSelectionPreference
	253, // 107: vtctldata.MoveTablesCreateResponse.details:type_name -> vtctldata.MoveTablesCreateResponse.TabletInfo
	274, // 108: vtctldata.PingTabletRequest.tablet_alias:type_name -> topodata.TabletAlias
	274, // 109: vtctldata.PlannedReparentShardRequest.new_primary:type_name -> topodata.TabletAlias
	274, // 110: vtctldata.PlannedReparentShardRequest.avoid_primary:type_name -> topodata.TabletAlias
	275, // 111: vtctldata.PlannedReparentShardRequest.wait_replicas_timeout:type_name -> vttime.Duration
	274, // 112: vtctldata.PlannedReparentShardResponse.promoted_primary:type_name -> topodata.TabletAlias
	270, // 113: vtctldata.PlannedReparentShardResponse.events:type_name -> logutil.Event
	274, // 114: vtctldata.RefreshStateRequest.tablet_alias:type_name -> topodata.TabletAlias
	274, // 115: vtctldata.ReloadSchemaRequest.tablet_alias:type_name -> topodata.TabletAlias
	270, // 116: vtctldata.ReloadSchemaKeyspaceResponse.events:type_name -> logutil.Event
	270, // 117: vtctldata.ReloadSchemaShardResponse.events:type_name -> logutil.Event
	274, // 118: vtctldata.ReparentTabletRequest.tablet:type_name -> topodata.TabletAlias
	274, // 119: vtctldata.ReparentTabletResponse.primary:type_name -> topodata.TabletAlias
	282, // 120: vtctldata.ReshardCreateRequest.tablet_types:type_name -> topodata.TabletType
	271, // 121: vtctldata.ReshardCreateRequest.tablet_selection_preference:type_name -> tabletmanagerdata.TabletSelectionPreference
	274, // 122: vtctldata.RestoreFromBackupRequest.tablet_alias:type_name -> topodata.TabletAlias
	273, // 123: vtctldata.RestoreFromBackupRequest.backup_time:type_name -> vttime.Time
	273, // 124: vtctldata.RestoreFromBackupRequest.restore_to_timestamp:type_name -> vttime.Time
	274, // 125: vtctldata.RestoreFromBackupResponse.tablet_alias:type_name -> topodata.TabletAlias
	270, // 126: vtctldata.RestoreFromBackupResponse.event:type_name -> logutil.Event
	254, // 127: vtctldata.RetrySchemaMigrationResponse.rows_affected_by_shard:type_name -> vtctldata.RetrySchemaMigrationResponse.RowsAffectedByShardEntry
	274, // 128: vtctldata.RunHealthCheckRequest.tablet_alias:type_name -> topodata.TabletAlias
	272, // 129: vtctldata.SetKeyspaceDurabilityPolicyResponse.keyspace:type_name -> topodata.Keyspace
	282, // 130: vtctldata.SetKeyspaceServedFromRequest.tablet_type:type_name -> topodata.TabletType
	272, // 131: vtctldata.SetKeyspaceServedFromResponse.keyspace:type_name -> topodata.Keyspace
	272, // 132: vtctldata.SetKeyspaceShardingInfoResponse.keyspace:type_name -> topodata.Keyspace
	276, // 133: vtctldata.SetShardIsPrimaryServingResponse.shard:type_name -> topodata.Shard
	282, // 134: vtctldata.SetShardTabletControlRequest.tablet_type:type_name -> topodata.TabletType
	276, // 135: vtctldata.SetShardTabletControlResponse.shard:type_name -> topodata.Shard
	274, // 136: vtctldata.SetWritableRequest.tablet_alias:type_name -> topodata.TabletAlias
	274, // 137: vtctldata.ShardReplicationAddRequest.tablet_alias:type_name -> topodata.TabletAlias
	295, // 138: vtctldata.ShardReplicationFixResponse.error:type_name -> topodata.ShardReplicationError
	255, // 139: vtctldata.ShardReplicationPositionsResponse.replication_statuses:type_name -> vtctldata.ShardReplicationPositionsResponse.ReplicationStatusesEntry
	256, // 140: vtctldata.ShardReplicationPositionsResponse.tablet_map:type_name -> vtctldata.ShardReplicationPositionsResponse.TabletMapEntry
	274, // 141: vtctldata.ShardReplicationRemoveRequest.tablet_alias:type_name -> topodata.TabletAlias
	274, // 142: vtctldata.SleepTabletRequest.tablet_alias:type_name -> topodata.TabletAlias
	275, // 143: vtctldata.SleepTabletRequest.duration:type_name -> vttime.Duration
	296, // 144: vtctldata.SourceShardAddRequest.key_range:type_name -> topodata.KeyRange
	276, // 145: vtctldata.SourceShardAddResponse.shard:type_name -> topodata.Shard
	276, // 146: vtctldata.SourceShardDeleteResponse.shard:type_name -> topodata.Shard
	274, // 147: vtctldata.StartReplicationRequest.tablet_alias:type_name -> topodata.TabletAlias
	274, // 148: vtctldata.StopReplicationRequest.tablet_alias:type_name -> topodata.TabletAlias
	274, // 149: vtctldata.TabletExternallyReparentedRequest.tablet:type_name -> topodata.TabletAlias
	274, // 150: vtctldata.TabletExternallyReparentedResponse.new_primary:type_name -> topodata.TabletAlias
	274, // 151: vtctldata.TabletExternallyReparentedResponse.old_primary:type_name -> topodata.TabletAlias
	277, // 152: vtctldata.UpdateCellInfoRequest.cell_info:type_name -> topodata.CellInfo
	277, // 153: vtctldata.UpdateCellInfoResponse.cell_info:type_name -> topodata.CellInfo
	297, // 154: vtctldata.UpdateCellsAliasRequest.cells_alias:type_name -> topodata.CellsAlias
	297, // 155: vtctldata.UpdateCellsAliasResponse.cells_alias:type_name -> topodata.CellsAlias
	257, // 156: vtctldata.ValidateResponse.results_by_keyspace:type_name -> vtctldata.ValidateResponse.ResultsByKeyspaceEntry
	258, // 157: vtctldata.ValidateKeyspaceResponse.results_by_shard:type_name -> vtctldata.ValidateKeyspaceResponse.ResultsByShardEntry
	259, // 158: vtctldata.ValidateSchemaKeyspaceResponse.results_by_shard:type_name -> vtctldata.ValidateSchemaKeyspaceResponse.ResultsByShardEntry
	260, // 159: vtctldata.ValidateVersionKeyspaceResponse.results_by_shard:type_name -> vtctldata.ValidateVersionKeyspaceResponse.ResultsByShardEntry
	261, // 160: vtctldata.ValidateVSchemaResponse.results_by_shard:type_name -> vtctldata.ValidateVSchemaResponse.ResultsByShardEntry
	282, // 161: vtctldata.VDiffCreateRequest.tablet_types:type_name -> topodata.TabletType
	271, // 162: vtctldata.VDiffCreateRequest.tablet_selection_preference:type_name -> tabletmanagerdata.TabletSelectionPreference
	275, // 163: vtctldata.VDiffCreateRequest.filtered_replication_wait_time:type_name -> vttime.Duration
	275, // 164: vtctldata.VDiffCreateRequest.wait_update_interval:type_name -> vttime.Duration
	262, // 165: vtctldata.VDiffShowResponse.tablet_responses:type_name -> vtctldata.VDiffShowResponse.TabletResponsesEntry
	263, // 166: vtctldata.WorkflowDeleteResponse.details:type_name -> vtctldata.WorkflowDeleteResponse.TabletInfo
	267, // 167: vtctldata.WorkflowStatusResponse.table_copy_state:type_name -> vtctldata.WorkflowStatusResponse.TableCopyStateEntry
	268, // 168: vtctldata.WorkflowStatusResponse.shard_streams:type_name -> vtctldata.WorkflowStatusResponse.ShardStreamsEntry
	282, // 169: vtctldata.WorkflowSwitchTrafficRequest.tablet_types:type_name -> topodata.TabletType
	275, // 170: vtctldata.WorkflowSwitchTrafficRequest.max_replication_lag_allowed:type_name -> vttime.Duration
	275, // 171: vtctldata.WorkflowSwitchTrafficRequest.timeout:type_name -> vttime.Duration
	298, // 172: vtctldata.WorkflowUpdateRequest.tablet_request:type_name -> tabletmanagerdata.UpdateVReplicationWorkflowRequest
	269, // 173: vtctldata.WorkflowUpdateResponse.details:type_name -> vtctldata.WorkflowUpdateResponse.TabletInfo
	...
	299, // 176: vtctldata.Workflow.ShardStream.tablet_controls:type_name -> topodata.Shard.TabletControl
	274, // 177: vtctldata.Workflow.Stream.tablet:type_name -> topodata.TabletAlias
	300, // 178: vtctldata.Workflow.Stream.binlog_source:type_name -> binlogdata.BinlogSource
	273, // 179: vtctldata.Workflow.Stream.transaction_timestamp:type_name -> vttime.Time
	273, // 180: vtctldata.Workflow.Stream.time_updated:type_name -> vttime.Time
	...
	273, // 183: vtctldata.Workflow.Stream.Log.created_at:type_name -> vttime.Time
	273, // 184: vtctldata.Workflow.Stream.Log.updated_at:type_name -> vttime.Time
	10,  // 185: vtctldata.FindAllShardsInKeyspaceResponse.ShardsEntry.value:type_name -> vtctldata.Shard
	297, // 186: vtctldata.GetCellsAliasesResponse.AliasesEntry.value:type_name -> topodata.CellsAlias
	249, // 187: vtctldata.GetSrvKeyspaceNamesResponse.NamesEntry.value:type_name -> vtctldata.GetSrvKeyspaceNamesResponse.NameList
	301, // 188: vtctldata.GetSrvKeyspacesResponse.SrvKeyspacesEntry.value:type_name -> topodata.SrvKeyspace
	294, // 189: vtctldata.GetSrvVSchemasResponse.SrvVSchemasEntry.value:type_name -> vschema.SrvVSchema
	274, // 190: vtctldata.MoveTablesCreateResponse.TabletInfo.tablet:type_name -> topodata.TabletAlias
	302, // 191: vtctldata.ShardReplicationPositionsResponse.ReplicationStatusesEntry.value:type_name -> replicationdata.Status
	283, // 192: vtctldata.ShardReplicationPositionsResponse.TabletMapEntry.value:type_name -> topodata.Tablet
	207, // 193: vtctldata.ValidateResponse.ResultsByKeyspaceEntry.value:type_name -> vtctldata.ValidateKeyspaceResponse
	211, // 194: vtctldata.ValidateKeyspaceResponse.ResultsByShardEntry.value:type_name -> vtctldata.ValidateShardResponse
	211, // 195: vtctldata.ValidateSchemaKeyspaceResponse.ResultsByShardEntry.value:type_name -> vtctldata.ValidateShardResponse
	211, // 196: vtctldata.ValidateVersionKeyspaceResponse.ResultsByShardEntry.value:type_name -> vtctldata.ValidateShardResponse
	211, // 197: vtctldata.ValidateVSchemaResponse.ResultsByShardEntry.value:type_name -> vtctldata.ValidateShardResponse
	303, // 198: vtctldata.VDiffShowResponse.TabletResponsesEntry.value:type_name -> tabletmanagerdata.VDiffResponse
	274, // 199: vtctldata.WorkflowDeleteResponse.TabletInfo.tablet:type_name -> topodata.TabletAlias
	274, // 200: vtctldata.WorkflowStatusResponse.ShardStreamState.tablet:type_name -> topodata.TabletAlias
	265, // 201: vtctldata.WorkflowStatusResponse.ShardStreams.streams:type_name -> vtctldata.WorkflowStatusResponse.ShardStreamState
	264, // 202: vtctldata.WorkflowStatusResponse.TableCopyStateEntry.value:type_name -> vtctldata.WorkflowStatusResponse.TableCopyState
	266, // 203: vtctldata.WorkflowStatusResponse.ShardStreamsEntry.value:type_name -> vtctldata.WorkflowStatusResponse.ShardStreams
	274, // 204: vtctldata.WorkflowUpdateResponse.TabletInfo.tablet:type_name -> topodata.TabletAlias
