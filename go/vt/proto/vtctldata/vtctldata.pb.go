...
var file_vtctldata_proto_depIdxs = []int32{
	...
	301, // 132: vtctldata.PlannedReparentShardResponse.promoted_primary:type_name -> topodata.TabletAlias
	297, // 133: vtctldata.PlannedReparentShardResponse.events:type_name -> logutil.Event
	301, // 134: vtctldata.RefreshStateRequest.tablet_alias:type_name -> topodata.TabletAlias
	301, // 135: vtctldata.ReloadSchemaRequest.tablet_alias:type_name -> topodata.TabletAlias
	297, // 136: vtctldata.ReloadSchemaKeyspaceResponse.events:type_name -> logutil.Event
	297, // 137: vtctldata.ReloadSchemaShardResponse.events:type_name -> logutil.Event
	301, // 138: vtctldata.ReparentTabletRequest.tablet:type_name -> topodata.TabletAlias
	301, // 139: vtctldata.ReparentTabletResponse.primary:type_name -> topodata.TabletAlias
	310, // 140: vtctldata.ReshardCreateRequest.tablet_types:type_name -> topodata.TabletType
	298, // 141: vtctldata.ReshardCreateRequest.tablet_selection_preference:type_name -> tabletmanagerdata.TabletSelectionPreference
	11,  // 142: vtctldata.ReshardCreateRequest.workflow_options:type_name -> vtctldata.WorkflowOptions
	301, // 143: vtctldata.RestoreFromBackupRequest.tablet_alias:type_name -> topodata.TabletAlias
	300, // 144: vtctldata.RestoreFromBackupRequest.backup_time:type_name -> vttime.Time
	300, // 145: vtctldata.RestoreFromBackupRequest.restore_to_timestamp:type_name -> vttime.Time
	301, // 146: vtctldata.RestoreFromBackupResponse.tablet_alias:type_name -> topodata.TabletAlias
	297, // 147: vtctldata.RestoreFromBackupResponse.event:type_name -> logutil.Event
	281, // 148: vtctldata.RetrySchemaMigrationResponse.rows_affected_by_shard:type_name -> vtctldata.RetrySchemaMigrationResponse.RowsAffectedByShardEntry
	301, // 149: vtctldata.RunHealthCheckRequest.tablet_alias:type_name -> topodata.TabletAlias
	299, // 150: vtctldata.SetKeyspaceDurabilityPolicyResponse.keyspace:type_name -> topodata.Keyspace
	299, // 151: vtctldata.SetKeyspaceShardingInfoResponse.keyspace:type_name -> topodata.Keyspace
	303, // 152: vtctldata.SetShardIsPrimaryServingResponse.shard:type_name -> topodata.Shard
	310, // 153: vtctldata.SetShardTabletControlRequest.tablet_type:type_name -> topodata.TabletType
	303, // 154: vtctldata.SetShardTabletControlResponse.shard:type_name -> topodata.Shard
	301, // 155: vtctldata.SetWritableRequest.tablet_alias:type_name -> topodata.TabletAlias
	301, // 156: vtctldata.ShardReplicationAddRequest.tablet_alias:type_name -> topodata.TabletAlias
	326, // 157: vtctldata.ShardReplicationFixResponse.error:type_name -> topodata.ShardReplicationError
	282, // 158: vtctldata.ShardReplicationPositionsResponse.replication_statuses:type_name -> vtctldata.ShardReplicationPositionsResponse.ReplicationStatusesEntry
	283, // 159: vtctldata.ShardReplicationPositionsResponse.tablet_map:type_name -> vtctldata.ShardReplicationPositionsResponse.TabletMapEntry
	301, // 160: vtctldata.ShardReplicationRemoveRequest.tablet_alias:type_name -> topodata.TabletAlias
	301, // 161: vtctldata.SleepTabletRequest.tablet_alias:type_name -> topodata.TabletAlias
	302, // 162: vtctldata.SleepTabletRequest.duration:type_name -> vttime.Duration
	327, // 163: vtctldata.SourceShardAddRequest.key_range:type_name -> topodata.KeyRange
	303, // 164: vtctldata.SourceShardAddResponse.shard:type_name -> topodata.Shard
	303, // 165: vtctldata.SourceShardDeleteResponse.shard:type_name -> topodata.Shard
	301, // 166: vtctldata.StartReplicationRequest.tablet_alias:type_name -> topodata.TabletAlias
	301, // 167: vtctldata.StopReplicationRequest.tablet_alias:type_name -> topodata.TabletAlias
	301, // 168: vtctldata.TabletExternallyReparentedRequest.tablet:type_name -> topodata.TabletAlias
	301, // 169: vtctldata.TabletExternallyReparentedResponse.new_primary:type_name -> topodata.TabletAlias
	301, // 170: vtctldata.TabletExternallyReparentedResponse.old_primary:type_name -> topodata.TabletAlias
	304, // 171: vtctldata.UpdateCellInfoRequest.cell_info:type_name -> topodata.CellInfo
	304, // 172: vtctldata.UpdateCellInfoResponse.cell_info:type_name -> topodata.CellInfo
	328, // 173: vtctldata.UpdateCellsAliasRequest.cells_alias:type_name -> topodata.CellsAlias
	328, // 174: vtctldata.UpdateCellsAliasResponse.cells_alias:type_name -> topodata.CellsAlias
	284, // 175: vtctldata.ValidateResponse.results_by_keyspace:type_name -> vtctldata.ValidateResponse.ResultsByKeyspaceEntry
	285, // 176: vtctldata.ValidateKeyspaceResponse.results_by_shard:type_name -> vtctldata.ValidateKeyspaceResponse.ResultsByShardEntry
	286, // 177: vtctldata.ValidateSchemaKeyspaceResponse.results_by_shard:type_name -> vtctldata.ValidateSchemaKeyspaceResponse.ResultsByShardEntry
	287, // 178: vtctldata.ValidateVersionKeyspaceResponse.results_by_shard:type_name -> vtctldata.ValidateVersionKeyspaceResponse.ResultsByShardEntry
	288, // 179: vtctldata.ValidateVSchemaResponse.results_by_shard:type_name -> vtctldata.ValidateVSchemaResponse.ResultsByShardEntry
	310, // 180: vtctldata.VDiffCreateRequest.tablet_types:type_name -> topodata.TabletType
	298, // 181: vtctldata.VDiffCreateRequest.tablet_selection_preference:type_name -> tabletmanagerdata.TabletSelectionPreference
	302, // 182: vtctldata.VDiffCreateRequest.filtered_replication_wait_time:type_name -> vttime.Duration
	302, // 183: vtctldata.VDiffCreateRequest.wait_update_interval:type_name -> vttime.Duration
	302, // 184: vtctldata.VDiffCreateRequest.max_diff_duration:type_name -> vttime.Duration
	289, // 185: vtctldata.VDiffShowResponse.tablet_responses:type_name -> vtctldata.VDiffShowResponse.TabletResponsesEntry
	290, // 186: vtctldata.WorkflowDeleteResponse.details:type_name -> vtctldata.WorkflowDeleteResponse.TabletInfo
	294, // 187: vtctldata.WorkflowStatusResponse.table_copy_state:type_name -> vtctldata.WorkflowStatusResponse.TableCopyStateEntry
	295, // 188: vtctldata.WorkflowStatusResponse.shard_streams:type_name -> vtctldata.WorkflowStatusResponse.ShardStreamsEntry
	310, // 189: vtctldata.WorkflowSwitchTrafficRequest.tablet_types:type_name -> topodata.TabletType
	302, // 190: vtctldata.WorkflowSwitchTrafficRequest.max_replication_lag_allowed:type_name -> vttime.Duration
	302, // 191: vtctldata.WorkflowSwitchTrafficRequest.timeout:type_name -> vttime.Duration
	329, // 192: vtctldata.WorkflowUpdateRequest.tablet_request:type_name -> tabletmanagerdata.UpdateVReplicationWorkflowRequest
	296, // 193: vtctldata.WorkflowUpdateResponse.details:type_name -> vtctldata.WorkflowUpdateResponse.TabletInfo
	330, // 194: vtctldata.GetMirrorRulesResponse.mirror_rules:type_name -> vschema.MirrorRules
	310, // 195: vtctldata.WorkflowMirrorTrafficRequest.tablet_types:type_name -> topodata.TabletType
	260, // 196: vtctldata.Workflow.ShardStreamsEntry.value:type_name -> vtctldata.Workflow.ShardStream
	261, // 197: vtctldata.Workflow.ShardStream.streams:type_name -> vtctldata.Workflow.Stream
	331, // 198: vtctldata.Workflow.ShardStream.tablet_controls:type_name -> topodata.Shard.TabletControl
	301, // 199: vtctldata.Workflow.Stream.tablet:type_name -> topodata.TabletAlias
	332, // 200: vtctldata.Workflow.Stream.binlog_source:type_name -> binlogdata.BinlogSource
	300, // 201: vtctldata.Workflow.Stream.transaction_timestamp:type_name -> vttime.Time
	300, // 202: vtctldata.Workflow.Stream.time_updated:type_name -> vttime.Time
	262, // 203: vtctldata.Workflow.Stream.copy_states:type_name -> vtctldata.Workflow.Stream.CopyState
	263, // 204: vtctldata.Workflow.Stream.logs:type_name -> vtctldata.Workflow.Stream.Log
	264, // 205: vtctldata.Workflow.Stream.throttler_status:type_name -> vtctldata.Workflow.Stream.ThrottlerStatus
	310, // 206: vtctldata.Workflow.Stream.tablet_types:type_name -> topodata.TabletType
	298, // 207: vtctldata.Workflow.Stream.tablet_selection_preference:type_name -> tabletmanagerdata.TabletSelectionPreference
	300, // 208: vtctldata.Workflow.Stream.Log.created_at:type_name -> vttime.Time
	300, // 209: vtctldata.Workflow.Stream.Log.updated_at:type_name -> vttime.Time
	300, // 210: vtctldata.Workflow.Stream.ThrottlerStatus.time_throttled:type_name -> vttime.Time
	267, // 211: vtctldata.ApplyVSchemaResponse.UnknownVindexParamsEntry.value:type_name -> vtctldata.ApplyVSchemaResponse.ParamList
	10,  // 212: vtctldata.FindAllShardsInKeyspaceResponse.ShardsEntry.value:type_name -> vtctldata.Shard
	328, // 213: vtctldata.GetCellsAliasesResponse.AliasesEntry.value:type_name -> topodata.CellsAlias
	333, // 214: vtctldata.GetShardReplicationResponse.ShardReplicationByCellEntry.value:type_name -> topodata.ShardReplication
	276, // 215: vtctldata.GetSrvKeyspaceNamesResponse.NamesEntry.value:type_name -> vtctldata.GetSrvKeyspaceNamesResponse.NameList
	334, // 216: vtctldata.GetSrvKeyspacesResponse.SrvKeyspacesEntry.value:type_name -> topodata.SrvKeyspace
	322, // 217: vtctldata.GetSrvVSchemasResponse.SrvVSchemasEntry.value:type_name -> vschema.SrvVSchema
	301, // 218: vtctldata.MoveTablesCreateResponse.TabletInfo.tablet:type_name -> topodata.TabletAlias
	335, // 219: vtctldata.ShardReplicationPositionsResponse.ReplicationStatusesEntry.value:type_name -> replicationdata.Status
	311, // 220: vtctldata.ShardReplicationPositionsResponse.TabletMapEntry.value:type_name -> topodata.Tablet
	224, // 221: vtctldata.ValidateResponse.ResultsByKeyspaceEntry.value:type_name -> vtctldata.ValidateKeyspaceResponse
	228, // 222: vtctldata.ValidateKeyspaceResponse.ResultsByShardEntry.value:type_name -> vtctldata.ValidateShardResponse
	228, // 223: vtctldata.ValidateSchemaKeyspaceResponse.ResultsByShardEntry.value:type_name -> vtctldata.ValidateShardResponse
	228, // 224: vtctldata.ValidateVersionKeyspaceResponse.ResultsByShardEntry.value:type_name -> vtctldata.ValidateShardResponse
	228, // 225: vtctldata.ValidateVSchemaResponse.ResultsByShardEntry.value:type_name -> vtctldata.ValidateShardResponse
	336, // 226: vtctldata.VDiffShowResponse.TabletResponsesEntry.value:type_name -> tabletmanagerdata.VDiffResponse
	301, // 227: vtctldata.WorkflowDeleteResponse.TabletInfo.tablet:type_name -> topodata.TabletAlias
	301, // 228: vtctldata.WorkflowStatusResponse.ShardStreamState.tablet:type_name -> topodata.TabletAlias
	292, // 229: vtctldata.WorkflowStatusResponse.ShardStreams.streams:type_name -> vtctldata.WorkflowStatusResponse.ShardStreamState
	291, // 230: vtctldata.WorkflowStatusResponse.TableCopyStateEntry.value:type_name -> vtctldata.WorkflowStatusResponse.TableCopyState
	293, // 231: vtctldata.WorkflowStatusResponse.ShardStreamsEntry.value:type_name -> vtctldata.WorkflowStatusResponse.ShardStreams
	301, // 232: vtctldata.WorkflowUpdateResponse.TabletInfo.tablet:type_name -> topodata.TabletAlias
