...
var file_vtctldata_proto_depIdxs = []int32{
	...
	326, // 155: vtctldata.ShardReplicationFixResponse.error:type_name -> topodata.ShardReplicationError
	...
	327, // 161: vtctldata.SourceShardAddRequest.key_range:type_name -> topodata.KeyRange
	...
	328, // 171: vtctldata.UpdateCellsAliasRequest.cells_alias:type_name -> topodata.CellsAlias
	328, // 172: vtctldata.UpdateCellsAliasResponse.cells_alias:type_name -> topodata.CellsAlias
	...
	329, // 190: vtctldata.WorkflowUpdateRequest.tablet_request:type_name -> tabletmanagerdata.UpdateVReplicationWorkflowRequest
	296, // 191: vtctldata.WorkflowUpdateResponse.details:type_name -> vtctldata.WorkflowUpdateResponse.TabletInfo
	330, // 192: vtctldata.GetMirrorRulesResponse.mirror_rules:type_name -> vschema.MirrorRules
	310, // 193: vtctldata.WorkflowMirrorTrafficRequest.tablet_types:type_name -> topodata.TabletType
	260, // 194: vtctldata.Workflow.ShardStreamsEntry.value:type_name -> vtctldata.Workflow.ShardStream
	261, // 195: vtctldata.Workflow.ShardStream.streams:type_name -> vtctldata.Workflow.Stream
	331, // 196: vtctldata.Workflow.ShardStream.tablet_controls:type_name -> topodata.Shard.TabletControl
	301, // 197: vtctldata.Workflow.Stream.tablet:type_name -> topodata.TabletAlias
	332, // 198: vtctldata.Workflow.Stream.binlog_source:type_name -> binlogdata.BinlogSource
	300, // 199: vtctldata.Workflow.Stream.transaction_timestamp:type_name -> vttime.Time
	300, // 200: vtctldata.Workflow.Stream.time_updated:type_name -> vttime.Time
	262, // 201: vtctldata.Workflow.Stream.copy_states:type_name -> vtctldata.Workflow.Stream.CopyState
	263, // 202: vtctldata.Workflow.Stream.logs:type_name -> vtctldata.Workflow.Stream.Log
	264, // 203: vtctldata.Workflow.Stream.throttler_status:type_name -> vtctldata.Workflow.Stream.ThrottlerStatus
	310, // 204: vtctldata.Workflow.Stream.tablet_types:type_name -> topodata.TabletType
	298, // 205: vtctldata.Workflow.Stream.tablet_selection_preference:type_name -> tabletmanagerdata.TabletSelectionPreference
	300, // 206: vtctldata.Workflow.Stream.Log.created_at:type_name -> vttime.Time
	300, // 207: vtctldata.Workflow.Stream.Log.updated_at:type_name -> vttime.Time
	300, // 208: vtctldata.Workflow.Stream.ThrottlerStatus.time_throttled:type_name -> vttime.Time
	267, // 209: vtctldata.ApplyVSchemaResponse.UnknownVindexParamsEntry.value:type_name -> vtctldata.ApplyVSchemaResponse.ParamList
	10,  // 210: vtctldata.FindAllShardsInKeyspaceResponse.ShardsEntry.value:type_name -> vtctldata.Shard
	328, // 211: vtctldata.GetCellsAliasesResponse.AliasesEntry.value:type_name -> topodata.CellsAlias
	333, // 212: vtctldata.GetShardReplicationResponse.ShardReplicationByCellEntry.value:type_name -> topodata.ShardReplication
	276, // 213: vtctldata.GetSrvKeyspaceNamesResponse.NamesEntry.value:type_name -> vtctldata.GetSrvKeyspaceNamesResponse.NameList
	334, // 214: vtctldata.GetSrvKeyspacesResponse.SrvKeyspacesEntry.value:type_name -> topodata.SrvKeyspace
	322, // 215: vtctldata.GetSrvVSchemasResponse.SrvVSchemasEntry.value:type_name -> vschema.SrvVSchema
	301, // 216: vtctldata.MoveTablesCreateResponse.TabletInfo.tablet:type_name -> topodata.TabletAlias
	335, // 217: vtctldata.ShardReplicationPositionsResponse.ReplicationStatusesEntry.value:type_name -> replicationdata.Status
	311, // 218: vtctldata.ShardReplicationPositionsResponse.TabletMapEntry.value:type_name -> topodata.Tablet
	224, // 219: vtctldata.ValidateResponse.ResultsByKeyspaceEntry.value:type_name -> vtctldata.ValidateKeyspaceResponse
	228, // 220: vtctldata.ValidateKeyspaceResponse.ResultsByShardEntry.value:type_name -> vtctldata.ValidateShardResponse
	228, // 221: vtctldata.ValidateSchemaKeyspaceResponse.ResultsByShardEntry.value:type_name -> vtctldata.ValidateShardResponse
	228, // 222: vtctldata.ValidateVersionKeyspaceResponse.ResultsByShardEntry.value:type_name -> vtctldata.ValidateShardResponse
	228, // 223: vtctldata.ValidateVSchemaResponse.ResultsByShardEntry.value:type_name -> vtctldata.ValidateShardResponse
	336, // 224: vtctldata.VDiffShowResponse.TabletResponsesEntry.value:type_name -> tabletmanagerdata.VDiffResponse
	301, // 225: vtctldata.WorkflowDeleteResponse.TabletInfo.tablet:type_name -> topodata.TabletAlias
	301, // 226: vtctldata.WorkflowStatusResponse.ShardStreamState.tablet:type_name -> topodata.TabletAlias
	292, // 227: vtctldata.WorkflowStatusResponse.ShardStreams.streams:type_name -> vtctldata.WorkflowStatusResponse.ShardStreamState
	291, // 228: vtctldata.WorkflowStatusResponse.TableCopyStateEntry.value:type_name -> vtctldata.WorkflowStatusResponse.TableCopyState
	293, // 229: vtctldata.WorkflowStatusResponse.ShardStreamsEntry.value:type_name -> vtctldata.WorkflowStatusResponse.ShardStreams
	301, // 230: vtctldata.WorkflowUpdateResponse.TabletInfo.tablet:type_name -> topodata.TabletAlias
