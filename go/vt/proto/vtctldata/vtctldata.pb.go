...
var file_vtctldata_proto_rawDesc = []byte{
	...
	0x65, 0x22, 0x86, 0x03, 0x0a, 0x12, 0x41, 0x70, 0x70, 0x6c, 0x79, 0x53, 0x63, 0x68, 0x65, 0x6d,
	...
	0x70, 0x61, 0x63, 0x65, 0x12, 0x3a, 0x0a, 0x19, 0x61, 0x6c, 0x6c, 0x6f, 0x77, 0x5f, 0x6c, 0x6f,
	0x6e, 0x67, 0x5f, 0x75, 0x6e, 0x61, 0x76, 0x61, 0x69, 0x6c, 0x61, 0x62, 0x69, 0x6c, 0x69, 0x74,
	0x79, 0x18, 0x02, 0x20, 0x01, 0x28, 0x08, 0x52, 0x17, 0x61, 0x6c, 0x6c, 0x6f, 0x77, 0x4c, 0x6f,
	0x6e, 0x67, 0x55, 0x6e, 0x61, 0x76, 0x61, 0x69, 0x6c, 0x61, 0x62, 0x69, 0x6c, 0x69, 0x74, 0x79,
	...
	0x65, 0x52, 0x07, 0x76, 0x53, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x22, 0xc2, 0x01, 0x0a, 0x0d, 0x42,
	...
	0x66, 0x6c, 0x6f, 0x77, 0x22, 0x49, 0x0a, 0x14, 0x47, 0x65, 0x74, 0x57, 0x6f, 0x72, 0x6b, 0x66,
	...
	0x73, 0x22, 0xe7, 0x05, 0x0a, 0x17, 0x4d, 0x6f, 0x76, 0x65, 0x54, 0x61, 0x62, 0x6c, 0x65, 0x73,
	...
	0x6c, 0x75, 0x64, 0x65, 0x54, 0x61, 0x62, 0x6c, 0x65, 0x73, 0x12, 0x29, 0x0a, 0x10, 0x65, 0x78,
	0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c, 0x5f, 0x63, 0x6c, 0x75, 0x73, 0x74, 0x65, 0x72, 0x18, 0x0b,
	...
	0x50, 0x0a, 0x1a, 0x4d, 0x6f, 0x76, 0x65, 0x54, 0x61, 0x62, 0x6c, 0x65, 0x73, 0x43, 0x6f, 0x6d,
	...
	0x73, 0x75, 0x6d, 0x6d, 0x61, 0x72, 0x79, 0x12, 0x18, 0x0a, 0x07, 0x64, 0x65, 0x74, 0x61, 0x69,
	0x6c, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x09, 0x52, 0x07, 0x64, 0x65, 0x74, 0x61, 0x69, 0x6c,
	...
	0x22, 0xc2, 0x01, 0x0a, 0x18, 0x52, 0x65, 0x73, 0x74, 0x6f, 0x72, 0x65, 0x46, 0x72, 0x6f, 0x6d,
	...
	0x72, 0x79, 0x52, 0x75, 0x6e, 0x22, 0xad, 0x01, 0x0a, 0x19, 0x52, 0x65, 0x73, 0x74, 0x6f, 0x72,
	...
	0x18, 0x09, 0x20, 0x01, 0x28, 0x08, 0x52, 0x06, 0x64, 0x72, 0x79, 0x52, 0x75, 0x6e, 0x22, 0x39,
	...
	0x52, 0x07, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x73, 0x22, 0x90, 0x01, 0x0a, 0x15, 0x57, 0x6f,
...
var file_vtctldata_proto_goTypes = []interface{}{
	...
	(*vschema.SrvVSchema)(nil),                                  // 242: vschema.SrvVSchema
	(*topodata.ShardReplicationError)(nil),                      // 243: topodata.ShardReplicationError
	(*topodata.KeyRange)(nil),                                   // 244: topodata.KeyRange
	(*topodata.CellsAlias)(nil),                                 // 245: topodata.CellsAlias
	(*tabletmanagerdata.UpdateVReplicationWorkflowRequest)(nil), // 246: tabletmanagerdata.UpdateVReplicationWorkflowRequest
	(*topodata.Shard_TabletControl)(nil),                        // 247: topodata.Shard.TabletControl
	(*binlogdata.BinlogSource)(nil),                             // 248: binlogdata.BinlogSource
	(*topodata.SrvKeyspace)(nil),                                // 249: topodata.SrvKeyspace
	(*replicationdata.Status)(nil),                              // 250: replicationdata.Status
}
var file_vtctldata_proto_depIdxs = []int32{
	...
	242, // 61: vtctldata.GetSrvVSchemaResponse.srv_v_schema:type_name -> vschema.SrvVSchema
	203, // 62: vtctldata.GetSrvVSchemasResponse.srv_v_schemas:type_name -> vtctldata.GetSrvVSchemasResponse.SrvVSchemasEntry
	230, // 63: vtctldata.GetTabletRequest.tablet_alias:type_name -> topodata.TabletAlias
	231, // 64: vtctldata.GetTabletResponse.tablet:type_name -> topodata.Tablet
	230, // 65: vtctldata.GetTabletsRequest.tablet_aliases:type_name -> topodata.TabletAlias
	220, // 66: vtctldata.GetTabletsRequest.tablet_type:type_name -> topodata.TabletType
	...
	230, // 69: vtctldata.GetVersionRequest.tablet_alias:type_name -> topodata.TabletAlias
	229, // 70: vtctldata.GetVSchemaResponse.v_schema:type_name -> vschema.Keyspace
	7,   // 71: vtctldata.GetWorkflowsResponse.workflows:type_name -> vtctldata.Workflow
	230, // 72: vtctldata.InitShardPrimaryRequest.primary_elect_tablet_alias:type_name -> topodata.TabletAlias
	227, // 73: vtctldata.InitShardPrimaryRequest.wait_replicas_timeout:type_name -> vttime.Duration
	219, // 74: vtctldata.InitShardPrimaryResponse.events:type_name -> logutil.Event
	220, // 75: vtctldata.MoveTablesCreateRequest.tablet_types:type_name -> topodata.TabletType
	221, // 76: vtctldata.MoveTablesCreateRequest.tablet_selection_preference:type_name -> tabletmanagerdata.TabletSelectionPreference
	204, // 77: vtctldata.MoveTablesCreateResponse.details:type_name -> vtctldata.MoveTablesCreateResponse.TabletInfo
	230, // 78: vtctldata.PingTabletRequest.tablet_alias:type_name -> topodata.TabletAlias
	230, // 79: vtctldata.PlannedReparentShardRequest.new_primary:type_name -> topodata.TabletAlias
	230, // 80: vtctldata.PlannedReparentShardRequest.avoid_primary:type_name -> topodata.TabletAlias
	227, // 81: vtctldata.PlannedReparentShardRequest.wait_replicas_timeout:type_name -> vttime.Duration
	230, // 82: vtctldata.PlannedReparentShardResponse.promoted_primary:type_name -> topodata.TabletAlias
	219, // 83: vtctldata.PlannedReparentShardResponse.events:type_name -> logutil.Event
	230, // 84: vtctldata.RefreshStateRequest.tablet_alias:type_name -> topodata.TabletAlias
	230, // 85: vtctldata.ReloadSchemaRequest.tablet_alias:type_name -> topodata.TabletAlias
	...
	230, // 88: vtctldata.ReparentTabletRequest.tablet:type_name -> topodata.TabletAlias
	230, // 89: vtctldata.ReparentTabletResponse.primary:type_name -> topodata.TabletAlias
	230, // 90: vtctldata.RestoreFromBackupRequest.tablet_alias:type_name -> topodata.TabletAlias
	234, // 91: vtctldata.RestoreFromBackupRequest.backup_time:type_name -> vttime.Time
	230, // 92: vtctldata.RestoreFromBackupResponse.tablet_alias:type_name -> topodata.TabletAlias
	219, // 93: vtctldata.RestoreFromBackupResponse.event:type_name -> logutil.Event
	230, // 94: vtctldata.RunHealthCheckRequest.tablet_alias:type_name -> topodata.TabletAlias
	222, // 95: vtctldata.SetKeyspaceDurabilityPolicyResponse.keyspace:type_name -> topodata.Keyspace
	220, // 96: vtctldata.SetKeyspaceServedFromRequest.tablet_type:type_name -> topodata.TabletType
	222, // 97: vtctldata.SetKeyspaceServedFromResponse.keyspace:type_name -> topodata.Keyspace
	222, // 98: vtctldata.SetKeyspaceShardingInfoResponse.keyspace:type_name -> topodata.Keyspace
	223, // 99: vtctldata.SetShardIsPrimaryServingResponse.shard:type_name -> topodata.Shard
	220, // 100: vtctldata.SetShardTabletControlRequest.tablet_type:type_name -> topodata.TabletType
	223, // 101: vtctldata.SetShardTabletControlResponse.shard:type_name -> topodata.Shard
	230, // 102: vtctldata.SetWritableRequest.tablet_alias:type_name -> topodata.TabletAlias
	230, // 103: vtctldata.ShardReplicationAddRequest.tablet_alias:type_name -> topodata.TabletAlias
	243, // 104: vtctldata.ShardReplicationFixResponse.error:type_name -> topodata.ShardReplicationError
	...
	230, // 107: vtctldata.ShardReplicationRemoveRequest.tablet_alias:type_name -> topodata.TabletAlias
	230, // 108: vtctldata.SleepTabletRequest.tablet_alias:type_name -> topodata.TabletAlias
	227, // 109: vtctldata.SleepTabletRequest.duration:type_name -> vttime.Duration
	244, // 110: vtctldata.SourceShardAddRequest.key_range:type_name -> topodata.KeyRange
	223, // 111: vtctldata.SourceShardAddResponse.shard:type_name -> topodata.Shard
	223, // 112: vtctldata.SourceShardDeleteResponse.shard:type_name -> topodata.Shard
	230, // 113: vtctldata.StartReplicationRequest.tablet_alias:type_name -> topodata.TabletAlias
	230, // 114: vtctldata.StopReplicationRequest.tablet_alias:type_name -> topodata.TabletAlias
	230, // 115: vtctldata.TabletExternallyReparentedRequest.tablet:type_name -> topodata.TabletAlias
	230, // 116: vtctldata.TabletExternallyReparentedResponse.new_primary:type_name -> topodata.TabletAlias
	230, // 117: vtctldata.TabletExternallyReparentedResponse.old_primary:type_name -> topodata.TabletAlias
	224, // 118: vtctldata.UpdateCellInfoRequest.cell_info:type_name -> topodata.CellInfo
	224, // 119: vtctldata.UpdateCellInfoResponse.cell_info:type_name -> topodata.CellInfo
	245, // 120: vtctldata.UpdateCellsAliasRequest.cells_alias:type_name -> topodata.CellsAlias
	245, // 121: vtctldata.UpdateCellsAliasResponse.cells_alias:type_name -> topodata.CellsAlias
	...
	220, // 130: vtctldata.WorkflowSwitchTrafficRequest.tablet_types:type_name -> topodata.TabletType
	227, // 131: vtctldata.WorkflowSwitchTrafficRequest.max_replication_lag_allowed:type_name -> vttime.Duration
	227, // 132: vtctldata.WorkflowSwitchTrafficRequest.timeout:type_name -> vttime.Duration
	246, // 133: vtctldata.WorkflowUpdateRequest.tablet_request:type_name -> tabletmanagerdata.UpdateVReplicationWorkflowRequest
	...
	247, // 137: vtctldata.Workflow.ShardStream.tablet_controls:type_name -> topodata.Shard.TabletControl
	230, // 138: vtctldata.Workflow.Stream.tablet:type_name -> topodata.TabletAlias
	248, // 139: vtctldata.Workflow.Stream.binlog_source:type_name -> binlogdata.BinlogSource
	...
	245, // 147: vtctldata.GetCellsAliasesResponse.AliasesEntry.value:type_name -> topodata.CellsAlias
	201, // 148: vtctldata.GetSrvKeyspaceNamesResponse.NamesEntry.value:type_name -> vtctldata.GetSrvKeyspaceNamesResponse.NameList
	249, // 149: vtctldata.GetSrvKeyspacesResponse.SrvKeyspacesEntry.value:type_name -> topodata.SrvKeyspace
	242, // 150: vtctldata.GetSrvVSchemasResponse.SrvVSchemasEntry.value:type_name -> vschema.SrvVSchema
	230, // 151: vtctldata.MoveTablesCreateResponse.TabletInfo.tablet:type_name -> topodata.TabletAlias
	250, // 152: vtctldata.ShardReplicationPositionsResponse.ReplicationStatusesEntry.value:type_name -> replicationdata.Status
	...
	230, // 159: vtctldata.WorkflowDeleteResponse.TabletInfo.tablet:type_name -> topodata.TabletAlias
	230, // 160: vtctldata.WorkflowStatusResponse.ShardStreamState.tablet:type_name -> topodata.TabletAlias
	...
	230, // 164: vtctldata.WorkflowUpdateResponse.TabletInfo.tablet:type_name -> topodata.TabletAlias
