...
var file_vtctldata_proto_rawDesc = []byte{
	...
	0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0xca, 0x06, 0x0a, 0x12,
	...
	0x6d, 0x70, 0x6c, 0x65, 0x52, 0x6f, 0x77, 0x73, 0x22, 0x29, 0x0a, 0x13, 0x56, 0x44, 0x69, 0x66,
...
var file_vtctldata_proto_depIdxs = []int32{
	...
	278, // 113: vtctldata.PlannedReparentShardResponse.promoted_primary:type_name -> topodata.TabletAlias
	274, // 114: vtctldata.PlannedReparentShardResponse.events:type_name -> logutil.Event
	278, // 115: vtctldata.RefreshStateRequest.tablet_alias:type_name -> topodata.TabletAlias
	278, // 116: vtctldata.ReloadSchemaRequest.tablet_alias:type_name -> topodata.TabletAlias
	274, // 117: vtctldata.ReloadSchemaKeyspaceResponse.events:type_name -> logutil.Event
	274, // 118: vtctldata.ReloadSchemaShardResponse.events:type_name -> logutil.Event
	278, // 119: vtctldata.ReparentTabletRequest.tablet:type_name -> topodata.TabletAlias
	278, // 120: vtctldata.ReparentTabletResponse.primary:type_name -> topodata.TabletAlias
	286, // 121: vtctldata.ReshardCreateRequest.tablet_types:type_name -> topodata.TabletType
	275, // 122: vtctldata.ReshardCreateRequest.tablet_selection_preference:type_name -> tabletmanagerdata.TabletSelectionPreference
	278, // 123: vtctldata.RestoreFromBackupRequest.tablet_alias:type_name -> topodata.TabletAlias
	277, // 124: vtctldata.RestoreFromBackupRequest.backup_time:type_name -> vttime.Time
	277, // 125: vtctldata.RestoreFromBackupRequest.restore_to_timestamp:type_name -> vttime.Time
	278, // 126: vtctldata.RestoreFromBackupResponse.tablet_alias:type_name -> topodata.TabletAlias
	274, // 127: vtctldata.RestoreFromBackupResponse.event:type_name -> logutil.Event
	258, // 128: vtctldata.RetrySchemaMigrationResponse.rows_affected_by_shard:type_name -> vtctldata.RetrySchemaMigrationResponse.RowsAffectedByShardEntry
	278, // 129: vtctldata.RunHealthCheckRequest.tablet_alias:type_name -> topodata.TabletAlias
	276, // 130: vtctldata.SetKeyspaceDurabilityPolicyResponse.keyspace:type_name -> topodata.Keyspace
	286, // 131: vtctldata.SetKeyspaceServedFromRequest.tablet_type:type_name -> topodata.TabletType
	276, // 132: vtctldata.SetKeyspaceServedFromResponse.keyspace:type_name -> topodata.Keyspace
	276, // 133: vtctldata.SetKeyspaceShardingInfoResponse.keyspace:type_name -> topodata.Keyspace
	280, // 134: vtctldata.SetShardIsPrimaryServingResponse.shard:type_name -> topodata.Shard
	286, // 135: vtctldata.SetShardTabletControlRequest.tablet_type:type_name -> topodata.TabletType
	280, // 136: vtctldata.SetShardTabletControlResponse.shard:type_name -> topodata.Shard
	278, // 137: vtctldata.SetWritableRequest.tablet_alias:type_name -> topodata.TabletAlias
	278, // 138: vtctldata.ShardReplicationAddRequest.tablet_alias:type_name -> topodata.TabletAlias
	299, // 139: vtctldata.ShardReplicationFixResponse.error:type_name -> topodata.ShardReplicationError
	259, // 140: vtctldata.ShardReplicationPositionsResponse.replication_statuses:type_name -> vtctldata.ShardReplicationPositionsResponse.ReplicationStatusesEntry
	260, // 141: vtctldata.ShardReplicationPositionsResponse.tablet_map:type_name -> vtctldata.ShardReplicationPositionsResponse.TabletMapEntry
	278, // 142: vtctldata.ShardReplicationRemoveRequest.tablet_alias:type_name -> topodata.TabletAlias
	278, // 143: vtctldata.SleepTabletRequest.tablet_alias:type_name -> topodata.TabletAlias
	279, // 144: vtctldata.SleepTabletRequest.duration:type_name -> vttime.Duration
	300, // 145: vtctldata.SourceShardAddRequest.key_range:type_name -> topodata.KeyRange
	280, // 146: vtctldata.SourceShardAddResponse.shard:type_name -> topodata.Shard
	280, // 147: vtctldata.SourceShardDeleteResponse.shard:type_name -> topodata.Shard
	278, // 148: vtctldata.StartReplicationRequest.tablet_alias:type_name -> topodata.TabletAlias
	278, // 149: vtctldata.StopReplicationRequest.tablet_alias:type_name -> topodata.TabletAlias
	278, // 150: vtctldata.TabletExternallyReparentedRequest.tablet:type_name -> topodata.TabletAlias
	278, // 151: vtctldata.TabletExternallyReparentedResponse.new_primary:type_name -> topodata.TabletAlias
	278, // 152: vtctldata.TabletExternallyReparentedResponse.old_primary:type_name -> topodata.TabletAlias
	281, // 153: vtctldata.UpdateCellInfoRequest.cell_info:type_name -> topodata.CellInfo
	281, // 154: vtctldata.UpdateCellInfoResponse.cell_info:type_name -> topodata.CellInfo
	301, // 155: vtctldata.UpdateCellsAliasRequest.cells_alias:type_name -> topodata.CellsAlias
	301, // 156: vtctldata.UpdateCellsAliasResponse.cells_alias:type_name -> topodata.CellsAlias
	261, // 157: vtctldata.ValidateResponse.results_by_keyspace:type_name -> vtctldata.ValidateResponse.ResultsByKeyspaceEntry
	262, // 158: vtctldata.ValidateKeyspaceResponse.results_by_shard:type_name -> vtctldata.ValidateKeyspaceResponse.ResultsByShardEntry
	263, // 159: vtctldata.ValidateSchemaKeyspaceResponse.results_by_shard:type_name -> vtctldata.ValidateSchemaKeyspaceResponse.ResultsByShardEntry
	264, // 160: vtctldata.ValidateVersionKeyspaceResponse.results_by_shard:type_name -> vtctldata.ValidateVersionKeyspaceResponse.ResultsByShardEntry
	265, // 161: vtctldata.ValidateVSchemaResponse.results_by_shard:type_name -> vtctldata.ValidateVSchemaResponse.ResultsByShardEntry
	286, // 162: vtctldata.VDiffCreateRequest.tablet_types:type_name -> topodata.TabletType
	275, // 163: vtctldata.VDiffCreateRequest.tablet_selection_preference:type_name -> tabletmanagerdata.TabletSelectionPreference
	279, // 164: vtctldata.VDiffCreateRequest.filtered_replication_wait_time:type_name -> vttime.Duration
	279, // 165: vtctldata.VDiffCreateRequest.wait_update_interval:type_name -> vttime.Duration
	...
	302, // 173: vtctldata.WorkflowUpdateRequest.tablet_request:type_name -> tabletmanagerdata.UpdateVReplicationWorkflowRequest
	273, // 174: vtctldata.WorkflowUpdateResponse.details:type_name -> vtctldata.WorkflowUpdateResponse.TabletInfo
	240, // 175: vtctldata.Workflow.ShardStreamsEntry.value:type_name -> vtctldata.Workflow.ShardStream
	241, // 176: vtctldata.Workflow.ShardStream.streams:type_name -> vtctldata.Workflow.Stream
	303, // 177: vtctldata.Workflow.ShardStream.tablet_controls:type_name -> topodata.Shard.TabletControl
	278, // 178: vtctldata.Workflow.Stream.tablet:type_name -> topodata.TabletAlias
	304, // 179: vtctldata.Workflow.Stream.binlog_source:type_name -> binlogdata.BinlogSource
	...
	242, // 182: vtctldata.Workflow.Stream.copy_states:type_name -> vtctldata.Workflow.Stream.CopyState
	243, // 183: vtctldata.Workflow.Stream.logs:type_name -> vtctldata.Workflow.Stream.Log
	244, // 184: vtctldata.Workflow.Stream.throttler_status:type_name -> vtctldata.Workflow.Stream.ThrottlerStatus
	...
	301, // 189: vtctldata.GetCellsAliasesResponse.AliasesEntry.value:type_name -> topodata.CellsAlias
	253, // 190: vtctldata.GetSrvKeyspaceNamesResponse.NamesEntry.value:type_name -> vtctldata.GetSrvKeyspaceNamesResponse.NameList
	305, // 191: vtctldata.GetSrvKeyspacesResponse.SrvKeyspacesEntry.value:type_name -> topodata.SrvKeyspace
	298, // 192: vtctldata.GetSrvVSchemasResponse.SrvVSchemasEntry.value:type_name -> vschema.SrvVSchema
	278, // 193: vtctldata.MoveTablesCreateResponse.TabletInfo.tablet:type_name -> topodata.TabletAlias
	306, // 194: vtctldata.ShardReplicationPositionsResponse.ReplicationStatusesEntry.value:type_name -> replicationdata.Status
	287, // 195: vtctldata.ShardReplicationPositionsResponse.TabletMapEntry.value:type_name -> topodata.Tablet
	209, // 196: vtctldata.ValidateResponse.ResultsByKeyspaceEntry.value:type_name -> vtctldata.ValidateKeyspaceResponse
	213, // 197: vtctldata.ValidateKeyspaceResponse.ResultsByShardEntry.value:type_name -> vtctldata.ValidateShardResponse
	213, // 198: vtctldata.ValidateSchemaKeyspaceResponse.ResultsByShardEntry.value:type_name -> vtctldata.ValidateShardResponse
	213, // 199: vtctldata.ValidateVersionKeyspaceResponse.ResultsByShardEntry.value:type_name -> vtctldata.ValidateShardResponse
	213, // 200: vtctldata.ValidateVSchemaResponse.ResultsByShardEntry.value:type_name -> vtctldata.ValidateShardResponse
	307, // 201: vtctldata.VDiffShowResponse.TabletResponsesEntry.value:type_name -> tabletmanagerdata.VDiffResponse
	278, // 202: vtctldata.WorkflowDeleteResponse.TabletInfo.tablet:type_name -> topodata.TabletAlias
	278, // 203: vtctldata.WorkflowStatusResponse.ShardStreamState.tablet:type_name -> topodata.TabletAlias
	269, // 204: vtctldata.WorkflowStatusResponse.ShardStreams.streams:type_name -> vtctldata.WorkflowStatusResponse.ShardStreamState
	268, // 205: vtctldata.WorkflowStatusResponse.TableCopyStateEntry.value:type_name -> vtctldata.WorkflowStatusResponse.TableCopyState
	270, // 206: vtctldata.WorkflowStatusResponse.ShardStreamsEntry.value:type_name -> vtctldata.WorkflowStatusResponse.ShardStreams
	278, // 207: vtctldata.WorkflowUpdateResponse.TabletInfo.tablet:type_name -> topodata.TabletAlias
