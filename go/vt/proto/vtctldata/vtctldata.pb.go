...
type UpdateThrottlerConfigRequest struct {
	...
	// AppMetrics are the metrics to be checked got the given AppName. These can be scoped. For example:
	// ["lag", "self/loadvg", "shard/threads_running"]
	AppMetrics []string `protobuf:"bytes,12,rep,name=app_metrics,json=appMetrics,proto3" json:"app_metrics,omitempty"`
}
...
func (x *UpdateThrottlerConfigRequest) GetAppMetrics() []string {
	if x != nil {
		return x.AppMetrics
	}
	return nil
...
var file_vtctldata_proto_rawDesc = []byte{
	...
	0x02, 0x38, 0x01, 0x22, 0xd5, 0x03, 0x0a, 0x1c, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x54, 0x68,
	...
	0x70, 0x5f, 0x6d, 0x65, 0x74, 0x72, 0x69, 0x63, 0x73, 0x18, 0x0c, 0x20, 0x03, 0x28, 0x09, 0x52,
	0x0a, 0x61, 0x70, 0x70, 0x4d, 0x65, 0x74, 0x72, 0x69, 0x63, 0x73, 0x22, 0x1f, 0x0a, 0x1d, 0x55,
