...
type EmergencyReparentShardRequest struct {
	...
	// or in its relay log, in Vitess position format (for example MySQL56/<uuid>:1-100).
	// The reparent fails if no candidate has received it. Only MySQL GTID shards are
	// supported. Empty means no requirement.
