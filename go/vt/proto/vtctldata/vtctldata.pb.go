...
var file_vtctldata_proto_rawDesc = []byte{
	...
	0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0x7c, 0x0a, 0x12, 0x53, 0x6c, 0x65, 0x65, 0x70, 0x54, 0x61,
...
var file_vtctldata_proto_goTypes = []any{
	...
	(*ShardReplicationFixRequest)(nil),           // 127: vtctldata.ShardReplicationFixRequest
	(*ShardReplicationFixResponse)(nil),          // 128: vtctldata.ShardReplicationFixResponse
	(*ShardReplicationPositionsRequest)(nil),     // 129: vtctldata.ShardReplicationPositionsRequest
	(*ShardReplicationPositionsResponse)(nil),    // 130: vtctldata.ShardReplicationPositionsResponse
	(*SleepTabletRequest)(nil),                   // 131: vtctldata.SleepTabletRequest
	(*SleepTabletResponse)(nil),                  // 132: vtctldata.SleepTabletResponse
	(*SourceShardAddRequest)(nil),                // 133: vtctldata.SourceShardAddRequest
	(*SourceShardAddResponse)(nil),               // 134: vtctldata.SourceShardAddResponse
	(*SourceShardDeleteRequest)(nil),             // 135: vtctldata.SourceShardDeleteRequest
	(*SourceShardDeleteResponse)(nil),            // 136: vtctldata.SourceShardDeleteResponse
	(*StartReplicationRequest)(nil),              // 137: vtctldata.StartReplicationRequest
	(*StartReplicationResponse)(nil),             // 138: vtctldata.StartReplicationResponse
	(*StopReplicationRequest)(nil),               // 139: vtctldata.StopReplicationRequest
	(*StopReplicationResponse)(nil),              // 140: vtctldata.StopReplicationResponse
	(*TabletExternallyReparentedRequest)(nil),    // 141: vtctldata.TabletExternallyReparentedRequest
	(*TabletExternallyReparentedResponse)(nil),   // 142: vtctldata.TabletExternallyReparentedResponse
	(*UpdateCellInfoRequest)(nil),                // 143: vtctldata.UpdateCellInfoRequest
	(*UpdateCellInfoResponse)(nil),               // 144: vtctldata.UpdateCellInfoResponse
	(*UpdateCellsAliasRequest)(nil),              // 145: vtctldata.UpdateCellsAliasRequest
	(*UpdateCellsAliasResponse)(nil),             // 146: vtctldata.UpdateCellsAliasResponse
	(*ValidateRequest)(nil),                      // 147: vtctldata.ValidateRequest
	(*ValidateResponse)(nil),                     // 148: vtctldata.ValidateResponse
	(*ValidateKeyspaceRequest)(nil),              // 149: vtctldata.ValidateKeyspaceRequest
	(*ValidateKeyspaceResponse)(nil),             // 150: vtctldata.ValidateKeyspaceResponse
	(*ValidateSchemaKeyspaceRequest)(nil),        // 151: vtctldata.ValidateSchemaKeyspaceRequest
	(*ValidateSchemaKeyspaceResponse)(nil),       // 152: vtctldata.ValidateSchemaKeyspaceResponse
	(*ValidateShardRequest)(nil),                 // 153: vtctldata.ValidateShardRequest
	(*ValidateShardResponse)(nil),                // 154: vtctldata.ValidateShardResponse
	(*ValidateVersionKeyspaceRequest)(nil),       // 155: vtctldata.ValidateVersionKeyspaceRequest
	(*ValidateVersionKeyspaceResponse)(nil),      // 156: vtctldata.ValidateVersionKeyspaceResponse
	(*ValidateVSchemaRequest)(nil),               // 157: vtctldata.ValidateVSchemaRequest
	(*ValidateVSchemaResponse)(nil),              // 158: vtctldata.ValidateVSchemaResponse
	nil,                                          // 159: vtctldata.Workflow.ShardStreamsEntry
	(*Workflow_ReplicationLocation)(nil),         // 160: vtctldata.Workflow.ReplicationLocation
	(*Workflow_ShardStream)(nil),                 // 161: vtctldata.Workflow.ShardStream
	(*Workflow_Stream)(nil),                      // 162: vtctldata.Workflow.Stream
	(*Workflow_Stream_CopyState)(nil),            // 163: vtctldata.Workflow.Stream.CopyState
	(*Workflow_Stream_Log)(nil),                  // 164: vtctldata.Workflow.Stream.Log
	nil,                                          // 165: vtctldata.FindAllShardsInKeyspaceResponse.ShardsEntry
	nil,                                          // 166: vtctldata.GetCellsAliasesResponse.AliasesEntry
	nil,                                          // 167: vtctldata.GetSrvKeyspaceNamesResponse.NamesEntry
	(*GetSrvKeyspaceNamesResponse_NameList)(nil), // 168: vtctldata.GetSrvKeyspaceNamesResponse.NameList
	nil,                                  // 169: vtctldata.GetSrvKeyspacesResponse.SrvKeyspacesEntry
	nil,                                  // 170: vtctldata.GetSrvVSchemasResponse.SrvVSchemasEntry
	nil,                                  // 171: vtctldata.ShardReplicationPositionsResponse.ReplicationStatusesEntry
	nil,                                  // 172: vtctldata.ShardReplicationPositionsResponse.TabletMapEntry
	nil,                                  // 173: vtctldata.ValidateResponse.ResultsByKeyspaceEntry
	nil,                                  // 174: vtctldata.ValidateKeyspaceResponse.ResultsByShardEntry
	nil,                                  // 175: vtctldata.ValidateSchemaKeyspaceResponse.ResultsByShardEntry
	nil,                                  // 176: vtctldata.ValidateVersionKeyspaceResponse.ResultsByShardEntry
	nil,                                  // 177: vtctldata.ValidateVSchemaResponse.ResultsByShardEntry
	(*logutil.Event)(nil),                // 178: logutil.Event
	(*topodata.Keyspace)(nil),            // 179: topodata.Keyspace
	(*topodata.Shard)(nil),               // 180: topodata.Shard
	(*topodata.CellInfo)(nil),            // 181: topodata.CellInfo
	(*vschema.RoutingRules)(nil),         // 182: vschema.RoutingRules
	(*vttime.Duration)(nil),              // 183: vttime.Duration
	(*vtrpc.CallerID)(nil),               // 184: vtrpc.CallerID
	(*vschema.Keyspace)(nil),             // 185: vschema.Keyspace
	(*topodata.TabletAlias)(nil),         // 186: topodata.TabletAlias
	(topodata.TabletType)(0),             // 187: topodata.TabletType
	(*topodata.Tablet)(nil),              // 188: topodata.Tablet
	(topodata.KeyspaceIdType)(0),         // 189: topodata.KeyspaceIdType
	(*topodata.Keyspace_ServedFrom)(nil), // 190: topodata.Keyspace.ServedFrom
	(topodata.KeyspaceType)(0),           // 191: topodata.KeyspaceType
	(*vttime.Time)(nil),                  // 192: vttime.Time
	(*query.QueryResult)(nil),            // 193: query.QueryResult
	(*tabletmanagerdata.ExecuteHookRequest)(nil),  // 194: tabletmanagerdata.ExecuteHookRequest
	(*tabletmanagerdata.ExecuteHookResponse)(nil), // 195: tabletmanagerdata.ExecuteHookResponse
	(*mysqlctl.BackupInfo)(nil),                   // 196: mysqlctl.BackupInfo
	(*tabletmanagerdata.SchemaDefinition)(nil),    // 197: tabletmanagerdata.SchemaDefinition
	(*vschema.SrvVSchema)(nil),                    // 198: vschema.SrvVSchema
	(*topodata.ShardReplicationError)(nil),        // 199: topodata.ShardReplicationError
	(*topodata.KeyRange)(nil),                     // 200: topodata.KeyRange
	(*topodata.CellsAlias)(nil),                   // 201: topodata.CellsAlias
	(*topodata.Shard_TabletControl)(nil),          // 202: topodata.Shard.TabletControl
	(*binlogdata.BinlogSource)(nil),               // 203: binlogdata.BinlogSource
	(*topodata.SrvKeyspace)(nil),                  // 204: topodata.SrvKeyspace
	(*replicationdata.Status)(nil),                // 205: replicationdata.Status
}
var file_vtctldata_proto_depIdxs = []int32{
	178, // 0: vtctldata.ExecuteVtctlCommandResponse.event:type_name -> logutil.Event
	...
	179, // 3: vtctldata.Keyspace.keyspace:type_name -> topodata.Keyspace
	180, // 4: vtctldata.Shard.shard:type_name -> topodata.Shard
	160, // 5: vtctldata.Workflow.source:type_name -> vtctldata.Workflow.ReplicationLocation
	160, // 6: vtctldata.Workflow.target:type_name -> vtctldata.Workflow.ReplicationLocation
	159, // 7: vtctldata.Workflow.shard_streams:type_name -> vtctldata.Workflow.ShardStreamsEntry
	181, // 8: vtctldata.AddCellInfoRequest.cell_info:type_name -> topodata.CellInfo
	182, // 9: vtctldata.ApplyRoutingRulesRequest.routing_rules:type_name -> vschema.RoutingRules
	183, // 10: vtctldata.ApplySchemaRequest.wait_replicas_timeout:type_name -> vttime.Duration
	184, // 11: vtctldata.ApplySchemaRequest.caller_id:type_name -> vtrpc.CallerID
	185, // 12: vtctldata.ApplyVSchemaRequest.v_schema:type_name -> vschema.Keyspace
	185, // 13: vtctldata.ApplyVSchemaResponse.v_schema:type_name -> vschema.Keyspace
	186, // 14: vtctldata.BackupRequest.tablet_alias:type_name -> topodata.TabletAlias
	186, // 15: vtctldata.BackupResponse.tablet_alias:type_name -> topodata.TabletAlias
	178, // 16: vtctldata.BackupResponse.event:type_name -> logutil.Event
	186, // 17: vtctldata.ChangeTabletTypeRequest.tablet_alias:type_name -> topodata.TabletAlias
	187, // 18: vtctldata.ChangeTabletTypeRequest.db_type:type_name -> topodata.TabletType
	188, // 19: vtctldata.ChangeTabletTypeResponse.before_tablet:type_name -> topodata.Tablet
	188, // 20: vtctldata.ChangeTabletTypeResponse.after_tablet:type_name -> topodata.Tablet
	189, // 21: vtctldata.CreateKeyspaceRequest.sharding_column_type:type_name -> topodata.KeyspaceIdType
	190, // 22: vtctldata.CreateKeyspaceRequest.served_froms:type_name -> topodata.Keyspace.ServedFrom
	191, // 23: vtctldata.CreateKeyspaceRequest.type:type_name -> topodata.KeyspaceType
	192, // 24: vtctldata.CreateKeyspaceRequest.snapshot_time:type_name -> vttime.Time
	...
	186, // 29: vtctldata.DeleteTabletsRequest.tablet_aliases:type_name -> topodata.TabletAlias
	186, // 30: vtctldata.EmergencyReparentShardRequest.new_primary:type_name -> topodata.TabletAlias
	186, // 31: vtctldata.EmergencyReparentShardRequest.ignore_replicas:type_name -> topodata.TabletAlias
	183, // 32: vtctldata.EmergencyReparentShardRequest.wait_replicas_timeout:type_name -> vttime.Duration
	186, // 33: vtctldata.EmergencyReparentShardResponse.promoted_primary:type_name -> topodata.TabletAlias
	178, // 34: vtctldata.EmergencyReparentShardResponse.events:type_name -> logutil.Event
	186, // 35: vtctldata.ExecuteFetchAsAppRequest.tablet_alias:type_name -> topodata.TabletAlias
	193, // 36: vtctldata.ExecuteFetchAsAppResponse.result:type_name -> query.QueryResult
	186, // 37: vtctldata.ExecuteFetchAsDBARequest.tablet_alias:type_name -> topodata.TabletAlias
	193, // 38: vtctldata.ExecuteFetchAsDBAResponse.result:type_name -> query.QueryResult
	186, // 39: vtctldata.ExecuteHookRequest.tablet_alias:type_name -> topodata.TabletAlias
	194, // 40: vtctldata.ExecuteHookRequest.tablet_hook_request:type_name -> tabletmanagerdata.ExecuteHookRequest
	195, // 41: vtctldata.ExecuteHookResponse.hook_result:type_name -> tabletmanagerdata.ExecuteHookResponse
	165, // 42: vtctldata.FindAllShardsInKeyspaceResponse.shards:type_name -> vtctldata.FindAllShardsInKeyspaceResponse.ShardsEntry
	196, // 43: vtctldata.GetBackupsResponse.backups:type_name -> mysqlctl.BackupInfo
	181, // 44: vtctldata.GetCellInfoResponse.cell_info:type_name -> topodata.CellInfo
	166, // 45: vtctldata.GetCellsAliasesResponse.aliases:type_name -> vtctldata.GetCellsAliasesResponse.AliasesEntry
	...
	182, // 48: vtctldata.GetRoutingRulesResponse.routing_rules:type_name -> vschema.RoutingRules
	186, // 49: vtctldata.GetSchemaRequest.tablet_alias:type_name -> topodata.TabletAlias
	197, // 50: vtctldata.GetSchemaResponse.schema:type_name -> tabletmanagerdata.SchemaDefinition
	6,   // 51: vtctldata.GetShardResponse.shard:type_name -> vtctldata.Shard
	167, // 52: vtctldata.GetSrvKeyspaceNamesResponse.names:type_name -> vtctldata.GetSrvKeyspaceNamesResponse.NamesEntry
	169, // 53: vtctldata.GetSrvKeyspacesResponse.srv_keyspaces:type_name -> vtctldata.GetSrvKeyspacesResponse.SrvKeyspacesEntry
	198, // 54: vtctldata.GetSrvVSchemaResponse.srv_v_schema:type_name -> vschema.SrvVSchema
	170, // 55: vtctldata.GetSrvVSchemasResponse.srv_v_schemas:type_name -> vtctldata.GetSrvVSchemasResponse.SrvVSchemasEntry
	186, // 56: vtctldata.GetTabletRequest.tablet_alias:type_name -> topodata.TabletAlias
	188, // 57: vtctldata.GetTabletResponse.tablet:type_name -> topodata.Tablet
	186, // 58: vtctldata.GetTabletsRequest.tablet_aliases:type_name -> topodata.TabletAlias
	187, // 59: vtctldata.GetTabletsRequest.tablet_type:type_name -> topodata.TabletType
	188, // 60: vtctldata.GetTabletsResponse.tablets:type_name -> topodata.Tablet
	186, // 61: vtctldata.GetVersionRequest.tablet_alias:type_name -> topodata.TabletAlias
	185, // 62: vtctldata.GetVSchemaResponse.v_schema:type_name -> vschema.Keyspace
	7,   // 63: vtctldata.GetWorkflowsResponse.workflows:type_name -> vtctldata.Workflow
	186, // 64: vtctldata.InitShardPrimaryRequest.primary_elect_tablet_alias:type_name -> topodata.TabletAlias
	183, // 65: vtctldata.InitShardPrimaryRequest.wait_replicas_timeout:type_name -> vttime.Duration
	178, // 66: vtctldata.InitShardPrimaryResponse.events:type_name -> logutil.Event
	186, // 67: vtctldata.PingTabletRequest.tablet_alias:type_name -> topodata.TabletAlias
	186, // 68: vtctldata.PlannedReparentShardRequest.new_primary:type_name -> topodata.TabletAlias
	186, // 69: vtctldata.PlannedReparentShardRequest.avoid_primary:type_name -> topodata.TabletAlias
	183, // 70: vtctldata.PlannedReparentShardRequest.wait_replicas_timeout:type_name -> vttime.Duration
	186, // 71: vtctldata.PlannedReparentShardResponse.promoted_primary:type_name -> topodata.TabletAlias
	178, // 72: vtctldata.PlannedReparentShardResponse.events:type_name -> logutil.Event
	186, // 73: vtctldata.RefreshStateRequest.tablet_alias:type_name -> topodata.TabletAlias
	186, // 74: vtctldata.ReloadSchemaRequest.tablet_alias:type_name -> topodata.TabletAlias
	178, // 75: vtctldata.ReloadSchemaKeyspaceResponse.events:type_name -> logutil.Event
	178, // 76: vtctldata.ReloadSchemaShardResponse.events:type_name -> logutil.Event
	186, // 77: vtctldata.ReparentTabletRequest.tablet:type_name -> topodata.TabletAlias
	186, // 78: vtctldata.ReparentTabletResponse.primary:type_name -> topodata.TabletAlias
	186, // 79: vtctldata.RestoreFromBackupRequest.tablet_alias:type_name -> topodata.TabletAlias
	192, // 80: vtctldata.RestoreFromBackupRequest.backup_time:type_name -> vttime.Time
	186, // 81: vtctldata.RestoreFromBackupResponse.tablet_alias:type_name -> topodata.TabletAlias
	178, // 82: vtctldata.RestoreFromBackupResponse.event:type_name -> logutil.Event
	186, // 83: vtctldata.RunHealthCheckRequest.tablet_alias:type_name -> topodata.TabletAlias
	187, // 84: vtctldata.SetKeyspaceServedFromRequest.tablet_type:type_name -> topodata.TabletType
	179, // 85: vtctldata.SetKeyspaceServedFromResponse.keyspace:type_name -> topodata.Keyspace
	189, // 86: vtctldata.SetKeyspaceShardingInfoRequest.column_type:type_name -> topodata.KeyspaceIdType
	179, // 87: vtctldata.SetKeyspaceShardingInfoResponse.keyspace:type_name -> topodata.Keyspace
	180, // 88: vtctldata.SetShardIsPrimaryServingResponse.shard:type_name -> topodata.Shard
	187, // 89: vtctldata.SetShardTabletControlRequest.tablet_type:type_name -> topodata.TabletType
	180, // 90: vtctldata.SetShardTabletControlResponse.shard:type_name -> topodata.Shard
	186, // 91: vtctldata.SetWritableRequest.tablet_alias:type_name -> topodata.TabletAlias
	199, // 92: vtctldata.ShardReplicationFixResponse.error:type_name -> topodata.ShardReplicationError
	171, // 93: vtctldata.ShardReplicationPositionsResponse.replication_statuses:type_name -> vtctldata.ShardReplicationPositionsResponse.ReplicationStatusesEntry
	172, // 94: vtctldata.ShardReplicationPositionsResponse.tablet_map:type_name -> vtctldata.ShardReplicationPositionsResponse.TabletMapEntry
	186, // 95: vtctldata.SleepTabletRequest.tablet_alias:type_name -> topodata.TabletAlias
	183, // 96: vtctldata.SleepTabletRequest.duration:type_name -> vttime.Duration
	200, // 97: vtctldata.SourceShardAddRequest.key_range:type_name -> topodata.KeyRange
	180, // 98: vtctldata.SourceShardAddResponse.shard:type_name -> topodata.Shard
	180, // 99: vtctldata.SourceShardDeleteResponse.shard:type_name -> topodata.Shard
	186, // 100: vtctldata.StartReplicationRequest.tablet_alias:type_name -> topodata.TabletAlias
	186, // 101: vtctldata.StopReplicationRequest.tablet_alias:type_name -> topodata.TabletAlias
	186, // 102: vtctldata.TabletExternallyReparentedRequest.tablet:type_name -> topodata.TabletAlias
	186, // 103: vtctldata.TabletExternallyReparentedResponse.new_primary:type_name -> topodata.TabletAlias
	186, // 104: vtctldata.TabletExternallyReparentedResponse.old_primary:type_name -> topodata.TabletAlias
	181, // 105: vtctldata.UpdateCellInfoRequest.cell_info:type_name -> topodata.CellInfo
	181, // 106: vtctldata.UpdateCellInfoResponse.cell_info:type_name -> topodata.CellInfo
	201, // 107: vtctldata.UpdateCellsAliasRequest.cells_alias:type_name -> topodata.CellsAlias
	201, // 108: vtctldata.UpdateCellsAliasResponse.cells_alias:type_name -> topodata.CellsAlias
	173, // 109: vtctldata.ValidateResponse.results_by_keyspace:type_name -> vtctldata.ValidateResponse.ResultsByKeyspaceEntry
	174, // 110: vtctldata.ValidateKeyspaceResponse.results_by_shard:type_name -> vtctldata.ValidateKeyspaceResponse.ResultsByShardEntry
	175, // 111: vtctldata.ValidateSchemaKeyspaceResponse.results_by_shard:type_name -> vtctldata.ValidateSchemaKeyspaceResponse.ResultsByShardEntry
	176, // 112: vtctldata.ValidateVersionKeyspaceResponse.results_by_shard:type_name -> vtctldata.ValidateVersionKeyspaceResponse.ResultsByShardEntry
	177, // 113: vtctldata.ValidateVSchemaResponse.results_by_shard:type_name -> vtctldata.ValidateVSchemaResponse.ResultsByShardEntry
	161, // 114: vtctldata.Workflow.ShardStreamsEntry.value:type_name -> vtctldata.Workflow.ShardStream
	162, // 115: vtctldata.Workflow.ShardStream.streams:type_name -> vtctldata.Workflow.Stream
	202, // 116: vtctldata.Workflow.ShardStream.tablet_controls:type_name -> topodata.Shard.TabletControl
	186, // 117: vtctldata.Workflow.Stream.tablet:type_name -> topodata.TabletAlias
	203, // 118: vtctldata.Workflow.Stream.binlog_source:type_name -> binlogdata.BinlogSource
	192, // 119: vtctldata.Workflow.Stream.transaction_timestamp:type_name -> vttime.Time
	192, // 120: vtctldata.Workflow.Stream.time_updated:type_name -> vttime.Time
	163, // 121: vtctldata.Workflow.Stream.copy_states:type_name -> vtctldata.Workflow.Stream.CopyState
	164, // 122: vtctldata.Workflow.Stream.logs:type_name -> vtctldata.Workflow.Stream.Log
	192, // 123: vtctldata.Workflow.Stream.Log.created_at:type_name -> vttime.Time
	192, // 124: vtctldata.Workflow.Stream.Log.updated_at:type_name -> vttime.Time
	6,   // 125: vtctldata.FindAllShardsInKeyspaceResponse.ShardsEntry.value:type_name -> vtctldata.Shard
	201, // 126: vtctldata.GetCellsAliasesResponse.AliasesEntry.value:type_name -> topodata.CellsAlias
	168, // 127: vtctldata.GetSrvKeyspaceNamesResponse.NamesEntry.value:type_name -> vtctldata.GetSrvKeyspaceNamesResponse.NameList
	204, // 128: vtctldata.GetSrvKeyspacesResponse.SrvKeyspacesEntry.value:type_name -> topodata.SrvKeyspace
	198, // 129: vtctldata.GetSrvVSchemasResponse.SrvVSchemasEntry.value:type_name -> vschema.SrvVSchema
	205, // 130: vtctldata.ShardReplicationPositionsResponse.ReplicationStatusesEntry.value:type_name -> replicationdata.Status
	188, // 131: vtctldata.ShardReplicationPositionsResponse.TabletMapEntry.value:type_name -> topodata.Tablet
	150, // 132: vtctldata.ValidateResponse.ResultsByKeyspaceEntry.value:type_name -> vtctldata.ValidateKeyspaceResponse
	154, // 133: vtctldata.ValidateKeyspaceResponse.ResultsByShardEntry.value:type_name -> vtctldata.ValidateShardResponse
	154, // 134: vtctldata.ValidateSchemaKeyspaceResponse.ResultsByShardEntry.value:type_name -> vtctldata.ValidateShardResponse
	154, // 135: vtctldata.ValidateVersionKeyspaceResponse.ResultsByShardEntry.value:type_name -> vtctldata.ValidateShardResponse
	154, // 136: vtctldata.ValidateVSchemaResponse.ResultsByShardEntry.value:type_name -> vtctldata.ValidateShardResponse
