...
var file_vtctldata_proto_msgTypes = make([]protoimpl.MessageInfo, 292)
var file_vtctldata_proto_goTypes = []any{
	...
	nil,                                          // 257: vtctldata.Workflow.ShardStreamsEntry
	(*Workflow_ReplicationLocation)(nil),         // 258: vtctldata.Workflow.ReplicationLocation
	(*Workflow_ShardStream)(nil),                 // 259: vtctldata.Workflow.ShardStream
	(*Workflow_Stream)(nil),                      // 260: vtctldata.Workflow.Stream
	(*Workflow_Stream_CopyState)(nil),            // 261: vtctldata.Workflow.Stream.CopyState
	(*Workflow_Stream_Log)(nil),                  // 262: vtctldata.Workflow.Stream.Log
	(*Workflow_Stream_ThrottlerStatus)(nil),      // 263: vtctldata.Workflow.Stream.ThrottlerStatus
	nil,                                          // 264: vtctldata.ApplySchemaResponse.RowsAffectedByShardEntry
	nil,                                          // 265: vtctldata.ApplyVSchemaResponse.UnknownVindexParamsEntry
	(*ApplyVSchemaResponse_ParamList)(nil),       // 266: vtctldata.ApplyVSchemaResponse.ParamList
	nil,                                          // 267: vtctldata.CancelSchemaMigrationResponse.RowsAffectedByShardEntry
	nil,                                          // 268: vtctldata.CleanupSchemaMigrationResponse.RowsAffectedByShardEntry
	nil,                                          // 269: vtctldata.CompleteSchemaMigrationResponse.RowsAffectedByShardEntry
	nil,                                          // 270: vtctldata.FindAllShardsInKeyspaceResponse.ShardsEntry
	nil,                                          // 271: vtctldata.ForceCutOverSchemaMigrationResponse.RowsAffectedByShardEntry
	nil,                                          // 272: vtctldata.GetCellsAliasesResponse.AliasesEntry
	nil,                                          // 273: vtctldata.GetShardReplicationResponse.ShardReplicationByCellEntry
	nil,                                          // 274: vtctldata.GetSrvKeyspaceNamesResponse.NamesEntry
	(*GetSrvKeyspaceNamesResponse_NameList)(nil), // 275: vtctldata.GetSrvKeyspaceNamesResponse.NameList
	nil, // 276: vtctldata.GetSrvKeyspacesResponse.SrvKeyspacesEntry
	nil, // 277: vtctldata.GetSrvVSchemasResponse.SrvVSchemasEntry
	nil, // 278: vtctldata.LaunchSchemaMigrationResponse.RowsAffectedByShardEntry
	(*MoveTablesCreateResponse_TabletInfo)(nil), // 279: vtctldata.MoveTablesCreateResponse.TabletInfo
	nil, // 280: vtctldata.RetrySchemaMigrationResponse.RowsAffectedByShardEntry
	nil, // 281: vtctldata.ShardReplicationPositionsResponse.ReplicationStatusesEntry
	nil, // 282: vtctldata.ShardReplicationPositionsResponse.TabletMapEntry
	nil, // 283: vtctldata.ValidateResponse.ResultsByKeyspaceEntry
	nil, // 284: vtctldata.ValidateKeyspaceResponse.ResultsByShardEntry
	nil, // 285: vtctldata.ValidateSchemaKeyspaceResponse.ResultsByShardEntry
	nil, // 286: vtctldata.ValidateVersionKeyspaceResponse.ResultsByShardEntry
	nil, // 287: vtctldata.ValidateVSchemaResponse.ResultsByShardEntry
	nil, // 288: vtctldata.VDiffShowResponse.TabletResponsesEntry
	(*WorkflowDeleteResponse_TabletInfo)(nil),       // 289: vtctldata.WorkflowDeleteResponse.TabletInfo
	(*WorkflowStatusResponse_TableCopyState)(nil),   // 290: vtctldata.WorkflowStatusResponse.TableCopyState
	(*WorkflowStatusResponse_ShardStreamState)(nil), // 291: vtctldata.WorkflowStatusResponse.ShardStreamState
	(*WorkflowStatusResponse_ShardStreams)(nil),     // 292: vtctldata.WorkflowStatusResponse.ShardStreams
	nil, // 293: vtctldata.WorkflowStatusResponse.TableCopyStateEntry
	nil, // 294: vtctldata.WorkflowStatusResponse.ShardStreamsEntry
	(*WorkflowUpdateResponse_TabletInfo)(nil),                   // 295: vtctldata.WorkflowUpdateResponse.TabletInfo
	(*logutil.Event)(nil),                                       // 296: logutil.Event
	(tabletmanagerdata.TabletSelectionPreference)(0),            // 297: tabletmanagerdata.TabletSelectionPreference
	(*topodata.Keyspace)(nil),                                   // 298: topodata.Keyspace
	(*vttime.Time)(nil),                                         // 299: vttime.Time
	(*topodata.TabletAlias)(nil),                                // 300: topodata.TabletAlias
	(*vttime.Duration)(nil),                                     // 301: vttime.Duration
	(*topodata.Shard)(nil),                                      // 302: topodata.Shard
	(*topodata.CellInfo)(nil),                                   // 303: topodata.CellInfo
	(*vschema.KeyspaceRoutingRules)(nil),                        // 304: vschema.KeyspaceRoutingRules
	(*vschema.RoutingRules)(nil),                                // 305: vschema.RoutingRules
	(*vschema.ShardRoutingRules)(nil),                           // 306: vschema.ShardRoutingRules
	(*vtrpc.CallerID)(nil),                                      // 307: vtrpc.CallerID
	(*vschema.Keyspace)(nil),                                    // 308: vschema.Keyspace
	(topodata.TabletType)(0),                                    // 309: topodata.TabletType
	(*topodata.Tablet)(nil),                                     // 310: topodata.Tablet
	(*tabletmanagerdata.CheckThrottlerResponse)(nil),            // 311: tabletmanagerdata.CheckThrottlerResponse
	...
	(*tabletmanagerdata.GetThrottlerStatusResponse)(nil),        // 322: tabletmanagerdata.GetThrottlerStatusResponse
	(*query.TransactionMetadata)(nil),                           // 323: query.TransactionMetadata
	(*query.Target)(nil),                                        // 324: query.Target
	(*topodata.ShardReplicationError)(nil),                      // 325: topodata.ShardReplicationError
	(*topodata.KeyRange)(nil),                                   // 326: topodata.KeyRange
	(*topodata.CellsAlias)(nil),                                 // 327: topodata.CellsAlias
	(*tabletmanagerdata.UpdateVReplicationWorkflowRequest)(nil), // 328: tabletmanagerdata.UpdateVReplicationWorkflowRequest
	(*vschema.MirrorRules)(nil),                                 // 329: vschema.MirrorRules
	(*topodata.Shard_TabletControl)(nil),                        // 330: topodata.Shard.TabletControl
	(*binlogdata.BinlogSource)(nil),                             // 331: binlogdata.BinlogSource
	(*topodata.ShardReplication)(nil),                           // 332: topodata.ShardReplication
	(*topodata.SrvKeyspace)(nil),                                // 333: topodata.SrvKeyspace
	(*replicationdata.Status)(nil),                              // 334: replicationdata.Status
	(*tabletmanagerdata.VDiffResponse)(nil),                     // 335: tabletmanagerdata.VDiffResponse
}
var file_vtctldata_proto_depIdxs = []int32{
	296, // 0: vtctldata.ExecuteVtctlCommandResponse.event:type_name -> logutil.Event
	...
	297, // 3: vtctldata.MaterializeSettings.tablet_selection_preference:type_name -> tabletmanagerdata.TabletSelectionPreference
	11,  // 4: vtctldata.MaterializeSettings.workflow_options:type_name -> vtctldata.WorkflowOptions
	298, // 5: vtctldata.Keyspace.keyspace:type_name -> topodata.Keyspace
	...
	299, // 13: vtctldata.SchemaMigration.cleaned_up_at:type_name -> vttime.Time
	3,   // 14: vtctldata.SchemaMigration.status:type_name -> vtctldata.SchemaMigration.Status
	300, // 15: vtctldata.SchemaMigration.tablet:type_name -> topodata.TabletAlias
	301, // 16: vtctldata.SchemaMigration.artifact_retention:type_name -> vttime.Duration
	299, // 17: vtctldata.SchemaMigration.last_throttled_at:type_name -> vttime.Time
	...
	299, // 20: vtctldata.SchemaMigration.ready_to_complete_at:type_name -> vttime.Time
	302, // 21: vtctldata.Shard.shard:type_name -> topodata.Shard
	258, // 22: vtctldata.Workflow.source:type_name -> vtctldata.Workflow.ReplicationLocation
	258, // 23: vtctldata.Workflow.target:type_name -> vtctldata.Workflow.ReplicationLocation
	257, // 24: vtctldata.Workflow.shard_streams:type_name -> vtctldata.Workflow.ShardStreamsEntry
	11,  // 25: vtctldata.Workflow.options:type_name -> vtctldata.WorkflowOptions
	303, // 26: vtctldata.AddCellInfoRequest.cell_info:type_name -> topodata.CellInfo
	304, // 27: vtctldata.ApplyKeyspaceRoutingRulesRequest.keyspace_routing_rules:type_name -> vschema.KeyspaceRoutingRules
	304, // 28: vtctldata.ApplyKeyspaceRoutingRulesResponse.keyspace_routing_rules:type_name -> vschema.KeyspaceRoutingRules
	305, // 29: vtctldata.ApplyRoutingRulesRequest.routing_rules:type_name -> vschema.RoutingRules
	306, // 30: vtctldata.ApplyShardRoutingRulesRequest.shard_routing_rules:type_name -> vschema.ShardRoutingRules
	301, // 31: vtctldata.ApplySchemaRequest.wait_replicas_timeout:type_name -> vttime.Duration
	307, // 32: vtctldata.ApplySchemaRequest.caller_id:type_name -> vtrpc.CallerID
	264, // 33: vtctldata.ApplySchemaResponse.rows_affected_by_shard:type_name -> vtctldata.ApplySchemaResponse.RowsAffectedByShardEntry
	308, // 34: vtctldata.ApplyVSchemaRequest.v_schema:type_name -> vschema.Keyspace
	308, // 35: vtctldata.ApplyVSchemaResponse.v_schema:type_name -> vschema.Keyspace
	265, // 36: vtctldata.ApplyVSchemaResponse.unknown_vindex_params:type_name -> vtctldata.ApplyVSchemaResponse.UnknownVindexParamsEntry
	300, // 37: vtctldata.BackupRequest.tablet_alias:type_name -> topodata.TabletAlias
	300, // 38: vtctldata.BackupResponse.tablet_alias:type_name -> topodata.TabletAlias
	296, // 39: vtctldata.BackupResponse.event:type_name -> logutil.Event
	267, // 40: vtctldata.CancelSchemaMigrationResponse.rows_affected_by_shard:type_name -> vtctldata.CancelSchemaMigrationResponse.RowsAffectedByShardEntry
	300, // 41: vtctldata.ChangeTabletTypeRequest.tablet_alias:type_name -> topodata.TabletAlias
	309, // 42: vtctldata.ChangeTabletTypeRequest.db_type:type_name -> topodata.TabletType
	310, // 43: vtctldata.ChangeTabletTypeResponse.before_tablet:type_name -> topodata.Tablet
	310, // 44: vtctldata.ChangeTabletTypeResponse.after_tablet:type_name -> topodata.Tablet
	300, // 45: vtctldata.CheckThrottlerRequest.tablet_alias:type_name -> topodata.TabletAlias
	300, // 46: vtctldata.CheckThrottlerResponse.tablet_alias:type_name -> topodata.TabletAlias
	311, // 47: vtctldata.CheckThrottlerResponse.Check:type_name -> tabletmanagerdata.CheckThrottlerResponse
	268, // 48: vtctldata.CleanupSchemaMigrationResponse.rows_affected_by_shard:type_name -> vtctldata.CleanupSchemaMigrationResponse.RowsAffectedByShardEntry
	269, // 49: vtctldata.CompleteSchemaMigrationResponse.rows_affected_by_shard:type_name -> vtctldata.CompleteSchemaMigrationResponse.RowsAffectedByShardEntry
	312, // 50: vtctldata.CreateKeyspaceRequest.type:type_name -> topodata.KeyspaceType
	299, // 51: vtctldata.CreateKeyspaceRequest.snapshot_time:type_name -> vttime.Time
	...
	300, // 56: vtctldata.DeleteTabletsRequest.tablet_aliases:type_name -> topodata.TabletAlias
	300, // 57: vtctldata.EmergencyReparentShardRequest.new_primary:type_name -> topodata.TabletAlias
	300, // 58: vtctldata.EmergencyReparentShardRequest.ignore_replicas:type_name -> topodata.TabletAlias
	301, // 59: vtctldata.EmergencyReparentShardRequest.wait_replicas_timeout:type_name -> vttime.Duration
	300, // 60: vtctldata.EmergencyReparentShardResponse.promoted_primary:type_name -> topodata.TabletAlias
	296, // 61: vtctldata.EmergencyReparentShardResponse.events:type_name -> logutil.Event
	300, // 62: vtctldata.ExecuteFetchAsAppRequest.tablet_alias:type_name -> topodata.TabletAlias
	313, // 63: vtctldata.ExecuteFetchAsAppResponse.result:type_name -> query.QueryResult
	300, // 64: vtctldata.ExecuteFetchAsDBARequest.tablet_alias:type_name -> topodata.TabletAlias
	313, // 65: vtctldata.ExecuteFetchAsDBAResponse.result:type_name -> query.QueryResult
	300, // 66: vtctldata.ExecuteHookRequest.tablet_alias:type_name -> topodata.TabletAlias
	314, // 67: vtctldata.ExecuteHookRequest.tablet_hook_request:type_name -> tabletmanagerdata.ExecuteHookRequest
	315, // 68: vtctldata.ExecuteHookResponse.hook_result:type_name -> tabletmanagerdata.ExecuteHookResponse
	300, // 69: vtctldata.ExecuteMultiFetchAsDBARequest.tablet_alias:type_name -> topodata.TabletAlias
	313, // 70: vtctldata.ExecuteMultiFetchAsDBAResponse.results:type_name -> query.QueryResult
	270, // 71: vtctldata.FindAllShardsInKeyspaceResponse.shards:type_name -> vtctldata.FindAllShardsInKeyspaceResponse.ShardsEntry
	271, // 72: vtctldata.ForceCutOverSchemaMigrationResponse.rows_affected_by_shard:type_name -> vtctldata.ForceCutOverSchemaMigrationResponse.RowsAffectedByShardEntry
	316, // 73: vtctldata.GetBackupsResponse.backups:type_name -> mysqlctl.BackupInfo
	303, // 74: vtctldata.GetCellInfoResponse.cell_info:type_name -> topodata.CellInfo
	272, // 75: vtctldata.GetCellsAliasesResponse.aliases:type_name -> vtctldata.GetCellsAliasesResponse.AliasesEntry
	300, // 76: vtctldata.GetFullStatusRequest.tablet_alias:type_name -> topodata.TabletAlias
	317, // 77: vtctldata.GetFullStatusResponse.status:type_name -> replicationdata.FullStatus
	...
	300, // 80: vtctldata.GetPermissionsRequest.tablet_alias:type_name -> topodata.TabletAlias
	318, // 81: vtctldata.GetPermissionsResponse.permissions:type_name -> tabletmanagerdata.Permissions
	304, // 82: vtctldata.GetKeyspaceRoutingRulesResponse.keyspace_routing_rules:type_name -> vschema.KeyspaceRoutingRules
	305, // 83: vtctldata.GetRoutingRulesResponse.routing_rules:type_name -> vschema.RoutingRules
	300, // 84: vtctldata.GetSchemaRequest.tablet_alias:type_name -> topodata.TabletAlias
	319, // 85: vtctldata.GetSchemaResponse.schema:type_name -> tabletmanagerdata.SchemaDefinition
	3,   // 86: vtctldata.GetSchemaMigrationsRequest.status:type_name -> vtctldata.SchemaMigration.Status
	301, // 87: vtctldata.GetSchemaMigrationsRequest.recent:type_name -> vttime.Duration
	...
	273, // 90: vtctldata.GetShardReplicationResponse.shard_replication_by_cell:type_name -> vtctldata.GetShardReplicationResponse.ShardReplicationByCellEntry
	10,  // 91: vtctldata.GetShardResponse.shard:type_name -> vtctldata.Shard
	306, // 92: vtctldata.GetShardRoutingRulesResponse.shard_routing_rules:type_name -> vschema.ShardRoutingRules
	274, // 93: vtctldata.GetSrvKeyspaceNamesResponse.names:type_name -> vtctldata.GetSrvKeyspaceNamesResponse.NamesEntry
	276, // 94: vtctldata.GetSrvKeyspacesResponse.srv_keyspaces:type_name -> vtctldata.GetSrvKeyspacesResponse.SrvKeyspacesEntry
	320, // 95: vtctldata.UpdateThrottlerConfigRequest.throttled_app:type_name -> topodata.ThrottledAppRule
	321, // 96: vtctldata.GetSrvVSchemaResponse.srv_v_schema:type_name -> vschema.SrvVSchema
	277, // 97: vtctldata.GetSrvVSchemasResponse.srv_v_schemas:type_name -> vtctldata.GetSrvVSchemasResponse.SrvVSchemasEntry
	300, // 98: vtctldata.GetTabletRequest.tablet_alias:type_name -> topodata.TabletAlias
	310, // 99: vtctldata.GetTabletResponse.tablet:type_name -> topodata.Tablet
	300, // 100: vtctldata.GetTabletsRequest.tablet_aliases:type_name -> topodata.TabletAlias
	309, // 101: vtctldata.GetTabletsRequest.tablet_type:type_name -> topodata.TabletType
	310, // 102: vtctldata.GetTabletsResponse.tablets:type_name -> topodata.Tablet
	300, // 103: vtctldata.GetThrottlerStatusRequest.tablet_alias:type_name -> topodata.TabletAlias
	322, // 104: vtctldata.GetThrottlerStatusResponse.status:type_name -> tabletmanagerdata.GetThrottlerStatusResponse
	118, // 105: vtctldata.GetTopologyPathResponse.cell:type_name -> vtctldata.TopologyCell
	323, // 106: vtctldata.GetUnresolvedTransactionsResponse.transactions:type_name -> query.TransactionMetadata
	324, // 107: vtctldata.ConcludeTransactionRequest.participants:type_name -> query.Target
	300, // 108: vtctldata.GetVersionRequest.tablet_alias:type_name -> topodata.TabletAlias
	308, // 109: vtctldata.GetVSchemaResponse.v_schema:type_name -> vschema.Keyspace
	12,  // 110: vtctldata.GetWorkflowsResponse.workflows:type_name -> vtctldata.Workflow
	300, // 111: vtctldata.InitShardPrimaryRequest.primary_elect_tablet_alias:type_name -> topodata.TabletAlias
	301, // 112: vtctldata.InitShardPrimaryRequest.wait_replicas_timeout:type_name -> vttime.Duration
	296, // 113: vtctldata.InitShardPrimaryResponse.events:type_name -> logutil.Event
	278, // 114: vtctldata.LaunchSchemaMigrationResponse.rows_affected_by_shard:type_name -> vtctldata.LaunchSchemaMigrationResponse.RowsAffectedByShardEntry
	308, // 115: vtctldata.LookupVindexCreateRequest.vindex:type_name -> vschema.Keyspace
	309, // 116: vtctldata.LookupVindexCreateRequest.tablet_types:type_name -> topodata.TabletType
	297, // 117: vtctldata.LookupVindexCreateRequest.tablet_selection_preference:type_name -> tabletmanagerdata.TabletSelectionPreference
	7,   // 118: vtctldata.MaterializeCreateRequest.settings:type_name -> vtctldata.MaterializeSettings
	309, // 119: vtctldata.MigrateCreateRequest.tablet_types:type_name -> topodata.TabletType
	297, // 120: vtctldata.MigrateCreateRequest.tablet_selection_preference:type_name -> tabletmanagerdata.TabletSelectionPreference
	309, // 121: vtctldata.MoveTablesCreateRequest.tablet_types:type_name -> topodata.TabletType
	297, // 122: vtctldata.MoveTablesCreateRequest.tablet_selection_preference:type_name -> tabletmanagerdata.TabletSelectionPreference
	11,  // 123: vtctldata.MoveTablesCreateRequest.workflow_options:type_name -> vtctldata.WorkflowOptions
	279, // 124: vtctldata.MoveTablesCreateResponse.details:type_name -> vtctldata.MoveTablesCreateResponse.TabletInfo
	300, // 125: vtctldata.PingTabletRequest.tablet_alias:type_name -> topodata.TabletAlias
	300, // 126: vtctldata.PlannedReparentShardRequest.new_primary:type_name -> topodata.TabletAlias
	300, // 127: vtctldata.PlannedReparentShardRequest.avoid_primary:type_name -> topodata.TabletAlias
	301, // 128: vtctldata.PlannedReparentShardRequest.wait_replicas_timeout:type_name -> vttime.Duration
	301, // 129: vtctldata.PlannedReparentShardRequest.tolerable_replication_lag:type_name -> vttime.Duration
	300, // 130: vtctldata.PlannedReparentShardResponse.promoted_primary:type_name -> topodata.TabletAlias
	296, // 131: vtctldata.PlannedReparentShardResponse.events:type_name -> logutil.Event
	300, // 132: vtctldata.RefreshStateRequest.tablet_alias:type_name -> topodata.TabletAlias
	300, // 133: vtctldata.ReloadSchemaRequest.tablet_alias:type_name -> topodata.TabletAlias
	296, // 134: vtctldata.ReloadSchemaKeyspaceResponse.events:type_name -> logutil.Event
	296, // 135: vtctldata.ReloadSchemaShardResponse.events:type_name -> logutil.Event
	300, // 136: vtctldata.ReparentTabletRequest.tablet:type_name -> topodata.TabletAlias
	300, // 137: vtctldata.ReparentTabletResponse.primary:type_name -> topodata.TabletAlias
	309, // 138: vtctldata.ReshardCreateRequest.tablet_types:type_name -> topodata.TabletType
	297, // 139: vtctldata.ReshardCreateRequest.tablet_selection_preference:type_name -> tabletmanagerdata.TabletSelectionPreference
	300, // 140: vtctldata.RestoreFromBackupRequest.tablet_alias:type_name -> topodata.TabletAlias
	299, // 141: vtctldata.RestoreFromBackupRequest.backup_time:type_name -> vttime.Time
	299, // 142: vtctldata.RestoreFromBackupRequest.restore_to_timestamp:type_name -> vttime.Time
	300, // 143: vtctldata.RestoreFromBackupResponse.tablet_alias:type_name -> topodata.TabletAlias
	296, // 144: vtctldata.RestoreFromBackupResponse.event:type_name -> logutil.Event
	280, // 145: vtctldata.RetrySchemaMigrationResponse.rows_affected_by_shard:type_name -> vtctldata.RetrySchemaMigrationResponse.RowsAffectedByShardEntry
	300, // 146: vtctldata.RunHealthCheckRequest.tablet_alias:type_name -> topodata.TabletAlias
	298, // 147: vtctldata.SetKeyspaceDurabilityPolicyResponse.keyspace:type_name -> topodata.Keyspace
	298, // 148: vtctldata.SetKeyspaceShardingInfoResponse.keyspace:type_name -> topodata.Keyspace
	302, // 149: vtctldata.SetShardIsPrimaryServingResponse.shard:type_name -> topodata.Shard
	309, // 150: vtctldata.SetShardTabletControlRequest.tablet_type:type_name -> topodata.TabletType
	302, // 151: vtctldata.SetShardTabletControlResponse.shard:type_name -> topodata.Shard
	300, // 152: vtctldata.SetWritableRequest.tablet_alias:type_name -> topodata.TabletAlias
	300, // 153: vtctldata.ShardReplicationAddRequest.tablet_alias:type_name -> topodata.TabletAlias
	325, // 154: vtctldata.ShardReplicationFixResponse.error:type_name -> topodata.ShardReplicationError
	281, // 155: vtctldata.ShardReplicationPositionsResponse.replication_statuses:type_name -> vtctldata.ShardReplicationPositionsResponse.ReplicationStatusesEntry
	282, // 156: vtctldata.ShardReplicationPositionsResponse.tablet_map:type_name -> vtctldata.ShardReplicationPositionsResponse.TabletMapEntry
	300, // 157: vtctldata.ShardReplicationRemoveRequest.tablet_alias:type_name -> topodata.TabletAlias
	300, // 158: vtctldata.SleepTabletRequest.tablet_alias:type_name -> topodata.TabletAlias
	301, // 159: vtctldata.SleepTabletRequest.duration:type_name -> vttime.Duration
	326, // 160: vtctldata.SourceShardAddRequest.key_range:type_name -> topodata.KeyRange
	302, // 161: vtctldata.SourceShardAddResponse.shard:type_name -> topodata.Shard
	302, // 162: vtctldata.SourceShardDeleteResponse.shard:type_name -> topodata.Shard
	300, // 163: vtctldata.StartReplicationRequest.tablet_alias:type_name -> topodata.TabletAlias
	300, // 164: vtctldata.StopReplicationRequest.tablet_alias:type_name -> topodata.TabletAlias
	300, // 165: vtctldata.TabletExternallyReparentedRequest.tablet:type_name -> topodata.TabletAlias
	300, // 166: vtctldata.TabletExternallyReparentedResponse.new_primary:type_name -> topodata.TabletAlias
	300, // 167: vtctldata.TabletExternallyReparentedResponse.old_primary:type_name -> topodata.TabletAlias
	303, // 168: vtctldata.UpdateCellInfoRequest.cell_info:type_name -> topodata.CellInfo
	303, // 169: vtctldata.UpdateCellInfoResponse.cell_info:type_name -> topodata.CellInfo
	327, // 170: vtctldata.UpdateCellsAliasRequest.cells_alias:type_name -> topodata.CellsAlias
	327, // 171: vtctldata.UpdateCellsAliasResponse.cells_alias:type_name -> topodata.CellsAlias
	283, // 172: vtctldata.ValidateResponse.results_by_keyspace:type_name -> vtctldata.ValidateResponse.ResultsByKeyspaceEntry
	284, // 173: vtctldata.ValidateKeyspaceResponse.results_by_shard:type_name -> vtctldata.ValidateKeyspaceResponse.ResultsByShardEntry
	285, // 174: vtctldata.ValidateSchemaKeyspaceResponse.results_by_shard:type_name -> vtctldata.ValidateSchemaKeyspaceResponse.ResultsByShardEntry
	286, // 175: vtctldata.ValidateVersionKeyspaceResponse.results_by_shard:type_name -> vtctldata.ValidateVersionKeyspaceResponse.ResultsByShardEntry
	287, // 176: vtctldata.ValidateVSchemaResponse.results_by_shard:type_name -> vtctldata.ValidateVSchemaResponse.ResultsByShardEntry
	309, // 177: vtctldata.VDiffCreateRequest.tablet_types:type_name -> topodata.TabletType
	297, // 178: vtctldata.VDiffCreateRequest.tablet_selection_preference:type_name -> tabletmanagerdata.TabletSelectionPreference
	301, // 179: vtctldata.VDiffCreateRequest.filtered_replication_wait_time:type_name -> vttime.Duration
	301, // 180: vtctldata.VDiffCreateRequest.wait_update_interval:type_name -> vttime.Duration
	301, // 181: vtctldata.VDiffCreateRequest.max_diff_duration:type_name -> vttime.Duration
	288, // 182: vtctldata.VDiffShowResponse.tablet_responses:type_name -> vtctldata.VDiffShowResponse.TabletResponsesEntry
	289, // 183: vtctldata.WorkflowDeleteResponse.details:type_name -> vtctldata.WorkflowDeleteResponse.TabletInfo
	293, // 184: vtctldata.WorkflowStatusResponse.table_copy_state:type_name -> vtctldata.WorkflowStatusResponse.TableCopyStateEntry
	294, // 185: vtctldata.WorkflowStatusResponse.shard_streams:type_name -> vtctldata.WorkflowStatusResponse.ShardStreamsEntry
	309, // 186: vtctldata.WorkflowSwitchTrafficRequest.tablet_types:type_name -> topodata.TabletType
	301, // 187: vtctldata.WorkflowSwitchTrafficRequest.max_replication_lag_allowed:type_name -> vttime.Duration
	301, // 188: vtctldata.WorkflowSwitchTrafficRequest.timeout:type_name -> vttime.Duration
	328, // 189: vtctldata.WorkflowUpdateRequest.tablet_request:type_name -> tabletmanagerdata.UpdateVReplicationWorkflowRequest
	295, // 190: vtctldata.WorkflowUpdateResponse.details:type_name -> vtctldata.WorkflowUpdateResponse.TabletInfo
	329, // 191: vtctldata.GetMirrorRulesResponse.mirror_rules:type_name -> vschema.MirrorRules
	309, // 192: vtctldata.WorkflowMirrorTrafficRequest.tablet_types:type_name -> topodata.TabletType
	259, // 193: vtctldata.Workflow.ShardStreamsEntry.value:type_name -> vtctldata.Workflow.ShardStream
	260, // 194: vtctldata.Workflow.ShardStream.streams:type_name -> vtctldata.Workflow.Stream
	330, // 195: vtctldata.Workflow.ShardStream.tablet_controls:type_name -> topodata.Shard.TabletControl
	300, // 196: vtctldata.Workflow.Stream.tablet:type_name -> topodata.TabletAlias
	331, // 197: vtctldata.Workflow.Stream.binlog_source:type_name -> binlogdata.BinlogSource
	299, // 198: vtctldata.Workflow.Stream.transaction_timestamp:type_name -> vttime.Time
	299, // 199: vtctldata.Workflow.Stream.time_updated:type_name -> vttime.Time
	261, // 200: vtctldata.Workflow.Stream.copy_states:type_name -> vtctldata.Workflow.Stream.CopyState
	262, // 201: vtctldata.Workflow.Stream.logs:type_name -> vtctldata.Workflow.Stream.Log
	263, // 202: vtctldata.Workflow.Stream.throttler_status:type_name -> vtctldata.Workflow.Stream.ThrottlerStatus
	309, // 203: vtctldata.Workflow.Stream.tablet_types:type_name -> topodata.TabletType
	297, // 204: vtctldata.Workflow.Stream.tablet_selection_preference:type_name -> tabletmanagerdata.TabletSelectionPreference
	299, // 205: vtctldata.Workflow.Stream.Log.created_at:type_name -> vttime.Time
	299, // 206: vtctldata.Workflow.Stream.Log.updated_at:type_name -> vttime.Time
	299, // 207: vtctldata.Workflow.Stream.ThrottlerStatus.time_throttled:type_name -> vttime.Time
	266, // 208: vtctldata.ApplyVSchemaResponse.UnknownVindexParamsEntry.value:type_name -> vtctldata.ApplyVSchemaResponse.ParamList
	10,  // 209: vtctldata.FindAllShardsInKeyspaceResponse.ShardsEntry.value:type_name -> vtctldata.Shard
	327, // 210: vtctldata.GetCellsAliasesResponse.AliasesEntry.value:type_name -> topodata.CellsAlias
	332, // 211: vtctldata.GetShardReplicationResponse.ShardReplicationByCellEntry.value:type_name -> topodata.ShardReplication
	275, // 212: vtctldata.GetSrvKeyspaceNamesResponse.NamesEntry.value:type_name -> vtctldata.GetSrvKeyspaceNamesResponse.NameList
	333, // 213: vtctldata.GetSrvKeyspacesResponse.SrvKeyspacesEntry.value:type_name -> topodata.SrvKeyspace
	321, // 214: vtctldata.GetSrvVSchemasResponse.SrvVSchemasEntry.value:type_name -> vschema.SrvVSchema
	300, // 215: vtctldata.MoveTablesCreateResponse.TabletInfo.tablet:type_name -> topodata.TabletAlias
	334, // 216: vtctldata.ShardReplicationPositionsResponse.ReplicationStatusesEntry.value:type_name -> replicationdata.Status
	310, // 217: vtctldata.ShardReplicationPositionsResponse.TabletMapEntry.value:type_name -> topodata.Tablet
	224, // 218: vtctldata.ValidateResponse.ResultsByKeyspaceEntry.value:type_name -> vtctldata.ValidateKeyspaceResponse
	228, // 219: vtctldata.ValidateKeyspaceResponse.ResultsByShardEntry.value:type_name -> vtctldata.ValidateShardResponse
	228, // 220: vtctldata.ValidateSchemaKeyspaceResponse.ResultsByShardEntry.value:type_name -> vtctldata.ValidateShardResponse
	228, // 221: vtctldata.ValidateVersionKeyspaceResponse.ResultsByShardEntry.value:type_name -> vtctldata.ValidateShardResponse
	228, // 222: vtctldata.ValidateVSchemaResponse.ResultsByShardEntry.value:type_name -> vtctldata.ValidateShardResponse
	335, // 223: vtctldata.VDiffShowResponse.TabletResponsesEntry.value:type_name -> tabletmanagerdata.VDiffResponse
	300, // 224: vtctldata.WorkflowDeleteResponse.TabletInfo.tablet:type_name -> topodata.TabletAlias
	300, // 225: vtctldata.WorkflowStatusResponse.ShardStreamState.tablet:type_name -> topodata.TabletAlias
	291, // 226: vtctldata.WorkflowStatusResponse.ShardStreams.streams:type_name -> vtctldata.WorkflowStatusResponse.ShardStreamState
	290, // 227: vtctldata.WorkflowStatusResponse.TableCopyStateEntry.value:type_name -> vtctldata.WorkflowStatusResponse.TableCopyState
	292, // 228: vtctldata.WorkflowStatusResponse.ShardStreamsEntry.value:type_name -> vtctldata.WorkflowStatusResponse.ShardStreams
	300, // 229: vtctldata.WorkflowUpdateResponse.TabletInfo.tablet:type_name -> topodata.TabletAlias
