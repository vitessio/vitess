...
var file_vtctldata_proto_depIdxs = []int32{
	...
	281, // 53: vtctldata.EmergencyReparentShardResponse.promoted_primary:type_name -> topodata.TabletAlias
	277, // 54: vtctldata.EmergencyReparentShardResponse.events:type_name -> logutil.Event
	281, // 55: vtctldata.ExecuteFetchAsAppRequest.tablet_alias:type_name -> topodata.TabletAlias
	292, // 56: vtctldata.ExecuteFetchAsAppResponse.result:type_name -> query.QueryResult
	281, // 57: vtctldata.ExecuteFetchAsDBARequest.tablet_alias:type_name -> topodata.TabletAlias
	292, // 58: vtctldata.ExecuteFetchAsDBAResponse.result:type_name -> query.QueryResult
	281, // 59: vtctldata.ExecuteHookRequest.tablet_alias:type_name -> topodata.TabletAlias
	293, // 60: vtctldata.ExecuteHookRequest.tablet_hook_request:type_name -> tabletmanagerdata.ExecuteHookRequest
	294, // 61: vtctldata.ExecuteHookResponse.hook_result:type_name -> tabletmanagerdata.ExecuteHookResponse
	...
	295, // 64: vtctldata.GetBackupsResponse.backups:type_name -> mysqlctl.BackupInfo
	284, // 65: vtctldata.GetCellInfoResponse.cell_info:type_name -> topodata.CellInfo
	253, // 66: vtctldata.GetCellsAliasesResponse.aliases:type_name -> vtctldata.GetCellsAliasesResponse.AliasesEntry
	281, // 67: vtctldata.GetFullStatusRequest.tablet_alias:type_name -> topodata.TabletAlias
	296, // 68: vtctldata.GetFullStatusResponse.status:type_name -> replicationdata.FullStatus
	...
	281, // 71: vtctldata.GetPermissionsRequest.tablet_alias:type_name -> topodata.TabletAlias
	297, // 72: vtctldata.GetPermissionsResponse.permissions:type_name -> tabletmanagerdata.Permissions
	285, // 73: vtctldata.GetRoutingRulesResponse.routing_rules:type_name -> vschema.RoutingRules
	281, // 74: vtctldata.GetSchemaRequest.tablet_alias:type_name -> topodata.TabletAlias
	298, // 75: vtctldata.GetSchemaResponse.schema:type_name -> tabletmanagerdata.SchemaDefinition
	3,   // 76: vtctldata.GetSchemaMigrationsRequest.status:type_name -> vtctldata.SchemaMigration.Status
	282, // 77: vtctldata.GetSchemaMigrationsRequest.recent:type_name -> vttime.Duration
	...
	254, // 80: vtctldata.GetShardReplicationResponse.shard_replication_by_cell:type_name -> vtctldata.GetShardReplicationResponse.ShardReplicationByCellEntry
	10,  // 81: vtctldata.GetShardResponse.shard:type_name -> vtctldata.Shard
	286, // 82: vtctldata.GetShardRoutingRulesResponse.shard_routing_rules:type_name -> vschema.ShardRoutingRules
	255, // 83: vtctldata.GetSrvKeyspaceNamesResponse.names:type_name -> vtctldata.GetSrvKeyspaceNamesResponse.NamesEntry
	257, // 84: vtctldata.GetSrvKeyspacesResponse.srv_keyspaces:type_name -> vtctldata.GetSrvKeyspacesResponse.SrvKeyspacesEntry
	299, // 85: vtctldata.UpdateThrottlerConfigRequest.throttled_app:type_name -> topodata.ThrottledAppRule
	300, // 86: vtctldata.GetSrvVSchemaResponse.srv_v_schema:type_name -> vschema.SrvVSchema
	258, // 87: vtctldata.GetSrvVSchemasResponse.srv_v_schemas:type_name -> vtctldata.GetSrvVSchemasResponse.SrvVSchemasEntry
	281, // 88: vtctldata.GetTabletRequest.tablet_alias:type_name -> topodata.TabletAlias
	290, // 89: vtctldata.GetTabletResponse.tablet:type_name -> topodata.Tablet
	281, // 90: vtctldata.GetTabletsRequest.tablet_aliases:type_name -> topodata.TabletAlias
	289, // 91: vtctldata.GetTabletsRequest.tablet_type:type_name -> topodata.TabletType
	290, // 92: vtctldata.GetTabletsResponse.tablets:type_name -> topodata.Tablet
	107, // 93: vtctldata.GetTopologyPathResponse.cell:type_name -> vtctldata.TopologyCell
	281, // 94: vtctldata.GetVersionRequest.tablet_alias:type_name -> topodata.TabletAlias
	288, // 95: vtctldata.GetVSchemaResponse.v_schema:type_name -> vschema.Keyspace
	11,  // 96: vtctldata.GetWorkflowsResponse.workflows:type_name -> vtctldata.Workflow
	281, // 97: vtctldata.InitShardPrimaryRequest.primary_elect_tablet_alias:type_name -> topodata.TabletAlias
	282, // 98: vtctldata.InitShardPrimaryRequest.wait_replicas_timeout:type_name -> vttime.Duration
	277, // 99: vtctldata.InitShardPrimaryResponse.events:type_name -> logutil.Event
	259, // 100: vtctldata.LaunchSchemaMigrationResponse.rows_affected_by_shard:type_name -> vtctldata.LaunchSchemaMigrationResponse.RowsAffectedByShardEntry
	288, // 101: vtctldata.LookupVindexCreateRequest.vindex:type_name -> vschema.Keyspace
	289, // 102: vtctldata.LookupVindexCreateRequest.tablet_types:type_name -> topodata.TabletType
	278, // 103: vtctldata.LookupVindexCreateRequest.tablet_selection_preference:type_name -> tabletmanagerdata.TabletSelectionPreference
	7,   // 104: vtctldata.MaterializeCreateRequest.settings:type_name -> vtctldata.MaterializeSettings
	289, // 105: vtctldata.MigrateCreateRequest.tablet_types:type_name -> topodata.TabletType
	278, // 106: vtctldata.MigrateCreateRequest.tablet_selection_preference:type_name -> tabletmanagerdata.TabletSelectionPreference
	289, // 107: vtctldata.MoveTablesCreateRequest.tablet_types:type_name -> topodata.TabletType
	278, // 108: vtctldata.MoveTablesCreateRequest.tablet_selection_preference:type_name -> tabletmanagerdata.TabletSelectionPreference
	260, // 109: vtctldata.MoveTablesCreateResponse.details:type_name -> vtctldata.MoveTablesCreateResponse.TabletInfo
	281, // 110: vtctldata.PingTabletRequest.tablet_alias:type_name -> topodata.TabletAlias
	281, // 111: vtctldata.PlannedReparentShardRequest.new_primary:type_name -> topodata.TabletAlias
	281, // 112: vtctldata.PlannedReparentShardRequest.avoid_primary:type_name -> topodata.TabletAlias
	282, // 113: vtctldata.PlannedReparentShardRequest.wait_replicas_timeout:type_name -> vttime.Duration
	282, // 114: vtctldata.PlannedReparentShardRequest.tolerable_replication_lag:type_name -> vttime.Duration
	281, // 115: vtctldata.PlannedReparentShardResponse.promoted_primary:type_name -> topodata.TabletAlias
	277, // 116: vtctldata.PlannedReparentShardResponse.events:type_name -> logutil.Event
	281, // 117: vtctldata.RefreshStateRequest.tablet_alias:type_name -> topodata.TabletAlias
	281, // 118: vtctldata.ReloadSchemaRequest.tablet_alias:type_name -> topodata.TabletAlias
	277, // 119: vtctldata.ReloadSchemaKeyspaceResponse.events:type_name -> logutil.Event
	277, // 120: vtctldata.ReloadSchemaShardResponse.events:type_name -> logutil.Event
	281, // 121: vtctldata.ReparentTabletRequest.tablet:type_name -> topodata.TabletAlias
	281, // 122: vtctldata.ReparentTabletResponse.primary:type_name -> topodata.TabletAlias
	289, // 123: vtctldata.ReshardCreateRequest.tablet_types:type_name -> topodata.TabletType
	278, // 124: vtctldata.ReshardCreateRequest.tablet_selection_preference:type_name -> tabletmanagerdata.TabletSelectionPreference
	281, // 125: vtctldata.RestoreFromBackupRequest.tablet_alias:type_name -> topodata.TabletAlias
	280, // 126: vtctldata.RestoreFromBackupRequest.backup_time:type_name -> vttime.Time
	280, // 127: vtctldata.RestoreFromBackupRequest.restore_to_timestamp:type_name -> vttime.Time
	281, // 128: vtctldata.RestoreFromBackupResponse.tablet_alias:type_name -> topodata.TabletAlias
	277, // 129: vtctldata.RestoreFromBackupResponse.event:type_name -> logutil.Event
	261, // 130: vtctldata.RetrySchemaMigrationResponse.rows_affected_by_shard:type_name -> vtctldata.RetrySchemaMigrationResponse.RowsAffectedByShardEntry
	281, // 131: vtctldata.RunHealthCheckRequest.tablet_alias:type_name -> topodata.TabletAlias
	279, // 132: vtctldata.SetKeyspaceDurabilityPolicyResponse.keyspace:type_name -> topodata.Keyspace
	279, // 133: vtctldata.SetKeyspaceShardingInfoResponse.keyspace:type_name -> topodata.Keyspace
	283, // 134: vtctldata.SetShardIsPrimaryServingResponse.shard:type_name -> topodata.Shard
	289, // 135: vtctldata.SetShardTabletControlRequest.tablet_type:type_name -> topodata.TabletType
	283, // 136: vtctldata.SetShardTabletControlResponse.shard:type_name -> topodata.Shard
	281, // 137: vtctldata.SetWritableRequest.tablet_alias:type_name -> topodata.TabletAlias
	281, // 138: vtctldata.ShardReplicationAddRequest.tablet_alias:type_name -> topodata.TabletAlias
	301, // 139: vtctldata.ShardReplicationFixResponse.error:type_name -> topodata.ShardReplicationError
	262, // 140: vtctldata.ShardReplicationPositionsResponse.replication_statuses:type_name -> vtctldata.ShardReplicationPositionsResponse.ReplicationStatusesEntry
	263, // 141: vtctldata.ShardReplicationPositionsResponse.tablet_map:type_name -> vtctldata.ShardReplicationPositionsResponse.TabletMapEntry
	281, // 142: vtctldata.ShardReplicationRemoveRequest.tablet_alias:type_name -> topodata.TabletAlias
	281, // 143: vtctldata.SleepTabletRequest.tablet_alias:type_name -> topodata.TabletAlias
	282, // 144: vtctldata.SleepTabletRequest.duration:type_name -> vttime.Duration
	302, // 145: vtctldata.SourceShardAddRequest.key_range:type_name -> topodata.KeyRange
	283, // 146: vtctldata.SourceShardAddResponse.shard:type_name -> topodata.Shard
	283, // 147: vtctldata.SourceShardDeleteResponse.shard:type_name -> topodata.Shard
	281, // 148: vtctldata.StartReplicationRequest.tablet_alias:type_name -> topodata.TabletAlias
	281, // 149: vtctldata.StopReplicationRequest.tablet_alias:type_name -> topodata.TabletAlias
	281, // 150: vtctldata.TabletExternallyReparentedRequest.tablet:type_name -> topodata.TabletAlias
	281, // 151: vtctldata.TabletExternallyReparentedResponse.new_primary:type_name -> topodata.TabletAlias
	281, // 152: vtctldata.TabletExternallyReparentedResponse.old_primary:type_name -> topodata.TabletAlias
	284, // 153: vtctldata.UpdateCellInfoRequest.cell_info:type_name -> topodata.CellInfo
	284, // 154: vtctldata.UpdateCellInfoResponse.cell_info:type_name -> topodata.CellInfo
	303, // 155: vtctldata.UpdateCellsAliasRequest.cells_alias:type_name -> topodata.CellsAlias
	303, // 156: vtctldata.UpdateCellsAliasResponse.cells_alias:type_name -> topodata.CellsAlias
	264, // 157: vtctldata.ValidateResponse.results_by_keyspace:type_name -> vtctldata.ValidateResponse.ResultsByKeyspaceEntry
	265, // 158: vtctldata.ValidateKeyspaceResponse.results_by_shard:type_name -> vtctldata.ValidateKeyspaceResponse.ResultsByShardEntry
	266, // 159: vtctldata.ValidateSchemaKeyspaceResponse.results_by_shard:type_name -> vtctldata.ValidateSchemaKeyspaceResponse.ResultsByShardEntry
	267, // 160: vtctldata.ValidateVersionKeyspaceResponse.results_by_shard:type_name -> vtctldata.ValidateVersionKeyspaceResponse.ResultsByShardEntry
	268, // 161: vtctldata.ValidateVSchemaResponse.results_by_shard:type_name -> vtctldata.ValidateVSchemaResponse.ResultsByShardEntry
	289, // 162: vtctldata.VDiffCreateRequest.tablet_types:type_name -> topodata.TabletType
	278, // 163: vtctldata.VDiffCreateRequest.tablet_selection_preference:type_name -> tabletmanagerdata.TabletSelectionPreference
	282, // 164: vtctldata.VDiffCreateRequest.filtered_replication_wait_time:type_name -> vttime.Duration
	282, // 165: vtctldata.VDiffCreateRequest.wait_update_interval:type_name -> vttime.Duration
	282, // 166: vtctldata.VDiffCreateRequest.max_diff_duration:type_name -> vttime.Duration
	269, // 167: vtctldata.VDiffShowResponse.tablet_responses:type_name -> vtctldata.VDiffShowResponse.TabletResponsesEntry
	270, // 168: vtctldata.WorkflowDeleteResponse.details:type_name -> vtctldata.WorkflowDeleteResponse.TabletInfo
	274, // 169: vtctldata.WorkflowStatusResponse.table_copy_state:type_name -> vtctldata.WorkflowStatusResponse.TableCopyStateEntry
	275, // 170: vtctldata.WorkflowStatusResponse.shard_streams:type_name -> vtctldata.WorkflowStatusResponse.ShardStreamsEntry
	289, // 171: vtctldata.WorkflowSwitchTrafficRequest.tablet_types:type_name -> topodata.TabletType
	282, // 172: vtctldata.WorkflowSwitchTrafficRequest.max_replication_lag_allowed:type_name -> vttime.Duration
	282, // 173: vtctldata.WorkflowSwitchTrafficRequest.timeout:type_name -> vttime.Duration
	304, // 174: vtctldata.WorkflowUpdateRequest.tablet_request:type_name -> tabletmanagerdata.UpdateVReplicationWorkflowRequest
	276, // 175: vtctldata.WorkflowUpdateResponse.details:type_name -> vtctldata.WorkflowUpdateResponse.TabletInfo
	...
	305, // 178: vtctldata.Workflow.ShardStream.tablet_controls:type_name -> topodata.Shard.TabletControl
	281, // 179: vtctldata.Workflow.Stream.tablet:type_name -> topodata.TabletAlias
	306, // 180: vtctldata.Workflow.Stream.binlog_source:type_name -> binlogdata.BinlogSource
	280, // 181: vtctldata.Workflow.Stream.transaction_timestamp:type_name -> vttime.Time
	...
	289, // 186: vtctldata.Workflow.Stream.tablet_types:type_name -> topodata.TabletType
	278, // 187: vtctldata.Workflow.Stream.tablet_selection_preference:type_name -> tabletmanagerdata.TabletSelectionPreference
	280, // 188: vtctldata.Workflow.Stream.Log.created_at:type_name -> vttime.Time
	280, // 189: vtctldata.Workflow.Stream.Log.updated_at:type_name -> vttime.Time
	280, // 190: vtctldata.Workflow.Stream.ThrottlerStatus.time_throttled:type_name -> vttime.Time
	247, // 191: vtctldata.ApplyVSchemaResponse.UnknownVindexParamsEntry.value:type_name -> vtctldata.ApplyVSchemaResponse.ParamList
	10,  // 192: vtctldata.FindAllShardsInKeyspaceResponse.ShardsEntry.value:type_name -> vtctldata.Shard
	303, // 193: vtctldata.GetCellsAliasesResponse.AliasesEntry.value:type_name -> topodata.CellsAlias
	307, // 194: vtctldata.GetShardReplicationResponse.ShardReplicationByCellEntry.value:type_name -> topodata.ShardReplication
	256, // 195: vtctldata.GetSrvKeyspaceNamesResponse.NamesEntry.value:type_name -> vtctldata.GetSrvKeyspaceNamesResponse.NameList
	308, // 196: vtctldata.GetSrvKeyspacesResponse.SrvKeyspacesEntry.value:type_name -> topodata.SrvKeyspace
	300, // 197: vtctldata.GetSrvVSchemasResponse.SrvVSchemasEntry.value:type_name -> vschema.SrvVSchema
	281, // 198: vtctldata.MoveTablesCreateResponse.TabletInfo.tablet:type_name -> topodata.TabletAlias
	309, // 199: vtctldata.ShardReplicationPositionsResponse.ReplicationStatusesEntry.value:type_name -> replicationdata.Status
	290, // 200: vtctldata.ShardReplicationPositionsResponse.TabletMapEntry.value:type_name -> topodata.Tablet
	209, // 201: vtctldata.ValidateResponse.ResultsByKeyspaceEntry.value:type_name -> vtctldata.ValidateKeyspaceResponse
	213, // 202: vtctldata.ValidateKeyspaceResponse.ResultsByShardEntry.value:type_name -> vtctldata.ValidateShardResponse
	213, // 203: vtctldata.ValidateSchemaKeyspaceResponse.ResultsByShardEntry.value:type_name -> vtctldata.ValidateShardResponse
	213, // 204: vtctldata.ValidateVersionKeyspaceResponse.ResultsByShardEntry.value:type_name -> vtctldata.ValidateShardResponse
	213, // 205: vtctldata.ValidateVSchemaResponse.ResultsByShardEntry.value:type_name -> vtctldata.ValidateShardResponse
	310, // 206: vtctldata.VDiffShowResponse.TabletResponsesEntry.value:type_name -> tabletmanagerdata.VDiffResponse
	281, // 207: vtctldata.WorkflowDeleteResponse.TabletInfo.tablet:type_name -> topodata.TabletAlias
	281, // 208: vtctldata.WorkflowStatusResponse.ShardStreamState.tablet:type_name -> topodata.TabletAlias
	272, // 209: vtctldata.WorkflowStatusResponse.ShardStreams.streams:type_name -> vtctldata.WorkflowStatusResponse.ShardStreamState
	271, // 210: vtctldata.WorkflowStatusResponse.TableCopyStateEntry.value:type_name -> vtctldata.WorkflowStatusResponse.TableCopyState
	273, // 211: vtctldata.WorkflowStatusResponse.ShardStreamsEntry.value:type_name -> vtctldata.WorkflowStatusResponse.ShardStreams
	281, // 212: vtctldata.WorkflowUpdateResponse.TabletInfo.tablet:type_name -> topodata.TabletAlias
