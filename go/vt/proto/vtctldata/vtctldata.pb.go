...
var file_vtctldata_proto_rawDesc = []byte{
	...
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x54, 0x0a, 0x20, 0x53, 0x68, 0x61, 0x72,
...
var file_vtctldata_proto_msgTypes = make([]protoimpl.MessageInfo, 175)
var file_vtctldata_proto_goTypes = []interface{}{
	...
	(*ShardReplicationPositionsRequest)(nil),     // 127: vtctldata.ShardReplicationPositionsRequest
	(*ShardReplicationPositionsResponse)(nil),    // 128: vtctldata.ShardReplicationPositionsResponse
	(*SleepTabletRequest)(nil),                   // 129: vtctldata.SleepTabletRequest
	(*SleepTabletResponse)(nil),                  // 130: vtctldata.SleepTabletResponse
	(*SourceShardAddRequest)(nil),                // 131: vtctldata.SourceShardAddRequest
	(*SourceShardAddResponse)(nil),               // 132: vtctldata.SourceShardAddResponse
	(*SourceShardDeleteRequest)(nil),             // 133: vtctldata.SourceShardDeleteRequest
	(*SourceShardDeleteResponse)(nil),            // 134: vtctldata.SourceShardDeleteResponse
	(*StartReplicationRequest)(nil),              // 135: vtctldata.StartReplicationRequest
	(*StartReplicationResponse)(nil),             // 136: vtctldata.StartReplicationResponse
	(*StopReplicationRequest)(nil),               // 137: vtctldata.StopReplicationRequest
	(*StopReplicationResponse)(nil),              // 138: vtctldata.StopReplicationResponse
	(*TabletExternallyReparentedRequest)(nil),    // 139: vtctldata.TabletExternallyReparentedRequest
	(*TabletExternallyReparentedResponse)(nil),   // 140: vtctldata.TabletExternallyReparentedResponse
	(*UpdateCellInfoRequest)(nil),                // 141: vtctldata.UpdateCellInfoRequest
	(*UpdateCellInfoResponse)(nil),               // 142: vtctldata.UpdateCellInfoResponse
	(*UpdateCellsAliasRequest)(nil),              // 143: vtctldata.UpdateCellsAliasRequest
	(*UpdateCellsAliasResponse)(nil),             // 144: vtctldata.UpdateCellsAliasResponse
	(*ValidateRequest)(nil),                      // 145: vtctldata.ValidateRequest
	(*ValidateResponse)(nil),                     // 146: vtctldata.ValidateResponse
	(*ValidateKeyspaceRequest)(nil),              // 147: vtctldata.ValidateKeyspaceRequest
	(*ValidateKeyspaceResponse)(nil),             // 148: vtctldata.ValidateKeyspaceResponse
	(*ValidateSchemaKeyspaceRequest)(nil),        // 149: vtctldata.ValidateSchemaKeyspaceRequest
	(*ValidateSchemaKeyspaceResponse)(nil),       // 150: vtctldata.ValidateSchemaKeyspaceResponse
	(*ValidateShardRequest)(nil),                 // 151: vtctldata.ValidateShardRequest
	(*ValidateShardResponse)(nil),                // 152: vtctldata.ValidateShardResponse
	(*ValidateVersionKeyspaceRequest)(nil),       // 153: vtctldata.ValidateVersionKeyspaceRequest
	(*ValidateVersionKeyspaceResponse)(nil),      // 154: vtctldata.ValidateVersionKeyspaceResponse
	(*ValidateVSchemaRequest)(nil),               // 155: vtctldata.ValidateVSchemaRequest
	(*ValidateVSchemaResponse)(nil),              // 156: vtctldata.ValidateVSchemaResponse
	nil,                                          // 157: vtctldata.Workflow.ShardStreamsEntry
	(*Workflow_ReplicationLocation)(nil),         // 158: vtctldata.Workflow.ReplicationLocation
	(*Workflow_ShardStream)(nil),                 // 159: vtctldata.Workflow.ShardStream
	(*Workflow_Stream)(nil),                      // 160: vtctldata.Workflow.Stream
	(*Workflow_Stream_CopyState)(nil),            // 161: vtctldata.Workflow.Stream.CopyState
	(*Workflow_Stream_Log)(nil),                  // 162: vtctldata.Workflow.Stream.Log
	nil,                                          // 163: vtctldata.FindAllShardsInKeyspaceResponse.ShardsEntry
	nil,                                          // 164: vtctldata.GetCellsAliasesResponse.AliasesEntry
	nil,                                          // 165: vtctldata.GetSrvKeyspaceNamesResponse.NamesEntry
	(*GetSrvKeyspaceNamesResponse_NameList)(nil), // 166: vtctldata.GetSrvKeyspaceNamesResponse.NameList
	nil,                                  // 167: vtctldata.GetSrvKeyspacesResponse.SrvKeyspacesEntry
	nil,                                  // 168: vtctldata.GetSrvVSchemasResponse.SrvVSchemasEntry
	nil,                                  // 169: vtctldata.ShardReplicationPositionsResponse.ReplicationStatusesEntry
	nil,                                  // 170: vtctldata.ShardReplicationPositionsResponse.TabletMapEntry
	nil,                                  // 171: vtctldata.ValidateResponse.ResultsByKeyspaceEntry
	nil,                                  // 172: vtctldata.ValidateKeyspaceResponse.ResultsByShardEntry
	nil,                                  // 173: vtctldata.ValidateSchemaKeyspaceResponse.ResultsByShardEntry
	nil,                                  // 174: vtctldata.ValidateVersionKeyspaceResponse.ResultsByShardEntry
	nil,                                  // 175: vtctldata.ValidateVSchemaResponse.ResultsByShardEntry
	(*logutil.Event)(nil),                // 176: logutil.Event
	(*topodata.Keyspace)(nil),            // 177: topodata.Keyspace
	(*topodata.Shard)(nil),               // 178: topodata.Shard
	(*topodata.CellInfo)(nil),            // 179: topodata.CellInfo
	(*vschema.RoutingRules)(nil),         // 180: vschema.RoutingRules
	(*vttime.Duration)(nil),              // 181: vttime.Duration
	(*vtrpc.CallerID)(nil),               // 182: vtrpc.CallerID
	(*vschema.Keyspace)(nil),             // 183: vschema.Keyspace
	(*topodata.TabletAlias)(nil),         // 184: topodata.TabletAlias
	(topodata.TabletType)(0),             // 185: topodata.TabletType
	(*topodata.Tablet)(nil),              // 186: topodata.Tablet
	(topodata.KeyspaceIdType)(0),         // 187: topodata.KeyspaceIdType
	(*topodata.Keyspace_ServedFrom)(nil), // 188: topodata.Keyspace.ServedFrom
	(topodata.KeyspaceType)(0),           // 189: topodata.KeyspaceType
	(*vttime.Time)(nil),                  // 190: vttime.Time
	(*query.QueryResult)(nil),            // 191: query.QueryResult
	(*tabletmanagerdata.ExecuteHookRequest)(nil),  // 192: tabletmanagerdata.ExecuteHookRequest
	(*tabletmanagerdata.ExecuteHookResponse)(nil), // 193: tabletmanagerdata.ExecuteHookResponse
	(*mysqlctl.BackupInfo)(nil),                   // 194: mysqlctl.BackupInfo
	(*tabletmanagerdata.SchemaDefinition)(nil),    // 195: tabletmanagerdata.SchemaDefinition
	(*vschema.SrvVSchema)(nil),                    // 196: vschema.SrvVSchema
	(*topodata.KeyRange)(nil),                     // 197: topodata.KeyRange
	(*topodata.CellsAlias)(nil),                   // 198: topodata.CellsAlias
	(*topodata.Shard_TabletControl)(nil),          // 199: topodata.Shard.TabletControl
	(*binlogdata.BinlogSource)(nil),               // 200: binlogdata.BinlogSource
	(*topodata.SrvKeyspace)(nil),                  // 201: topodata.SrvKeyspace
	(*replicationdata.Status)(nil),                // 202: replicationdata.Status
}
var file_vtctldata_proto_depIdxs = []int32{
	176, // 0: vtctldata.ExecuteVtctlCommandResponse.event:type_name -> logutil.Event
	...
	177, // 3: vtctldata.Keyspace.keyspace:type_name -> topodata.Keyspace
	178, // 4: vtctldata.Shard.shard:type_name -> topodata.Shard
	158, // 5: vtctldata.Workflow.source:type_name -> vtctldata.Workflow.ReplicationLocation
	158, // 6: vtctldata.Workflow.target:type_name -> vtctldata.Workflow.ReplicationLocation
	157, // 7: vtctldata.Workflow.shard_streams:type_name -> vtctldata.Workflow.ShardStreamsEntry
	179, // 8: vtctldata.AddCellInfoRequest.cell_info:type_name -> topodata.CellInfo
	180, // 9: vtctldata.ApplyRoutingRulesRequest.routing_rules:type_name -> vschema.RoutingRules
	181, // 10: vtctldata.ApplySchemaRequest.wait_replicas_timeout:type_name -> vttime.Duration
	182, // 11: vtctldata.ApplySchemaRequest.caller_id:type_name -> vtrpc.CallerID
	183, // 12: vtctldata.ApplyVSchemaRequest.v_schema:type_name -> vschema.Keyspace
	183, // 13: vtctldata.ApplyVSchemaResponse.v_schema:type_name -> vschema.Keyspace
	184, // 14: vtctldata.BackupRequest.tablet_alias:type_name -> topodata.TabletAlias
	184, // 15: vtctldata.BackupResponse.tablet_alias:type_name -> topodata.TabletAlias
	176, // 16: vtctldata.BackupResponse.event:type_name -> logutil.Event
	184, // 17: vtctldata.ChangeTabletTypeRequest.tablet_alias:type_name -> topodata.TabletAlias
	185, // 18: vtctldata.ChangeTabletTypeRequest.db_type:type_name -> topodata.TabletType
	186, // 19: vtctldata.ChangeTabletTypeResponse.before_tablet:type_name -> topodata.Tablet
	186, // 20: vtctldata.ChangeTabletTypeResponse.after_tablet:type_name -> topodata.Tablet
	187, // 21: vtctldata.CreateKeyspaceRequest.sharding_column_type:type_name -> topodata.KeyspaceIdType
	188, // 22: vtctldata.CreateKeyspaceRequest.served_froms:type_name -> topodata.Keyspace.ServedFrom
	189, // 23: vtctldata.CreateKeyspaceRequest.type:type_name -> topodata.KeyspaceType
	190, // 24: vtctldata.CreateKeyspaceRequest.snapshot_time:type_name -> vttime.Time
	...
	184, // 29: vtctldata.DeleteTabletsRequest.tablet_aliases:type_name -> topodata.TabletAlias
	184, // 30: vtctldata.EmergencyReparentShardRequest.new_primary:type_name -> topodata.TabletAlias
	184, // 31: vtctldata.EmergencyReparentShardRequest.ignore_replicas:type_name -> topodata.TabletAlias
	181, // 32: vtctldata.EmergencyReparentShardRequest.wait_replicas_timeout:type_name -> vttime.Duration
	184, // 33: vtctldata.EmergencyReparentShardResponse.promoted_primary:type_name -> topodata.TabletAlias
	176, // 34: vtctldata.EmergencyReparentShardResponse.events:type_name -> logutil.Event
	184, // 35: vtctldata.ExecuteFetchAsAppRequest.tablet_alias:type_name -> topodata.TabletAlias
	191, // 36: vtctldata.ExecuteFetchAsAppResponse.result:type_name -> query.QueryResult
	184, // 37: vtctldata.ExecuteFetchAsDBARequest.tablet_alias:type_name -> topodata.TabletAlias
	191, // 38: vtctldata.ExecuteFetchAsDBAResponse.result:type_name -> query.QueryResult
	184, // 39: vtctldata.ExecuteHookRequest.tablet_alias:type_name -> topodata.TabletAlias
	192, // 40: vtctldata.ExecuteHookRequest.tablet_hook_request:type_name -> tabletmanagerdata.ExecuteHookRequest
	193, // 41: vtctldata.ExecuteHookResponse.hook_result:type_name -> tabletmanagerdata.ExecuteHookResponse
	163, // 42: vtctldata.FindAllShardsInKeyspaceResponse.shards:type_name -> vtctldata.FindAllShardsInKeyspaceResponse.ShardsEntry
	194, // 43: vtctldata.GetBackupsResponse.backups:type_name -> mysqlctl.BackupInfo
	179, // 44: vtctldata.GetCellInfoResponse.cell_info:type_name -> topodata.CellInfo
	164, // 45: vtctldata.GetCellsAliasesResponse.aliases:type_name -> vtctldata.GetCellsAliasesResponse.AliasesEntry
	...
	180, // 48: vtctldata.GetRoutingRulesResponse.routing_rules:type_name -> vschema.RoutingRules
	184, // 49: vtctldata.GetSchemaRequest.tablet_alias:type_name -> topodata.TabletAlias
	195, // 50: vtctldata.GetSchemaResponse.schema:type_name -> tabletmanagerdata.SchemaDefinition
	6,   // 51: vtctldata.GetShardResponse.shard:type_name -> vtctldata.Shard
	165, // 52: vtctldata.GetSrvKeyspaceNamesResponse.names:type_name -> vtctldata.GetSrvKeyspaceNamesResponse.NamesEntry
	167, // 53: vtctldata.GetSrvKeyspacesResponse.srv_keyspaces:type_name -> vtctldata.GetSrvKeyspacesResponse.SrvKeyspacesEntry
	196, // 54: vtctldata.GetSrvVSchemaResponse.srv_v_schema:type_name -> vschema.SrvVSchema
	168, // 55: vtctldata.GetSrvVSchemasResponse.srv_v_schemas:type_name -> vtctldata.GetSrvVSchemasResponse.SrvVSchemasEntry
	184, // 56: vtctldata.GetTabletRequest.tablet_alias:type_name -> topodata.TabletAlias
	186, // 57: vtctldata.GetTabletResponse.tablet:type_name -> topodata.Tablet
	184, // 58: vtctldata.GetTabletsRequest.tablet_aliases:type_name -> topodata.TabletAlias
	185, // 59: vtctldata.GetTabletsRequest.tablet_type:type_name -> topodata.TabletType
	186, // 60: vtctldata.GetTabletsResponse.tablets:type_name -> topodata.Tablet
	184, // 61: vtctldata.GetVersionRequest.tablet_alias:type_name -> topodata.TabletAlias
	183, // 62: vtctldata.GetVSchemaResponse.v_schema:type_name -> vschema.Keyspace
	7,   // 63: vtctldata.GetWorkflowsResponse.workflows:type_name -> vtctldata.Workflow
	184, // 64: vtctldata.InitShardPrimaryRequest.primary_elect_tablet_alias:type_name -> topodata.TabletAlias
	181, // 65: vtctldata.InitShardPrimaryRequest.wait_replicas_timeout:type_name -> vttime.Duration
	176, // 66: vtctldata.InitShardPrimaryResponse.events:type_name -> logutil.Event
	184, // 67: vtctldata.PingTabletRequest.tablet_alias:type_name -> topodata.TabletAlias
	184, // 68: vtctldata.PlannedReparentShardRequest.new_primary:type_name -> topodata.TabletAlias
	184, // 69: vtctldata.PlannedReparentShardRequest.avoid_primary:type_name -> topodata.TabletAlias
	181, // 70: vtctldata.PlannedReparentShardRequest.wait_replicas_timeout:type_name -> vttime.Duration
	184, // 71: vtctldata.PlannedReparentShardResponse.promoted_primary:type_name -> topodata.TabletAlias
	176, // 72: vtctldata.PlannedReparentShardResponse.events:type_name -> logutil.Event
	184, // 73: vtctldata.RefreshStateRequest.tablet_alias:type_name -> topodata.TabletAlias
	184, // 74: vtctldata.ReloadSchemaRequest.tablet_alias:type_name -> topodata.TabletAlias
	176, // 75: vtctldata.ReloadSchemaKeyspaceResponse.events:type_name -> logutil.Event
	176, // 76: vtctldata.ReloadSchemaShardResponse.events:type_name -> logutil.Event
	184, // 77: vtctldata.ReparentTabletRequest.tablet:type_name -> topodata.TabletAlias
	184, // 78: vtctldata.ReparentTabletResponse.primary:type_name -> topodata.TabletAlias
	184, // 79: vtctldata.RestoreFromBackupRequest.tablet_alias:type_name -> topodata.TabletAlias
	190, // 80: vtctldata.RestoreFromBackupRequest.backup_time:type_name -> vttime.Time
	184, // 81: vtctldata.RestoreFromBackupResponse.tablet_alias:type_name -> topodata.TabletAlias
	176, // 82: vtctldata.RestoreFromBackupResponse.event:type_name -> logutil.Event
	184, // 83: vtctldata.RunHealthCheckRequest.tablet_alias:type_name -> topodata.TabletAlias
	185, // 84: vtctldata.SetKeyspaceServedFromRequest.tablet_type:type_name -> topodata.TabletType
	177, // 85: vtctldata.SetKeyspaceServedFromResponse.keyspace:type_name -> topodata.Keyspace
	187, // 86: vtctldata.SetKeyspaceShardingInfoRequest.column_type:type_name -> topodata.KeyspaceIdType
	177, // 87: vtctldata.SetKeyspaceShardingInfoResponse.keyspace:type_name -> topodata.Keyspace
	178, // 88: vtctldata.SetShardIsPrimaryServingResponse.shard:type_name -> topodata.Shard
	185, // 89: vtctldata.SetShardTabletControlRequest.tablet_type:type_name -> topodata.TabletType
	178, // 90: vtctldata.SetShardTabletControlResponse.shard:type_name -> topodata.Shard
	184, // 91: vtctldata.SetWritableRequest.tablet_alias:type_name -> topodata.TabletAlias
	169, // 92: vtctldata.ShardReplicationPositionsResponse.replication_statuses:type_name -> vtctldata.ShardReplicationPositionsResponse.ReplicationStatusesEntry
	170, // 93: vtctldata.ShardReplicationPositionsResponse.tablet_map:type_name -> vtctldata.ShardReplicationPositionsResponse.TabletMapEntry
	184, // 94: vtctldata.SleepTabletRequest.tablet_alias:type_name -> topodata.TabletAlias
	181, // 95: vtctldata.SleepTabletRequest.duration:type_name -> vttime.Duration
	197, // 96: vtctldata.SourceShardAddRequest.key_range:type_name -> topodata.KeyRange
	178, // 97: vtctldata.SourceShardAddResponse.shard:type_name -> topodata.Shard
	178, // 98: vtctldata.SourceShardDeleteResponse.shard:type_name -> topodata.Shard
	184, // 99: vtctldata.StartReplicationRequest.tablet_alias:type_name -> topodata.TabletAlias
	184, // 100: vtctldata.StopReplicationRequest.tablet_alias:type_name -> topodata.TabletAlias
	184, // 101: vtctldata.TabletExternallyReparentedRequest.tablet:type_name -> topodata.TabletAlias
	184, // 102: vtctldata.TabletExternallyReparentedResponse.new_primary:type_name -> topodata.TabletAlias
	184, // 103: vtctldata.TabletExternallyReparentedResponse.old_primary:type_name -> topodata.TabletAlias
	179, // 104: vtctldata.UpdateCellInfoRequest.cell_info:type_name -> topodata.CellInfo
	179, // 105: vtctldata.UpdateCellInfoResponse.cell_info:type_name -> topodata.CellInfo
	198, // 106: vtctldata.UpdateCellsAliasRequest.cells_alias:type_name -> topodata.CellsAlias
	198, // 107: vtctldata.UpdateCellsAliasResponse.cells_alias:type_name -> topodata.CellsAlias
	171, // 108: vtctldata.ValidateResponse.results_by_keyspace:type_name -> vtctldata.ValidateResponse.ResultsByKeyspaceEntry
	172, // 109: vtctldata.ValidateKeyspaceResponse.results_by_shard:type_name -> vtctldata.ValidateKeyspaceResponse.ResultsByShardEntry
	173, // 110: vtctldata.ValidateSchemaKeyspaceResponse.results_by_shard:type_name -> vtctldata.ValidateSchemaKeyspaceResponse.ResultsByShardEntry
	174, // 111: vtctldata.ValidateVersionKeyspaceResponse.results_by_shard:type_name -> vtctldata.ValidateVersionKeyspaceResponse.ResultsByShardEntry
	175, // 112: vtctldata.ValidateVSchemaResponse.results_by_shard:type_name -> vtctldata.ValidateVSchemaResponse.ResultsByShardEntry
	159, // 113: vtctldata.Workflow.ShardStreamsEntry.value:type_name -> vtctldata.Workflow.ShardStream
	160, // 114: vtctldata.Workflow.ShardStream.streams:type_name -> vtctldata.Workflow.Stream
	199, // 115: vtctldata.Workflow.ShardStream.tablet_controls:type_name -> topodata.Shard.TabletControl
	184, // 116: vtctldata.Workflow.Stream.tablet:type_name -> topodata.TabletAlias
	200, // 117: vtctldata.Workflow.Stream.binlog_source:type_name -> binlogdata.BinlogSource
	190, // 118: vtctldata.Workflow.Stream.transaction_timestamp:type_name -> vttime.Time
	190, // 119: vtctldata.Workflow.Stream.time_updated:type_name -> vttime.Time
	161, // 120: vtctldata.Workflow.Stream.copy_states:type_name -> vtctldata.Workflow.Stream.CopyState
	162, // 121: vtctldata.Workflow.Stream.logs:type_name -> vtctldata.Workflow.Stream.Log
	190, // 122: vtctldata.Workflow.Stream.Log.created_at:type_name -> vttime.Time
	190, // 123: vtctldata.Workflow.Stream.Log.updated_at:type_name -> vttime.Time
	6,   // 124: vtctldata.FindAllShardsInKeyspaceResponse.ShardsEntry.value:type_name -> vtctldata.Shard
	198, // 125: vtctldata.GetCellsAliasesResponse.AliasesEntry.value:type_name -> topodata.CellsAlias
	166, // 126: vtctldata.GetSrvKeyspaceNamesResponse.NamesEntry.value:type_name -> vtctldata.GetSrvKeyspaceNamesResponse.NameList
	201, // 127: vtctldata.GetSrvKeyspacesResponse.SrvKeyspacesEntry.value:type_name -> topodata.SrvKeyspace
	196, // 128: vtctldata.GetSrvVSchemasResponse.SrvVSchemasEntry.value:type_name -> vschema.SrvVSchema
	202, // 129: vtctldata.ShardReplicationPositionsResponse.ReplicationStatusesEntry.value:type_name -> replicationdata.Status
	186, // 130: vtctldata.ShardReplicationPositionsResponse.TabletMapEntry.value:type_name -> topodata.Tablet
	148, // 131: vtctldata.ValidateResponse.ResultsByKeyspaceEntry.value:type_name -> vtctldata.ValidateKeyspaceResponse
	152, // 132: vtctldata.ValidateKeyspaceResponse.ResultsByShardEntry.value:type_name -> vtctldata.ValidateShardResponse
	152, // 133: vtctldata.ValidateSchemaKeyspaceResponse.ResultsByShardEntry.value:type_name -> vtctldata.ValidateShardResponse
	152, // 134: vtctldata.ValidateVersionKeyspaceResponse.ResultsByShardEntry.value:type_name -> vtctldata.ValidateShardResponse
	152, // 135: vtctldata.ValidateVSchemaResponse.ResultsByShardEntry.value:type_name -> vtctldata.ValidateShardResponse
