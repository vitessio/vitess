...
var file_vtctldata_proto_rawDesc = []byte{
	...
	0x44, 0x72, 0x79, 0x52, 0x75, 0x6e, 0x22, 0x32, 0x0a, 0x15, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x54,
	...
	0x09, 0x52, 0x07, 0x61, 0x70, 0x70, 0x4e, 0x61, 0x6d, 0x65, 0x22, 0x9c, 0x04, 0x0a, 0x16, 0x43,
	...
	0x65, 0x63, 0x6b, 0x65, 0x64, 0x12, 0x48, 0x0a, 0x07, 0x6d, 0x65, 0x74, 0x72, 0x69, 0x63, 0x73,
	0x18, 0x07, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x2e, 0x2e, 0x76, 0x74, 0x63, 0x74, 0x6c, 0x64, 0x61,
	...
	0xa1, 0x01, 0x0a, 0x06, 0x4d, 0x65, 0x74, 0x72, 0x69, 0x63, 0x12, 0x12, 0x0a, 0x04, 0x6e, 0x61,
	...
	0x6f, 0x6c, 0x64, 0x12, 0x14, 0x0a, 0x05, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x18, 0x05, 0x20, 0x01,
	...
	0x61, 0x67, 0x65, 0x1a, 0x64, 0x0a, 0x0c, 0x4d, 0x65, 0x74, 0x72, 0x69, 0x63, 0x73, 0x45, 0x6e,
	0x74, 0x72, 0x79, 0x12, 0x10, 0x0a, 0x03, 0x6b, 0x65, 0x79, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09,
...
var file_vtctldata_proto_depIdxs = []int32{
	...
	259, // 44: vtctldata.CheckThrottlerResponse.metrics:type_name -> vtctldata.CheckThrottlerResponse.MetricsEntry
	260, // 45: vtctldata.CleanupSchemaMigrationResponse.rows_affected_by_shard:type_name -> vtctldata.CleanupSchemaMigrationResponse.RowsAffectedByShardEntry
	261, // 46: vtctldata.CompleteSchemaMigrationResponse.rows_affected_by_shard:type_name -> vtctldata.CompleteSchemaMigrationResponse.RowsAffectedByShardEntry
	303, // 47: vtctldata.CreateKeyspaceRequest.type:type_name -> topodata.KeyspaceType
	291, // 48: vtctldata.CreateKeyspaceRequest.snapshot_time:type_name -> vttime.Time
	...
	292, // 53: vtctldata.DeleteTabletsRequest.tablet_aliases:type_name -> topodata.TabletAlias
	292, // 54: vtctldata.EmergencyReparentShardRequest.new_primary:type_name -> topodata.TabletAlias
	292, // 55: vtctldata.EmergencyReparentShardRequest.ignore_replicas:type_name -> topodata.TabletAlias
	293, // 56: vtctldata.EmergencyReparentShardRequest.wait_replicas_timeout:type_name -> vttime.Duration
	292, // 57: vtctldata.EmergencyReparentShardResponse.promoted_primary:type_name -> topodata.TabletAlias
	288, // 58: vtctldata.EmergencyReparentShardResponse.events:type_name -> logutil.Event
	292, // 59: vtctldata.ExecuteFetchAsAppRequest.tablet_alias:type_name -> topodata.TabletAlias
	304, // 60: vtctldata.ExecuteFetchAsAppResponse.result:type_name -> query.QueryResult
	292, // 61: vtctldata.ExecuteFetchAsDBARequest.tablet_alias:type_name -> topodata.TabletAlias
	304, // 62: vtctldata.ExecuteFetchAsDBAResponse.result:type_name -> query.QueryResult
	292, // 63: vtctldata.ExecuteHookRequest.tablet_alias:type_name -> topodata.TabletAlias
	305, // 64: vtctldata.ExecuteHookRequest.tablet_hook_request:type_name -> tabletmanagerdata.ExecuteHookRequest
	306, // 65: vtctldata.ExecuteHookResponse.hook_result:type_name -> tabletmanagerdata.ExecuteHookResponse
	292, // 66: vtctldata.ExecuteMultiFetchAsDBARequest.tablet_alias:type_name -> topodata.TabletAlias
	304, // 67: vtctldata.ExecuteMultiFetchAsDBAResponse.results:type_name -> query.QueryResult
	262, // 68: vtctldata.FindAllShardsInKeyspaceResponse.shards:type_name -> vtctldata.FindAllShardsInKeyspaceResponse.ShardsEntry
	263, // 69: vtctldata.ForceCutOverSchemaMigrationResponse.rows_affected_by_shard:type_name -> vtctldata.ForceCutOverSchemaMigrationResponse.RowsAffectedByShardEntry
	307, // 70: vtctldata.GetBackupsResponse.backups:type_name -> mysqlctl.BackupInfo
	295, // 71: vtctldata.GetCellInfoResponse.cell_info:type_name -> topodata.CellInfo
	264, // 72: vtctldata.GetCellsAliasesResponse.aliases:type_name -> vtctldata.GetCellsAliasesResponse.AliasesEntry
	292, // 73: vtctldata.GetFullStatusRequest.tablet_alias:type_name -> topodata.TabletAlias
	308, // 74: vtctldata.GetFullStatusResponse.status:type_name -> replicationdata.FullStatus
	...
	292, // 77: vtctldata.GetPermissionsRequest.tablet_alias:type_name -> topodata.TabletAlias
	309, // 78: vtctldata.GetPermissionsResponse.permissions:type_name -> tabletmanagerdata.Permissions
	296, // 79: vtctldata.GetKeyspaceRoutingRulesResponse.keyspace_routing_rules:type_name -> vschema.KeyspaceRoutingRules
	297, // 80: vtctldata.GetRoutingRulesResponse.routing_rules:type_name -> vschema.RoutingRules
	292, // 81: vtctldata.GetSchemaRequest.tablet_alias:type_name -> topodata.TabletAlias
	310, // 82: vtctldata.GetSchemaResponse.schema:type_name -> tabletmanagerdata.SchemaDefinition
	3,   // 83: vtctldata.GetSchemaMigrationsRequest.status:type_name -> vtctldata.SchemaMigration.Status
	293, // 84: vtctldata.GetSchemaMigrationsRequest.recent:type_name -> vttime.Duration
	...
	265, // 87: vtctldata.GetShardReplicationResponse.shard_replication_by_cell:type_name -> vtctldata.GetShardReplicationResponse.ShardReplicationByCellEntry
	10,  // 88: vtctldata.GetShardResponse.shard:type_name -> vtctldata.Shard
	298, // 89: vtctldata.GetShardRoutingRulesResponse.shard_routing_rules:type_name -> vschema.ShardRoutingRules
	266, // 90: vtctldata.GetSrvKeyspaceNamesResponse.names:type_name -> vtctldata.GetSrvKeyspaceNamesResponse.NamesEntry
	268, // 91: vtctldata.GetSrvKeyspacesResponse.srv_keyspaces:type_name -> vtctldata.GetSrvKeyspacesResponse.SrvKeyspacesEntry
	311, // 92: vtctldata.UpdateThrottlerConfigRequest.throttled_app:type_name -> topodata.ThrottledAppRule
	312, // 93: vtctldata.GetSrvVSchemaResponse.srv_v_schema:type_name -> vschema.SrvVSchema
	269, // 94: vtctldata.GetSrvVSchemasResponse.srv_v_schemas:type_name -> vtctldata.GetSrvVSchemasResponse.SrvVSchemasEntry
	292, // 95: vtctldata.GetTabletRequest.tablet_alias:type_name -> topodata.TabletAlias
	302, // 96: vtctldata.GetTabletResponse.tablet:type_name -> topodata.Tablet
	292, // 97: vtctldata.GetTabletsRequest.tablet_aliases:type_name -> topodata.TabletAlias
	301, // 98: vtctldata.GetTabletsRequest.tablet_type:type_name -> topodata.TabletType
	302, // 99: vtctldata.GetTabletsResponse.tablets:type_name -> topodata.Tablet
	116, // 100: vtctldata.GetTopologyPathResponse.cell:type_name -> vtctldata.TopologyCell
	292, // 101: vtctldata.GetVersionRequest.tablet_alias:type_name -> topodata.TabletAlias
	300, // 102: vtctldata.GetVSchemaResponse.v_schema:type_name -> vschema.Keyspace
	12,  // 103: vtctldata.GetWorkflowsResponse.workflows:type_name -> vtctldata.Workflow
	292, // 104: vtctldata.InitShardPrimaryRequest.primary_elect_tablet_alias:type_name -> topodata.TabletAlias
	293, // 105: vtctldata.InitShardPrimaryRequest.wait_replicas_timeout:type_name -> vttime.Duration
	288, // 106: vtctldata.InitShardPrimaryResponse.events:type_name -> logutil.Event
	270, // 107: vtctldata.LaunchSchemaMigrationResponse.rows_affected_by_shard:type_name -> vtctldata.LaunchSchemaMigrationResponse.RowsAffectedByShardEntry
	300, // 108: vtctldata.LookupVindexCreateRequest.vindex:type_name -> vschema.Keyspace
	301, // 109: vtctldata.LookupVindexCreateRequest.tablet_types:type_name -> topodata.TabletType
	289, // 110: vtctldata.LookupVindexCreateRequest.tablet_selection_preference:type_name -> tabletmanagerdata.TabletSelectionPreference
	7,   // 111: vtctldata.MaterializeCreateRequest.settings:type_name -> vtctldata.MaterializeSettings
	301, // 112: vtctldata.MigrateCreateRequest.tablet_types:type_name -> topodata.TabletType
	289, // 113: vtctldata.MigrateCreateRequest.tablet_selection_preference:type_name -> tabletmanagerdata.TabletSelectionPreference
	301, // 114: vtctldata.MoveTablesCreateRequest.tablet_types:type_name -> topodata.TabletType
	289, // 115: vtctldata.MoveTablesCreateRequest.tablet_selection_preference:type_name -> tabletmanagerdata.TabletSelectionPreference
	11,  // 116: vtctldata.MoveTablesCreateRequest.workflow_options:type_name -> vtctldata.WorkflowOptions
	271, // 117: vtctldata.MoveTablesCreateResponse.details:type_name -> vtctldata.MoveTablesCreateResponse.TabletInfo
	292, // 118: vtctldata.PingTabletRequest.tablet_alias:type_name -> topodata.TabletAlias
	292, // 119: vtctldata.PlannedReparentShardRequest.new_primary:type_name -> topodata.TabletAlias
	292, // 120: vtctldata.PlannedReparentShardRequest.avoid_primary:type_name -> topodata.TabletAlias
	293, // 121: vtctldata.PlannedReparentShardRequest.wait_replicas_timeout:type_name -> vttime.Duration
	293, // 122: vtctldata.PlannedReparentShardRequest.tolerable_replication_lag:type_name -> vttime.Duration
	292, // 123: vtctldata.PlannedReparentShardResponse.promoted_primary:type_name -> topodata.TabletAlias
	288, // 124: vtctldata.PlannedReparentShardResponse.events:type_name -> logutil.Event
	292, // 125: vtctldata.RefreshStateRequest.tablet_alias:type_name -> topodata.TabletAlias
	292, // 126: vtctldata.ReloadSchemaRequest.tablet_alias:type_name -> topodata.TabletAlias
	288, // 127: vtctldata.ReloadSchemaKeyspaceResponse.events:type_name -> logutil.Event
	288, // 128: vtctldata.ReloadSchemaShardResponse.events:type_name -> logutil.Event
	292, // 129: vtctldata.ReparentTabletRequest.tablet:type_name -> topodata.TabletAlias
	292, // 130: vtctldata.ReparentTabletResponse.primary:type_name -> topodata.TabletAlias
	301, // 131: vtctldata.ReshardCreateRequest.tablet_types:type_name -> topodata.TabletType
	289, // 132: vtctldata.ReshardCreateRequest.tablet_selection_preference:type_name -> tabletmanagerdata.TabletSelectionPreference
	292, // 133: vtctldata.RestoreFromBackupRequest.tablet_alias:type_name -> topodata.TabletAlias
	291, // 134: vtctldata.RestoreFromBackupRequest.backup_time:type_name -> vttime.Time
	291, // 135: vtctldata.RestoreFromBackupRequest.restore_to_timestamp:type_name -> vttime.Time
	292, // 136: vtctldata.RestoreFromBackupResponse.tablet_alias:type_name -> topodata.TabletAlias
	288, // 137: vtctldata.RestoreFromBackupResponse.event:type_name -> logutil.Event
	272, // 138: vtctldata.RetrySchemaMigrationResponse.rows_affected_by_shard:type_name -> vtctldata.RetrySchemaMigrationResponse.RowsAffectedByShardEntry
	292, // 139: vtctldata.RunHealthCheckRequest.tablet_alias:type_name -> topodata.TabletAlias
	290, // 140: vtctldata.SetKeyspaceDurabilityPolicyResponse.keyspace:type_name -> topodata.Keyspace
	290, // 141: vtctldata.SetKeyspaceShardingInfoResponse.keyspace:type_name -> topodata.Keyspace
	294, // 142: vtctldata.SetShardIsPrimaryServingResponse.shard:type_name -> topodata.Shard
	301, // 143: vtctldata.SetShardTabletControlRequest.tablet_type:type_name -> topodata.TabletType
	294, // 144: vtctldata.SetShardTabletControlResponse.shard:type_name -> topodata.Shard
	292, // 145: vtctldata.SetWritableRequest.tablet_alias:type_name -> topodata.TabletAlias
	292, // 146: vtctldata.ShardReplicationAddRequest.tablet_alias:type_name -> topodata.TabletAlias
	313, // 147: vtctldata.ShardReplicationFixResponse.error:type_name -> topodata.ShardReplicationError
	273, // 148: vtctldata.ShardReplicationPositionsResponse.replication_statuses:type_name -> vtctldata.ShardReplicationPositionsResponse.ReplicationStatusesEntry
	274, // 149: vtctldata.ShardReplicationPositionsResponse.tablet_map:type_name -> vtctldata.ShardReplicationPositionsResponse.TabletMapEntry
	292, // 150: vtctldata.ShardReplicationRemoveRequest.tablet_alias:type_name -> topodata.TabletAlias
	292, // 151: vtctldata.SleepTabletRequest.tablet_alias:type_name -> topodata.TabletAlias
	293, // 152: vtctldata.SleepTabletRequest.duration:type_name -> vttime.Duration
	314, // 153: vtctldata.SourceShardAddRequest.key_range:type_name -> topodata.KeyRange
	294, // 154: vtctldata.SourceShardAddResponse.shard:type_name -> topodata.Shard
	294, // 155: vtctldata.SourceShardDeleteResponse.shard:type_name -> topodata.Shard
	292, // 156: vtctldata.StartReplicationRequest.tablet_alias:type_name -> topodata.TabletAlias
	292, // 157: vtctldata.StopReplicationRequest.tablet_alias:type_name -> topodata.TabletAlias
	292, // 158: vtctldata.TabletExternallyReparentedRequest.tablet:type_name -> topodata.TabletAlias
	292, // 159: vtctldata.TabletExternallyReparentedResponse.new_primary:type_name -> topodata.TabletAlias
	292, // 160: vtctldata.TabletExternallyReparentedResponse.old_primary:type_name -> topodata.TabletAlias
	295, // 161: vtctldata.UpdateCellInfoRequest.cell_info:type_name -> topodata.CellInfo
	295, // 162: vtctldata.UpdateCellInfoResponse.cell_info:type_name -> topodata.CellInfo
	315, // 163: vtctldata.UpdateCellsAliasRequest.cells_alias:type_name -> topodata.CellsAlias
	315, // 164: vtctldata.UpdateCellsAliasResponse.cells_alias:type_name -> topodata.CellsAlias
	275, // 165: vtctldata.ValidateResponse.results_by_keyspace:type_name -> vtctldata.ValidateResponse.ResultsByKeyspaceEntry
	276, // 166: vtctldata.ValidateKeyspaceResponse.results_by_shard:type_name -> vtctldata.ValidateKeyspaceResponse.ResultsByShardEntry
	277, // 167: vtctldata.ValidateSchemaKeyspaceResponse.results_by_shard:type_name -> vtctldata.ValidateSchemaKeyspaceResponse.ResultsByShardEntry
	278, // 168: vtctldata.ValidateVersionKeyspaceResponse.results_by_shard:type_name -> vtctldata.ValidateVersionKeyspaceResponse.ResultsByShardEntry
	279, // 169: vtctldata.ValidateVSchemaResponse.results_by_shard:type_name -> vtctldata.ValidateVSchemaResponse.ResultsByShardEntry
	301, // 170: vtctldata.VDiffCreateRequest.tablet_types:type_name -> topodata.TabletType
	289, // 171: vtctldata.VDiffCreateRequest.tablet_selection_preference:type_name -> tabletmanagerdata.TabletSelectionPreference
	293, // 172: vtctldata.VDiffCreateRequest.filtered_replication_wait_time:type_name -> vttime.Duration
	293, // 173: vtctldata.VDiffCreateRequest.wait_update_interval:type_name -> vttime.Duration
	293, // 174: vtctldata.VDiffCreateRequest.max_diff_duration:type_name -> vttime.Duration
	280, // 175: vtctldata.VDiffShowResponse.tablet_responses:type_name -> vtctldata.VDiffShowResponse.TabletResponsesEntry
	281, // 176: vtctldata.WorkflowDeleteResponse.details:type_name -> vtctldata.WorkflowDeleteResponse.TabletInfo
	285, // 177: vtctldata.WorkflowStatusResponse.table_copy_state:type_name -> vtctldata.WorkflowStatusResponse.TableCopyStateEntry
	286, // 178: vtctldata.WorkflowStatusResponse.shard_streams:type_name -> vtctldata.WorkflowStatusResponse.ShardStreamsEntry
	301, // 179: vtctldata.WorkflowSwitchTrafficRequest.tablet_types:type_name -> topodata.TabletType
	293, // 180: vtctldata.WorkflowSwitchTrafficRequest.max_replication_lag_allowed:type_name -> vttime.Duration
	293, // 181: vtctldata.WorkflowSwitchTrafficRequest.timeout:type_name -> vttime.Duration
	316, // 182: vtctldata.WorkflowUpdateRequest.tablet_request:type_name -> tabletmanagerdata.UpdateVReplicationWorkflowRequest
	287, // 183: vtctldata.WorkflowUpdateResponse.details:type_name -> vtctldata.WorkflowUpdateResponse.TabletInfo
	249, // 184: vtctldata.Workflow.ShardStreamsEntry.value:type_name -> vtctldata.Workflow.ShardStream
	250, // 185: vtctldata.Workflow.ShardStream.streams:type_name -> vtctldata.Workflow.Stream
	317, // 186: vtctldata.Workflow.ShardStream.tablet_controls:type_name -> topodata.Shard.TabletControl
	292, // 187: vtctldata.Workflow.Stream.tablet:type_name -> topodata.TabletAlias
	318, // 188: vtctldata.Workflow.Stream.binlog_source:type_name -> binlogdata.BinlogSource
	291, // 189: vtctldata.Workflow.Stream.transaction_timestamp:type_name -> vttime.Time
	291, // 190: vtctldata.Workflow.Stream.time_updated:type_name -> vttime.Time
	251, // 191: vtctldata.Workflow.Stream.copy_states:type_name -> vtctldata.Workflow.Stream.CopyState
	252, // 192: vtctldata.Workflow.Stream.logs:type_name -> vtctldata.Workflow.Stream.Log
	253, // 193: vtctldata.Workflow.Stream.throttler_status:type_name -> vtctldata.Workflow.Stream.ThrottlerStatus
	301, // 194: vtctldata.Workflow.Stream.tablet_types:type_name -> topodata.TabletType
	289, // 195: vtctldata.Workflow.Stream.tablet_selection_preference:type_name -> tabletmanagerdata.TabletSelectionPreference
	291, // 196: vtctldata.Workflow.Stream.Log.created_at:type_name -> vttime.Time
	291, // 197: vtctldata.Workflow.Stream.Log.updated_at:type_name -> vttime.Time
	291, // 198: vtctldata.Workflow.Stream.ThrottlerStatus.time_throttled:type_name -> vttime.Time
	256, // 199: vtctldata.ApplyVSchemaResponse.UnknownVindexParamsEntry.value:type_name -> vtctldata.ApplyVSchemaResponse.ParamList
	258, // 200: vtctldata.CheckThrottlerResponse.MetricsEntry.value:type_name -> vtctldata.CheckThrottlerResponse.Metric
	10,  // 201: vtctldata.FindAllShardsInKeyspaceResponse.ShardsEntry.value:type_name -> vtctldata.Shard
	315, // 202: vtctldata.GetCellsAliasesResponse.AliasesEntry.value:type_name -> topodata.CellsAlias
	319, // 203: vtctldata.GetShardReplicationResponse.ShardReplicationByCellEntry.value:type_name -> topodata.ShardReplication
	267, // 204: vtctldata.GetSrvKeyspaceNamesResponse.NamesEntry.value:type_name -> vtctldata.GetSrvKeyspaceNamesResponse.NameList
	320, // 205: vtctldata.GetSrvKeyspacesResponse.SrvKeyspacesEntry.value:type_name -> topodata.SrvKeyspace
	312, // 206: vtctldata.GetSrvVSchemasResponse.SrvVSchemasEntry.value:type_name -> vschema.SrvVSchema
	292, // 207: vtctldata.MoveTablesCreateResponse.TabletInfo.tablet:type_name -> topodata.TabletAlias
	321, // 208: vtctldata.ShardReplicationPositionsResponse.ReplicationStatusesEntry.value:type_name -> replicationdata.Status
	302, // 209: vtctldata.ShardReplicationPositionsResponse.TabletMapEntry.value:type_name -> topodata.Tablet
	218, // 210: vtctldata.ValidateResponse.ResultsByKeyspaceEntry.value:type_name -> vtctldata.ValidateKeyspaceResponse
	222, // 211: vtctldata.ValidateKeyspaceResponse.ResultsByShardEntry.value:type_name -> vtctldata.ValidateShardResponse
	222, // 212: vtctldata.ValidateSchemaKeyspaceResponse.ResultsByShardEntry.value:type_name -> vtctldata.ValidateShardResponse
	222, // 213: vtctldata.ValidateVersionKeyspaceResponse.ResultsByShardEntry.value:type_name -> vtctldata.ValidateShardResponse
	222, // 214: vtctldata.ValidateVSchemaResponse.ResultsByShardEntry.value:type_name -> vtctldata.ValidateShardResponse
	322, // 215: vtctldata.VDiffShowResponse.TabletResponsesEntry.value:type_name -> tabletmanagerdata.VDiffResponse
	292, // 216: vtctldata.WorkflowDeleteResponse.TabletInfo.tablet:type_name -> topodata.TabletAlias
	292, // 217: vtctldata.WorkflowStatusResponse.ShardStreamState.tablet:type_name -> topodata.TabletAlias
	283, // 218: vtctldata.WorkflowStatusResponse.ShardStreams.streams:type_name -> vtctldata.WorkflowStatusResponse.ShardStreamState
	282, // 219: vtctldata.WorkflowStatusResponse.TableCopyStateEntry.value:type_name -> vtctldata.WorkflowStatusResponse.TableCopyState
	284, // 220: vtctldata.WorkflowStatusResponse.ShardStreamsEntry.value:type_name -> vtctldata.WorkflowStatusResponse.ShardStreams
	292, // 221: vtctldata.WorkflowUpdateResponse.TabletInfo.tablet:type_name -> topodata.TabletAlias
