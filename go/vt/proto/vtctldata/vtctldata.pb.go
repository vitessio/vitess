...
type VDiffCreateRequest struct {
	...
	MaxExtraRowsToCompare       uint64                                      `protobuf:"varint,14,opt,name=max_extra_rows_to_compare,json=maxExtraRowsToCompare,proto3" json:"max_extra_rows_to_compare,omitempty"`
	...
	MaxReportSampleRows         uint64                                      `protobuf:"varint,19,opt,name=max_report_sample_rows,json=maxReportSampleRows,proto3" json:"max_report_sample_rows,omitempty"`
}
...
func (x *VDiffCreateRequest) GetLimit() uint32 {
	if x != nil {
		return x.Limit
	}
	return 0
...
func (x *VDiffCreateRequest) GetMaxExtraRowsToCompare() uint64 {
	if x != nil {
...
func (x *VDiffCreateRequest) GetMaxReportSampleRows() uint64 {
	if x != nil {
...
var file_vtctldata_proto_rawDesc = []byte{
	...
	0x65, 0x18, 0x0e, 0x20, 0x01, 0x28, 0x04, 0x52, 0x15, 0x6d, 0x61, 0x78, 0x45, 0x78, 0x74, 0x72,
	...
	0x6d, 0x70, 0x6c, 0x65, 0x5f, 0x72, 0x6f, 0x77, 0x73, 0x18, 0x13, 0x20, 0x01, 0x28, 0x04, 0x52,
