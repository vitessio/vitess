...
var file_vtctldata_proto_rawDesc = []byte{
	...
	0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0xca, 0x06, 0x0a, 0x12, 0x56, 0x44,
	...
	0x6c, 0x65, 0x52, 0x6f, 0x77, 0x73, 0x22, 0x29, 0x0a, 0x13, 0x56, 0x44, 0x69, 0x66, 0x66, 0x43,
	...
	0x73, 0x65, 0x22, 0x9a, 0x01, 0x0a, 0x15, 0x57, 0x6f, 0x72, 0x6b, 0x66, 0x6c, 0x6f, 0x77, 0x44,
	...
	0x6b, 0x65, 0x79, 0x73, 0x70, 0x61, 0x63, 0x65, 0x12, 0x1a, 0x0a, 0x08, 0x77, 0x6f, 0x72, 0x6b,
	0x66, 0x6c, 0x6f, 0x77, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x77, 0x6f, 0x72, 0x6b,
	0x66, 0x6c, 0x6f, 0x77, 0x22, 0xe6, 0x07, 0x0a, 0x16, 0x57, 0x6f, 0x72, 0x6b, 0x66, 0x6c, 0x6f,
...
var file_vtctldata_proto_goTypes = []interface{}{
	...
	(*SetKeyspaceServedFromRequest)(nil),         // 172: vtctldata.SetKeyspaceServedFromRequest
	(*SetKeyspaceServedFromResponse)(nil),        // 173: vtctldata.SetKeyspaceServedFromResponse
	...
	(*topodata.Keyspace_ServedFrom)(nil),                        // 288: topodata.Keyspace.ServedFrom
	(topodata.KeyspaceType)(0),                                  // 289: topodata.KeyspaceType
	(*query.QueryResult)(nil),                                   // 290: query.QueryResult
	(*tabletmanagerdata.ExecuteHookRequest)(nil),                // 291: tabletmanagerdata.ExecuteHookRequest
	(*tabletmanagerdata.ExecuteHookResponse)(nil),               // 292: tabletmanagerdata.ExecuteHookResponse
	(*mysqlctl.BackupInfo)(nil),                                 // 293: mysqlctl.BackupInfo
	(*replicationdata.FullStatus)(nil),                          // 294: replicationdata.FullStatus
	(*tabletmanagerdata.Permissions)(nil),                       // 295: tabletmanagerdata.Permissions
	(*tabletmanagerdata.SchemaDefinition)(nil),                  // 296: tabletmanagerdata.SchemaDefinition
	(*topodata.ThrottledAppRule)(nil),                           // 297: topodata.ThrottledAppRule
	(*vschema.SrvVSchema)(nil),                                  // 298: vschema.SrvVSchema
	(*topodata.ShardReplicationError)(nil),                      // 299: topodata.ShardReplicationError
	(*topodata.KeyRange)(nil),                                   // 300: topodata.KeyRange
	(*topodata.CellsAlias)(nil),                                 // 301: topodata.CellsAlias
	(*tabletmanagerdata.UpdateVReplicationWorkflowRequest)(nil), // 302: tabletmanagerdata.UpdateVReplicationWorkflowRequest
	(*topodata.Shard_TabletControl)(nil),                        // 303: topodata.Shard.TabletControl
	(*binlogdata.BinlogSource)(nil),                             // 304: binlogdata.BinlogSource
	(*topodata.SrvKeyspace)(nil),                                // 305: topodata.SrvKeyspace
	(*replicationdata.Status)(nil),                              // 306: replicationdata.Status
	(*tabletmanagerdata.VDiffResponse)(nil),                     // 307: tabletmanagerdata.VDiffResponse
}
var file_vtctldata_proto_depIdxs = []int32{
	...
	278, // 32: vtctldata.BackupRequest.tablet_alias:type_name -> topodata.TabletAlias
	278, // 33: vtctldata.BackupResponse.tablet_alias:type_name -> topodata.TabletAlias
	274, // 34: vtctldata.BackupResponse.event:type_name -> logutil.Event
	246, // 35: vtctldata.CancelSchemaMigrationResponse.rows_affected_by_shard:type_name -> vtctldata.CancelSchemaMigrationResponse.RowsAffectedByShardEntry
	278, // 36: vtctldata.ChangeTabletTypeRequest.tablet_alias:type_name -> topodata.TabletAlias
	286, // 37: vtctldata.ChangeTabletTypeRequest.db_type:type_name -> topodata.TabletType
	287, // 38: vtctldata.ChangeTabletTypeResponse.before_tablet:type_name -> topodata.Tablet
	287, // 39: vtctldata.ChangeTabletTypeResponse.after_tablet:type_name -> topodata.Tablet
	247, // 40: vtctldata.CleanupSchemaMigrationResponse.rows_affected_by_shard:type_name -> vtctldata.CleanupSchemaMigrationResponse.RowsAffectedByShardEntry
	248, // 41: vtctldata.CompleteSchemaMigrationResponse.rows_affected_by_shard:type_name -> vtctldata.CompleteSchemaMigrationResponse.RowsAffectedByShardEntry
	288, // 42: vtctldata.CreateKeyspaceRequest.served_froms:type_name -> topodata.Keyspace.ServedFrom
	289, // 43: vtctldata.CreateKeyspaceRequest.type:type_name -> topodata.KeyspaceType
	...
	290, // 56: vtctldata.ExecuteFetchAsAppResponse.result:type_name -> query.QueryResult
	278, // 57: vtctldata.ExecuteFetchAsDBARequest.tablet_alias:type_name -> topodata.TabletAlias
	290, // 58: vtctldata.ExecuteFetchAsDBAResponse.result:type_name -> query.QueryResult
	278, // 59: vtctldata.ExecuteHookRequest.tablet_alias:type_name -> topodata.TabletAlias
	291, // 60: vtctldata.ExecuteHookRequest.tablet_hook_request:type_name -> tabletmanagerdata.ExecuteHookRequest
	292, // 61: vtctldata.ExecuteHookResponse.hook_result:type_name -> tabletmanagerdata.ExecuteHookResponse
	...
	293, // 64: vtctldata.GetBackupsResponse.backups:type_name -> mysqlctl.BackupInfo
	...
	294, // 68: vtctldata.GetFullStatusResponse.status:type_name -> replicationdata.FullStatus
	...
	295, // 72: vtctldata.GetPermissionsResponse.permissions:type_name -> tabletmanagerdata.Permissions
	...
	296, // 75: vtctldata.GetSchemaResponse.schema:type_name -> tabletmanagerdata.SchemaDefinition
	...
	297, // 84: vtctldata.UpdateThrottlerConfigRequest.throttled_app:type_name -> topodata.ThrottledAppRule
	298, // 85: vtctldata.GetSrvVSchemaResponse.srv_v_schema:type_name -> vschema.SrvVSchema
	...
	286, // 132: vtctldata.SetKeyspaceServedFromRequest.tablet_type:type_name -> topodata.TabletType
	276, // 133: vtctldata.SetKeyspaceServedFromResponse.keyspace:type_name -> topodata.Keyspace
	276, // 134: vtctldata.SetKeyspaceShardingInfoResponse.keyspace:type_name -> topodata.Keyspace
	280, // 135: vtctldata.SetShardIsPrimaryServingResponse.shard:type_name -> topodata.Shard
	286, // 136: vtctldata.SetShardTabletControlRequest.tablet_type:type_name -> topodata.TabletType
	280, // 137: vtctldata.SetShardTabletControlResponse.shard:type_name -> topodata.Shard
	278, // 138: vtctldata.SetWritableRequest.tablet_alias:type_name -> topodata.TabletAlias
	278, // 139: vtctldata.ShardReplicationAddRequest.tablet_alias:type_name -> topodata.TabletAlias
	299, // 140: vtctldata.ShardReplicationFixResponse.error:type_name -> topodata.ShardReplicationError
	259, // 141: vtctldata.ShardReplicationPositionsResponse.replication_statuses:type_name -> vtctldata.ShardReplicationPositionsResponse.ReplicationStatusesEntry
	260, // 142: vtctldata.ShardReplicationPositionsResponse.tablet_map:type_name -> vtctldata.ShardReplicationPositionsResponse.TabletMapEntry
	278, // 143: vtctldata.ShardReplicationRemoveRequest.tablet_alias:type_name -> topodata.TabletAlias
	278, // 144: vtctldata.SleepTabletRequest.tablet_alias:type_name -> topodata.TabletAlias
	279, // 145: vtctldata.SleepTabletRequest.duration:type_name -> vttime.Duration
	300, // 146: vtctldata.SourceShardAddRequest.key_range:type_name -> topodata.KeyRange
	280, // 147: vtctldata.SourceShardAddResponse.shard:type_name -> topodata.Shard
	280, // 148: vtctldata.SourceShardDeleteResponse.shard:type_name -> topodata.Shard
	278, // 149: vtctldata.StartReplicationRequest.tablet_alias:type_name -> topodata.TabletAlias
	278, // 150: vtctldata.StopReplicationRequest.tablet_alias:type_name -> topodata.TabletAlias
	278, // 151: vtctldata.TabletExternallyReparentedRequest.tablet:type_name -> topodata.TabletAlias
	278, // 152: vtctldata.TabletExternallyReparentedResponse.new_primary:type_name -> topodata.TabletAlias
	278, // 153: vtctldata.TabletExternallyReparentedResponse.old_primary:type_name -> topodata.TabletAlias
	281, // 154: vtctldata.UpdateCellInfoRequest.cell_info:type_name -> topodata.CellInfo
	281, // 155: vtctldata.UpdateCellInfoResponse.cell_info:type_name -> topodata.CellInfo
	301, // 156: vtctldata.UpdateCellsAliasRequest.cells_alias:type_name -> topodata.CellsAlias
	301, // 157: vtctldata.UpdateCellsAliasResponse.cells_alias:type_name -> topodata.CellsAlias
	261, // 158: vtctldata.ValidateResponse.results_by_keyspace:type_name -> vtctldata.ValidateResponse.ResultsByKeyspaceEntry
	262, // 159: vtctldata.ValidateKeyspaceResponse.results_by_shard:type_name -> vtctldata.ValidateKeyspaceResponse.ResultsByShardEntry
	263, // 160: vtctldata.ValidateSchemaKeyspaceResponse.results_by_shard:type_name -> vtctldata.ValidateSchemaKeyspaceResponse.ResultsByShardEntry
	264, // 161: vtctldata.ValidateVersionKeyspaceResponse.results_by_shard:type_name -> vtctldata.ValidateVersionKeyspaceResponse.ResultsByShardEntry
	265, // 162: vtctldata.ValidateVSchemaResponse.results_by_shard:type_name -> vtctldata.ValidateVSchemaResponse.ResultsByShardEntry
	286, // 163: vtctldata.VDiffCreateRequest.tablet_types:type_name -> topodata.TabletType
	275, // 164: vtctldata.VDiffCreateRequest.tablet_selection_preference:type_name -> tabletmanagerdata.TabletSelectionPreference
	279, // 165: vtctldata.VDiffCreateRequest.filtered_replication_wait_time:type_name -> vttime.Duration
	279, // 166: vtctldata.VDiffCreateRequest.wait_update_interval:type_name -> vttime.Duration
	266, // 167: vtctldata.VDiffShowResponse.tablet_responses:type_name -> vtctldata.VDiffShowResponse.TabletResponsesEntry
	267, // 168: vtctldata.WorkflowDeleteResponse.details:type_name -> vtctldata.WorkflowDeleteResponse.TabletInfo
	271, // 169: vtctldata.WorkflowStatusResponse.table_copy_state:type_name -> vtctldata.WorkflowStatusResponse.TableCopyStateEntry
	272, // 170: vtctldata.WorkflowStatusResponse.shard_streams:type_name -> vtctldata.WorkflowStatusResponse.ShardStreamsEntry
	286, // 171: vtctldata.WorkflowSwitchTrafficRequest.tablet_types:type_name -> topodata.TabletType
	279, // 172: vtctldata.WorkflowSwitchTrafficRequest.max_replication_lag_allowed:type_name -> vttime.Duration
	279, // 173: vtctldata.WorkflowSwitchTrafficRequest.timeout:type_name -> vttime.Duration
	302, // 174: vtctldata.WorkflowUpdateRequest.tablet_request:type_name -> tabletmanagerdata.UpdateVReplicationWorkflowRequest
	273, // 175: vtctldata.WorkflowUpdateResponse.details:type_name -> vtctldata.WorkflowUpdateResponse.TabletInfo
	...
	303, // 178: vtctldata.Workflow.ShardStream.tablet_controls:type_name -> topodata.Shard.TabletControl
	278, // 179: vtctldata.Workflow.Stream.tablet:type_name -> topodata.TabletAlias
	304, // 180: vtctldata.Workflow.Stream.binlog_source:type_name -> binlogdata.BinlogSource
	277, // 181: vtctldata.Workflow.Stream.transaction_timestamp:type_name -> vttime.Time
	277, // 182: vtctldata.Workflow.Stream.time_updated:type_name -> vttime.Time
	...
	277, // 186: vtctldata.Workflow.Stream.Log.created_at:type_name -> vttime.Time
	277, // 187: vtctldata.Workflow.Stream.Log.updated_at:type_name -> vttime.Time
	277, // 188: vtctldata.Workflow.Stream.ThrottlerStatus.time_throttled:type_name -> vttime.Time
	10,  // 189: vtctldata.FindAllShardsInKeyspaceResponse.ShardsEntry.value:type_name -> vtctldata.Shard
	301, // 190: vtctldata.GetCellsAliasesResponse.AliasesEntry.value:type_name -> topodata.CellsAlias
	253, // 191: vtctldata.GetSrvKeyspaceNamesResponse.NamesEntry.value:type_name -> vtctldata.GetSrvKeyspaceNamesResponse.NameList
	305, // 192: vtctldata.GetSrvKeyspacesResponse.SrvKeyspacesEntry.value:type_name -> topodata.SrvKeyspace
	298, // 193: vtctldata.GetSrvVSchemasResponse.SrvVSchemasEntry.value:type_name -> vschema.SrvVSchema
	278, // 194: vtctldata.MoveTablesCreateResponse.TabletInfo.tablet:type_name -> topodata.TabletAlias
	306, // 195: vtctldata.ShardReplicationPositionsResponse.ReplicationStatusesEntry.value:type_name -> replicationdata.Status
	287, // 196: vtctldata.ShardReplicationPositionsResponse.TabletMapEntry.value:type_name -> topodata.Tablet
	209, // 197: vtctldata.ValidateResponse.ResultsByKeyspaceEntry.value:type_name -> vtctldata.ValidateKeyspaceResponse
	213, // 198: vtctldata.ValidateKeyspaceResponse.ResultsByShardEntry.value:type_name -> vtctldata.ValidateShardResponse
	213, // 199: vtctldata.ValidateSchemaKeyspaceResponse.ResultsByShardEntry.value:type_name -> vtctldata.ValidateShardResponse
	213, // 200: vtctldata.ValidateVersionKeyspaceResponse.ResultsByShardEntry.value:type_name -> vtctldata.ValidateShardResponse
	213, // 201: vtctldata.ValidateVSchemaResponse.ResultsByShardEntry.value:type_name -> vtctldata.ValidateShardResponse
	307, // 202: vtctldata.VDiffShowResponse.TabletResponsesEntry.value:type_name -> tabletmanagerdata.VDiffResponse
