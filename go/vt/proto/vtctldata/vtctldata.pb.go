...
var file_vtctldata_proto_depIdxs = []int32{
	...
	306, // 65: vtctldata.EmergencyReparentShardRequest.expected_primary:type_name -> topodata.TabletAlias
	306, // 66: vtctldata.EmergencyReparentShardResponse.promoted_primary:type_name -> topodata.TabletAlias
	302, // 67: vtctldata.EmergencyReparentShardResponse.events:type_name -> logutil.Event
	306, // 68: vtctldata.ExecuteFetchAsAppRequest.tablet_alias:type_name -> topodata.TabletAlias
	319, // 69: vtctldata.ExecuteFetchAsAppResponse.result:type_name -> query.QueryResult
	306, // 70: vtctldata.ExecuteFetchAsDBARequest.tablet_alias:type_name -> topodata.TabletAlias
	319, // 71: vtctldata.ExecuteFetchAsDBAResponse.result:type_name -> query.QueryResult
	306, // 72: vtctldata.ExecuteHookRequest.tablet_alias:type_name -> topodata.TabletAlias
	320, // 73: vtctldata.ExecuteHookRequest.tablet_hook_request:type_name -> tabletmanagerdata.ExecuteHookRequest
	321, // 74: vtctldata.ExecuteHookResponse.hook_result:type_name -> tabletmanagerdata.ExecuteHookResponse
	306, // 75: vtctldata.ExecuteMultiFetchAsDBARequest.tablet_alias:type_name -> topodata.TabletAlias
	319, // 76: vtctldata.ExecuteMultiFetchAsDBAResponse.results:type_name -> query.QueryResult
	276, // 77: vtctldata.FindAllShardsInKeyspaceResponse.shards:type_name -> vtctldata.FindAllShardsInKeyspaceResponse.ShardsEntry
	277, // 78: vtctldata.ForceCutOverSchemaMigrationResponse.rows_affected_by_shard:type_name -> vtctldata.ForceCutOverSchemaMigrationResponse.RowsAffectedByShardEntry
	322, // 79: vtctldata.GetBackupsResponse.backups:type_name -> mysqlctl.BackupInfo
	309, // 80: vtctldata.GetCellInfoResponse.cell_info:type_name -> topodata.CellInfo
	278, // 81: vtctldata.GetCellsAliasesResponse.aliases:type_name -> vtctldata.GetCellsAliasesResponse.AliasesEntry
	306, // 82: vtctldata.GetFullStatusRequest.tablet_alias:type_name -> topodata.TabletAlias
	323, // 83: vtctldata.GetFullStatusResponse.status:type_name -> replicationdata.FullStatus
	8,   // 84: vtctldata.GetKeyspacesResponse.keyspaces:type_name -> vtctldata.Keyspace
	8,   // 85: vtctldata.GetKeyspaceResponse.keyspace:type_name -> vtctldata.Keyspace
	306, // 86: vtctldata.GetPermissionsRequest.tablet_alias:type_name -> topodata.TabletAlias
	324, // 87: vtctldata.GetPermissionsResponse.permissions:type_name -> tabletmanagerdata.Permissions
	310, // 88: vtctldata.GetKeyspaceRoutingRulesResponse.keyspace_routing_rules:type_name -> vschema.KeyspaceRoutingRules
	311, // 89: vtctldata.GetRoutingRulesResponse.routing_rules:type_name -> vschema.RoutingRules
	306, // 90: vtctldata.GetSchemaRequest.tablet_alias:type_name -> topodata.TabletAlias
	325, // 91: vtctldata.GetSchemaResponse.schema:type_name -> tabletmanagerdata.SchemaDefinition
	3,   // 92: vtctldata.GetSchemaMigrationsRequest.status:type_name -> vtctldata.SchemaMigration.Status
	307, // 93: vtctldata.GetSchemaMigrationsRequest.recent:type_name -> vttime.Duration
	1,   // 94: vtctldata.GetSchemaMigrationsRequest.order:type_name -> vtctldata.QueryOrdering
	9,   // 95: vtctldata.GetSchemaMigrationsResponse.migrations:type_name -> vtctldata.SchemaMigration
	279, // 96: vtctldata.GetShardReplicationResponse.shard_replication_by_cell:type_name -> vtctldata.GetShardReplicationResponse.ShardReplicationByCellEntry
	10,  // 97: vtctldata.GetShardResponse.shard:type_name -> vtctldata.Shard
	312, // 98: vtctldata.GetShardRoutingRulesResponse.shard_routing_rules:type_name -> vschema.ShardRoutingRules
	280, // 99: vtctldata.GetSrvKeyspaceNamesResponse.names:type_name -> vtctldata.GetSrvKeyspaceNamesResponse.NamesEntry
	282, // 100: vtctldata.GetSrvKeyspacesResponse.srv_keyspaces:type_name -> vtctldata.GetSrvKeyspacesResponse.SrvKeyspacesEntry
	326, // 101: vtctldata.UpdateThrottlerConfigRequest.throttled_app:type_name -> topodata.ThrottledAppRule
	327, // 102: vtctldata.GetSrvVSchemaResponse.srv_v_schema:type_name -> vschema.SrvVSchema
	283, // 103: vtctldata.GetSrvVSchemasResponse.srv_v_schemas:type_name -> vtctldata.GetSrvVSchemasResponse.SrvVSchemasEntry
	306, // 104: vtctldata.GetTabletRequest.tablet_alias:type_name -> topodata.TabletAlias
	316, // 105: vtctldata.GetTabletResponse.tablet:type_name -> topodata.Tablet
	306, // 106: vtctldata.GetTabletsRequest.tablet_aliases:type_name -> topodata.TabletAlias
	315, // 107: vtctldata.GetTabletsRequest.tablet_type:type_name -> topodata.TabletType
	316, // 108: vtctldata.GetTabletsResponse.tablets:type_name -> topodata.Tablet
	306, // 109: vtctldata.GetThrottlerStatusRequest.tablet_alias:type_name -> topodata.TabletAlias
	328, // 110: vtctldata.GetThrottlerStatusResponse.status:type_name -> tabletmanagerdata.GetThrottlerStatusResponse
	120, // 111: vtctldata.GetTopologyPathResponse.cell:type_name -> vtctldata.TopologyCell
	329, // 112: vtctldata.GetUnresolvedTransactionsResponse.transactions:type_name -> query.TransactionMetadata
	330, // 113: vtctldata.ConcludeTransactionRequest.participants:type_name -> query.Target
	306, // 114: vtctldata.GetVersionRequest.tablet_alias:type_name -> topodata.TabletAlias
	314, // 115: vtctldata.GetVSchemaResponse.v_schema:type_name -> vschema.Keyspace
	12,  // 116: vtctldata.GetWorkflowsResponse.workflows:type_name -> vtctldata.Workflow
	306, // 117: vtctldata.InitShardPrimaryRequest.primary_elect_tablet_alias:type_name -> topodata.TabletAlias
	307, // 118: vtctldata.InitShardPrimaryRequest.wait_replicas_timeout:type_name -> vttime.Duration
	302, // 119: vtctldata.InitShardPrimaryResponse.events:type_name -> logutil.Event
	284, // 120: vtctldata.LaunchSchemaMigrationResponse.rows_affected_by_shard:type_name -> vtctldata.LaunchSchemaMigrationResponse.RowsAffectedByShardEntry
	314, // 121: vtctldata.LookupVindexCreateRequest.vindex:type_name -> vschema.Keyspace
	315, // 122: vtctldata.LookupVindexCreateRequest.tablet_types:type_name -> topodata.TabletType
	303, // 123: vtctldata.LookupVindexCreateRequest.tablet_selection_preference:type_name -> tabletmanagerdata.TabletSelectionPreference
	7,   // 124: vtctldata.MaterializeCreateRequest.settings:type_name -> vtctldata.MaterializeSettings
	315, // 125: vtctldata.MigrateCreateRequest.tablet_types:type_name -> topodata.TabletType
	303, // 126: vtctldata.MigrateCreateRequest.tablet_selection_preference:type_name -> tabletmanagerdata.TabletSelectionPreference
	315, // 127: vtctldata.MoveTablesCreateRequest.tablet_types:type_name -> topodata.TabletType
	303, // 128: vtctldata.MoveTablesCreateRequest.tablet_selection_preference:type_name -> tabletmanagerdata.TabletSelectionPreference
	11,  // 129: vtctldata.MoveTablesCreateRequest.workflow_options:type_name -> vtctldata.WorkflowOptions
	285, // 130: vtctldata.MoveTablesCreateResponse.details:type_name -> vtctldata.MoveTablesCreateResponse.TabletInfo
	306, // 131: vtctldata.PingTabletRequest.tablet_alias:type_name -> topodata.TabletAlias
	306, // 132: vtctldata.PlannedReparentShardRequest.new_primary:type_name -> topodata.TabletAlias
	306, // 133: vtctldata.PlannedReparentShardRequest.avoid_primary:type_name -> topodata.TabletAlias
	307, // 134: vtctldata.PlannedReparentShardRequest.wait_replicas_timeout:type_name -> vttime.Duration
	307, // 135: vtctldata.PlannedReparentShardRequest.tolerable_replication_lag:type_name -> vttime.Duration
	306, // 136: vtctldata.PlannedReparentShardRequest.expected_primary:type_name -> topodata.TabletAlias
	306, // 137: vtctldata.PlannedReparentShardResponse.promoted_primary:type_name -> topodata.TabletAlias
	302, // 138: vtctldata.PlannedReparentShardResponse.events:type_name -> logutil.Event
	306, // 139: vtctldata.RefreshStateRequest.tablet_alias:type_name -> topodata.TabletAlias
	306, // 140: vtctldata.ReloadSchemaRequest.tablet_alias:type_name -> topodata.TabletAlias
	302, // 141: vtctldata.ReloadSchemaKeyspaceResponse.events:type_name -> logutil.Event
	302, // 142: vtctldata.ReloadSchemaShardResponse.events:type_name -> logutil.Event
	306, // 143: vtctldata.ReparentTabletRequest.tablet:type_name -> topodata.TabletAlias
	306, // 144: vtctldata.ReparentTabletResponse.primary:type_name -> topodata.TabletAlias
	315, // 145: vtctldata.ReshardCreateRequest.tablet_types:type_name -> topodata.TabletType
	303, // 146: vtctldata.ReshardCreateRequest.tablet_selection_preference:type_name -> tabletmanagerdata.TabletSelectionPreference
	11,  // 147: vtctldata.ReshardCreateRequest.workflow_options:type_name -> vtctldata.WorkflowOptions
	306, // 148: vtctldata.RestoreFromBackupRequest.tablet_alias:type_name -> topodata.TabletAlias
	305, // 149: vtctldata.RestoreFromBackupRequest.backup_time:type_name -> vttime.Time
	305, // 150: vtctldata.RestoreFromBackupRequest.restore_to_timestamp:type_name -> vttime.Time
	306, // 151: vtctldata.RestoreFromBackupResponse.tablet_alias:type_name -> topodata.TabletAlias
	302, // 152: vtctldata.RestoreFromBackupResponse.event:type_name -> logutil.Event
	286, // 153: vtctldata.RetrySchemaMigrationResponse.rows_affected_by_shard:type_name -> vtctldata.RetrySchemaMigrationResponse.RowsAffectedByShardEntry
	306, // 154: vtctldata.RunHealthCheckRequest.tablet_alias:type_name -> topodata.TabletAlias
	304, // 155: vtctldata.SetKeyspaceDurabilityPolicyResponse.keyspace:type_name -> topodata.Keyspace
	304, // 156: vtctldata.SetKeyspaceShardingInfoResponse.keyspace:type_name -> topodata.Keyspace
	308, // 157: vtctldata.SetShardIsPrimaryServingResponse.shard:type_name -> topodata.Shard
	315, // 158: vtctldata.SetShardTabletControlRequest.tablet_type:type_name -> topodata.TabletType
	308, // 159: vtctldata.SetShardTabletControlResponse.shard:type_name -> topodata.Shard
	306, // 160: vtctldata.SetWritableRequest.tablet_alias:type_name -> topodata.TabletAlias
	306, // 161: vtctldata.ShardReplicationAddRequest.tablet_alias:type_name -> topodata.TabletAlias
	331, // 162: vtctldata.ShardReplicationFixResponse.error:type_name -> topodata.ShardReplicationError
	287, // 163: vtctldata.ShardReplicationPositionsResponse.replication_statuses:type_name -> vtctldata.ShardReplicationPositionsResponse.ReplicationStatusesEntry
	288, // 164: vtctldata.ShardReplicationPositionsResponse.tablet_map:type_name -> vtctldata.ShardReplicationPositionsResponse.TabletMapEntry
	306, // 165: vtctldata.ShardReplicationRemoveRequest.tablet_alias:type_name -> topodata.TabletAlias
	306, // 166: vtctldata.SleepTabletRequest.tablet_alias:type_name -> topodata.TabletAlias
	307, // 167: vtctldata.SleepTabletRequest.duration:type_name -> vttime.Duration
	332, // 168: vtctldata.SourceShardAddRequest.key_range:type_name -> topodata.KeyRange
	308, // 169: vtctldata.SourceShardAddResponse.shard:type_name -> topodata.Shard
	308, // 170: vtctldata.SourceShardDeleteResponse.shard:type_name -> topodata.Shard
	306, // 171: vtctldata.StartReplicationRequest.tablet_alias:type_name -> topodata.TabletAlias
	306, // 172: vtctldata.StopReplicationRequest.tablet_alias:type_name -> topodata.TabletAlias
	306, // 173: vtctldata.TabletExternallyReparentedRequest.tablet:type_name -> topodata.TabletAlias
	306, // 174: vtctldata.TabletExternallyReparentedResponse.new_primary:type_name -> topodata.TabletAlias
	306, // 175: vtctldata.TabletExternallyReparentedResponse.old_primary:type_name -> topodata.TabletAlias
	309, // 176: vtctldata.UpdateCellInfoRequest.cell_info:type_name -> topodata.CellInfo
	309, // 177: vtctldata.UpdateCellInfoResponse.cell_info:type_name -> topodata.CellInfo
	333, // 178: vtctldata.UpdateCellsAliasRequest.cells_alias:type_name -> topodata.CellsAlias
	333, // 179: vtctldata.UpdateCellsAliasResponse.cells_alias:type_name -> topodata.CellsAlias
	289, // 180: vtctldata.ValidateResponse.results_by_keyspace:type_name -> vtctldata.ValidateResponse.ResultsByKeyspaceEntry
	290, // 181: vtctldata.ValidateKeyspaceResponse.results_by_shard:type_name -> vtctldata.ValidateKeyspaceResponse.ResultsByShardEntry
	291, // 182: vtctldata.ValidateSchemaKeyspaceResponse.results_by_shard:type_name -> vtctldata.ValidateSchemaKeyspaceResponse.ResultsByShardEntry
	292, // 183: vtctldata.ValidateVersionKeyspaceResponse.results_by_shard:type_name -> vtctldata.ValidateVersionKeyspaceResponse.ResultsByShardEntry
	293, // 184: vtctldata.ValidateVSchemaResponse.results_by_shard:type_name -> vtctldata.ValidateVSchemaResponse.ResultsByShardEntry
	315, // 185: vtctldata.VDiffCreateRequest.tablet_types:type_name -> topodata.TabletType
	303, // 186: vtctldata.VDiffCreateRequest.tablet_selection_preference:type_name -> tabletmanagerdata.TabletSelectionPreference
	307, // 187: vtctldata.VDiffCreateRequest.filtered_replication_wait_time:type_name -> vttime.Duration
	307, // 188: vtctldata.VDiffCreateRequest.wait_update_interval:type_name -> vttime.Duration
	307, // 189: vtctldata.VDiffCreateRequest.max_diff_duration:type_name -> vttime.Duration
	294, // 190: vtctldata.VDiffShowResponse.tablet_responses:type_name -> vtctldata.VDiffShowResponse.TabletResponsesEntry
	295, // 191: vtctldata.WorkflowDeleteResponse.details:type_name -> vtctldata.WorkflowDeleteResponse.TabletInfo
	299, // 192: vtctldata.WorkflowStatusResponse.table_copy_state:type_name -> vtctldata.WorkflowStatusResponse.TableCopyStateEntry
	300, // 193: vtctldata.WorkflowStatusResponse.shard_streams:type_name -> vtctldata.WorkflowStatusResponse.ShardStreamsEntry
	315, // 194: vtctldata.WorkflowSwitchTrafficRequest.tablet_types:type_name -> topodata.TabletType
	307, // 195: vtctldata.WorkflowSwitchTrafficRequest.max_replication_lag_allowed:type_name -> vttime.Duration
	307, // 196: vtctldata.WorkflowSwitchTrafficRequest.timeout:type_name -> vttime.Duration
	334, // 197: vtctldata.WorkflowUpdateRequest.tablet_request:type_name -> tabletmanagerdata.UpdateVReplicationWorkflowRequest
	301, // 198: vtctldata.WorkflowUpdateResponse.details:type_name -> vtctldata.WorkflowUpdateResponse.TabletInfo
	335, // 199: vtctldata.GetMirrorRulesResponse.mirror_rules:type_name -> vschema.MirrorRules
	315, // 200: vtctldata.WorkflowMirrorTrafficRequest.tablet_types:type_name -> topodata.TabletType
	262, // 201: vtctldata.Workflow.ShardStreamsEntry.value:type_name -> vtctldata.Workflow.ShardStream
	263, // 202: vtctldata.Workflow.ShardStream.streams:type_name -> vtctldata.Workflow.Stream
	336, // 203: vtctldata.Workflow.ShardStream.tablet_controls:type_name -> topodata.Shard.TabletControl
	306, // 204: vtctldata.Workflow.Stream.tablet:type_name -> topodata.TabletAlias
	337, // 205: vtctldata.Workflow.Stream.binlog_source:type_name -> binlogdata.BinlogSource
	305, // 206: vtctldata.Workflow.Stream.transaction_timestamp:type_name -> vttime.Time
	305, // 207: vtctldata.Workflow.Stream.time_updated:type_name -> vttime.Time
	264, // 208: vtctldata.Workflow.Stream.copy_states:type_name -> vtctldata.Workflow.Stream.CopyState
	265, // 209: vtctldata.Workflow.Stream.logs:type_name -> vtctldata.Workflow.Stream.Log
	266, // 210: vtctldata.Workflow.Stream.throttler_status:type_name -> vtctldata.Workflow.Stream.ThrottlerStatus
	315, // 211: vtctldata.Workflow.Stream.tablet_types:type_name -> topodata.TabletType
	303, // 212: vtctldata.Workflow.Stream.tablet_selection_preference:type_name -> tabletmanagerdata.TabletSelectionPreference
	305, // 213: vtctldata.Workflow.Stream.Log.created_at:type_name -> vttime.Time
	305, // 214: vtctldata.Workflow.Stream.Log.updated_at:type_name -> vttime.Time
	305, // 215: vtctldata.Workflow.Stream.ThrottlerStatus.time_throttled:type_name -> vttime.Time
	269, // 216: vtctldata.ApplyVSchemaResponse.UnknownVindexParamsEntry.value:type_name -> vtctldata.ApplyVSchemaResponse.ParamList
	10,  // 217: vtctldata.FindAllShardsInKeyspaceResponse.ShardsEntry.value:type_name -> vtctldata.Shard
	333, // 218: vtctldata.GetCellsAliasesResponse.AliasesEntry.value:type_name -> topodata.CellsAlias
	338, // 219: vtctldata.GetShardReplicationResponse.ShardReplicationByCellEntry.value:type_name -> topodata.ShardReplication
	281, // 220: vtctldata.GetSrvKeyspaceNamesResponse.NamesEntry.value:type_name -> vtctldata.GetSrvKeyspaceNamesResponse.NameList
	339, // 221: vtctldata.GetSrvKeyspacesResponse.SrvKeyspacesEntry.value:type_name -> topodata.SrvKeyspace
	327, // 222: vtctldata.GetSrvVSchemasResponse.SrvVSchemasEntry.value:type_name -> vschema.SrvVSchema
	306, // 223: vtctldata.MoveTablesCreateResponse.TabletInfo.tablet:type_name -> topodata.TabletAlias
	340, // 224: vtctldata.ShardReplicationPositionsResponse.ReplicationStatusesEntry.value:type_name -> replicationdata.Status
	316, // 225: vtctldata.ShardReplicationPositionsResponse.TabletMapEntry.value:type_name -> topodata.Tablet
	226, // 226: vtctldata.ValidateResponse.ResultsByKeyspaceEntry.value:type_name -> vtctldata.ValidateKeyspaceResponse
	230, // 227: vtctldata.ValidateKeyspaceResponse.ResultsByShardEntry.value:type_name -> vtctldata.ValidateShardResponse
	230, // 228: vtctldata.ValidateSchemaKeyspaceResponse.ResultsByShardEntry.value:type_name -> vtctldata.ValidateShardResponse
	230, // 229: vtctldata.ValidateVersionKeyspaceResponse.ResultsByShardEntry.value:type_name -> vtctldata.ValidateShardResponse
	230, // 230: vtctldata.ValidateVSchemaResponse.ResultsByShardEntry.value:type_name -> vtctldata.ValidateShardResponse
	341, // 231: vtctldata.VDiffShowResponse.TabletResponsesEntry.value:type_name -> tabletmanagerdata.VDiffResponse
	306, // 232: vtctldata.WorkflowDeleteResponse.TabletInfo.tablet:type_name -> topodata.TabletAlias
	306, // 233: vtctldata.WorkflowStatusResponse.ShardStreamState.tablet:type_name -> topodata.TabletAlias
	297, // 234: vtctldata.WorkflowStatusResponse.ShardStreams.streams:type_name -> vtctldata.WorkflowStatusResponse.ShardStreamState
	296, // 235: vtctldata.WorkflowStatusResponse.TableCopyStateEntry.value:type_name -> vtctldata.WorkflowStatusResponse.TableCopyState
	298, // 236: vtctldata.WorkflowStatusResponse.ShardStreamsEntry.value:type_name -> vtctldata.WorkflowStatusResponse.ShardStreams
	306, // 237: vtctldata.WorkflowUpdateResponse.TabletInfo.tablet:type_name -> topodata.TabletAlias
