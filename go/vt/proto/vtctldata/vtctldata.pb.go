...
var file_vtctldata_proto_rawDesc = []byte{
	...
	0x65, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0xca, 0x06, 0x0a,
	...
	0x61, 0x6d, 0x70, 0x6c, 0x65, 0x52, 0x6f, 0x77, 0x73, 0x22, 0x29, 0x0a, 0x13, 0x56, 0x44, 0x69,
	...
	0x09, 0x52, 0x08, 0x6b, 0x65, 0x79, 0x73, 0x70, 0x61, 0x63, 0x65, 0x12, 0x1a, 0x0a, 0x08, 0x77,
	0x6f, 0x72, 0x6b, 0x66, 0x6c, 0x6f, 0x77, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x77,
	0x6f, 0x72, 0x6b, 0x66, 0x6c, 0x6f, 0x77, 0x22, 0xe6, 0x07, 0x0a, 0x16, 0x57, 0x6f, 0x72, 0x6b,
...
var file_vtctldata_proto_depIdxs = []int32{
	...
	278, // 113: vtctldata.PlannedReparentShardRequest.tolerable_replication_lag:type_name -> vttime.Duration
	277, // 114: vtctldata.PlannedReparentShardResponse.promoted_primary:type_name -> topodata.TabletAlias
	273, // 115: vtctldata.PlannedReparentShardResponse.events:type_name -> logutil.Event
	277, // 116: vtctldata.RefreshStateRequest.tablet_alias:type_name -> topodata.TabletAlias
	277, // 117: vtctldata.ReloadSchemaRequest.tablet_alias:type_name -> topodata.TabletAlias
	273, // 118: vtctldata.ReloadSchemaKeyspaceResponse.events:type_name -> logutil.Event
	273, // 119: vtctldata.ReloadSchemaShardResponse.events:type_name -> logutil.Event
	277, // 120: vtctldata.ReparentTabletRequest.tablet:type_name -> topodata.TabletAlias
	277, // 121: vtctldata.ReparentTabletResponse.primary:type_name -> topodata.TabletAlias
	285, // 122: vtctldata.ReshardCreateRequest.tablet_types:type_name -> topodata.TabletType
	274, // 123: vtctldata.ReshardCreateRequest.tablet_selection_preference:type_name -> tabletmanagerdata.TabletSelectionPreference
	277, // 124: vtctldata.RestoreFromBackupRequest.tablet_alias:type_name -> topodata.TabletAlias
	276, // 125: vtctldata.RestoreFromBackupRequest.backup_time:type_name -> vttime.Time
	276, // 126: vtctldata.RestoreFromBackupRequest.restore_to_timestamp:type_name -> vttime.Time
	277, // 127: vtctldata.RestoreFromBackupResponse.tablet_alias:type_name -> topodata.TabletAlias
	273, // 128: vtctldata.RestoreFromBackupResponse.event:type_name -> logutil.Event
	257, // 129: vtctldata.RetrySchemaMigrationResponse.rows_affected_by_shard:type_name -> vtctldata.RetrySchemaMigrationResponse.RowsAffectedByShardEntry
	277, // 130: vtctldata.RunHealthCheckRequest.tablet_alias:type_name -> topodata.TabletAlias
	275, // 131: vtctldata.SetKeyspaceDurabilityPolicyResponse.keyspace:type_name -> topodata.Keyspace
	285, // 132: vtctldata.SetKeyspaceServedFromRequest.tablet_type:type_name -> topodata.TabletType
	275, // 133: vtctldata.SetKeyspaceServedFromResponse.keyspace:type_name -> topodata.Keyspace
	275, // 134: vtctldata.SetKeyspaceShardingInfoResponse.keyspace:type_name -> topodata.Keyspace
	279, // 135: vtctldata.SetShardIsPrimaryServingResponse.shard:type_name -> topodata.Shard
	285, // 136: vtctldata.SetShardTabletControlRequest.tablet_type:type_name -> topodata.TabletType
	279, // 137: vtctldata.SetShardTabletControlResponse.shard:type_name -> topodata.Shard
	277, // 138: vtctldata.SetWritableRequest.tablet_alias:type_name -> topodata.TabletAlias
	277, // 139: vtctldata.ShardReplicationAddRequest.tablet_alias:type_name -> topodata.TabletAlias
	298, // 140: vtctldata.ShardReplicationFixResponse.error:type_name -> topodata.ShardReplicationError
	258, // 141: vtctldata.ShardReplicationPositionsResponse.replication_statuses:type_name -> vtctldata.ShardReplicationPositionsResponse.ReplicationStatusesEntry
	259, // 142: vtctldata.ShardReplicationPositionsResponse.tablet_map:type_name -> vtctldata.ShardReplicationPositionsResponse.TabletMapEntry
	277, // 143: vtctldata.ShardReplicationRemoveRequest.tablet_alias:type_name -> topodata.TabletAlias
	277, // 144: vtctldata.SleepTabletRequest.tablet_alias:type_name -> topodata.TabletAlias
	278, // 145: vtctldata.SleepTabletRequest.duration:type_name -> vttime.Duration
	299, // 146: vtctldata.SourceShardAddRequest.key_range:type_name -> topodata.KeyRange
	279, // 147: vtctldata.SourceShardAddResponse.shard:type_name -> topodata.Shard
	279, // 148: vtctldata.SourceShardDeleteResponse.shard:type_name -> topodata.Shard
	277, // 149: vtctldata.StartReplicationRequest.tablet_alias:type_name -> topodata.TabletAlias
	277, // 150: vtctldata.StopReplicationRequest.tablet_alias:type_name -> topodata.TabletAlias
	277, // 151: vtctldata.TabletExternallyReparentedRequest.tablet:type_name -> topodata.TabletAlias
	277, // 152: vtctldata.TabletExternallyReparentedResponse.new_primary:type_name -> topodata.TabletAlias
	277, // 153: vtctldata.TabletExternallyReparentedResponse.old_primary:type_name -> topodata.TabletAlias
	280, // 154: vtctldata.UpdateCellInfoRequest.cell_info:type_name -> topodata.CellInfo
	280, // 155: vtctldata.UpdateCellInfoResponse.cell_info:type_name -> topodata.CellInfo
	300, // 156: vtctldata.UpdateCellsAliasRequest.cells_alias:type_name -> topodata.CellsAlias
	300, // 157: vtctldata.UpdateCellsAliasResponse.cells_alias:type_name -> topodata.CellsAlias
	260, // 158: vtctldata.ValidateResponse.results_by_keyspace:type_name -> vtctldata.ValidateResponse.ResultsByKeyspaceEntry
	261, // 159: vtctldata.ValidateKeyspaceResponse.results_by_shard:type_name -> vtctldata.ValidateKeyspaceResponse.ResultsByShardEntry
	262, // 160: vtctldata.ValidateSchemaKeyspaceResponse.results_by_shard:type_name -> vtctldata.ValidateSchemaKeyspaceResponse.ResultsByShardEntry
	263, // 161: vtctldata.ValidateVersionKeyspaceResponse.results_by_shard:type_name -> vtctldata.ValidateVersionKeyspaceResponse.ResultsByShardEntry
	264, // 162: vtctldata.ValidateVSchemaResponse.results_by_shard:type_name -> vtctldata.ValidateVSchemaResponse.ResultsByShardEntry
	285, // 163: vtctldata.VDiffCreateRequest.tablet_types:type_name -> topodata.TabletType
	274, // 164: vtctldata.VDiffCreateRequest.tablet_selection_preference:type_name -> tabletmanagerdata.TabletSelectionPreference
	278, // 165: vtctldata.VDiffCreateRequest.filtered_replication_wait_time:type_name -> vttime.Duration
	278, // 166: vtctldata.VDiffCreateRequest.wait_update_interval:type_name -> vttime.Duration
	265, // 167: vtctldata.VDiffShowResponse.tablet_responses:type_name -> vtctldata.VDiffShowResponse.TabletResponsesEntry
	266, // 168: vtctldata.WorkflowDeleteResponse.details:type_name -> vtctldata.WorkflowDeleteResponse.TabletInfo
	270, // 169: vtctldata.WorkflowStatusResponse.table_copy_state:type_name -> vtctldata.WorkflowStatusResponse.TableCopyStateEntry
	271, // 170: vtctldata.WorkflowStatusResponse.shard_streams:type_name -> vtctldata.WorkflowStatusResponse.ShardStreamsEntry
	285, // 171: vtctldata.WorkflowSwitchTrafficRequest.tablet_types:type_name -> topodata.TabletType
	278, // 172: vtctldata.WorkflowSwitchTrafficRequest.max_replication_lag_allowed:type_name -> vttime.Duration
	278, // 173: vtctldata.WorkflowSwitchTrafficRequest.timeout:type_name -> vttime.Duration
	301, // 174: vtctldata.WorkflowUpdateRequest.tablet_request:type_name -> tabletmanagerdata.UpdateVReplicationWorkflowRequest
	272, // 175: vtctldata.WorkflowUpdateResponse.details:type_name -> vtctldata.WorkflowUpdateResponse.TabletInfo
	238, // 176: vtctldata.Workflow.ShardStreamsEntry.value:type_name -> vtctldata.Workflow.ShardStream
	239, // 177: vtctldata.Workflow.ShardStream.streams:type_name -> vtctldata.Workflow.Stream
	302, // 178: vtctldata.Workflow.ShardStream.tablet_controls:type_name -> topodata.Shard.TabletControl
	277, // 179: vtctldata.Workflow.Stream.tablet:type_name -> topodata.TabletAlias
	303, // 180: vtctldata.Workflow.Stream.binlog_source:type_name -> binlogdata.BinlogSource
	276, // 181: vtctldata.Workflow.Stream.transaction_timestamp:type_name -> vttime.Time
	276, // 182: vtctldata.Workflow.Stream.time_updated:type_name -> vttime.Time
	240, // 183: vtctldata.Workflow.Stream.copy_states:type_name -> vtctldata.Workflow.Stream.CopyState
	241, // 184: vtctldata.Workflow.Stream.logs:type_name -> vtctldata.Workflow.Stream.Log
	242, // 185: vtctldata.Workflow.Stream.throttler_status:type_name -> vtctldata.Workflow.Stream.ThrottlerStatus
	...
	276, // 188: vtctldata.Workflow.Stream.ThrottlerStatus.time_throttled:type_name -> vttime.Time
	245, // 189: vtctldata.ApplyVSchemaResponse.VindexUnknownParamsEntry.value:type_name -> vtctldata.ApplyVSchemaResponse.ParamList
	10,  // 190: vtctldata.FindAllShardsInKeyspaceResponse.ShardsEntry.value:type_name -> vtctldata.Shard
	300, // 191: vtctldata.GetCellsAliasesResponse.AliasesEntry.value:type_name -> topodata.CellsAlias
	252, // 192: vtctldata.GetSrvKeyspaceNamesResponse.NamesEntry.value:type_name -> vtctldata.GetSrvKeyspaceNamesResponse.NameList
	304, // 193: vtctldata.GetSrvKeyspacesResponse.SrvKeyspacesEntry.value:type_name -> topodata.SrvKeyspace
	297, // 194: vtctldata.GetSrvVSchemasResponse.SrvVSchemasEntry.value:type_name -> vschema.SrvVSchema
	277, // 195: vtctldata.MoveTablesCreateResponse.TabletInfo.tablet:type_name -> topodata.TabletAlias
	305, // 196: vtctldata.ShardReplicationPositionsResponse.ReplicationStatusesEntry.value:type_name -> replicationdata.Status
	286, // 197: vtctldata.ShardReplicationPositionsResponse.TabletMapEntry.value:type_name -> topodata.Tablet
	...
	306, // 203: vtctldata.VDiffShowResponse.TabletResponsesEntry.value:type_name -> tabletmanagerdata.VDiffResponse
	277, // 204: vtctldata.WorkflowDeleteResponse.TabletInfo.tablet:type_name -> topodata.TabletAlias
	277, // 205: vtctldata.WorkflowStatusResponse.ShardStreamState.tablet:type_name -> topodata.TabletAlias
	268, // 206: vtctldata.WorkflowStatusResponse.ShardStreams.streams:type_name -> vtctldata.WorkflowStatusResponse.ShardStreamState
	267, // 207: vtctldata.WorkflowStatusResponse.TableCopyStateEntry.value:type_name -> vtctldata.WorkflowStatusResponse.TableCopyState
	269, // 208: vtctldata.WorkflowStatusResponse.ShardStreamsEntry.value:type_name -> vtctldata.WorkflowStatusResponse.ShardStreams
	277, // 209: vtctldata.WorkflowUpdateResponse.TabletInfo.tablet:type_name -> topodata.TabletAlias
