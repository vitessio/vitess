...
var file_vtctldata_proto_rawDesc = []byte{
	...
	0x62, 0x6c, 0x65, 0x74, 0x22, 0xb1, 0x01, 0x0a, 0x11, 0x47, 0x65, 0x74, 0x54, 0x61, 0x62, 0x6c,
	...
	0x74, 0x41, 0x6c, 0x69, 0x61, 0x73, 0x65, 0x73, 0x22, 0x40, 0x0a, 0x12, 0x47, 0x65, 0x74, 0x54,
	...
	0x74, 0x52, 0x07, 0x74, 0x61, 0x62, 0x6c, 0x65, 0x74, 0x73, 0x22, 0x2f, 0x0a, 0x11, 0x47, 0x65,
	...
	0x09, 0x52, 0x08, 0x6b, 0x65, 0x79, 0x73, 0x70, 0x61, 0x63, 0x65, 0x22, 0x42, 0x0a, 0x12, 0x47,
	...
	0x73, 0x75, 0x6c, 0x74, 0x73, 0x2a, 0x4a, 0x0a, 0x15, 0x4d, 0x61, 0x74, 0x65, 0x72, 0x69, 0x61,
...
var file_vtctldata_proto_msgTypes = make([]protoimpl.MessageInfo, 145)
var file_vtctldata_proto_goTypes = []interface{}{
	...
	(*ReloadSchemaRequest)(nil),                  // 86: vtctldata.ReloadSchemaRequest
	(*ReloadSchemaResponse)(nil),                 // 87: vtctldata.ReloadSchemaResponse
	(*ReloadSchemaKeyspaceRequest)(nil),          // 88: vtctldata.ReloadSchemaKeyspaceRequest
	(*ReloadSchemaKeyspaceResponse)(nil),         // 89: vtctldata.ReloadSchemaKeyspaceResponse
	(*ReloadSchemaShardRequest)(nil),             // 90: vtctldata.ReloadSchemaShardRequest
	(*ReloadSchemaShardResponse)(nil),            // 91: vtctldata.ReloadSchemaShardResponse
	(*RemoveKeyspaceCellRequest)(nil),            // 92: vtctldata.RemoveKeyspaceCellRequest
	(*RemoveKeyspaceCellResponse)(nil),           // 93: vtctldata.RemoveKeyspaceCellResponse
	(*RemoveShardCellRequest)(nil),               // 94: vtctldata.RemoveShardCellRequest
	(*RemoveShardCellResponse)(nil),              // 95: vtctldata.RemoveShardCellResponse
	(*ReparentTabletRequest)(nil),                // 96: vtctldata.ReparentTabletRequest
	(*ReparentTabletResponse)(nil),               // 97: vtctldata.ReparentTabletResponse
	(*RunHealthCheckRequest)(nil),                // 98: vtctldata.RunHealthCheckRequest
	(*RunHealthCheckResponse)(nil),               // 99: vtctldata.RunHealthCheckResponse
	(*SetKeyspaceServedFromRequest)(nil),         // 100: vtctldata.SetKeyspaceServedFromRequest
	(*SetKeyspaceServedFromResponse)(nil),        // 101: vtctldata.SetKeyspaceServedFromResponse
	(*SetKeyspaceShardingInfoRequest)(nil),       // 102: vtctldata.SetKeyspaceShardingInfoRequest
	(*SetKeyspaceShardingInfoResponse)(nil),      // 103: vtctldata.SetKeyspaceShardingInfoResponse
	(*SetShardIsPrimaryServingRequest)(nil),      // 104: vtctldata.SetShardIsPrimaryServingRequest
	(*SetShardIsPrimaryServingResponse)(nil),     // 105: vtctldata.SetShardIsPrimaryServingResponse
	(*SetShardTabletControlRequest)(nil),         // 106: vtctldata.SetShardTabletControlRequest
	(*SetShardTabletControlResponse)(nil),        // 107: vtctldata.SetShardTabletControlResponse
	(*SetWritableRequest)(nil),                   // 108: vtctldata.SetWritableRequest
	(*SetWritableResponse)(nil),                  // 109: vtctldata.SetWritableResponse
	(*ShardReplicationPositionsRequest)(nil),     // 110: vtctldata.ShardReplicationPositionsRequest
	(*ShardReplicationPositionsResponse)(nil),    // 111: vtctldata.ShardReplicationPositionsResponse
	(*SleepTabletRequest)(nil),                   // 112: vtctldata.SleepTabletRequest
	(*SleepTabletResponse)(nil),                  // 113: vtctldata.SleepTabletResponse
	(*StartReplicationRequest)(nil),              // 114: vtctldata.StartReplicationRequest
	(*StartReplicationResponse)(nil),             // 115: vtctldata.StartReplicationResponse
	(*StopReplicationRequest)(nil),               // 116: vtctldata.StopReplicationRequest
	(*StopReplicationResponse)(nil),              // 117: vtctldata.StopReplicationResponse
	(*TabletExternallyReparentedRequest)(nil),    // 118: vtctldata.TabletExternallyReparentedRequest
	(*TabletExternallyReparentedResponse)(nil),   // 119: vtctldata.TabletExternallyReparentedResponse
	(*UpdateCellInfoRequest)(nil),                // 120: vtctldata.UpdateCellInfoRequest
	(*UpdateCellInfoResponse)(nil),               // 121: vtctldata.UpdateCellInfoResponse
	(*UpdateCellsAliasRequest)(nil),              // 122: vtctldata.UpdateCellsAliasRequest
	(*UpdateCellsAliasResponse)(nil),             // 123: vtctldata.UpdateCellsAliasResponse
	(*ValidateRequest)(nil),                      // 124: vtctldata.ValidateRequest
	(*ValidateResponse)(nil),                     // 125: vtctldata.ValidateResponse
	(*ValidateKeyspaceRequest)(nil),              // 126: vtctldata.ValidateKeyspaceRequest
	(*ValidateKeyspaceResponse)(nil),             // 127: vtctldata.ValidateKeyspaceResponse
	(*ValidateShardRequest)(nil),                 // 128: vtctldata.ValidateShardRequest
	(*ValidateShardResponse)(nil),                // 129: vtctldata.ValidateShardResponse
	nil,                                          // 130: vtctldata.Workflow.ShardStreamsEntry
	(*Workflow_ReplicationLocation)(nil),         // 131: vtctldata.Workflow.ReplicationLocation
	(*Workflow_ShardStream)(nil),                 // 132: vtctldata.Workflow.ShardStream
	(*Workflow_Stream)(nil),                      // 133: vtctldata.Workflow.Stream
	(*Workflow_Stream_CopyState)(nil),            // 134: vtctldata.Workflow.Stream.CopyState
	(*Workflow_Stream_Log)(nil),                  // 135: vtctldata.Workflow.Stream.Log
	nil,                                          // 136: vtctldata.FindAllShardsInKeyspaceResponse.ShardsEntry
	nil,                                          // 137: vtctldata.GetCellsAliasesResponse.AliasesEntry
	nil,                                          // 138: vtctldata.GetSrvKeyspaceNamesResponse.NamesEntry
	(*GetSrvKeyspaceNamesResponse_NameList)(nil), // 139: vtctldata.GetSrvKeyspaceNamesResponse.NameList
	nil,                                  // 140: vtctldata.GetSrvKeyspacesResponse.SrvKeyspacesEntry
	nil,                                  // 141: vtctldata.GetSrvVSchemasResponse.SrvVSchemasEntry
	nil,                                  // 142: vtctldata.ShardReplicationPositionsResponse.ReplicationStatusesEntry
	nil,                                  // 143: vtctldata.ShardReplicationPositionsResponse.TabletMapEntry
	nil,                                  // 144: vtctldata.ValidateResponse.ResultsByKeyspaceEntry
	nil,                                  // 145: vtctldata.ValidateKeyspaceResponse.ResultsByShardEntry
	(*logutil.Event)(nil),                // 146: logutil.Event
	(*topodata.Keyspace)(nil),            // 147: topodata.Keyspace
	(*topodata.Shard)(nil),               // 148: topodata.Shard
	(*topodata.CellInfo)(nil),            // 149: topodata.CellInfo
	(*vschema.RoutingRules)(nil),         // 150: vschema.RoutingRules
	...
	(*topodata.Tablet)(nil),              // 154: topodata.Tablet
	(topodata.KeyspaceIdType)(0),         // 155: topodata.KeyspaceIdType
	(*topodata.Keyspace_ServedFrom)(nil), // 156: topodata.Keyspace.ServedFrom
	(topodata.KeyspaceType)(0),           // 157: topodata.KeyspaceType
	(*vttime.Time)(nil),                  // 158: vttime.Time
	(*vttime.Duration)(nil),              // 159: vttime.Duration
	(*mysqlctl.BackupInfo)(nil),          // 160: mysqlctl.BackupInfo
	(*tabletmanagerdata.SchemaDefinition)(nil), // 161: tabletmanagerdata.SchemaDefinition
	(*vschema.SrvVSchema)(nil),                 // 162: vschema.SrvVSchema
	(*topodata.CellsAlias)(nil),                // 163: topodata.CellsAlias
	(*topodata.Shard_TabletControl)(nil),       // 164: topodata.Shard.TabletControl
	(*binlogdata.BinlogSource)(nil),            // 165: binlogdata.BinlogSource
	(*topodata.SrvKeyspace)(nil),               // 166: topodata.SrvKeyspace
	(*replicationdata.Status)(nil),             // 167: replicationdata.Status
}
var file_vtctldata_proto_depIdxs = []int32{
	146, // 0: vtctldata.ExecuteVtctlCommandResponse.event:type_name -> logutil.Event
	...
	147, // 3: vtctldata.Keyspace.keyspace:type_name -> topodata.Keyspace
	148, // 4: vtctldata.Shard.shard:type_name -> topodata.Shard
	131, // 5: vtctldata.Workflow.source:type_name -> vtctldata.Workflow.ReplicationLocation
	131, // 6: vtctldata.Workflow.target:type_name -> vtctldata.Workflow.ReplicationLocation
	130, // 7: vtctldata.Workflow.shard_streams:type_name -> vtctldata.Workflow.ShardStreamsEntry
	149, // 8: vtctldata.AddCellInfoRequest.cell_info:type_name -> topodata.CellInfo
	150, // 9: vtctldata.ApplyRoutingRulesRequest.routing_rules:type_name -> vschema.RoutingRules
	151, // 10: vtctldata.ApplyVSchemaRequest.v_schema:type_name -> vschema.Keyspace
	151, // 11: vtctldata.ApplyVSchemaResponse.v_schema:type_name -> vschema.Keyspace
	152, // 12: vtctldata.ChangeTabletTypeRequest.tablet_alias:type_name -> topodata.TabletAlias
	153, // 13: vtctldata.ChangeTabletTypeRequest.db_type:type_name -> topodata.TabletType
	154, // 14: vtctldata.ChangeTabletTypeResponse.before_tablet:type_name -> topodata.Tablet
	154, // 15: vtctldata.ChangeTabletTypeResponse.after_tablet:type_name -> topodata.Tablet
	155, // 16: vtctldata.CreateKeyspaceRequest.sharding_column_type:type_name -> topodata.KeyspaceIdType
	156, // 17: vtctldata.CreateKeyspaceRequest.served_froms:type_name -> topodata.Keyspace.ServedFrom
	157, // 18: vtctldata.CreateKeyspaceRequest.type:type_name -> topodata.KeyspaceType
	158, // 19: vtctldata.CreateKeyspaceRequest.snapshot_time:type_name -> vttime.Time
	...
	152, // 24: vtctldata.DeleteTabletsRequest.tablet_aliases:type_name -> topodata.TabletAlias
	152, // 25: vtctldata.EmergencyReparentShardRequest.new_primary:type_name -> topodata.TabletAlias
	152, // 26: vtctldata.EmergencyReparentShardRequest.ignore_replicas:type_name -> topodata.TabletAlias
	159, // 27: vtctldata.EmergencyReparentShardRequest.wait_replicas_timeout:type_name -> vttime.Duration
	152, // 28: vtctldata.EmergencyReparentShardResponse.promoted_primary:type_name -> topodata.TabletAlias
	146, // 29: vtctldata.EmergencyReparentShardResponse.events:type_name -> logutil.Event
	136, // 30: vtctldata.FindAllShardsInKeyspaceResponse.shards:type_name -> vtctldata.FindAllShardsInKeyspaceResponse.ShardsEntry
	160, // 31: vtctldata.GetBackupsResponse.backups:type_name -> mysqlctl.BackupInfo
	149, // 32: vtctldata.GetCellInfoResponse.cell_info:type_name -> topodata.CellInfo
	137, // 33: vtctldata.GetCellsAliasesResponse.aliases:type_name -> vtctldata.GetCellsAliasesResponse.AliasesEntry
	...
	150, // 36: vtctldata.GetRoutingRulesResponse.routing_rules:type_name -> vschema.RoutingRules
	152, // 37: vtctldata.GetSchemaRequest.tablet_alias:type_name -> topodata.TabletAlias
	161, // 38: vtctldata.GetSchemaResponse.schema:type_name -> tabletmanagerdata.SchemaDefinition
	6,   // 39: vtctldata.GetShardResponse.shard:type_name -> vtctldata.Shard
	138, // 40: vtctldata.GetSrvKeyspaceNamesResponse.names:type_name -> vtctldata.GetSrvKeyspaceNamesResponse.NamesEntry
	140, // 41: vtctldata.GetSrvKeyspacesResponse.srv_keyspaces:type_name -> vtctldata.GetSrvKeyspacesResponse.SrvKeyspacesEntry
	162, // 42: vtctldata.GetSrvVSchemaResponse.srv_v_schema:type_name -> vschema.SrvVSchema
	141, // 43: vtctldata.GetSrvVSchemasResponse.srv_v_schemas:type_name -> vtctldata.GetSrvVSchemasResponse.SrvVSchemasEntry
	152, // 44: vtctldata.GetTabletRequest.tablet_alias:type_name -> topodata.TabletAlias
	154, // 45: vtctldata.GetTabletResponse.tablet:type_name -> topodata.Tablet
	152, // 46: vtctldata.GetTabletsRequest.tablet_aliases:type_name -> topodata.TabletAlias
	154, // 47: vtctldata.GetTabletsResponse.tablets:type_name -> topodata.Tablet
	151, // 48: vtctldata.GetVSchemaResponse.v_schema:type_name -> vschema.Keyspace
	7,   // 49: vtctldata.GetWorkflowsResponse.workflows:type_name -> vtctldata.Workflow
	152, // 50: vtctldata.InitShardPrimaryRequest.primary_elect_tablet_alias:type_name -> topodata.TabletAlias
	159, // 51: vtctldata.InitShardPrimaryRequest.wait_replicas_timeout:type_name -> vttime.Duration
	146, // 52: vtctldata.InitShardPrimaryResponse.events:type_name -> logutil.Event
	152, // 53: vtctldata.PingTabletRequest.tablet_alias:type_name -> topodata.TabletAlias
	152, // 54: vtctldata.PlannedReparentShardRequest.new_primary:type_name -> topodata.TabletAlias
	152, // 55: vtctldata.PlannedReparentShardRequest.avoid_primary:type_name -> topodata.TabletAlias
	159, // 56: vtctldata.PlannedReparentShardRequest.wait_replicas_timeout:type_name -> vttime.Duration
	152, // 57: vtctldata.PlannedReparentShardResponse.promoted_primary:type_name -> topodata.TabletAlias
	146, // 58: vtctldata.PlannedReparentShardResponse.events:type_name -> logutil.Event
	152, // 59: vtctldata.RefreshStateRequest.tablet_alias:type_name -> topodata.TabletAlias
	152, // 60: vtctldata.ReloadSchemaRequest.tablet_alias:type_name -> topodata.TabletAlias
	146, // 61: vtctldata.ReloadSchemaKeyspaceResponse.events:type_name -> logutil.Event
	146, // 62: vtctldata.ReloadSchemaShardResponse.events:type_name -> logutil.Event
	152, // 63: vtctldata.ReparentTabletRequest.tablet:type_name -> topodata.TabletAlias
	152, // 64: vtctldata.ReparentTabletResponse.primary:type_name -> topodata.TabletAlias
	152, // 65: vtctldata.RunHealthCheckRequest.tablet_alias:type_name -> topodata.TabletAlias
	153, // 66: vtctldata.SetKeyspaceServedFromRequest.tablet_type:type_name -> topodata.TabletType
	147, // 67: vtctldata.SetKeyspaceServedFromResponse.keyspace:type_name -> topodata.Keyspace
	155, // 68: vtctldata.SetKeyspaceShardingInfoRequest.column_type:type_name -> topodata.KeyspaceIdType
	147, // 69: vtctldata.SetKeyspaceShardingInfoResponse.keyspace:type_name -> topodata.Keyspace
	148, // 70: vtctldata.SetShardIsPrimaryServingResponse.shard:type_name -> topodata.Shard
	153, // 71: vtctldata.SetShardTabletControlRequest.tablet_type:type_name -> topodata.TabletType
	148, // 72: vtctldata.SetShardTabletControlResponse.shard:type_name -> topodata.Shard
	152, // 73: vtctldata.SetWritableRequest.tablet_alias:type_name -> topodata.TabletAlias
	142, // 74: vtctldata.ShardReplicationPositionsResponse.replication_statuses:type_name -> vtctldata.ShardReplicationPositionsResponse.ReplicationStatusesEntry
	143, // 75: vtctldata.ShardReplicationPositionsResponse.tablet_map:type_name -> vtctldata.ShardReplicationPositionsResponse.TabletMapEntry
	152, // 76: vtctldata.SleepTabletRequest.tablet_alias:type_name -> topodata.TabletAlias
	159, // 77: vtctldata.SleepTabletRequest.duration:type_name -> vttime.Duration
	152, // 78: vtctldata.StartReplicationRequest.tablet_alias:type_name -> topodata.TabletAlias
	152, // 79: vtctldata.StopReplicationRequest.tablet_alias:type_name -> topodata.TabletAlias
	152, // 80: vtctldata.TabletExternallyReparentedRequest.tablet:type_name -> topodata.TabletAlias
	152, // 81: vtctldata.TabletExternallyReparentedResponse.new_primary:type_name -> topodata.TabletAlias
	152, // 82: vtctldata.TabletExternallyReparentedResponse.old_primary:type_name -> topodata.TabletAlias
	149, // 83: vtctldata.UpdateCellInfoRequest.cell_info:type_name -> topodata.CellInfo
	149, // 84: vtctldata.UpdateCellInfoResponse.cell_info:type_name -> topodata.CellInfo
	163, // 85: vtctldata.UpdateCellsAliasRequest.cells_alias:type_name -> topodata.CellsAlias
	163, // 86: vtctldata.UpdateCellsAliasResponse.cells_alias:type_name -> topodata.CellsAlias
	144, // 87: vtctldata.ValidateResponse.results_by_keyspace:type_name -> vtctldata.ValidateResponse.ResultsByKeyspaceEntry
	145, // 88: vtctldata.ValidateKeyspaceResponse.results_by_shard:type_name -> vtctldata.ValidateKeyspaceResponse.ResultsByShardEntry
	132, // 89: vtctldata.Workflow.ShardStreamsEntry.value:type_name -> vtctldata.Workflow.ShardStream
	133, // 90: vtctldata.Workflow.ShardStream.streams:type_name -> vtctldata.Workflow.Stream
	164, // 91: vtctldata.Workflow.ShardStream.tablet_controls:type_name -> topodata.Shard.TabletControl
	152, // 92: vtctldata.Workflow.Stream.tablet:type_name -> topodata.TabletAlias
	165, // 93: vtctldata.Workflow.Stream.binlog_source:type_name -> binlogdata.BinlogSource
	158, // 94: vtctldata.Workflow.Stream.transaction_timestamp:type_name -> vttime.Time
	158, // 95: vtctldata.Workflow.Stream.time_updated:type_name -> vttime.Time
	134, // 96: vtctldata.Workflow.Stream.copy_states:type_name -> vtctldata.Workflow.Stream.CopyState
	135, // 97: vtctldata.Workflow.Stream.logs:type_name -> vtctldata.Workflow.Stream.Log
	158, // 98: vtctldata.Workflow.Stream.Log.created_at:type_name -> vttime.Time
	158, // 99: vtctldata.Workflow.Stream.Log.updated_at:type_name -> vttime.Time
	6,   // 100: vtctldata.FindAllShardsInKeyspaceResponse.ShardsEntry.value:type_name -> vtctldata.Shard
	163, // 101: vtctldata.GetCellsAliasesResponse.AliasesEntry.value:type_name -> topodata.CellsAlias
	139, // 102: vtctldata.GetSrvKeyspaceNamesResponse.NamesEntry.value:type_name -> vtctldata.GetSrvKeyspaceNamesResponse.NameList
	166, // 103: vtctldata.GetSrvKeyspacesResponse.SrvKeyspacesEntry.value:type_name -> topodata.SrvKeyspace
	162, // 104: vtctldata.GetSrvVSchemasResponse.SrvVSchemasEntry.value:type_name -> vschema.SrvVSchema
	167, // 105: vtctldata.ShardReplicationPositionsResponse.ReplicationStatusesEntry.value:type_name -> replicationdata.Status
	154, // 106: vtctldata.ShardReplicationPositionsResponse.TabletMapEntry.value:type_name -> topodata.Tablet
	127, // 107: vtctldata.ValidateResponse.ResultsByKeyspaceEntry.value:type_name -> vtctldata.ValidateKeyspaceResponse
	129, // 108: vtctldata.ValidateKeyspaceResponse.ResultsByShardEntry.value:type_name -> vtctldata.ValidateShardResponse
