...
var file_vtctldata_proto_rawDesc = []byte{
	...
	0x73, 0x68, 0x22, 0x4f, 0x0a, 0x13, 0x52, 0x65, 0x6c, 0x6f, 0x61, 0x64, 0x53, 0x63, 0x68, 0x65,
	0x6d, 0x61, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x38, 0x0a, 0x0c, 0x74, 0x61, 0x62,
	0x6c, 0x65, 0x74, 0x5f, 0x61, 0x6c, 0x69, 0x61, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32,
	0x15, 0x2e, 0x74, 0x6f, 0x70, 0x6f, 0x64, 0x61, 0x74, 0x61, 0x2e, 0x54, 0x61, 0x62, 0x6c, 0x65,
	0x74, 0x41, 0x6c, 0x69, 0x61, 0x73, 0x52, 0x0b, 0x74, 0x61, 0x62, 0x6c, 0x65, 0x74, 0x41, 0x6c,
	...
	0x6e, 0x74, 0x73, 0x22, 0x7f, 0x0a, 0x19, 0x52, 0x65, 0x6d, 0x6f, 0x76, 0x65, 0x4b, 0x65, 0x79,
	...
	0x75, 0x6c, 0x74, 0x73, 0x2a, 0x4a, 0x0a, 0x15, 0x4d, 0x61, 0x74, 0x65, 0x72, 0x69, 0x61, 0x6c,
...
var file_vtctldata_proto_depIdxs = []int32{
	...
	155, // 50: vtctldata.GetTabletsRequest.tablet_type:type_name -> topodata.TabletType
	156, // 51: vtctldata.GetTabletsResponse.tablets:type_name -> topodata.Tablet
	153, // 52: vtctldata.GetVSchemaResponse.v_schema:type_name -> vschema.Keyspace
	7,   // 53: vtctldata.GetWorkflowsResponse.workflows:type_name -> vtctldata.Workflow
	154, // 54: vtctldata.InitShardPrimaryRequest.primary_elect_tablet_alias:type_name -> topodata.TabletAlias
	161, // 55: vtctldata.InitShardPrimaryRequest.wait_replicas_timeout:type_name -> vttime.Duration
	148, // 56: vtctldata.InitShardPrimaryResponse.events:type_name -> logutil.Event
	154, // 57: vtctldata.PingTabletRequest.tablet_alias:type_name -> topodata.TabletAlias
	154, // 58: vtctldata.PlannedReparentShardRequest.new_primary:type_name -> topodata.TabletAlias
	154, // 59: vtctldata.PlannedReparentShardRequest.avoid_primary:type_name -> topodata.TabletAlias
	161, // 60: vtctldata.PlannedReparentShardRequest.wait_replicas_timeout:type_name -> vttime.Duration
	154, // 61: vtctldata.PlannedReparentShardResponse.promoted_primary:type_name -> topodata.TabletAlias
	148, // 62: vtctldata.PlannedReparentShardResponse.events:type_name -> logutil.Event
	154, // 63: vtctldata.RefreshStateRequest.tablet_alias:type_name -> topodata.TabletAlias
	154, // 64: vtctldata.ReloadSchemaRequest.tablet_alias:type_name -> topodata.TabletAlias
	148, // 65: vtctldata.ReloadSchemaKeyspaceResponse.events:type_name -> logutil.Event
	148, // 66: vtctldata.ReloadSchemaShardResponse.events:type_name -> logutil.Event
	154, // 67: vtctldata.ReparentTabletRequest.tablet:type_name -> topodata.TabletAlias
	154, // 68: vtctldata.ReparentTabletResponse.primary:type_name -> topodata.TabletAlias
	154, // 69: vtctldata.RunHealthCheckRequest.tablet_alias:type_name -> topodata.TabletAlias
	155, // 70: vtctldata.SetKeyspaceServedFromRequest.tablet_type:type_name -> topodata.TabletType
	149, // 71: vtctldata.SetKeyspaceServedFromResponse.keyspace:type_name -> topodata.Keyspace
	157, // 72: vtctldata.SetKeyspaceShardingInfoRequest.column_type:type_name -> topodata.KeyspaceIdType
	149, // 73: vtctldata.SetKeyspaceShardingInfoResponse.keyspace:type_name -> topodata.Keyspace
	150, // 74: vtctldata.SetShardIsPrimaryServingResponse.shard:type_name -> topodata.Shard
	155, // 75: vtctldata.SetShardTabletControlRequest.tablet_type:type_name -> topodata.TabletType
	150, // 76: vtctldata.SetShardTabletControlResponse.shard:type_name -> topodata.Shard
	154, // 77: vtctldata.SetWritableRequest.tablet_alias:type_name -> topodata.TabletAlias
	144, // 78: vtctldata.ShardReplicationPositionsResponse.replication_statuses:type_name -> vtctldata.ShardReplicationPositionsResponse.ReplicationStatusesEntry
	145, // 79: vtctldata.ShardReplicationPositionsResponse.tablet_map:type_name -> vtctldata.ShardReplicationPositionsResponse.TabletMapEntry
	154, // 80: vtctldata.SleepTabletRequest.tablet_alias:type_name -> topodata.TabletAlias
	161, // 81: vtctldata.SleepTabletRequest.duration:type_name -> vttime.Duration
	154, // 82: vtctldata.StartReplicationRequest.tablet_alias:type_name -> topodata.TabletAlias
	154, // 83: vtctldata.StopReplicationRequest.tablet_alias:type_name -> topodata.TabletAlias
	154, // 84: vtctldata.TabletExternallyReparentedRequest.tablet:type_name -> topodata.TabletAlias
	154, // 85: vtctldata.TabletExternallyReparentedResponse.new_primary:type_name -> topodata.TabletAlias
	154, // 86: vtctldata.TabletExternallyReparentedResponse.old_primary:type_name -> topodata.TabletAlias
	151, // 87: vtctldata.UpdateCellInfoRequest.cell_info:type_name -> topodata.CellInfo
	151, // 88: vtctldata.UpdateCellInfoResponse.cell_info:type_name -> topodata.CellInfo
	167, // 89: vtctldata.UpdateCellsAliasRequest.cells_alias:type_name -> topodata.CellsAlias
	167, // 90: vtctldata.UpdateCellsAliasResponse.cells_alias:type_name -> topodata.CellsAlias
	146, // 91: vtctldata.ValidateResponse.results_by_keyspace:type_name -> vtctldata.ValidateResponse.ResultsByKeyspaceEntry
	147, // 92: vtctldata.ValidateKeyspaceResponse.results_by_shard:type_name -> vtctldata.ValidateKeyspaceResponse.ResultsByShardEntry
	134, // 93: vtctldata.Workflow.ShardStreamsEntry.value:type_name -> vtctldata.Workflow.ShardStream
	135, // 94: vtctldata.Workflow.ShardStream.streams:type_name -> vtctldata.Workflow.Stream
	168, // 95: vtctldata.Workflow.ShardStream.tablet_controls:type_name -> topodata.Shard.TabletControl
	154, // 96: vtctldata.Workflow.Stream.tablet:type_name -> topodata.TabletAlias
	169, // 97: vtctldata.Workflow.Stream.binlog_source:type_name -> binlogdata.BinlogSource
	160, // 98: vtctldata.Workflow.Stream.transaction_timestamp:type_name -> vttime.Time
	160, // 99: vtctldata.Workflow.Stream.time_updated:type_name -> vttime.Time
	136, // 100: vtctldata.Workflow.Stream.copy_states:type_name -> vtctldata.Workflow.Stream.CopyState
	137, // 101: vtctldata.Workflow.Stream.logs:type_name -> vtctldata.Workflow.Stream.Log
	160, // 102: vtctldata.Workflow.Stream.Log.created_at:type_name -> vttime.Time
	160, // 103: vtctldata.Workflow.Stream.Log.updated_at:type_name -> vttime.Time
	6,   // 104: vtctldata.FindAllShardsInKeyspaceResponse.ShardsEntry.value:type_name -> vtctldata.Shard
	167, // 105: vtctldata.GetCellsAliasesResponse.AliasesEntry.value:type_name -> topodata.CellsAlias
	141, // 106: vtctldata.GetSrvKeyspaceNamesResponse.NamesEntry.value:type_name -> vtctldata.GetSrvKeyspaceNamesResponse.NameList
	170, // 107: vtctldata.GetSrvKeyspacesResponse.SrvKeyspacesEntry.value:type_name -> topodata.SrvKeyspace
	166, // 108: vtctldata.GetSrvVSchemasResponse.SrvVSchemasEntry.value:type_name -> vschema.SrvVSchema
	171, // 109: vtctldata.ShardReplicationPositionsResponse.ReplicationStatusesEntry.value:type_name -> replicationdata.Status
	156, // 110: vtctldata.ShardReplicationPositionsResponse.TabletMapEntry.value:type_name -> topodata.Tablet
	129, // 111: vtctldata.ValidateResponse.ResultsByKeyspaceEntry.value:type_name -> vtctldata.ValidateKeyspaceResponse
	131, // 112: vtctldata.ValidateKeyspaceResponse.ResultsByShardEntry.value:type_name -> vtctldata.ValidateShardResponse
