...
var file_vtctldata_proto_rawDesc = []byte{
	...
	0xae, 0x01, 0x0a, 0x13, 0x47, 0x65, 0x74, 0x57, 0x6f, 0x72, 0x6b, 0x66, 0x6c, 0x6f, 0x77, 0x73,
	0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x1a, 0x0a, 0x08, 0x6b, 0x65, 0x79, 0x73, 0x70,
	0x61, 0x63, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x6b, 0x65, 0x79, 0x73, 0x70,
	...
	0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0xca, 0x06, 0x0a, 0x12, 0x56, 0x44, 0x69, 0x66, 0x66, 0x43,
	...
	0x77, 0x73, 0x22, 0x29, 0x0a, 0x13, 0x56, 0x44, 0x69, 0x66, 0x66, 0x43, 0x72, 0x65, 0x61, 0x74,
...
var file_vtctldata_proto_depIdxs = []int32{
	...
	276, // 112: vtctldata.PlannedReparentShardRequest.tolerable_replication_lag:type_name -> vttime.Duration
	275, // 113: vtctldata.PlannedReparentShardResponse.promoted_primary:type_name -> topodata.TabletAlias
	271, // 114: vtctldata.PlannedReparentShardResponse.events:type_name -> logutil.Event
	275, // 115: vtctldata.RefreshStateRequest.tablet_alias:type_name -> topodata.TabletAlias
	275, // 116: vtctldata.ReloadSchemaRequest.tablet_alias:type_name -> topodata.TabletAlias
	271, // 117: vtctldata.ReloadSchemaKeyspaceResponse.events:type_name -> logutil.Event
	271, // 118: vtctldata.ReloadSchemaShardResponse.events:type_name -> logutil.Event
	275, // 119: vtctldata.ReparentTabletRequest.tablet:type_name -> topodata.TabletAlias
	275, // 120: vtctldata.ReparentTabletResponse.primary:type_name -> topodata.TabletAlias
	283, // 121: vtctldata.ReshardCreateRequest.tablet_types:type_name -> topodata.TabletType
	272, // 122: vtctldata.ReshardCreateRequest.tablet_selection_preference:type_name -> tabletmanagerdata.TabletSelectionPreference
	275, // 123: vtctldata.RestoreFromBackupRequest.tablet_alias:type_name -> topodata.TabletAlias
	274, // 124: vtctldata.RestoreFromBackupRequest.backup_time:type_name -> vttime.Time
	274, // 125: vtctldata.RestoreFromBackupRequest.restore_to_timestamp:type_name -> vttime.Time
	275, // 126: vtctldata.RestoreFromBackupResponse.tablet_alias:type_name -> topodata.TabletAlias
	271, // 127: vtctldata.RestoreFromBackupResponse.event:type_name -> logutil.Event
	255, // 128: vtctldata.RetrySchemaMigrationResponse.rows_affected_by_shard:type_name -> vtctldata.RetrySchemaMigrationResponse.RowsAffectedByShardEntry
	275, // 129: vtctldata.RunHealthCheckRequest.tablet_alias:type_name -> topodata.TabletAlias
	273, // 130: vtctldata.SetKeyspaceDurabilityPolicyResponse.keyspace:type_name -> topodata.Keyspace
	283, // 131: vtctldata.SetKeyspaceServedFromRequest.tablet_type:type_name -> topodata.TabletType
	273, // 132: vtctldata.SetKeyspaceServedFromResponse.keyspace:type_name -> topodata.Keyspace
	273, // 133: vtctldata.SetKeyspaceShardingInfoResponse.keyspace:type_name -> topodata.Keyspace
	277, // 134: vtctldata.SetShardIsPrimaryServingResponse.shard:type_name -> topodata.Shard
	283, // 135: vtctldata.SetShardTabletControlRequest.tablet_type:type_name -> topodata.TabletType
	277, // 136: vtctldata.SetShardTabletControlResponse.shard:type_name -> topodata.Shard
	275, // 137: vtctldata.SetWritableRequest.tablet_alias:type_name -> topodata.TabletAlias
	275, // 138: vtctldata.ShardReplicationAddRequest.tablet_alias:type_name -> topodata.TabletAlias
	296, // 139: vtctldata.ShardReplicationFixResponse.error:type_name -> topodata.ShardReplicationError
	256, // 140: vtctldata.ShardReplicationPositionsResponse.replication_statuses:type_name -> vtctldata.ShardReplicationPositionsResponse.ReplicationStatusesEntry
	257, // 141: vtctldata.ShardReplicationPositionsResponse.tablet_map:type_name -> vtctldata.ShardReplicationPositionsResponse.TabletMapEntry
	275, // 142: vtctldata.ShardReplicationRemoveRequest.tablet_alias:type_name -> topodata.TabletAlias
	275, // 143: vtctldata.SleepTabletRequest.tablet_alias:type_name -> topodata.TabletAlias
	276, // 144: vtctldata.SleepTabletRequest.duration:type_name -> vttime.Duration
	297, // 145: vtctldata.SourceShardAddRequest.key_range:type_name -> topodata.KeyRange
	277, // 146: vtctldata.SourceShardAddResponse.shard:type_name -> topodata.Shard
	277, // 147: vtctldata.SourceShardDeleteResponse.shard:type_name -> topodata.Shard
	275, // 148: vtctldata.StartReplicationRequest.tablet_alias:type_name -> topodata.TabletAlias
	275, // 149: vtctldata.StopReplicationRequest.tablet_alias:type_name -> topodata.TabletAlias
	275, // 150: vtctldata.TabletExternallyReparentedRequest.tablet:type_name -> topodata.TabletAlias
	275, // 151: vtctldata.TabletExternallyReparentedResponse.new_primary:type_name -> topodata.TabletAlias
	275, // 152: vtctldata.TabletExternallyReparentedResponse.old_primary:type_name -> topodata.TabletAlias
	278, // 153: vtctldata.UpdateCellInfoRequest.cell_info:type_name -> topodata.CellInfo
	278, // 154: vtctldata.UpdateCellInfoResponse.cell_info:type_name -> topodata.CellInfo
	298, // 155: vtctldata.UpdateCellsAliasRequest.cells_alias:type_name -> topodata.CellsAlias
	298, // 156: vtctldata.UpdateCellsAliasResponse.cells_alias:type_name -> topodata.CellsAlias
	258, // 157: vtctldata.ValidateResponse.results_by_keyspace:type_name -> vtctldata.ValidateResponse.ResultsByKeyspaceEntry
	259, // 158: vtctldata.ValidateKeyspaceResponse.results_by_shard:type_name -> vtctldata.ValidateKeyspaceResponse.ResultsByShardEntry
	260, // 159: vtctldata.ValidateSchemaKeyspaceResponse.results_by_shard:type_name -> vtctldata.ValidateSchemaKeyspaceResponse.ResultsByShardEntry
	261, // 160: vtctldata.ValidateVersionKeyspaceResponse.results_by_shard:type_name -> vtctldata.ValidateVersionKeyspaceResponse.ResultsByShardEntry
	262, // 161: vtctldata.ValidateVSchemaResponse.results_by_shard:type_name -> vtctldata.ValidateVSchemaResponse.ResultsByShardEntry
	283, // 162: vtctldata.VDiffCreateRequest.tablet_types:type_name -> topodata.TabletType
	272, // 163: vtctldata.VDiffCreateRequest.tablet_selection_preference:type_name -> tabletmanagerdata.TabletSelectionPreference
	276, // 164: vtctldata.VDiffCreateRequest.filtered_replication_wait_time:type_name -> vttime.Duration
	276, // 165: vtctldata.VDiffCreateRequest.wait_update_interval:type_name -> vttime.Duration
	263, // 166: vtctldata.VDiffShowResponse.tablet_responses:type_name -> vtctldata.VDiffShowResponse.TabletResponsesEntry
	264, // 167: vtctldata.WorkflowDeleteResponse.details:type_name -> vtctldata.WorkflowDeleteResponse.TabletInfo
	268, // 168: vtctldata.WorkflowStatusResponse.table_copy_state:type_name -> vtctldata.WorkflowStatusResponse.TableCopyStateEntry
	269, // 169: vtctldata.WorkflowStatusResponse.shard_streams:type_name -> vtctldata.WorkflowStatusResponse.ShardStreamsEntry
	283, // 170: vtctldata.WorkflowSwitchTrafficRequest.tablet_types:type_name -> topodata.TabletType
	276, // 171: vtctldata.WorkflowSwitchTrafficRequest.max_replication_lag_allowed:type_name -> vttime.Duration
	276, // 172: vtctldata.WorkflowSwitchTrafficRequest.timeout:type_name -> vttime.Duration
	299, // 173: vtctldata.WorkflowUpdateRequest.tablet_request:type_name -> tabletmanagerdata.UpdateVReplicationWorkflowRequest
	270, // 174: vtctldata.WorkflowUpdateResponse.details:type_name -> vtctldata.WorkflowUpdateResponse.TabletInfo
	...
	300, // 177: vtctldata.Workflow.ShardStream.tablet_controls:type_name -> topodata.Shard.TabletControl
	275, // 178: vtctldata.Workflow.Stream.tablet:type_name -> topodata.TabletAlias
	301, // 179: vtctldata.Workflow.Stream.binlog_source:type_name -> binlogdata.BinlogSource
	274, // 180: vtctldata.Workflow.Stream.transaction_timestamp:type_name -> vttime.Time
	274, // 181: vtctldata.Workflow.Stream.time_updated:type_name -> vttime.Time
	...
	274, // 185: vtctldata.Workflow.Stream.Log.created_at:type_name -> vttime.Time
	274, // 186: vtctldata.Workflow.Stream.Log.updated_at:type_name -> vttime.Time
	274, // 187: vtctldata.Workflow.Stream.ThrottlerStatus.time_throttled:type_name -> vttime.Time
	10,  // 188: vtctldata.FindAllShardsInKeyspaceResponse.ShardsEntry.value:type_name -> vtctldata.Shard
	298, // 189: vtctldata.GetCellsAliasesResponse.AliasesEntry.value:type_name -> topodata.CellsAlias
	250, // 190: vtctldata.GetSrvKeyspaceNamesResponse.NamesEntry.value:type_name -> vtctldata.GetSrvKeyspaceNamesResponse.NameList
	302, // 191: vtctldata.GetSrvKeyspacesResponse.SrvKeyspacesEntry.value:type_name -> topodata.SrvKeyspace
	295, // 192: vtctldata.GetSrvVSchemasResponse.SrvVSchemasEntry.value:type_name -> vschema.SrvVSchema
	275, // 193: vtctldata.MoveTablesCreateResponse.TabletInfo.tablet:type_name -> topodata.TabletAlias
	303, // 194: vtctldata.ShardReplicationPositionsResponse.ReplicationStatusesEntry.value:type_name -> replicationdata.Status
	284, // 195: vtctldata.ShardReplicationPositionsResponse.TabletMapEntry.value:type_name -> topodata.Tablet
	207, // 196: vtctldata.ValidateResponse.ResultsByKeyspaceEntry.value:type_name -> vtctldata.ValidateKeyspaceResponse
	211, // 197: vtctldata.ValidateKeyspaceResponse.ResultsByShardEntry.value:type_name -> vtctldata.ValidateShardResponse
	211, // 198: vtctldata.ValidateSchemaKeyspaceResponse.ResultsByShardEntry.value:type_name -> vtctldata.ValidateShardResponse
	211, // 199: vtctldata.ValidateVersionKeyspaceResponse.ResultsByShardEntry.value:type_name -> vtctldata.ValidateShardResponse
	211, // 200: vtctldata.ValidateVSchemaResponse.ResultsByShardEntry.value:type_name -> vtctldata.ValidateShardResponse
	304, // 201: vtctldata.VDiffShowResponse.TabletResponsesEntry.value:type_name -> tabletmanagerdata.VDiffResponse
	275, // 202: vtctldata.WorkflowDeleteResponse.TabletInfo.tablet:type_name -> topodata.TabletAlias
	275, // 203: vtctldata.WorkflowStatusResponse.ShardStreamState.tablet:type_name -> topodata.TabletAlias
	266, // 204: vtctldata.WorkflowStatusResponse.ShardStreams.streams:type_name -> vtctldata.WorkflowStatusResponse.ShardStreamState
	265, // 205: vtctldata.WorkflowStatusResponse.TableCopyStateEntry.value:type_name -> vtctldata.WorkflowStatusResponse.TableCopyState
	267, // 206: vtctldata.WorkflowStatusResponse.ShardStreamsEntry.value:type_name -> vtctldata.WorkflowStatusResponse.ShardStreams
	275, // 207: vtctldata.WorkflowUpdateResponse.TabletInfo.tablet:type_name -> topodata.TabletAlias
