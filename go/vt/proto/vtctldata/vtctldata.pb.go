...
var file_vtctldata_proto_rawDesc = []byte{
	...
	0x06, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x73, 0x22, 0x7f, 0x0a, 0x19, 0x52, 0x65, 0x6d, 0x6f, 0x76,
	...
	0x6d, 0x61, 0x72, 0x79, 0x42, 0x28, 0x5a, 0x26, 0x76, 0x69, 0x74, 0x65, 0x73, 0x73, 0x2e, 0x69,
...
var file_vtctldata_proto_msgTypes = make([]protoimpl.MessageInfo, 78)
var file_vtctldata_proto_goTypes = []interface{}{
	...
	(*GetSrvVSchemasRequest)(nil),              // 43: vtctldata.GetSrvVSchemasRequest
	(*GetSrvVSchemasResponse)(nil),             // 44: vtctldata.GetSrvVSchemasResponse
	...
	nil,                                  // 75: vtctldata.GetSrvVSchemasResponse.SrvVSchemasEntry
	nil,                                  // 76: vtctldata.ShardReplicationPositionsResponse.ReplicationStatusesEntry
	nil,                                  // 77: vtctldata.ShardReplicationPositionsResponse.TabletMapEntry
	(*logutil.Event)(nil),                // 78: logutil.Event
	(*topodata.Keyspace)(nil),            // 79: topodata.Keyspace
	(*topodata.Shard)(nil),               // 80: topodata.Shard
	...
	(*vschema.Keyspace)(nil),                   // 93: vschema.Keyspace
	(*topodata.Shard_TabletControl)(nil),       // 94: topodata.Shard.TabletControl
	(*binlogdata.BinlogSource)(nil),            // 95: binlogdata.BinlogSource
	(*topodata.CellsAlias)(nil),                // 96: topodata.CellsAlias
	(*topodata.SrvKeyspace)(nil),               // 97: topodata.SrvKeyspace
	(*replicationdata.Status)(nil),             // 98: replicationdata.Status
}
var file_vtctldata_proto_depIdxs = []int32{
	78, // 0: vtctldata.ExecuteVtctlCommandResponse.event:type_name -> logutil.Event
	2,  // 1: vtctldata.MaterializeSettings.table_settings:type_name -> vtctldata.TableMaterializeSettings
	79, // 2: vtctldata.Keyspace.keyspace:type_name -> topodata.Keyspace
	80, // 3: vtctldata.Shard.shard:type_name -> topodata.Shard
	...
	81, // 7: vtctldata.ChangeTabletTypeRequest.tablet_alias:type_name -> topodata.TabletAlias
	82, // 8: vtctldata.ChangeTabletTypeRequest.db_type:type_name -> topodata.TabletType
	83, // 9: vtctldata.ChangeTabletTypeResponse.before_tablet:type_name -> topodata.Tablet
	83, // 10: vtctldata.ChangeTabletTypeResponse.after_tablet:type_name -> topodata.Tablet
	84, // 11: vtctldata.CreateKeyspaceRequest.sharding_column_type:type_name -> topodata.KeyspaceIdType
	85, // 12: vtctldata.CreateKeyspaceRequest.served_froms:type_name -> topodata.Keyspace.ServedFrom
	86, // 13: vtctldata.CreateKeyspaceRequest.type:type_name -> topodata.KeyspaceType
	87, // 14: vtctldata.CreateKeyspaceRequest.snapshot_time:type_name -> vttime.Time
	...
	81, // 19: vtctldata.DeleteTabletsRequest.tablet_aliases:type_name -> topodata.TabletAlias
	81, // 20: vtctldata.EmergencyReparentShardRequest.new_primary:type_name -> topodata.TabletAlias
	81, // 21: vtctldata.EmergencyReparentShardRequest.ignore_replicas:type_name -> topodata.TabletAlias
	88, // 22: vtctldata.EmergencyReparentShardRequest.wait_replicas_timeout:type_name -> vttime.Duration
	81, // 23: vtctldata.EmergencyReparentShardResponse.promoted_primary:type_name -> topodata.TabletAlias
	78, // 24: vtctldata.EmergencyReparentShardResponse.events:type_name -> logutil.Event
	72, // 25: vtctldata.FindAllShardsInKeyspaceResponse.shards:type_name -> vtctldata.FindAllShardsInKeyspaceResponse.ShardsEntry
	89, // 26: vtctldata.GetBackupsResponse.backups:type_name -> mysqlctl.BackupInfo
	90, // 27: vtctldata.GetCellInfoResponse.cell_info:type_name -> topodata.CellInfo
	...
	81, // 31: vtctldata.GetSchemaRequest.tablet_alias:type_name -> topodata.TabletAlias
	91, // 32: vtctldata.GetSchemaResponse.schema:type_name -> tabletmanagerdata.SchemaDefinition
	...
	92, // 35: vtctldata.GetSrvVSchemaResponse.srv_v_schema:type_name -> vschema.SrvVSchema
	75, // 36: vtctldata.GetSrvVSchemasResponse.srv_v_schemas:type_name -> vtctldata.GetSrvVSchemasResponse.SrvVSchemasEntry
	81, // 37: vtctldata.GetTabletRequest.tablet_alias:type_name -> topodata.TabletAlias
	83, // 38: vtctldata.GetTabletResponse.tablet:type_name -> topodata.Tablet
	81, // 39: vtctldata.GetTabletsRequest.tablet_aliases:type_name -> topodata.TabletAlias
	83, // 40: vtctldata.GetTabletsResponse.tablets:type_name -> topodata.Tablet
	93, // 41: vtctldata.GetVSchemaResponse.v_schema:type_name -> vschema.Keyspace
	6,  // 42: vtctldata.GetWorkflowsResponse.workflows:type_name -> vtctldata.Workflow
	81, // 43: vtctldata.InitShardPrimaryRequest.primary_elect_tablet_alias:type_name -> topodata.TabletAlias
	88, // 44: vtctldata.InitShardPrimaryRequest.wait_replicas_timeout:type_name -> vttime.Duration
	78, // 45: vtctldata.InitShardPrimaryResponse.events:type_name -> logutil.Event
	81, // 46: vtctldata.PlannedReparentShardRequest.new_primary:type_name -> topodata.TabletAlias
	81, // 47: vtctldata.PlannedReparentShardRequest.avoid_primary:type_name -> topodata.TabletAlias
	88, // 48: vtctldata.PlannedReparentShardRequest.wait_replicas_timeout:type_name -> vttime.Duration
	81, // 49: vtctldata.PlannedReparentShardResponse.promoted_primary:type_name -> topodata.TabletAlias
	78, // 50: vtctldata.PlannedReparentShardResponse.events:type_name -> logutil.Event
	81, // 51: vtctldata.ReparentTabletRequest.tablet:type_name -> topodata.TabletAlias
	81, // 52: vtctldata.ReparentTabletResponse.primary:type_name -> topodata.TabletAlias
	76, // 53: vtctldata.ShardReplicationPositionsResponse.replication_statuses:type_name -> vtctldata.ShardReplicationPositionsResponse.ReplicationStatusesEntry
	77, // 54: vtctldata.ShardReplicationPositionsResponse.tablet_map:type_name -> vtctldata.ShardReplicationPositionsResponse.TabletMapEntry
	81, // 55: vtctldata.TabletExternallyReparentedRequest.tablet:type_name -> topodata.TabletAlias
	81, // 56: vtctldata.TabletExternallyReparentedResponse.new_primary:type_name -> topodata.TabletAlias
	81, // 57: vtctldata.TabletExternallyReparentedResponse.old_primary:type_name -> topodata.TabletAlias
	...
	94, // 60: vtctldata.Workflow.ShardStream.tablet_controls:type_name -> topodata.Shard.TabletControl
	81, // 61: vtctldata.Workflow.Stream.tablet:type_name -> topodata.TabletAlias
	95, // 62: vtctldata.Workflow.Stream.binlog_source:type_name -> binlogdata.BinlogSource
	87, // 63: vtctldata.Workflow.Stream.transaction_timestamp:type_name -> vttime.Time
	...
	96, // 67: vtctldata.GetCellsAliasesResponse.AliasesEntry.value:type_name -> topodata.CellsAlias
	97, // 68: vtctldata.GetSrvKeyspacesResponse.SrvKeyspacesEntry.value:type_name -> topodata.SrvKeyspace
	92, // 69: vtctldata.GetSrvVSchemasResponse.SrvVSchemasEntry.value:type_name -> vschema.SrvVSchema
	98, // 70: vtctldata.ShardReplicationPositionsResponse.ReplicationStatusesEntry.value:type_name -> replicationdata.Status
