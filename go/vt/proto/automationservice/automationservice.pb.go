...
func init() {
	proto.RegisterFile("automationservice.proto", fileDescriptor_automationservice_7755ad51c1ee3618)
}

var fileDescriptor_automationservice_7755ad51c1ee3618 = []byte{
