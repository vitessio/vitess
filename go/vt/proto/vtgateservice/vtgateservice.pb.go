...
const file_vtgateservice_proto_rawDesc = "" +
	"\n" +
	"\x13vtgateservice.proto\x12\rvtgateservice\x1a\fvtgate.proto2\xaf\x05\n" +
	"\x06Vitess\x12<\n" +
	...
	"\fCloseSession\x12\x1b.vtgate.CloseSessionRequest\x1a\x1c.vtgate.CloseSessionResponse\"\x00\x12O\n" +
	"\x0eBinlogDumpGTID\x12\x1d.vtgate.BinlogDumpGTIDRequest\x1a\x1a.vtgate.BinlogDumpResponse\"\x000\x01BB\n" +
...
var file_vtgateservice_proto_goTypes = []any{
	...
	(*vtgate.BinlogDumpGTIDRequest)(nil),      // 8: vtgate.BinlogDumpGTIDRequest
	(*vtgate.ExecuteResponse)(nil),            // 9: vtgate.ExecuteResponse
	(*vtgate.ExecuteMultiResponse)(nil),       // 10: vtgate.ExecuteMultiResponse
	(*vtgate.ExecuteBatchResponse)(nil),       // 11: vtgate.ExecuteBatchResponse
	(*vtgate.StreamExecuteResponse)(nil),      // 12: vtgate.StreamExecuteResponse
	(*vtgate.StreamExecuteMultiResponse)(nil), // 13: vtgate.StreamExecuteMultiResponse
	(*vtgate.VStreamResponse)(nil),            // 14: vtgate.VStreamResponse
	(*vtgate.PrepareResponse)(nil),            // 15: vtgate.PrepareResponse
	(*vtgate.CloseSessionResponse)(nil),       // 16: vtgate.CloseSessionResponse
	(*vtgate.BinlogDumpResponse)(nil),         // 17: vtgate.BinlogDumpResponse
}
var file_vtgateservice_proto_depIdxs = []int32{
	...
	8,  // 8: vtgateservice.Vitess.BinlogDumpGTID:input_type -> vtgate.BinlogDumpGTIDRequest
	9,  // 9: vtgateservice.Vitess.Execute:output_type -> vtgate.ExecuteResponse
	10, // 10: vtgateservice.Vitess.ExecuteMulti:output_type -> vtgate.ExecuteMultiResponse
	11, // 11: vtgateservice.Vitess.ExecuteBatch:output_type -> vtgate.ExecuteBatchResponse
	12, // 12: vtgateservice.Vitess.StreamExecute:output_type -> vtgate.StreamExecuteResponse
	13, // 13: vtgateservice.Vitess.StreamExecuteMulti:output_type -> vtgate.StreamExecuteMultiResponse
	14, // 14: vtgateservice.Vitess.VStream:output_type -> vtgate.VStreamResponse
	15, // 15: vtgateservice.Vitess.Prepare:output_type -> vtgate.PrepareResponse
	16, // 16: vtgateservice.Vitess.CloseSession:output_type -> vtgate.CloseSessionResponse
	17, // 17: vtgateservice.Vitess.BinlogDumpGTID:output_type -> vtgate.BinlogDumpResponse
