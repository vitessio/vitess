...
func (e *executor) fixUniquenessConstraint(retryCtx context.Context, master *discovery.LegacyTabletStats, isRetry bool, errorToFix error) error {
...
func (e *executor) generateDeleteForUniqueIndexConstraint(retryCtx context.Context, master *discovery.LegacyTabletStats, schema, table, indexName string, indexValues []string) (string, error) {
