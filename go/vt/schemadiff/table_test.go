...
func TestCreateTableDiff(t *testing.T) {
	tt := []struct {
		...
		},
		{
			...
			diff:      "alter table t1 change column i1 i2 int not null after id",
			cdiff:     "ALTER TABLE `t1` CHANGE COLUMN `i1` `i2` int NOT NULL AFTER `id`",
		},
		{
			...
			colrename: ColumnRenameHeuristicStatement,
			diff:      "alter table t1 change column i1 i2 int not null",
			cdiff:     "ALTER TABLE `t1` CHANGE COLUMN `i1` `i2` int NOT NULL",
		},
		{
			...
			colrename: ColumnRenameHeuristicStatement,
			diff:      "alter table t1 change column i1 i2 int not null after id, change column v1 v2 varchar(32)",
			cdiff:     "ALTER TABLE `t1` CHANGE COLUMN `i1` `i2` int NOT NULL AFTER `id`, CHANGE COLUMN `v1` `v2` varchar(32)",
		},
		{
