...
func TestSchemaDiff(t *testing.T) {
	...
	tt := []struct {
		...
		// FKs
		{
			...
			instantCapability:     InstantDDLCapabilityIrrelevant,
			expectRelatedFKTables: []string{"t1", "t3"},
		},
		{
			...
			sequential:            true,
			instantCapability:     InstantDDLCapabilityIrrelevant,
			expectRelatedFKTables: []string{"tp", "t3"},
		},
		{
			...
			expectRelatedFKTables: []string{"t11", "t12"},
		},
		{
		...
		},
		{
			...
			entityOrder:           []string{"t2"},
			instantCapability:     InstantDDLCapabilityImpossible,
			expectRelatedFKTables: []string{"t1", "t2"},
		},
		{
			...
			instantCapability:     InstantDDLCapabilityImpossible,
			expectRelatedFKTables: []string{"tp", "t2"},
		},
		{
		...
		},
		{
			...
			instantCapability:     InstantDDLCapabilityImpossible,
			expectRelatedFKTables: []string{"t0", "t2"},
		},
		{
			...
			instantCapability:     InstantDDLCapabilityImpossible,
			expectRelatedFKTables: []string{"t2", "t9"},
		},
		{
		...
		},
		{
			...
			instantCapability:     InstantDDLCapabilityImpossible,
			expectRelatedFKTables: []string{"t1", "t2", "t3", "t4", "t5"},
		},
		{
			name: "drop fk",
			fromQueries: []string{
		...
		},
		{
			...
			instantCapability:     InstantDDLCapabilityImpossible,
			fkStrategy:            ForeignKeyCheckStrategyStrict,
			expectRelatedFKTables: []string{"t1", "t2", "t3"},
		},
		{
		...
		},
		{
			...
			entityOrder:           []string{"t1"},
			instantCapability:     InstantDDLCapabilityImpossible,
			expectRelatedFKTables: []string{"t1", "parent"},
		},
		{
	...
	for _, tc := range tt {
		t.Run(tc.name, func(t *testing.T) {
			...
			for name, e := range relatedFKTables {
				require.NotNil(t, e)
				assert.Equal(t, name, e.Name())
			}
			assert.ElementsMatch(t, tc.expectRelatedFKTables, maps.Keys(relatedFKTables))
