...
create table vitess_seq(id int, next_id bigint, chunk_size bigint, increment bigint, primary key(id)) comment 'vitess_sequence';
insert into vitess_seq values(0, 1, 4, 2);
