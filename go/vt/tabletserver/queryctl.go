...
func AllowQueries(dbconfig *dbconfigs.DBConfig, schemaOverrides []SchemaOverride, qrs *QueryRules, mysqld *mysqlctl.Mysqld) error {
	return SqlQueryRpcService.allowQueries(dbconfig, schemaOverrides, qrs, mysqld)
}
