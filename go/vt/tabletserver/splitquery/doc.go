...
//   represented by the FullScanAlgorithm and EqualSplitsAlgorithm types. See the documentation of
//   these types for more details on each algorithm.
...
//   We also pass a type implementing the MySQLExecutor interface that the algorithm will
//   use to send statements to MySQL.
//   algorithm, err := NewFullScanAlgorithm(&splitParams, mySqlExecutor)
//   if (err != nil) {
