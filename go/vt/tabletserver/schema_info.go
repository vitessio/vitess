...
func NewSchemaInfo(
	...
	si := &SchemaInfo{
		...
		connPool: NewConnPool("", newSqlDBConn, 2, idleTimeout),
...
func (si *SchemaInfo) Open(appParams, dbaParams *sqldbconn.ConnectionParams, schemaOverrides []SchemaOverride, cachePool *CachePool, strictMode bool) {
