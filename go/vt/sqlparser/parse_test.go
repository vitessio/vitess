...
func TestFunctionCalls(t *testing.T) {
	queries := []string{
		...
		"select INTERVAL(col1, col2) from dual",
		...
		"select JSON_ARRAYAGG() from dual",
		...
		"select JSON_OBJECTAGG() from dual",
		...
		"select STD() from dual",
		"select STDDEV() from dual",
		"select STDDEV_POP() from dual",
		"select STDDEV_SAMP() from dual",
		"select STR_TO_DATE() from dual",
		"select STRCMP() from dual",
		"select SUBDATE() from dual",
		"select SUBSTR() from dual",
		"select SUBSTRING() from dual",
		...
		"select TIMESTAMPADD() from dual",
		"select TIMESTAMPDIFF() from dual",
		...
		"select VAR_POP() from dual",
		"select VAR_SAMP() from dual",
		"select VARIANCE() from dual",
	...
	skippedTestCases := []parseTest{
		{
			// USING syntax parsed by not captured
