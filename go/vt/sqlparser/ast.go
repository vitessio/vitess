...
type (
	...
	// JSONValueModifierExpr represents a subset of json value modifier functions.
	// Functions represented: JSON_ARRAY_APPEND, JSON_ARRAY_INSERT, JSON_INSERT, JSON_REPLACE, JSON_SET
	JSONValueModifierExpr struct {
		Name    ColIdent
		JSONDoc Expr
		Params  []JSONValueModifierParam
	}
