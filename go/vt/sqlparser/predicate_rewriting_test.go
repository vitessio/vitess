...
func TestExpressionRewriting(in *testing.T) {
	old := logger
	defer func() {
		logger = old
	}()
	...
	in.Run("SimplifyExpression", func(in *testing.T) {
		tests := []struct {
			in       string
			expected string
		}{{
	...
	in.Run("RewritePredicate", func(in *testing.T) {
		tests := []struct {
			in       string
			expected string
		}{{
	...
	in.Run("ExtractINFromOR", func(in *testing.T) {
		tests := []struct {
			in       string
			expected string
		}{{
