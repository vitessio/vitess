...
// Migration tokens
%token <bytes> VITESS_MIGRATION CANCEL RETRY COMPLETE
...
%token <bytes> KEYSPACES VITESS_KEYSPACES VITESS_SHARDS VITESS_TABLETS VITESS_MIGRATIONS CODE PRIVILEGES FUNCTION OPEN TRIGGERS EVENT USER
