...
func initMySQLProtocol() {
	...
	if *mysqlServerPort >= 0 {
		mysqlListener, err = mysql.NewListener("tcp", net.JoinHostPort(*mysqlServerBindAddress, fmt.Sprintf("%v", *mysqlServerPort)), authServer, mh, false, *mysqlConnReadTimeout, *mysqlConnWriteTimeout)
		if err != nil {
