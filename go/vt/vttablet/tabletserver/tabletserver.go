...
func (tsv *TabletServer) GetSchema(ctx context.Context, target *querypb.Target, tableType querypb.TableType, tableNames []string) (schemaDef map[string]string, err error) {
	err = tsv.execRequest(
		ctx, tsv.QueryTimeout.Get(),
		"GetSchema", "", nil,
		target, nil, false, /* allowOnShutdown */
