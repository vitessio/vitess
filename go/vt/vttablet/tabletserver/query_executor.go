...
func (qre *QueryExecutor) execAlterMigration() (*sqltypes.Result, error) {
	...
	case sqlparser.PostponeMigrationType:
		return qre.tsv.onlineDDLExecutor.PostponeMigration(qre.ctx, alterMigration.UUID)
	case sqlparser.PostponeAllMigrationType:
		return qre.tsv.onlineDDLExecutor.PostponePendingMigrations(qre.ctx)
