...
func registerTabletEnvFlags(fs *pflag.FlagSet) {
	...
	fs.Var((*topoproto.TabletTypeListFlag)(&currentConfig.TxThrottlerTabletTypes), "tx_throttler_tablet_types", "A comma-separated list of tablet types. Only tablets of this type with be monitored for replication lag by the transaction throttler. Supported types: replica,rdonly")
