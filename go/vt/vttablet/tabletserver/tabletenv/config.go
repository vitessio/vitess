...
func registerTabletEnvFlags(fs *pflag.FlagSet) {
	...
	flagutil.DualFormatBoolVar(fs, &enableConsolidatorReplicas, "enable_consolidator_replicas", true, "This option enables the query consolidator only on replicas.")
