...
func registerTabletEnvFlags(fs *pflag.FlagSet) {
	...
	fs.BoolVar(&currentConfig.EnableSystemHealthMonitor, "enable-system-health-monitor", false, "Enable collection of system health metrics, currently cpu usage only.")
