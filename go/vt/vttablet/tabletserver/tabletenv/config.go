...
func registerTabletEnvFlags(fs *pflag.FlagSet) {
	...
	_ = fs.MarkDeprecated("queryserver-config-pool-prefill-parallelism", "it will be removed in the future release.")
	...
	_ = fs.MarkDeprecated("queryserver-config-stream-pool-prefill-parallelism", "it will be removed in the future release.")
	...
	_ = fs.MarkDeprecated("queryserver-config-transaction-prefill-parallelism", "it will be removed in the future release.")
