...
func registerTabletEnvFlags(fs *pflag.FlagSet) {
	...
	_ = fs.MarkDeprecated("queryserver-config-pool-prefill-parallelism", "This flag is deprecated.")
	...
	_ = fs.MarkDeprecated("queryserver-config-stream-pool-prefill-parallelism", "This flag is deprecated.")
	...
	_ = fs.MarkDeprecated("queryserver-config-transaction-prefill-parallelism", "This flag is deprecated.")
	...
	SecondsVar(fs, &currentConfig.OltpReadPool.MaxLifetimeSeconds, "queryserver-max-lifetime", defaultConfig.OltpReadPool.MaxLifetimeSeconds, "query server refresh timeout (in seconds), vttablet manages various mysql connection pools. This config means if a connection has lived at least this long, it connection will be removed from pool upon the next time it is returned to the pool.")
