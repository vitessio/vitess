...
func registerTabletEnvFlags(fs *pflag.FlagSet) {
	...
	fs.DurationVar(&currentConfig.TxThrottlerTopoRefreshInterval, "tx-throttler-topo-refresh-interval", time.Minute*5, "The rate that transaction throttler will refresh the topology to find cells.")
