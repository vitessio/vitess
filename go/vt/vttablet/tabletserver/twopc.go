...
func (tpc *TwoPC) SaveRedo(ctx context.Context, conn *DedicatedConnection, dtid string, queries []string) error {
...
func (tpc *TwoPC) UpdateRedo(ctx context.Context, conn *DedicatedConnection, dtid string, state int) error {
	bindVars := map[string]*querypb.BindVariable{
		"dtid":  sqltypes.StringBindVariable(dtid),
...
func (tpc *TwoPC) DeleteRedo(ctx context.Context, conn *DedicatedConnection, dtid string) error {
	bindVars := map[string]*querypb.BindVariable{
		"dtid": sqltypes.StringBindVariable(dtid),
	}
...
func (tpc *TwoPC) CreateTransaction(ctx context.Context, conn *DedicatedConnection, dtid string, participants []*querypb.Target) error {
	bindVars := map[string]*querypb.BindVariable{
		"dtid":     sqltypes.StringBindVariable(dtid),
...
func (tpc *TwoPC) Transition(ctx context.Context, conn *DedicatedConnection, dtid string, state querypb.TransactionState) error {
	bindVars := map[string]*querypb.BindVariable{
		"dtid":    sqltypes.StringBindVariable(dtid),
		"state":   sqltypes.Int64BindVariable(int64(state)),
...
func (tpc *TwoPC) DeleteTransaction(ctx context.Context, conn *DedicatedConnection, dtid string) error {
	bindVars := map[string]*querypb.BindVariable{
		"dtid": sqltypes.StringBindVariable(dtid),
	}
...
func (tpc *TwoPC) exec(ctx context.Context, conn *DedicatedConnection, pq *sqlparser.ParsedQuery, bindVars map[string]*querypb.BindVariable) (*sqltypes.Result, error) {
