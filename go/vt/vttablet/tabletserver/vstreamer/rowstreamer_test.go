...
func TestStreamRowsScan(t *testing.T) {
	...
	// t1: all rows
	wantStream := []string{
		`fields:<name:"id" type:INT32 table:"t1" org_table:"t1" database:"vttest" org_name:"id" column_length:11 charset:63 flags:53251 > fields:<name:"val" type:VARBINARY table:"t1" org_table:"t1" database:"vttest" org_name:"val" column_length:128 charset:63 flags:128 > pkfields:<name:"id" type:INT32 > `,
	...
	wantStream = []string{
		`fields:<name:"val" type:VARBINARY table:"t1" org_table:"t1" database:"vttest" org_name:"val" column_length:128 charset:63 flags:128 > fields:<name:"id" type:INT32 table:"t1" org_table:"t1" database:"vttest" org_name:"id" column_length:11 charset:63 flags:53251 > pkfields:<name:"id" type:INT32 > `,
	...
	// t3: all rows
	wantStream = []string{
		`fields:<name:"id" type:INT32 table:"t3" org_table:"t3" database:"vttest" org_name:"id" column_length:11 charset:63 flags:32768 > fields:<name:"val" type:VARBINARY table:"t3" org_table:"t3" database:"vttest" org_name:"val" column_length:128 charset:63 flags:128 > pkfields:<name:"id" type:INT32 > pkfields:<name:"val" type:VARBINARY > `,
...
func TestStreamRowsKeyRange(t *testing.T) {
	...
	wantStream := []string{
		`fields:<name:"id1" type:INT32 table:"t1" org_table:"t1" database:"vttest" org_name:"id1" column_length:11 charset:63 flags:53251 > fields:<name:"val" type:VARBINARY table:"t1" org_table:"t1" database:"vttest" org_name:"val" column_length:128 charset:63 flags:128 > pkfields:<name:"id1" type:INT32 > `,
