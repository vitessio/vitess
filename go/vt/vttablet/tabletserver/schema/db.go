...
func reloadTablesDataInDB(ctx context.Context, conn *connpool.Connection, tables []*Table, droppedTables []string) error {
...
func reloadViewsDataInDB(ctx context.Context, conn *connpool.Connection, views []*Table, droppedViews []string) error {
...
func getViewDefinition(ctx context.Context, conn *connpool.Connection, bv map[string]*querypb.BindVariable, callback func(qr *sqltypes.Result) error, alloc func() *sqltypes.Result, bufferSize int) error {
...
func getCreateStatement(ctx context.Context, conn *connpool.Connection, tableName string) (string, error) {
...
func getChangedViewNames(ctx context.Context, conn *connpool.Connection, isServingPrimary bool) (map[string]any, error) {
...
func (se *Engine) getMismatchedTableNames(ctx context.Context, conn *connpool.Connection, isServingPrimary bool) (map[string]any, error) {
...
func reloadDataInDB(ctx context.Context, conn *connpool.Connection, altered []*Table, created []*Table, dropped []*Table) error {
