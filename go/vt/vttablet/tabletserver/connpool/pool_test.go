...
func TestConnPoolStateWhilePoolIsClosed(t *testing.T) {
	...
	assert.EqualValues(t, 0, connPool.UsagePercent(), "pool usage percent should be 0")
...
func TestConnPoolStateWhilePoolIsOpen(t *testing.T) {
	...
	assert.EqualValues(t, 1, connPool.UsagePercent(), "pool usage percent should be 1")
...
func TestConnPoolStateWithSettings(t *testing.T) {
	...
	assert.EqualValues(t, 1, connPool.Active(), "pool active connections should be 1")
	assert.EqualValues(t, 1, connPool.InUse(), "pool inUse connections should be 1")
	assert.EqualValues(t, 20, connPool.UsagePercent(), "pool usage percent should be 20")
	...
	assert.EqualValues(t, 1, connPool.InUse(), "pool inUse connections should be 1")
	assert.EqualValues(t, 40, connPool.UsagePercent(), "pool usage percent should be 40")
	assert.EqualValues(t, 1, connPool.GetCount(), "pool get count should be 1")
	...
	assert.EqualValues(t, 100, connPool.UsagePercent(), "pool usage percent should be 100")
	assert.EqualValues(t, 1, connPool.GetCount(), "pool get count should be 1")
