...
func (tp *TxPool) Begin(ctx context.Context, options *querypb.ExecuteOptions, readOnly bool, reservedID int64, savepointQueries []string, setting *SettingPlan) (*StatefulConnection, string, string, error) {
...
func (tp *TxPool) createConn(ctx context.Context, options *querypb.ExecuteOptions, setting *SettingPlan) (*StatefulConnection, error) {
