...
func TestSchemaVersioning(t *testing.T) {
	...
	var cases = []test{
		...
		},
		{
			...
			output: []string{
				`gtid`,
				`type:DDL statement:"alter table vitess_version\n\tmodify column id3 varbinary(16)"`,
				`version`,
				`gtid`,
			},
		}, {
