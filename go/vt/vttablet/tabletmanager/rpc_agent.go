...
type RPCTM interface {
	...
	ExecuteFetchAsDba(ctx context.Context, query []byte, dbName string, maxrows int, disableBinlogs bool, disableForeignKeyChecks bool, reloadSchema bool) (*querypb.QueryResult, error)
