...
// VReplicationCutOverOnlineDDL executes a vreplication online DDL cutover for MySQL >- 8.0.13
func (tm *TabletManager) VReplicationCutOverOnlineDDL(ctx context.Context, id int, tableName string, vreplTableName string) error {
	return tm.VREngine.CutOverOnlineDDL(id, tableName, vreplTableName)
}
