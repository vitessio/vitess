...
type VStreamerClient interface {
	...
	VStream(ctx context.Context, startPos string, tablePKs []*vstreamer.TablePK, filter *binlogdatapb.Filter, send func([]*binlogdatapb.VEvent) error) error
...
func (c *mysqlConnector) VStream(ctx context.Context, startPos string, tablePKs []*vstreamer.TablePK, filter *binlogdatapb.Filter, send func([]*binlogdatapb.VEvent) error) error {
...
func (tc *tabletConnector) VStream(ctx context.Context, startPos string, tablePKs []*vstreamer.TablePK, filter *binlogdatapb.Filter, send func([]*binlogdatapb.VEvent) error) error {
