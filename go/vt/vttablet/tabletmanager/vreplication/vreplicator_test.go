...
func TestLoadSettingsTracksCopyPhase(t *testing.T) {
	...
	vr := &vreplicator{
		id:       1,
		stats:    stats,
		dbClient: newVDBClient(&copyPhaseDBClient{}, stats, 0),
	}
...
func TestStateMetricNotStuckAfterFailedErrorWrite(t *testing.T) {
	...
	vr.storeState(binlogdatapb.VReplicationWorkflowState_Copying)
	...
	require.Error(t, err)
	require.Equal(t, binlogdatapb.VReplicationWorkflowState_Copying, vr.getState(),
