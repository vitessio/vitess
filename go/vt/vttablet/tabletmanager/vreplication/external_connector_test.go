...
func TestExternalConnectorCopy(t *testing.T) {
	...
	expectDBClientAndVreplicationQueries(t, []string{
		"begin",
		"insert /*+ MAX_EXECUTION_TIME(3600000) */ into tab1(id,val) values (1,'a'), (2,'b')",
	...
	expectDBClientQueries(t, qh.Expect(
		"begin",
		"insert /*+ MAX_EXECUTION_TIME(3600000) */ into tab1(id,val) values (3,'c')",
	...
	expectDBClientAndVreplicationQueries(t, []string{
		"begin",
		"insert /*+ MAX_EXECUTION_TIME(3600000) */ into tab2(id,val) values (1,'a'), (2,'b')",
		"/insert into _vt.copy_state",
		"commit",
		"/delete cs, pca from _vt.copy_state as cs left join _vt.post_copy_action as pca on cs.vrepl_id=pca.vrepl_id and cs.table_name=pca.table_name",
		"/update _vt.vreplication set state='Running'",
	...
	expectDBClientAndVreplicationQueries(t, []string{
		"begin",
		"insert /*+ MAX_EXECUTION_TIME(3600000) */ into tab3(id,val) values (1,'a'), (2,'b')",
		"/insert into _vt.copy_state",
		"commit",
		"/delete cs, pca from _vt.copy_state as cs left join _vt.post_copy_action as pca on cs.vrepl_id=pca.vrepl_id and cs.table_name=pca.table_name",
		"/update _vt.vreplication set state='Running'",
...
func TestExternalConnectorPlay(t *testing.T) {
	...
	expectDBClientAndVreplicationQueries(t, []string{
		"begin",
		"insert /*+ MAX_EXECUTION_TIME(3600000) */ into tab1(id,val) values (1,'a')",
		"insert /*+ MAX_EXECUTION_TIME(3600000) */ into tab1(id,val) values (2,'b')",
		"/update _vt.vreplication set pos=",
		"commit",
	}, pos)
}
