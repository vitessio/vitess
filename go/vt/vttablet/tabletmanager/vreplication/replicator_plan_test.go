		...
		plan: &TestReplicatorPlan{
			...
			TablePlans: map[string]*TestTablePlan{
				"t2": {
					...
					InsertFront:  "insert /*+ MAX_EXECUTION_TIME(3600000) */ into t1(c1,c2)",
					InsertValues: "(:a_c1,:a_c2)",
					Insert:       "insert /*+ MAX_EXECUTION_TIME(3600000) */ into t1(c1,c2) values (:a_c1,:a_c2)",
					Update:       "update /*+ MAX_EXECUTION_TIME(3600000) */ t1 set c2=:a_c2 where c1=:b_c1",
					Delete:       "delete /*+ MAX_EXECUTION_TIME(3600000) */ from t1 where c1=:b_c1",
				},
			},
		},
		planpk: &TestReplicatorPlan{
			...
			TablePlans: map[string]*TestTablePlan{
				"t2": {
					...
					InsertFront:  "insert /*+ MAX_EXECUTION_TIME(3600000) */ into t1(c1,c2)",
					InsertValues: "(:a_c1,:a_c2)",
					Insert:       "insert /*+ MAX_EXECUTION_TIME(3600000) */ into t1(c1,c2) select /*+ MAX_EXECUTION_TIME(3600000) */ :a_c1, :a_c2 from dual where (:a_pk1,:a_pk2) <= (1,'aaa')",
					Update:       "update /*+ MAX_EXECUTION_TIME(3600000) */ t1 set c2=:a_c2 where c1=:b_c1 and (:b_pk1,:b_pk2) <= (1,'aaa')",
					Delete:       "delete /*+ MAX_EXECUTION_TIME(3600000) */ from t1 where c1=:b_c1 and (:b_pk1,:b_pk2) <= (1,'aaa')",
				},
			},
		},
	}, {
		...
		plan: &TestReplicatorPlan{
			...
			TablePlans: map[string]*TestTablePlan{
				"t2": {
					...
					SendRule:     "t2",
					PKReferences: []string{"c1"},
					InsertFront:  "insert /*+ MAX_EXECUTION_TIME(3600000) */ into t1(c1,c2,c3)",
					InsertValues: "(:a_c1,:a_c2,:a_c3)",
					InsertOnDup:  "on duplicate key update c2=values(c2)",
					Insert:       "insert /*+ MAX_EXECUTION_TIME(3600000) */ into t1(c1,c2,c3) values (:a_c1,:a_c2,:a_c3) on duplicate key update c2=values(c2)",
					Update:       "update /*+ MAX_EXECUTION_TIME(3600000) */ t1 set c2=:a_c2 where c1=:b_c1",
					Delete:       "update /*+ MAX_EXECUTION_TIME(3600000) */ t1 set c2=null where c1=:b_c1",
				},
			},
		},
		planpk: &TestReplicatorPlan{
			...
			TablePlans: map[string]*TestTablePlan{
				"t2": {
					...
					InsertValues: "(:a_c1,:a_c2,:a_c3)",
					InsertOnDup:  "on duplicate key update c2=values(c2)",
					Insert:       "insert /*+ MAX_EXECUTION_TIME(3600000) */ into t1(c1,c2,c3) select /*+ MAX_EXECUTION_TIME(3600000) */ :a_c1, :a_c2, :a_c3 from dual where (:a_pk1,:a_pk2) <= (1,'aaa') on duplicate key update c2=values(c2)",
					Update:       "update /*+ MAX_EXECUTION_TIME(3600000) */ t1 set c2=:a_c2 where c1=:b_c1 and (:b_pk1,:b_pk2) <= (1,'aaa')",
					Delete:       "update /*+ MAX_EXECUTION_TIME(3600000) */ t1 set c2=null where c1=:b_c1 and (:b_pk1,:b_pk2) <= (1,'aaa')",
				},
			},
		},
	}, {
		...
		plan: &TestReplicatorPlan{
			...
			TablePlans: map[string]*TestTablePlan{
				"t2": {
					...
					SendRule:     "t2",
					PKReferences: []string{"c1"},
					InsertFront:  "insert /*+ MAX_EXECUTION_TIME(3600000) */ ignore into t1(c1,c2,c3)",
					InsertValues: "(:a_c1,:a_c2,:a_c3)",
					Insert:       "insert /*+ MAX_EXECUTION_TIME(3600000) */ ignore into t1(c1,c2,c3) values (:a_c1,:a_c2,:a_c3)",
					Update:       "insert /*+ MAX_EXECUTION_TIME(3600000) */ ignore into t1(c1,c2,c3) values (:a_c1,:a_c2,:a_c3)",
				},
			},
		},
		planpk: &TestReplicatorPlan{
			...
			TablePlans: map[string]*TestTablePlan{
				"t2": {
					...
					InsertFront:  "insert /*+ MAX_EXECUTION_TIME(3600000) */ ignore into t1(c1,c2,c3)",
					InsertValues: "(:a_c1,:a_c2,:a_c3)",
					Insert:       "insert /*+ MAX_EXECUTION_TIME(3600000) */ ignore into t1(c1,c2,c3) select /*+ MAX_EXECUTION_TIME(3600000) */ :a_c1, :a_c2, :a_c3 from dual where (:a_pk1,:a_pk2) <= (1,'aaa')",
					Update:       "insert /*+ MAX_EXECUTION_TIME(3600000) */ ignore into t1(c1,c2,c3) select /*+ MAX_EXECUTION_TIME(3600000) */ :a_c1, :a_c2, :a_c3 from dual where (:a_pk1,:a_pk2) <= (1,'aaa')",
				},
			},
		},
	}, {
		...
		plan: &TestReplicatorPlan{
			...
			TablePlans: map[string]*TestTablePlan{
				"t1": {
					...
					Insert:       "insert /*+ MAX_EXECUTION_TIME(3600000) */ into t1(c1,c2,c3) values (foo(:a_a),foo(:a_a, :a_b),:a_c)",
					Update:       "update /*+ MAX_EXECUTION_TIME(3600000) */ t1 set c2=foo(:a_a, :a_b), c3=:a_c where c1=(foo(:b_a))",
					Delete:       "delete /*+ MAX_EXECUTION_TIME(3600000) */ from t1 where c1=(foo(:b_a))",
				},
			},
		},
		planpk: &TestReplicatorPlan{
			...
			TablePlans: map[string]*TestTablePlan{
				"t1": {
					...
					InsertFront:  "insert /*+ MAX_EXECUTION_TIME(3600000) */ into t1(c1,c2,c3)",
					InsertValues: "(foo(:a_a),foo(:a_a, :a_b),:a_c)",
					Insert:       "insert /*+ MAX_EXECUTION_TIME(3600000) */ into t1(c1,c2,c3) select /*+ MAX_EXECUTION_TIME(3600000) */ foo(:a_a), foo(:a_a, :a_b), :a_c from dual where (:a_pk1,:a_pk2) <= (1,'aaa')",
					Update:       "update /*+ MAX_EXECUTION_TIME(3600000) */ t1 set c2=foo(:a_a, :a_b), c3=:a_c where c1=(foo(:b_a)) and (:b_pk1,:b_pk2) <= (1,'aaa')",
					Delete:       "delete /*+ MAX_EXECUTION_TIME(3600000) */ from t1 where c1=(foo(:b_a)) and (:b_pk1,:b_pk2) <= (1,'aaa')",
				},
			},
		},
	}, {
		...
		plan: &TestReplicatorPlan{
			...
			TablePlans: map[string]*TestTablePlan{
				"t1": {
					...
					Insert:       "insert /*+ MAX_EXECUTION_TIME(3600000) */ into t1(c1,c2) values (:a_a + :a_b,:a_c)",
					Update:       "update /*+ MAX_EXECUTION_TIME(3600000) */ t1 set c2=:a_c where c1=(:b_a + :b_b)",
					Delete:       "delete /*+ MAX_EXECUTION_TIME(3600000) */ from t1 where c1=(:b_a + :b_b)",
				},
			},
		},
		planpk: &TestReplicatorPlan{
			...
			TablePlans: map[string]*TestTablePlan{
				"t1": {
					...
					InsertFront:  "insert /*+ MAX_EXECUTION_TIME(3600000) */ into t1(c1,c2)",
					InsertValues: "(:a_a + :a_b,:a_c)",
					Insert:       "insert /*+ MAX_EXECUTION_TIME(3600000) */ into t1(c1,c2) select /*+ MAX_EXECUTION_TIME(3600000) */ :a_a + :a_b, :a_c from dual where (:a_pk1,:a_pk2) <= (1,'aaa')",
					Update:       "update /*+ MAX_EXECUTION_TIME(3600000) */ t1 set c2=:a_c where c1=(:b_a + :b_b) and (:b_pk1,:b_pk2) <= (1,'aaa')",
					Delete:       "delete /*+ MAX_EXECUTION_TIME(3600000) */ from t1 where c1=(:b_a + :b_b) and (:b_pk1,:b_pk2) <= (1,'aaa')",
				},
			},
		},
	}, {
		...
		plan: &TestReplicatorPlan{
			...
			TablePlans: map[string]*TestTablePlan{
				"t1": {
					...
					Insert:       "insert /*+ MAX_EXECUTION_TIME(3600000) */ into t1(c1,c2) values (:a_c1,convert(:a_c using utf8mb4))",
					Update:       "update /*+ MAX_EXECUTION_TIME(3600000) */ t1 set c2=convert(:a_c using utf8mb4) where c1=:b_c1",
					Delete:       "delete /*+ MAX_EXECUTION_TIME(3600000) */ from t1 where c1=:b_c1",
				},
			},
		},
		planpk: &TestReplicatorPlan{
			...
			TablePlans: map[string]*TestTablePlan{
				"t1": {
					...
					InsertFront:  "insert /*+ MAX_EXECUTION_TIME(3600000) */ into t1(c1,c2)",
					InsertValues: "(:a_c1,convert(:a_c using utf8mb4))",
					Insert:       "insert /*+ MAX_EXECUTION_TIME(3600000) */ into t1(c1,c2) select /*+ MAX_EXECUTION_TIME(3600000) */ :a_c1, convert(:a_c using utf8mb4) from dual where (:a_pk1,:a_pk2) <= (1,'aaa')",
					Update:       "update /*+ MAX_EXECUTION_TIME(3600000) */ t1 set c2=convert(:a_c using utf8mb4) where c1=:b_c1 and (:b_pk1,:b_pk2) <= (1,'aaa')",
					Delete:       "delete /*+ MAX_EXECUTION_TIME(3600000) */ from t1 where c1=:b_c1 and (:b_pk1,:b_pk2) <= (1,'aaa')",
				},
			},
		},
		...
		plan: &TestReplicatorPlan{
			...
			TablePlans: map[string]*TestTablePlan{
				"primary": {
					...
					SendRule:     "primary",
					PKReferences: []string{"c1"},
					InsertFront:  "insert /*+ MAX_EXECUTION_TIME(3600000) */ into t1(c1,c2,`primary`)",
					InsertValues: "(:a_c1,:a_c2,:a_primary)",
					Insert:       "insert /*+ MAX_EXECUTION_TIME(3600000) */ into t1(c1,c2,`primary`) values (:a_c1,:a_c2,:a_primary)",
					Update:       "update /*+ MAX_EXECUTION_TIME(3600000) */ t1 set c2=:a_c2, `primary`=:a_primary where c1=:b_c1",
					Delete:       "delete /*+ MAX_EXECUTION_TIME(3600000) */ from t1 where c1=:b_c1",
				},
			},
		},
		planpk: &TestReplicatorPlan{
			...
			TablePlans: map[string]*TestTablePlan{
				"primary": {
					...
					InsertFront:  "insert /*+ MAX_EXECUTION_TIME(3600000) */ into t1(c1,c2,`primary`)",
					InsertValues: "(:a_c1,:a_c2,:a_primary)",
					Insert:       "insert /*+ MAX_EXECUTION_TIME(3600000) */ into t1(c1,c2,`primary`) select /*+ MAX_EXECUTION_TIME(3600000) */ :a_c1, :a_c2, :a_primary from dual where (:a_pk1,:a_pk2) <= (1,'aaa')",
					Update:       "update /*+ MAX_EXECUTION_TIME(3600000) */ t1 set c2=:a_c2, `primary`=:a_primary where c1=:b_c1 and (:b_pk1,:b_pk2) <= (1,'aaa')",
					Delete:       "delete /*+ MAX_EXECUTION_TIME(3600000) */ from t1 where c1=:b_c1 and (:b_pk1,:b_pk2) <= (1,'aaa')",
				},
			},
		},
		...
		plan: &TestReplicatorPlan{
			...
			TablePlans: map[string]*TestTablePlan{
				"t1": {
					...
					SendRule:     "t1",
					PKReferences: []string{"c1"},
					InsertFront:  "insert /*+ MAX_EXECUTION_TIME(3600000) */ into t1(c1,c2,ksid)",
					InsertValues: "(:a_c1,:a_c2,:a_keyspace_id)",
					Insert:       "insert /*+ MAX_EXECUTION_TIME(3600000) */ into t1(c1,c2,ksid) values (:a_c1,:a_c2,:a_keyspace_id)",
					Update:       "update /*+ MAX_EXECUTION_TIME(3600000) */ t1 set c2=:a_c2, ksid=:a_keyspace_id where c1=:b_c1",
					Delete:       "delete /*+ MAX_EXECUTION_TIME(3600000) */ from t1 where c1=:b_c1",
				},
			},
		},
		planpk: &TestReplicatorPlan{
			...
			TablePlans: map[string]*TestTablePlan{
				"t1": {
					...
					InsertFront:  "insert /*+ MAX_EXECUTION_TIME(3600000) */ into t1(c1,c2,ksid)",
					InsertValues: "(:a_c1,:a_c2,:a_keyspace_id)",
					Insert:       "insert /*+ MAX_EXECUTION_TIME(3600000) */ into t1(c1,c2,ksid) select /*+ MAX_EXECUTION_TIME(3600000) */ :a_c1, :a_c2, :a_keyspace_id from dual where (:a_pk1,:a_pk2) <= (1,'aaa')",
					Update:       "update /*+ MAX_EXECUTION_TIME(3600000) */ t1 set c2=:a_c2, ksid=:a_keyspace_id where c1=:b_c1 and (:b_pk1,:b_pk2) <= (1,'aaa')",
					Delete:       "delete /*+ MAX_EXECUTION_TIME(3600000) */ from t1 where c1=:b_c1 and (:b_pk1,:b_pk2) <= (1,'aaa')",
				},
			},
		},
