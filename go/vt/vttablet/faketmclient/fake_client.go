...
func (client *FakeTabletManagerClient) VReplicationCutOverOnlineDDL(ctx context.Context, tablet *topodatapb.Tablet, id int, tableName string, vreplTabeName string) error {
	return nil
}
