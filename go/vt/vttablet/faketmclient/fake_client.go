...
func (client *FakeTabletManagerClient) UpdateTabletControls(context.Context, *topodatapb.Tablet, tabletmanagerdatapb.TabletControl) (*tabletmanagerdatapb.UpdateTabletControlsResponse, error) {
