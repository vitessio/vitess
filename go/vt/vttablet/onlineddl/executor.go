...
var vexecUpdateTemplates = []string{
	fmt.Sprintf(`update %s.schema_migrations set migration_status='val1' where mysql_schema='val2'`, sidecardb.GetIdentifier()),
	fmt.Sprintf(`update %s.schema_migrations set migration_status='val1' where migration_uuid='val2' and mysql_schema='val3'`, sidecardb.GetIdentifier()),
	fmt.Sprintf(`update %s.schema_migrations set migration_status='val1' where migration_uuid='val2' and mysql_schema='val3' and shard='val4'`, sidecardb.GetIdentifier()),
}
...
func (e *Executor) terminateVReplMigration(ctx context.Context, uuid string) error {
	...
	query, err := sqlparser.ParseAndBind(fmt.Sprintf(sqlStopVReplStream, sidecardb.GetIdentifier()),
...

	{
...

		{
			...
			query := fmt.Sprintf("update %s.vreplication set workflow_type = %d where workflow = '%s'",
				sidecardb.GetIdentifier(), binlogdatapb.VReplicationWorkflowType_OnlineDDL, v.workflow)
			if _, err := e.vreplicationExec(ctx, tablet.Tablet, query); err != nil {
...
func (e *Executor) readMigration(ctx context.Context, uuid string) (onlineDDL *schema.OnlineDDL, row sqltypes.RowNamedValues, err error) {
	...
	parsed := sqlparser.BuildParsedQuery(fmt.Sprintf(sqlSelectMigration, sidecardb.GetIdentifier()), ":migration_uuid")
	bindVars := map[string]*querypb.BindVariable{
...
func (e *Executor) readPendingMigrationsUUIDs(ctx context.Context) (uuids []string, err error) {
	r, err := e.execQuery(ctx, fmt.Sprintf(sqlSelectPendingMigrations, sidecardb.GetIdentifier()))
	if err != nil {
		return uuids, err
	}
...
func (e *Executor) scheduleNextMigration(ctx context.Context) error {
	...
	r, err := e.execQuery(ctx, fmt.Sprintf(sqlSelectQueuedMigrations, sidecardb.GetIdentifier()))
	if err != nil {
		return err
	}
	for _, row := range r.Named().Rows {
...
func (e *Executor) reviewQueuedMigrations(ctx context.Context) error {
	...
	r, err := e.execQuery(ctx, fmt.Sprintf(sqlSelectQueuedUnreviewedMigrations, sidecardb.GetIdentifier()))
	if err != nil {
		return err
	}
...
func (e *Executor) validateMigrationRevertible(ctx context.Context, revertMigration *schema.OnlineDDL, revertingMigrationUUID string) (err error) {
	...
	}
	{
		...
		}
		{
			...
			query, err := sqlparser.ParseAndBind(fmt.Sprintf(sqlSelectCompleteMigrationsOnTable, sidecardb.GetIdentifier()),
...
func (e *Executor) getCompletedMigrationByContextAndSQL(ctx context.Context, onlineDDL *schema.OnlineDDL) (completedUUID string, err error) {
	...
	query, err := sqlparser.ParseAndBind(fmt.Sprintf(sqlSelectCompleteMigrationsByContextAndSQL, sidecardb.GetIdentifier()),
		sqltypes.StringBindVariable(e.keyspace),
...
func (e *Executor) runNextMigration(ctx context.Context) error {
	...
	getNonConflictingMigration := func() (*schema.OnlineDDL, error) {
		...
		r, err := e.execQuery(ctx, fmt.Sprintf(sqlSelectReadyMigrations, sidecardb.GetIdentifier()))
		if err != nil {
			return nil, err
		}
		for _, row := range r.Named().Rows {
...
func (e *Executor) readVReplStream(ctx context.Context, uuid string, okIfMissing bool) (*VReplStream, error) {
	query, err := sqlparser.ParseAndBind(fmt.Sprintf(sqlReadVReplStream, sidecardb.GetIdentifier()),
		sqltypes.StringBindVariable(uuid),
	)
	if err != nil {
		return nil, err
...
func (e *Executor) isVReplMigrationReadyToCutOver(ctx context.Context, s *VReplStream) (isReady bool, err error) {
	...
	}
	{
		...
		query, err := sqlparser.ParseAndBind(fmt.Sprintf(sqlReadCountCopyState, sidecardb.GetIdentifier()),
...
func (e *Executor) reviewRunningMigrations(ctx context.Context) (countRunnning int, cancellable []*cancellableMigration, err error) {
	...
	r, err := e.execQuery(ctx, fmt.Sprintf(sqlSelectRunningMigrations, sidecardb.GetIdentifier()))
	if err != nil {
...
func (e *Executor) reviewStaleMigrations(ctx context.Context) error {
	...
	query, err := sqlparser.ParseAndBind(fmt.Sprintf(sqlSelectStaleMigrations, sidecardb.GetIdentifier()),
...
func (e *Executor) deleteVReplicationEntry(ctx context.Context, uuid string) error {
	query, err := sqlparser.ParseAndBind(fmt.Sprintf(sqlDeleteVReplStream, sidecardb.GetIdentifier()),
		sqltypes.StringBindVariable(e.dbName),
		sqltypes.StringBindVariable(uuid),
	)
	if err != nil {
...
func (e *Executor) gcArtifacts(ctx context.Context) error {
	...
	if _, err := e.execQuery(ctx, fmt.Sprintf(sqlFixCompletedTimestamp, sidecardb.GetIdentifier())); err != nil {
	...
	query, err := sqlparser.ParseAndBind(fmt.Sprintf(sqlSelectUncollectedArtifacts, sidecardb.GetIdentifier()),
...
func (e *Executor) updateMigrationStartedTimestamp(ctx context.Context, uuid string) error {
	parsed := sqlparser.BuildParsedQuery(fmt.Sprintf(sqlUpdateMigrationStartedTimestamp, sidecardb.GetIdentifier()),
		":migration_uuid",
	)
	bindVars := map[string]*querypb.BindVariable{
		"migration_uuid": sqltypes.StringBindVariable(uuid),
...
func (e *Executor) updateMigrationTimestamp(ctx context.Context, timestampColumn string, uuid string) error {
	parsed := sqlparser.BuildParsedQuery(fmt.Sprintf(sqlUpdateMigrationTimestamp, sidecardb.GetIdentifier(),
		timestampColumn),
		":migration_uuid",
	)
	bindVars := map[string]*querypb.BindVariable{
...
func (e *Executor) updateMigrationLogPath(ctx context.Context, uuid string, hostname, logPath string) error {
	...
	query, err := sqlparser.ParseAndBind(fmt.Sprintf(sqlUpdateMigrationLogPath, sidecardb.GetIdentifier()),
...
func (e *Executor) updateArtifacts(ctx context.Context, uuid string, artifacts ...string) error {
	...
	query, err := sqlparser.ParseAndBind(fmt.Sprintf(sqlUpdateArtifacts, sidecardb.GetIdentifier()),
...
func (e *Executor) clearArtifacts(ctx context.Context, uuid string) error {
	query, err := sqlparser.ParseAndBind(fmt.Sprintf(sqlClearArtifacts, sidecardb.GetIdentifier()),
		sqltypes.StringBindVariable(uuid),
	)
	if err != nil {
		return err
...
func (e *Executor) updateMigrationSpecialPlan(ctx context.Context, uuid string, specialPlan string) error {
	query, err := sqlparser.ParseAndBind(fmt.Sprintf(sqlUpdateSpecialPlan, sidecardb.GetIdentifier()),
...
func (e *Executor) updateMigrationStage(ctx context.Context, uuid string, stage string, args ...interface{}) error {
	...
	query, err := sqlparser.ParseAndBind(fmt.Sprintf(sqlUpdateStage, sidecardb.GetIdentifier()),
...
func (e *Executor) incrementCutoverAttempts(ctx context.Context, uuid string) error {
	query, err := sqlparser.ParseAndBind(fmt.Sprintf(sqlIncrementCutoverAttempts, sidecardb.GetIdentifier()),
		sqltypes.StringBindVariable(uuid),
	)
	if err != nil {
		return err
...
func (e *Executor) updateMigrationTablet(ctx context.Context, uuid string) error {
	query, err := sqlparser.ParseAndBind(fmt.Sprintf(sqlUpdateTablet, sidecardb.GetIdentifier()),
...
func (e *Executor) updateTabletFailure(ctx context.Context, uuid string) error {
	parsed := sqlparser.BuildParsedQuery(fmt.Sprintf(sqlUpdateTabletFailure, sidecardb.GetIdentifier()),
		":migration_uuid",
	)
	bindVars := map[string]*querypb.BindVariable{
		"migration_uuid": sqltypes.StringBindVariable(uuid),
...
func (e *Executor) updateMigrationStatusFailedOrCancelled(ctx context.Context, uuid string) error {
	...
	query, err := sqlparser.ParseAndBind(fmt.Sprintf(sqlUpdateMigrationStatusFailedOrCancelled, sidecardb.GetIdentifier()),
		sqltypes.StringBindVariable(uuid),
	)
	if err != nil {
		return err
...
func (e *Executor) updateMigrationStatus(ctx context.Context, uuid string, status schema.OnlineDDLStatus) error {
	...
	query, err := sqlparser.ParseAndBind(fmt.Sprintf(sqlUpdateMigrationStatus, sidecardb.GetIdentifier()),
...
func (e *Executor) updateDDLAction(ctx context.Context, uuid string, actionStr string) error {
	query, err := sqlparser.ParseAndBind(fmt.Sprintf(sqlUpdateDDLAction, sidecardb.GetIdentifier()),
...
func (e *Executor) updateMigrationMessage(ctx context.Context, uuid string, message string) error {
	...
	update := func(message string) error {
		...
		query, err := sqlparser.ParseAndBind(fmt.Sprintf(sqlUpdateMessage, sidecardb.GetIdentifier()),
...
func (e *Executor) updateSchemaAnalysis(ctx context.Context, uuid string,
	...
	query, err := sqlparser.ParseAndBind(fmt.Sprintf(sqlUpdateSchemaAnalysis, sidecardb.GetIdentifier()),
...
func (e *Executor) updateMySQLTable(ctx context.Context, uuid string, tableName string) error {
	query, err := sqlparser.ParseAndBind(fmt.Sprintf(sqlUpdateMySQLTable, sidecardb.GetIdentifier()),
...
func (e *Executor) updateMigrationETASeconds(ctx context.Context, uuid string, etaSeconds int64) error {
	query, err := sqlparser.ParseAndBind(fmt.Sprintf(sqlUpdateMigrationETASeconds, sidecardb.GetIdentifier()),
...
func (e *Executor) updateMigrationProgress(ctx context.Context, uuid string, progress float64) error {
	...
	query, err := sqlparser.ParseAndBind(fmt.Sprintf(sqlUpdateMigrationProgress, sidecardb.GetIdentifier()),
...
func (e *Executor) updateMigrationProgressByRowsCopied(ctx context.Context, uuid string, rowsCopied int64) error {
	query, err := sqlparser.ParseAndBind(fmt.Sprintf(sqlUpdateMigrationProgressByRowsCopied, sidecardb.GetIdentifier()),
...
func (e *Executor) updateMigrationETASecondsByProgress(ctx context.Context, uuid string) error {
	query, err := sqlparser.ParseAndBind(fmt.Sprintf(sqlUpdateMigrationETASecondsByProgress, sidecardb.GetIdentifier()),
		sqltypes.StringBindVariable(uuid),
	)
	if err != nil {
		return err
...
func (e *Executor) updateMigrationLastThrottled(ctx context.Context, uuid string, lastThrottledUnixTime int64, throttledCompnent string) error {
	query, err := sqlparser.ParseAndBind(fmt.Sprintf(sqlUpdateLastThrottled, sidecardb.GetIdentifier()),
...
func (e *Executor) updateMigrationTableRows(ctx context.Context, uuid string, tableRows int64) error {
	query, err := sqlparser.ParseAndBind(fmt.Sprintf(sqlUpdateMigrationTableRows, sidecardb.GetIdentifier()),
...
func (e *Executor) updateRowsCopied(ctx context.Context, uuid string, rowsCopied int64) error {
	...
	query, err := sqlparser.ParseAndBind(fmt.Sprintf(sqlUpdateMigrationRowsCopied, sidecardb.GetIdentifier()),
		sqltypes.Int64BindVariable(rowsCopied),
		sqltypes.StringBindVariable(uuid),
	)
	if err != nil {
...
func (e *Executor) updateVitessLivenessIndicator(ctx context.Context, uuid string, livenessIndicator int64) error {
	query, err := sqlparser.ParseAndBind(fmt.Sprintf(sqlUpdateMigrationVitessLivenessIndicator, sidecardb.GetIdentifier()),
...
func (e *Executor) updateMigrationIsView(ctx context.Context, uuid string, isView bool) error {
	query, err := sqlparser.ParseAndBind(fmt.Sprintf(sqlUpdateMigrationIsView, sidecardb.GetIdentifier()),
...
func (e *Executor) updateMigrationSetImmediateOperation(ctx context.Context, uuid string) error {
	query, err := sqlparser.ParseAndBind(fmt.Sprintf(sqlUpdateMigrationSetImmediateOperation, sidecardb.GetIdentifier()),
		sqltypes.StringBindVariable(uuid),
	)
	if err != nil {
		return err
...
func (e *Executor) updateMigrationReadyToComplete(ctx context.Context, uuid string, isReady bool) error {
	query, err := sqlparser.ParseAndBind(fmt.Sprintf(sqlUpdateMigrationReadyToComplete, sidecardb.GetIdentifier()),
...
func (e *Executor) updateMigrationStowawayTable(ctx context.Context, uuid string, tableName string) error {
	query, err := sqlparser.ParseAndBind(fmt.Sprintf(sqlUpdateMigrationStowawayTable, sidecardb.GetIdentifier()),
		sqltypes.StringBindVariable(tableName),
		sqltypes.StringBindVariable(uuid),
	)
	if err != nil {
...
func (e *Executor) updateMigrationUserThrottleRatio(ctx context.Context, uuid string, ratio float64) error {
	query, err := sqlparser.ParseAndBind(fmt.Sprintf(sqlUpdateMigrationUserThrottleRatio, sidecardb.GetIdentifier()),
...
func (e *Executor) retryMigrationWhere(ctx context.Context, whereExpr string) (result *sqltypes.Result, err error) {
	e.migrationMutex.Lock()
	defer e.migrationMutex.Unlock()
	parsed := sqlparser.BuildParsedQuery(fmt.Sprintf(sqlRetryMigrationWhere, sidecardb.GetIdentifier(), whereExpr),
		":tablet")
	bindVars := map[string]*querypb.BindVariable{
...
func (e *Executor) RetryMigration(ctx context.Context, uuid string) (result *sqltypes.Result, err error) {
	...
	query, err := sqlparser.ParseAndBind(fmt.Sprintf(sqlRetryMigration, sidecardb.GetIdentifier()),
		sqltypes.StringBindVariable(e.TabletAliasString()),
		sqltypes.StringBindVariable(uuid),
	)
	if err != nil {
...
func (e *Executor) CleanupMigration(ctx context.Context, uuid string) (result *sqltypes.Result, err error) {
	...
	query, err := sqlparser.ParseAndBind(fmt.Sprintf(sqlUpdateReadyForCleanup, sidecardb.GetIdentifier()),
		sqltypes.StringBindVariable(uuid),
	)
	if err != nil {
		return nil, err
...
func (e *Executor) CompleteMigration(ctx context.Context, uuid string) (result *sqltypes.Result, err error) {
	...
	query, err := sqlparser.ParseAndBind(fmt.Sprintf(sqlUpdateCompleteMigration, sidecardb.GetIdentifier()),
		sqltypes.StringBindVariable(uuid),
	)
	if err != nil {
		return nil, err
...
func (e *Executor) LaunchMigration(ctx context.Context, uuid string, shardsArg string) (result *sqltypes.Result, err error) {
	...
	query, err := sqlparser.ParseAndBind(fmt.Sprintf(sqlUpdateLaunchMigration, sidecardb.GetIdentifier()),
		sqltypes.StringBindVariable(uuid),
	)
	if err != nil {
		return nil, err
...
func (e *Executor) SubmitMigration(
	...
	submitQuery, err := sqlparser.ParseAndBind(fmt.Sprintf(sqlInsertMigration, sidecardb.GetIdentifier()),
