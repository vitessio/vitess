...
func analyzeSpecialAlterPlan(ctx context.Context, onlineDDL *schema.OnlineDDL, createTable *sqlparser.CreateTable, capableOf capabilities.CapableOf, parser *sqlparser.Parser) (plan *SpecialAlterPlan, shouldApplyPlanPerStrategy bool, err error) {
