...
// ColumnValues contains table data values for columns
type ColumnValues struct {
	abstractValues []interface{}
	ValuesPointers []interface{}
}

// NewColumnValues initiates a values list
...
// ToColumnValues converts abstrcat values into a ColumnValues list
...
// AbstractValues gets the abtracts values of this list
func (v *ColumnValues) AbstractValues() []interface{} {
	return v.abstractValues
}

// StringColumn return the string value of a column
func (v *ColumnValues) StringColumn(index int) string {
	val := v.AbstractValues()[index]
...
// String returns a visual representation of this list
func (v *ColumnValues) String() string {
	stringValues := []string{}
	for i := range v.AbstractValues() {
		stringValues = append(stringValues, v.StringColumn(i))
	}
