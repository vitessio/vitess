...
func (fra *fakeRPCTM) CreateVRWorkflow(ctx context.Context, req *tabletmanagerdatapb.CreateVRWorkflowRequest) (*tabletmanagerdatapb.CreateVRWorkflowResponse, error) {
	//TODO implement me
	panic("implement me")
}
