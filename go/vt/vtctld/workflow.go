...
func registerVtctldWorkflowFlags(fs *pflag.FlagSet) {
	...
	fs.MarkDeprecated("workflow_manager_init", "it will be removed in the future releases.")
	...
	fs.MarkDeprecated("workflow_manager_use_election", "it will be removed in the future releases.")
	...
	fs.MarkDeprecated("workflow_manager_disable", "it will be removed in the future releases.")
}
