...
func (ts *trafficSwitcher) mirrorTableTraffic(ctx context.Context, percent float32) error {
	...
	mrs[ts.SourceKeyspaceName()] = topotools.MirrorRule{
		ToKeyspace: ts.TargetKeyspaceName(),
		Percent:    percent,
	}
