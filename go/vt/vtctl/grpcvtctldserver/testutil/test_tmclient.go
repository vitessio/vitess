...
func (fake *TabletManagerClient) FullStatus(ctx context.Context, tablet *topodatapb.Tablet, req *tabletmanagerdatapb.FullStatusRequest) (*replicationdatapb.FullStatus, error) {
