...
// It assumes the row was part of the result set of a SELECT generated by the
// selectSchemaMigrationsQuery function above.
...
// valueToVTTime converts a SQL value into a vttime Time type. It first parses
// the raw string value into a Go Time type in the local timezone. This is a
// correct conversion only if the vtctld is set to the same timezone as the
...
// valueToVTDuration converts a SQL value into a vttime Duration type. It takes
