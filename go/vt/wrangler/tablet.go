...
func (wr *Wrangler) ChangeTabletType(ctx context.Context, tabletAlias *topodatapb.TabletAlias, tabletType topodatapb.TabletType, force bool) error {
	...
	if !force && !topo.IsTrivialTypeChange(ti.Type, tabletType) {
