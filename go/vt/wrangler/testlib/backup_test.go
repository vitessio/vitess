...
func testBackupRestore(t *testing.T, cDetails *compressionDetails) error {
	...
	err = destTablet.TM.RestoreBackup(ctx, logutil.NewConsoleLogger(), []string{}, /* allowedBackupEngines */
		time.Time{} /* backupTime */, false /* deleteBeforeRestore */, false /* dryRun */, mysqlShutdownTimeout,
		"" /* restoreToPos */, time.Time{} /* restoreToTimestamp */, 0 /* waitForBackupInterval */)
	if err != nil {
		return err
	}
	// verify the full status
	...
	require.NoError(t, primary.TM.RestoreBackup(ctx, logutil.NewConsoleLogger(), []string{}, /* allowedBackupEngines */
		time.Time{} /* backupTime */, false /* deleteBeforeRestore */, false /* dryRun */, mysqlShutdownTimeout,
		"" /* restoreToPos */, time.Time{} /* restoreToTimestamp */, 0 /* waitForBackupInterval */),
		"RestoreData failed")
	...
	require.NoError(t, primary.TM.RestoreBackup(ctx, logutil.NewConsoleLogger(), []string{}, /* allowedBackupEngines */
		backupTime, false /* deleteBeforeRestore */, false /* dryRun */, mysqlShutdownTimeout,
		"" /* restoreToPos */, time.Time{} /* restoreToTimestamp */, 0 /* waitForBackupInterval */),
...
func TestBackupRestoreLagged(t *testing.T) {
	...
	errCh = make(chan error, 1)
	go func(ctx context.Context, tablet *FakeTablet) {
		errCh <- tablet.TM.RestoreBackup(ctx, logutil.NewConsoleLogger(), []string{}, /* allowedBackupEngines */
			time.Time{} /* backupTime */, false /* deleteBeforeRestore */, false /* dryRun */, mysqlShutdownTimeout,
			"" /* restoreToPos */, time.Time{} /* restoreToTimestamp */, 0 /* waitForBackupInterval */)
	}(ctx, destTablet)
...
func TestDisableActiveReparents(t *testing.T) {
	...
	require.NoError(t, destTablet.TM.RestoreBackup(ctx, logutil.NewConsoleLogger(), []string{}, /* allowedBackupEngines */
		time.Time{} /* backupTime */, false /* deleteBeforeRestore */, false /* dryRun */, mysqlShutdownTimeout,
		"" /* restoreToPos */, time.Time{} /* restoreToTimestamp */, 0 /* waitForBackupInterval */))
	// verify the full status
	require.NoError(t, destTablet.FakeMysqlDaemon.CheckSuperQueryList(), "destTablet.FakeMysqlDaemon.CheckSuperQueryList failed")
