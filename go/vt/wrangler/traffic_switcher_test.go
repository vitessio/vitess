...
func TestTableMigrateOneToMany(t *testing.T) {
	...
	wantdryRunDropSources := []string{
		...
		"	Keyspace ks1 Shard 0 DbName vt_ks1 Tablet 10 Table t1 RemovalType DropTable",
		"	Keyspace ks1 Shard 0 DbName vt_ks1 Tablet 10 Table t2 RemovalType DropTable",
	...
	results, err := tme.wr.DropSources(ctx, tme.targetKeyspace, "test", DropTable, false)
	...
	wantdryRunRenameSources := []string{
		...
		"Lock keyspace ks2",
		"Dropping following tables:",
		"	Keyspace ks1 Shard 0 DbName vt_ks1 Tablet 10 Table t1 RemovalType RenameTable",
		"	Keyspace ks1 Shard 0 DbName vt_ks1 Tablet 10 Table t2 RemovalType RenameTable",
		"Blacklisted tables t1,t2 will be removed from:",
		"	Keyspace ks1 Shard 0 Tablet 10",
		"Delete reverse vreplication streams on source:",
		"	Keyspace ks1 Shard 0 Workflow test_reverse DbName vt_ks1 Tablet 10",
	...
	results, err = tme.wr.DropSources(ctx, tme.targetKeyspace, "test", RenameTable, false)
	require.NoError(t, err)
