...
(
    ...
    `ready_timestamp`                 datetime         NULL     DEFAULT NULL,
    `started_timestamp`               datetime         NULL     DEFAULT NULL,
    `liveness_timestamp`              datetime         NULL     DEFAULT NULL,
    `completed_timestamp`             datetime         NULL     DEFAULT NULL,
    `cleanup_timestamp`               datetime         NULL     DEFAULT NULL,
    ...
    `message_timestamp`               datetime         NULL     DEFAULT NULL,
    ...
    `last_throttled_timestamp`        datetime         NULL     DEFAULT NULL,
    `component_throttled`             tinytext         NOT NULL,
    `reason_throttled`                text             NOT NULL,
    `cancelled_timestamp`             datetime         NULL     DEFAULT NULL,
    ...
    `reviewed_timestamp`              datetime         NULL DEFAULT NULL,
    `ready_to_complete_timestamp`     datetime         NULL DEFAULT NULL,
    `shadow_analyzed_timestamp`       datetime         NULL DEFAULT NULL,
    `removed_foreign_key_names`       text             NOT NULL,
    `last_cutover_attempt_timestamp`  datetime         NULL DEFAULT NULL,
