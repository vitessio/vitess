...
func initVtgateExecutor(vSchemaStr, ksShardMapStr string, opts *Options) error {
	...
	vtgateExecutor = vtgate.NewExecutor(context.Background(), explainTopo, vtexplainCell, resolver, opts.Normalize, false, streamSize, cache.DefaultConfig, schemaTracker, false)
