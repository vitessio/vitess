...
func RegisterFlags() {
	OnParse(func(fs *pflag.FlagSet) {
		...
		fs.IntVar(&tableRefreshRate, "table-refresh-rate", tableRefreshRate, "time interval in milliseconds to refresh tables in status page with refreshRequired class")
