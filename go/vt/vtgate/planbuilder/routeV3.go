...
func newRoute(stmt sqlparser.SelectStatement) (*routeV3, *symtab) {
	rb := &routeV3{
		Select:        stmt,
		order:         1,
...
// un-redirected route.
func (rb *routeV3) Resolve() *routeV3 {
	for rb.Redirect != nil {
		rb = rb.Redirect
	}
	return rb
...
func (rb *routeV3) Order() int {
	return rb.order
}

// Reorder implements the logicalPlan interface
func (rb *routeV3) Reorder(order int) {
	rb.order = order + 1
}

// Primitive implements the logicalPlan interface
func (rb *routeV3) Primitive() engine.Primitive {
	return rb.eroute
}

// ResultColumns implements the logicalPlan interface
func (rb *routeV3) ResultColumns() []*resultColumn {
...
func (rb *routeV3) PushAnonymous(expr sqlparser.SelectExpr) *resultColumn {
...
func (rb *routeV3) SetLimit(limit *sqlparser.Limit) {
	rb.Select.SetLimit(limit)
}

// WireupGen4 implements the logicalPlan interface
func (rb *routeV3) WireupGen4(semTable *semantics.SemTable) error {
	rb.prepareTheAST()
...
func (rb *routeV3) ContainsTables() semantics.TableSet {
	return rb.tables
}

// Wireup implements the logicalPlan interface
func (rb *routeV3) Wireup(plan logicalPlan, jt *jointab) error {
...
func (rb *routeV3) procureValues(plan logicalPlan, jt *jointab, val sqlparser.Expr) (sqltypes.PlanValue, error) {
	switch val := val.(type) {
...
func (rb *routeV3) isLocal(col *sqlparser.ColName) bool {
...
// returns no result.
func (rb *routeV3) generateFieldQuery(sel sqlparser.SelectStatement, jt *jointab) string {
...
func (rb *routeV3) SupplyVar(from, to int, col *sqlparser.ColName, varname string) {
	// route is an atomic primitive. So, SupplyVar cannot be
	// called on it.
	panic("BUG: routeV3 is an atomic node.")
}

// SupplyCol implements the logicalPlan interface
func (rb *routeV3) SupplyCol(col *sqlparser.ColName) (rc *resultColumn, colNumber int) {
...
func (rb *routeV3) SupplyWeightString(colNumber int, alsoAddToGroupBy bool) (weightcolNumber int, err error) {
...
func (rb *routeV3) Rewrite(inputs ...logicalPlan) error {
	if len(inputs) != 0 {
		return vterrors.Errorf(vtrpcpb.Code_INTERNAL, "routeV3: wrong number of inputs")
	}
	return nil
}

// Inputs implements the logicalPlan interface
func (rb *routeV3) Inputs() []logicalPlan {
	return []logicalPlan{}
}

// MergeSubquery returns true if the subquery route could successfully be merged
// with the outer route.
func (rb *routeV3) MergeSubquery(pb *primitiveBuilder, inner *routeV3) bool {
...
// with the rb route.
func (rb *routeV3) MergeUnion(right *routeV3, isDistinct bool) bool {
...
func (rb *routeV3) isSingleShard() bool {
	switch rb.eroute.Opcode {
...
func (rb *routeV3) JoinCanMerge(pb *primitiveBuilder, rrb *routeV3, ajoin *sqlparser.JoinTableExpr, where sqlparser.Expr) bool {
...
func (rb *routeV3) SubqueryCanMerge(pb *primitiveBuilder, inner *routeV3) bool {
...
func (rb *routeV3) unionCanMerge(other *routeV3, distinct bool) bool {
...
func (rb *routeV3) canMergeOnFilter(pb *primitiveBuilder, rrb *routeV3, filter sqlparser.Expr) bool {
...
// the route.
func (rb *routeV3) UpdatePlan(pb *primitiveBuilder, filter sqlparser.Expr) {
	switch rb.eroute.Opcode {
...
func (rb *routeV3) updateRoute(opcode engine.RouteOpcode, vindex vindexes.SingleColumn, condition sqlparser.Expr) {
...
func (rb *routeV3) computePlan(pb *primitiveBuilder, filter sqlparser.Expr) (opcode engine.RouteOpcode, vindex vindexes.SingleColumn, condition sqlparser.Expr) {
...
func (rb *routeV3) computeLikePlan(pb *primitiveBuilder, comparison *sqlparser.ComparisonExpr) (opcode engine.RouteOpcode, vindex vindexes.SingleColumn, condition sqlparser.Expr) {
...
func (rb *routeV3) computeEqualPlan(pb *primitiveBuilder, comparison *sqlparser.ComparisonExpr) (opcode engine.RouteOpcode, vindex vindexes.SingleColumn, condition sqlparser.Expr) {
	left := comparison.Left
	right := comparison.Right
...
func (rb *routeV3) computeISPlan(pb *primitiveBuilder, comparison *sqlparser.IsExpr) (opcode engine.RouteOpcode, vindex vindexes.SingleColumn, expr sqlparser.Expr) {
...
func (rb *routeV3) computeINPlan(pb *primitiveBuilder, comparison *sqlparser.ComparisonExpr) (opcode engine.RouteOpcode, vindex vindexes.SingleColumn, expr sqlparser.Expr) {
...
func (rb *routeV3) computeSimpleINPlan(pb *primitiveBuilder, comparison *sqlparser.ComparisonExpr) (opcode engine.RouteOpcode, vindex vindexes.SingleColumn, expr sqlparser.Expr) {
	vindex = pb.st.Vindex(comparison.Left, rb)
	if vindex == nil {
		return engine.SelectScatter, nil, nil
	}
...
func (rb *routeV3) computeCompositeINPlan(pb *primitiveBuilder, comparison *sqlparser.ComparisonExpr) (opcode engine.RouteOpcode, vindex vindexes.SingleColumn, values sqlparser.Expr) {
...
func (rb *routeV3) iterateCompositeIN(
	pb *primitiveBuilder,
...
func (rb *routeV3) compositePlanForCol(pb *primitiveBuilder, comparison *sqlparser.ComparisonExpr, coordinates []int) (opcode engine.RouteOpcode, values sqlparser.Expr) {
...
func (rb *routeV3) computeNotInPlan(right sqlparser.Expr) engine.RouteOpcode {
...
func (rb *routeV3) exprIsValue(expr sqlparser.Expr) bool {
