...
func TestMergeJoins(t *testing.T) {
	...
	for i, tc := range tests {
		t.Run(fmt.Sprintf("%d", i), func(t *testing.T) {
			result, _ := tryMerge(optimizeContext{semTable: semantics.NewSemTable()}, tc.l, tc.r, tc.predicates, nil) // fakeMerger ? how to test this
...
func TestCreateRoutePlanForOuter(t *testing.T) {
	...
	merge, _ := tryMerge(optimizeContext{semTable: semTable}, a, b, []sqlparser.Expr{}, fakeMerger)
	assert.NotNil(merge)
}
