...
type (
	planFunc = func(expr *sqlparser.SetExpr, vschema context.VSchema, ec *expressionConverter) (engine.SetOp, error)
...
func buildSetPlan(stmt *sqlparser.Set, vschema context.VSchema) (engine.Primitive, error) {
...
func buildSetOpReadOnly(s setting) planFunc {
	return func(expr *sqlparser.SetExpr, schema context.VSchema, _ *expressionConverter) (engine.SetOp, error) {
...
func buildSetOpIgnore(s setting) planFunc {
	return func(expr *sqlparser.SetExpr, vschema context.VSchema, _ *expressionConverter) (engine.SetOp, error) {
...
func planSysVarCheckIgnore(expr *sqlparser.SetExpr, schema context.VSchema, boolean bool) (engine.SetOp, error) {
...
func buildSetOpVitessAware(s setting) planFunc {
	return func(astExpr *sqlparser.SetExpr, vschema context.VSchema, ec *expressionConverter) (engine.SetOp, error) {
		var err error
...
func resolveDestination(vschema context.VSchema) (*vindexes.Keyspace, key.Destination, error) {
