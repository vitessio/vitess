...
func (*hashIndex) Map(vindexes.VCursor, []sqltypes.Value) ([]vindexes.Ksid, error) { return nil, nil }
...
func (*lookupIndex) Map(vindexes.VCursor, []sqltypes.Value) ([]vindexes.Ksid, error)   { return nil, nil }
