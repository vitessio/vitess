...
func (rb *routeGen4) Order() int {
	return 1
}

// Reorder implements the logicalPlan interface
func (rb *routeGen4) Reorder(order int) {
...
func (rb *routeGen4) ResultColumns() []*resultColumn {
	return nil
}
...
func (rb *routeGen4) WireupGen4(semTable *semantics.SemTable) error {
	rb.prepareTheAST()
...
func (rb *routeGen4) Wireup(plan logicalPlan, jt *jointab) error {
	return nil
}
...
func (rb *routeGen4) SupplyVar(from, to int, col *sqlparser.ColName, varname string) {
...
func (rb *routeGen4) SupplyCol(col *sqlparser.ColName) (rc *resultColumn, colNumber int) {
	panic("gen4 only, baby")
}

// SupplyWeightString implements the logicalPlan interface
func (rb *routeGen4) SupplyWeightString(colNumber int, alsoAddToGroupBy bool) (weightcolNumber int, err error) {
	panic("gen4 only, baby")
}
