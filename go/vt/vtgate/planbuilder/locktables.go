...
func buildLockPlan(stmt sqlparser.Statement, _ *sqlparser.ReservedVars, _ context.VSchema) (engine.Primitive, error) {
...
func buildUnlockPlan(stmt sqlparser.Statement, _ *sqlparser.ReservedVars, _ context.VSchema) (engine.Primitive, error) {
