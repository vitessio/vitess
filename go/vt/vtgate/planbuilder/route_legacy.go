...
var _ logicalPlan = (*routeLegacy)(nil)
...
func newRouteLegacy(stmt sqlparser.SelectStatement) (*routeLegacy, *symtab) {
	rb := &routeLegacy{
		Select:        stmt,
		order:         1,
...
// un-redirected route.
func (rb *routeLegacy) Resolve() *routeLegacy {
	for rb.Redirect != nil {
		rb = rb.Redirect
	}
	return rb
...
func (rb *routeLegacy) Order() int {
	return rb.order
}

// Reorder implements the logicalPlan interface
func (rb *routeLegacy) Reorder(order int) {
	rb.order = order + 1
}

// Primitive implements the logicalPlan interface
func (rb *routeLegacy) Primitive() engine.Primitive {
	return rb.eroute
}

// ResultColumns implements the logicalPlan interface
func (rb *routeLegacy) ResultColumns() []*resultColumn {
...
func (rb *routeLegacy) PushAnonymous(expr sqlparser.SelectExpr) *resultColumn {
...
func (rb *routeLegacy) SetLimit(limit *sqlparser.Limit) {
	rb.Select.SetLimit(limit)
}

// WireupGen4 implements the logicalPlan interface
func (rb *routeLegacy) WireupGen4(semTable *semantics.SemTable) error {
	rb.prepareTheAST()
...
func (rb *routeLegacy) ContainsTables() semantics.TableSet {
	return rb.tables
}

// Wireup implements the logicalPlan interface
func (rb *routeLegacy) Wireup(plan logicalPlan, jt *jointab) error {
...
func (rb *routeLegacy) prepareTheAST() {
	_ = sqlparser.Walk(func(node sqlparser.SQLNode) (bool, error) {
		switch node := node.(type) {
		case *sqlparser.Select:
			if len(node.SelectExprs) == 0 {
...
func (rb *routeLegacy) procureValues(plan logicalPlan, jt *jointab, val sqlparser.Expr) (sqltypes.PlanValue, error) {
	switch val := val.(type) {
...
func (rb *routeLegacy) isLocal(col *sqlparser.ColName) bool {
...
// returns no result.
func (rb *routeLegacy) generateFieldQuery(sel sqlparser.SelectStatement, jt *jointab) string {
...
func (rb *routeLegacy) SupplyVar(from, to int, col *sqlparser.ColName, varname string) {
...
func (rb *routeLegacy) SupplyCol(col *sqlparser.ColName) (rc *resultColumn, colNumber int) {
...
func (rb *routeLegacy) SupplyWeightString(colNumber int, alsoAddToGroupBy bool) (weightcolNumber int, err error) {
...
func (rb *routeLegacy) Rewrite(inputs ...logicalPlan) error {
	if len(inputs) != 0 {
...
func (rb *routeLegacy) Inputs() []logicalPlan {
	return []logicalPlan{}
}

// MergeSubquery returns true if the subquery route could successfully be merged
// with the outer route.
func (rb *routeLegacy) MergeSubquery(pb *primitiveBuilder, inner *routeLegacy) bool {
...
// with the rb route.
func (rb *routeLegacy) MergeUnion(right *routeLegacy, isDistinct bool) bool {
...
func (rb *routeLegacy) isSingleShard() bool {
	switch rb.eroute.Opcode {
...
func (rb *routeLegacy) JoinCanMerge(pb *primitiveBuilder, rrb *routeLegacy, ajoin *sqlparser.JoinTableExpr, where sqlparser.Expr) bool {
...
func (rb *routeLegacy) SubqueryCanMerge(pb *primitiveBuilder, inner *routeLegacy) bool {
...
func (rb *routeLegacy) unionCanMerge(other *routeLegacy, distinct bool) bool {
...
func (rb *routeLegacy) canMergeOnFilter(pb *primitiveBuilder, rrb *routeLegacy, filter sqlparser.Expr) bool {
...
// the route.
func (rb *routeLegacy) UpdatePlan(pb *primitiveBuilder, filter sqlparser.Expr) {
	switch rb.eroute.Opcode {
...
func (rb *routeLegacy) updateRoute(opcode engine.RouteOpcode, vindex vindexes.SingleColumn, condition sqlparser.Expr) {
...
func (rb *routeLegacy) computePlan(pb *primitiveBuilder, filter sqlparser.Expr) (opcode engine.RouteOpcode, vindex vindexes.SingleColumn, condition sqlparser.Expr) {
...
func (rb *routeLegacy) computeLikePlan(pb *primitiveBuilder, comparison *sqlparser.ComparisonExpr) (opcode engine.RouteOpcode, vindex vindexes.SingleColumn, condition sqlparser.Expr) {
...
func (rb *routeLegacy) computeEqualPlan(pb *primitiveBuilder, comparison *sqlparser.ComparisonExpr) (opcode engine.RouteOpcode, vindex vindexes.SingleColumn, condition sqlparser.Expr) {
	left := comparison.Left
	right := comparison.Right
...
func (rb *routeLegacy) computeISPlan(pb *primitiveBuilder, comparison *sqlparser.IsExpr) (opcode engine.RouteOpcode, vindex vindexes.SingleColumn, expr sqlparser.Expr) {
...
func (rb *routeLegacy) computeINPlan(pb *primitiveBuilder, comparison *sqlparser.ComparisonExpr) (opcode engine.RouteOpcode, vindex vindexes.SingleColumn, expr sqlparser.Expr) {
...
func (rb *routeLegacy) computeSimpleINPlan(pb *primitiveBuilder, comparison *sqlparser.ComparisonExpr) (opcode engine.RouteOpcode, vindex vindexes.SingleColumn, expr sqlparser.Expr) {
	vindex = pb.st.Vindex(comparison.Left, rb)
	if vindex == nil {
		return engine.SelectScatter, nil, nil
	}
...
func (rb *routeLegacy) computeCompositeINPlan(pb *primitiveBuilder, comparison *sqlparser.ComparisonExpr) (opcode engine.RouteOpcode, vindex vindexes.SingleColumn, values sqlparser.Expr) {
...
func (rb *routeLegacy) iterateCompositeIN(
	pb *primitiveBuilder,
...
func (rb *routeLegacy) compositePlanForCol(pb *primitiveBuilder, comparison *sqlparser.ComparisonExpr, coordinates []int) (opcode engine.RouteOpcode, values sqlparser.Expr) {
...
func (rb *routeLegacy) computeNotInPlan(right sqlparser.Expr) engine.RouteOpcode {
...
func (rb *routeLegacy) exprIsValue(expr sqlparser.Expr) bool {
