...
func (conn *FakeVTGateConn) ExecuteBatch(ctx context.Context, sqlList []string, bindVarsList []map[string]interface{}, keyspace string, tabletType topodatapb.TabletType, asTransaction bool, session interface{}, options *querypb.ExecuteOptions, execParallel bool) ([]sqltypes.QueryResponse, interface{}, error) {
	panic("not implemented")
}
