...
var (
	...
	plannerVersion   = flag.String("planner_version", "v3", "Sets the default planner to use when the session has not changed it. Valid values are: V3, V4, V4Greedy and v4fallback. v4fallfack tries the new gen4 planner and falls back to the V3 planner if the gen4 fails. All V4 versions should be considered experimental!")
