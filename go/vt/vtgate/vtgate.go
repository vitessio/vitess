...
func registerFlags(fs *pflag.FlagSet) {
	...
	fs.BoolVar(&normalizePrepStmts, "normalize_prepared_stmts", normalizePrepStmts, "when set to true, normalize prepared statement queries as well, if -normalize_queries is already true")
