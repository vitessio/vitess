...
func registerFlags(fs *pflag.FlagSet) {
	...
	fs.IntVar(&truncateErrorLen, "vtgate-config-truncate-error-len", truncateErrorLen, "truncate errors sent to client if they are longer than this value (0 means do not truncate)")
