...
func (cached *BinaryCoercedExpr) CachedSize(alloc bool) int64 {
	if cached == nil {
		return int64(0)
	}
	size := int64(0)
...
func (cached *EvalResult) CachedSize(alloc bool) int64 {
	...
	// field bytes2 []byte
	{
		size += hack.RuntimeAllocSize(int64(cap(cached.bytes2)))
	}
	// field tuple2 *[]vitess.io/vitess/go/vt/vtgate/evalengine.item
	if cached.tuple2 != nil {
		size += int64(24)
		size += hack.RuntimeAllocSize(int64(cap(*cached.tuple2)) * int64(36))
		for _, elem := range *cached.tuple2 {
			size += elem.CachedSize(false)
		}
	}
	// field decimal2 *vitess.io/vitess/go/vt/vtgate/evalengine.decimalResult
	size += cached.decimal2.CachedSize(true)
	return size
}
...
func (cached *item) CachedSize(alloc bool) int64 {
	if cached == nil {
		return int64(0)
	}
	size := int64(0)
	...
	// field res *vitess.io/vitess/go/vt/vtgate/evalengine.EvalResult
	size += cached.res.CachedSize(true)
	return size
}
