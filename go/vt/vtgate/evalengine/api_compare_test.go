	...
	tests := []testCase{
		{
			...
			v1:   NewColumn(0, sqltypes.Int64, collations.CollationBinaryID), v2: NewColumn(0, sqltypes.Int64, collations.CollationBinaryID),
		...
		},
		{
			...
			v1:   NewColumn(0, sqltypes.Int64, collations.CollationBinaryID), v2: NewColumn(1, sqltypes.Int64, collations.CollationBinaryID),
			out: &F, op: sqlparser.EqualOp,
			row: []sqltypes.Value{sqltypes.NewInt64(18), sqltypes.NewInt64(98)},
		},
		{
			name: "unsigned integers are equal",
			v1:   NewColumn(0, sqltypes.Uint64, collations.CollationBinaryID), v2: NewColumn(0, sqltypes.Uint64, collations.CollationBinaryID),
			out: &T, op: sqlparser.EqualOp,
			row: []sqltypes.Value{sqltypes.NewUint64(18)},
		},
		{
			name: "unsigned integer and integer are equal",
			v1:   NewColumn(0, sqltypes.Uint64, collations.CollationBinaryID), v2: NewColumn(1, sqltypes.Int64, collations.CollationBinaryID),
			out: &T, op: sqlparser.EqualOp,
	...
	tests := []testCase{
		{
			...
			v1:   NewColumn(0, sqltypes.Decimal, collations.CollationBinaryID), v2: NewColumn(0, sqltypes.Decimal, collations.CollationBinaryID),
			out: &T, op: sqlparser.EqualOp,
			row: []sqltypes.Value{sqltypes.NewDecimal("12.9019")},
		},
		{
			name: "decimals are not equal",
			v1:   NewColumn(0, sqltypes.Decimal, collations.CollationBinaryID), v2: NewColumn(1, sqltypes.Decimal, collations.CollationBinaryID),
			out: &T, op: sqlparser.NotEqualOp,
	...
	tests := []testCase{
		{
			...
			v1:   NewColumn(0, sqltypes.Datetime, collations.CollationBinaryID), v2: NewColumn(0, sqltypes.Datetime, collations.CollationBinaryID),
			out: &T, op: sqlparser.EqualOp,
			row: []sqltypes.Value{sqltypes.NewDatetime("2021-10-22 12:00:00")},
		},
		{
			name: "datetimes are not equal (1)",
			v1:   NewColumn(0, sqltypes.Datetime, collations.CollationBinaryID), v2: NewColumn(1, sqltypes.Datetime, collations.CollationBinaryID),
			out: &F, op: sqlparser.EqualOp,
	...
	tests := []testCase{
		{
			...
			v1:   NewColumn(0, sqltypes.Timestamp, collations.CollationBinaryID), v2: NewColumn(0, sqltypes.Timestamp, collations.CollationBinaryID),
			out: &T, op: sqlparser.EqualOp,
			row: []sqltypes.Value{sqltypes.NewTimestamp("2021-10-22 12:00:00")},
		},
		{
			name: "timestamps are not equal (1)",
			v1:   NewColumn(0, sqltypes.Timestamp, collations.CollationBinaryID), v2: NewColumn(1, sqltypes.Timestamp, collations.CollationBinaryID),
			out: &F, op: sqlparser.EqualOp,
	...
	tests := []testCase{
		{
			...
			v1:   NewColumn(0, sqltypes.Date, collations.CollationBinaryID), v2: NewColumn(0, sqltypes.Date, collations.CollationBinaryID),
			out: &T, op: sqlparser.EqualOp,
			row: []sqltypes.Value{sqltypes.NewDate("2021-10-22")},
		},
		{
			name: "dates are not equal (1)",
			v1:   NewColumn(0, sqltypes.Date, collations.CollationBinaryID), v2: NewColumn(1, sqltypes.Date, collations.CollationBinaryID),
			out: &F, op: sqlparser.EqualOp,
	...
	tests := []testCase{
		{
			...
			v1:   NewColumn(0, sqltypes.Time, collations.CollationBinaryID), v2: NewColumn(0, sqltypes.Time, collations.CollationBinaryID),
			out: &T, op: sqlparser.EqualOp,
	...
	tests := []testCase{
		{
			...
			v1:   NewColumn(0, sqltypes.Date, collations.CollationBinaryID), v2: NewColumn(1, sqltypes.Datetime, collations.CollationBinaryID),
			out: &T, op: sqlparser.EqualOp,
		...
		},
		{
			...
			v1:   NewBindVar("k1", sqltypes.Date, collations.CollationBinaryID), v2: NewBindVar("k2", sqltypes.Datetime, collations.CollationBinaryID),
			out: &T, op: sqlparser.EqualOp,
			bv: map[string]*querypb.BindVariable{
		...
		},
		{
			...
			v1:   NewColumn(0, sqltypes.Date, collations.CollationBinaryID), v2: NewColumn(1, sqltypes.Timestamp, collations.CollationBinaryID),
			out: &T, op: sqlparser.EqualOp,
		...
		},
		{
			...
			v1:   NewColumn(0, sqltypes.Date, collations.CollationBinaryID), v2: NewColumn(1, sqltypes.Time, collations.CollationBinaryID),
			out: &F, op: sqlparser.EqualOp,
		...
		},
		{
			...
			v1:   NewColumn(0, sqltypes.VarChar, collations.CollationUtf8mb4ID), v2: NewColumn(1, sqltypes.Datetime, collations.CollationBinaryID),
			out: &T, op: sqlparser.EqualOp,
			row: []sqltypes.Value{sqltypes.NewVarChar("2021-10-22"), sqltypes.NewDatetime("2021-10-22 00:00:00")},
		},
		{
			name: "string equal timestamp",
			v1:   NewColumn(0, sqltypes.VarChar, collations.CollationUtf8mb4ID), v2: NewColumn(1, sqltypes.Timestamp, collations.CollationBinaryID),
			out: &T, op: sqlparser.EqualOp,
		...
		},
		{
			...
			v1:   NewColumn(0, sqltypes.VarChar, collations.CollationUtf8mb4ID), v2: NewColumn(1, sqltypes.Time, collations.CollationBinaryID),
			out: &T, op: sqlparser.EqualOp,
			row: []sqltypes.Value{sqltypes.NewVarChar("00:05:12"), sqltypes.NewTime("00:05:12")},
		},
		{
			name: "string equal date",
			v1:   NewColumn(0, sqltypes.VarChar, collations.CollationUtf8mb4ID), v2: NewColumn(1, sqltypes.Date, collations.CollationBinaryID),
			out: &T, op: sqlparser.EqualOp,
		...
		},
		{
			...
			v1:   NewColumn(0, sqltypes.Date, collations.CollationBinaryID), v2: NewColumn(1, sqltypes.VarChar, collations.CollationUtf8mb4ID),
			out: &T, op: sqlparser.NotEqualOp,
	...
	tests := []testCase{
		{
			...
			v1:   NewColumn(0, sqltypes.VarChar, collations.Default()), v2: NewColumn(1, sqltypes.VarChar, collations.Default()),
			out: &T, op: sqlparser.EqualOp,
			row: []sqltypes.Value{sqltypes.NewVarChar("toto"), sqltypes.NewVarChar("toto")},
		},
		{
			name: "string equal number",
			v1:   NewColumn(0, sqltypes.VarChar, collations.Default()), v2: NewColumn(1, sqltypes.Int64, collations.CollationBinaryID),
			out: &T, op: sqlparser.EqualOp,
