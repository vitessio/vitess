...
func TestCompareNumerics(t *testing.T) {
	tests := []testCase{
		...
		},
		{
			...
			v1:   NewColumn(0), v2: NewLiteralInt(0),
			out: &T, op: sqlparser.EqualOp,
		...
		},
		{
			...
			v1:   NewColumn(0), v2: NewLiteralFloat(1.0),
			out: &T, op: sqlparser.EqualOp,
	...
	tests := []testCase{
		{
			...
			v1:   NewColumnWithCollation(0, defaultCollation()), v2: NewColumnWithCollation(1, defaultCollation()),
			out: &T, op: sqlparser.EqualOp,
