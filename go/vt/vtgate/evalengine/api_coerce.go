...
func CoerceTypes(collationEnv *collations.Environment, v1, v2 Type) (out Type, err error) {
	if v1 == v2 {
		return v1, nil
	}
	...
	case sqltypes.IsTextOrBinary(v1.Type()) && sqltypes.IsTextOrBinary(v2.Type()):
		mergedCollation, _, _, ferr := mergeCollations(collationEnv, typedCoercionCollation(v1.Type(), v1.Collation()), typedCoercionCollation(v2.Type(), v2.Collation()), v1.Type(), v2.Type())
		if ferr != nil {
			return Type{}, ferr
		}
