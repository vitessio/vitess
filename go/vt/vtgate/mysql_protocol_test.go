...
func TestMySQLProtocolExecuteUseStatement(t *testing.T) {
	...
	require.Error(t, err)
	assert.Contains(t, err.Error(), "VT05003: Unknown database 'InvalidKeyspace' (errno 1049) (sqlstate 42000)")
...
func TestMysqlProtocolInvalidDB(t *testing.T) {
	...
	require.EqualError(t, err, "VT05003: Unknown database 'invalidDB' (errno 1049) (sqlstate 42000)")
}
