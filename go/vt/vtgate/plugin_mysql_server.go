...
func registerPluginFlags(fs *pflag.FlagSet) {
	...
	fs.BoolVar(&mysqlDrainOnTerm, "mysql-server-drain-onterm", mysqlDrainOnTerm, "If set, the server waits for up to --onterm_timeout for connected clients to drain")
}
