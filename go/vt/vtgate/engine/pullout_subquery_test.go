...
func TestPulloutSubqueryValueGood(t *testing.T) {
	...
	result, err := ps.TryExecute(&noopVCursor{}, nil, bindVars, false)
...
func TestPulloutSubqueryValueNone(t *testing.T) {
	...
	if _, err := ps.TryExecute(&noopVCursor{}, nil, make(map[string]*querypb.BindVariable), false); err != nil {
		t.Error(err)
	}
...
func TestPulloutSubqueryValueBadColumns(t *testing.T) {
	...
	_, err := ps.TryExecute(&noopVCursor{}, nil, make(map[string]*querypb.BindVariable), false)
