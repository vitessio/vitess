...
func TestSelectEqual(t *testing.T) {
	...
	vc.ExpectLog(t, []string{
		`Execute select from, toc from lkp where from in ::from for update from: type:TUPLE values:<type:INT64 value:"1" >  false`,
...
func TestSelectINNonUnique(t *testing.T) {
	...
	vc.ExpectLog(t, []string{
		`Execute select from, toc from lkp where from in ::from for update from: type:TUPLE values:<type:INT64 value:"1" > values:<type:INT64 value:"2" > values:<type:INT64 value:"4" >  false`,
