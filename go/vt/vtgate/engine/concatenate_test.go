...
func TestConcatenate_NoErrors(t *testing.T) {
	...
	for _, tc := range testCases {
		...
		t.Run(tc.testName+"-Execute", func(t *testing.T) {
			qr, err := concatenate.TryExecute(context.Background(), newNoopVCursor(context.Background()), nil, true)
			if tc.expectedError == "" {
...
func TestConcatenate_WithErrors(t *testing.T) {
	...
	_, err := concatenate.TryExecute(context.Background(), newNoopVCursor(ctx), nil, true)
