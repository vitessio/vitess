...
func TestInsertUnsharded(t *testing.T) {
	...
	result, err := ins.Execute(context.Background(), vc, map[string]*querypb.BindVariable{}, false)
	if err != nil {
		t.Fatal(err)
	}
	...
	_, err = ins.Execute(context.Background(), vc, map[string]*querypb.BindVariable{}, false)
