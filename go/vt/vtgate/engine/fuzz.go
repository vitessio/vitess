...
func execUpdate(f *fuzz.ConsumeFuzzer) {
	...
	vc := &loggingVCursor{}
	_, _ = upd.TryExecute(vc, nil, map[string]*querypb.BindVariable{}, false)
}
...
func execInsert(f *fuzz.ConsumeFuzzer) {
	...
	vc := &loggingVCursor{}
	_, _ = ins.TryExecute(vc, nil, map[string]*querypb.BindVariable{}, false)
}
...
func execRoute(f *fuzz.ConsumeFuzzer) {
	...
	_, _ = sel.TryExecute(vc, nil, map[string]*querypb.BindVariable{}, false)
}
