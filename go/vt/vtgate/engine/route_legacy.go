...
// NewSimpleRouteLegacy creates a RouteLegacy with the bare minimum of parameters.
func NewSimpleRouteLegacy(opcode RouteOpcode, keyspace *vindexes.Keyspace) *RouteLegacy {
	return &RouteLegacy{
		Opcode:   opcode,
		Keyspace: keyspace,
	}
...
// NewRouteRouteLegacy creates a RouteLegacy.
func NewRouteRouteLegacy(opcode RouteOpcode, keyspace *vindexes.Keyspace, query, fieldQuery string) *RouteLegacy {
	return &RouteLegacy{
		Opcode:     opcode,
		Keyspace:   keyspace,
		Query:      query,
