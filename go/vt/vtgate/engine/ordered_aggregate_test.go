...
func TestOrderedAggregateExecute(t *testing.T) {
	...
	oa := &OrderedAggregate{
		Aggregates:  []*AggregateParams{NewAggregateParam(AggregateSum, 1, "", collations.Local())},
...
func TestOrderedAggregateExecuteTruncate(t *testing.T) {
	...
	aggr := NewAggregateParam(AggregateSum, 1, "", collations.Local())
...
func TestMinMaxFailsCorrectly(t *testing.T) {
	...
	aggr := NewAggregateParam(AggregateMax, 0, "", collations.Local())
	aggr.WCol = 1
	oa := &ScalarAggregate{
		Aggregates:          []*AggregateParams{aggr},
...
func TestOrderedAggregateExecuteCountDistinct(t *testing.T) {
	...
	aggr1 := NewAggregateParam(AggregateCountDistinct, 1, "count(distinct col2)", collations.Local())
	aggr2 := NewAggregateParam(AggregateSum, 2, "", collations.Local())
...
func TestOrderedAggregateStreamCountDistinct(t *testing.T) {
	...
	oa := &OrderedAggregate{
		Aggregates: []*AggregateParams{
			NewAggregateParam(AggregateCountDistinct, 1, "count(distinct col2)", collations.Local()),
			aggr2},
		GroupByKeys: []*GroupByParams{{KeyCol: 0}},
		Input:       fp,
	}
...
func TestOrderedAggregateSumDistinctGood(t *testing.T) {
	...
	oa := &OrderedAggregate{
		Aggregates: []*AggregateParams{
			NewAggregateParam(AggregateSumDistinct, 1, "sum(distinct col2)", collations.Local()),
			NewAggregateParam(AggregateSum, 2, "", collations.Local()),
		},
		GroupByKeys: []*GroupByParams{{KeyCol: 0}},
		Input:       fp,
	}
...
func TestOrderedAggregateSumDistinctTolerateError(t *testing.T) {
	...
	oa := &OrderedAggregate{
		Aggregates:  []*AggregateParams{NewAggregateParam(AggregateSumDistinct, 1, "sum(distinct col2)", collations.Local())},
		GroupByKeys: []*GroupByParams{{KeyCol: 0}},
		Input:       fp,
	}
...
func TestOrderedAggregateExecuteGtid(t *testing.T) {
	...
	oa := &OrderedAggregate{
		Aggregates:          []*AggregateParams{NewAggregateParam(AggregateGtid, 1, "vgtid", collations.Local())},
		TruncateColumnCount: 2,
		Input:               fp,
	}
...
func TestCountDistinctOnVarchar(t *testing.T) {
	...
	aggr := NewAggregateParam(AggregateCountDistinct, 1, "count(distinct c2)", collations.Local())
	aggr.WCol = 2
	oa := &OrderedAggregate{
		Aggregates:          []*AggregateParams{aggr},
		GroupByKeys:         []*GroupByParams{{KeyCol: 0}},
...
func TestSumDistinctOnVarcharWithNulls(t *testing.T) {
	...
	aggr := NewAggregateParam(AggregateSumDistinct, 1, "sum(distinct c2)", collations.Local())
	aggr.WCol = 2
	oa := &OrderedAggregate{
		Aggregates:          []*AggregateParams{aggr},
		GroupByKeys:         []*GroupByParams{{KeyCol: 0}},
...
func TestMultiDistinct(t *testing.T) {
	...
	oa := &OrderedAggregate{
		Aggregates: []*AggregateParams{
			NewAggregateParam(AggregateCountDistinct, 1, "count(distinct c2)", collations.Local()),
			NewAggregateParam(AggregateSumDistinct, 2, "sum(distinct c3)", collations.Local()),
		},
		GroupByKeys: []*GroupByParams{{KeyCol: 0}},
		Input:       fp,
	}
...
func TestGroupConcatWithAggrOnEngine(t *testing.T) {
	...
	for _, tcase := range tcases {
		t.Run(tcase.name, func(t *testing.T) {
			...
			oa := &OrderedAggregate{
				Aggregates:  []*AggregateParams{NewAggregateParam(AggregateGroupConcat, 1, "group_concat(c2)", collations.Local())},
				GroupByKeys: []*GroupByParams{{KeyCol: 0}},
				Input:       fp,
			}
			qr, err := oa.TryExecute(context.Background(), &noopVCursor{}, nil, false)
...
func TestGroupConcat(t *testing.T) {
	...
	for _, tcase := range tcases {
		t.Run(tcase.name, func(t *testing.T) {
			fp := &fakePrimitive{results: []*sqltypes.Result{tcase.inputResult}}
			oa := &OrderedAggregate{
				Aggregates:  []*AggregateParams{NewAggregateParam(AggregateGroupConcat, 1, "", collations.Local())},
				GroupByKeys: []*GroupByParams{{KeyCol: 0}},
				Input:       fp,
			}
			qr, err := oa.TryExecute(context.Background(), &noopVCursor{}, nil, false)
