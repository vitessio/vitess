...
func getInfoSchema57() map[string]map[string]query.Type {
	...
	cols["FILE_NAME"] = query.Type(6165)
	...
	cols["ENGINE"] = query.Type(6165)
	cols["FULLTEXT_KEYS"] = query.Type(6165)
	cols["DELETED_ROWS"] = query.Type(265)
	cols["UPDATE_COUNT"] = query.Type(265)
	...
	cols["CREATION_TIME"] = query.Type(2064)
	cols["LAST_UPDATE_TIME"] = query.Type(2064)
	cols["LAST_ACCESS_TIME"] = query.Type(2064)
	cols["RECOVER_TIME"] = query.Type(265)
	cols["TRANSACTION_COUNTER"] = query.Type(265)
	cols["VERSION"] = query.Type(265)
	cols["ROW_FORMAT"] = query.Type(6165)
	cols["TABLE_ROWS"] = query.Type(265)
	cols["AVG_ROW_LENGTH"] = query.Type(265)
	cols["DATA_LENGTH"] = query.Type(265)
	cols["MAX_DATA_LENGTH"] = query.Type(265)
	cols["INDEX_LENGTH"] = query.Type(265)
	cols["DATA_FREE"] = query.Type(265)
	cols["CREATE_TIME"] = query.Type(2064)
	...
	cols = map[string]query.Type{}
	cols["VARIABLE_NAME"] = query.Type(6165)
	cols["VARIABLE_VALUE"] = query.Type(6165)
	...
	cols = map[string]query.Type{}
	cols["POOL_ID"] = query.Type(265)
	cols["BLOCK_ID"] = query.Type(265)
	cols["SPACE"] = query.Type(265)
	cols["PAGE_NUMBER"] = query.Type(265)
	cols["PAGE_TYPE"] = query.Type(6165)
	cols["FLUSH_TYPE"] = query.Type(265)
	cols["FIX_COUNT"] = query.Type(265)
	cols["IS_HASHED"] = query.Type(6165)
	cols["NEWEST_MODIFICATION"] = query.Type(265)
	cols["OLDEST_MODIFICATION"] = query.Type(265)
	cols["ACCESS_TIME"] = query.Type(265)
	cols["TABLE_NAME"] = query.Type(6165)
	cols["INDEX_NAME"] = query.Type(6165)
	cols["NUMBER_RECORDS"] = query.Type(265)
	cols["DATA_SIZE"] = query.Type(265)
	cols["COMPRESSED_SIZE"] = query.Type(265)
	cols["PAGE_STATE"] = query.Type(6165)
	cols["IO_FIX"] = query.Type(6165)
	cols["IS_OLD"] = query.Type(6165)
	cols["FREE_PAGE_CLOCK"] = query.Type(265)
	infSchema["INNODB_BUFFER_PAGE"] = cols
	cols = map[string]query.Type{}
	cols["POOL_ID"] = query.Type(265)
	cols["LRU_POSITION"] = query.Type(265)
	cols["SPACE"] = query.Type(265)
	cols["PAGE_NUMBER"] = query.Type(265)
	cols["PAGE_TYPE"] = query.Type(6165)
	cols["FLUSH_TYPE"] = query.Type(265)
	...
	cols = map[string]query.Type{}
	cols["POOL_ID"] = query.Type(265)
	cols["POOL_SIZE"] = query.Type(265)
	cols["FREE_BUFFERS"] = query.Type(265)
	cols["DATABASE_PAGES"] = query.Type(265)
	cols["OLD_DATABASE_PAGES"] = query.Type(265)
	cols["MODIFIED_DATABASE_PAGES"] = query.Type(265)
	cols["PENDING_DECOMPRESS"] = query.Type(265)
	cols["PENDING_READS"] = query.Type(265)
	cols["PENDING_FLUSH_LRU"] = query.Type(265)
	cols["PENDING_FLUSH_LIST"] = query.Type(265)
	cols["PAGES_MADE_YOUNG"] = query.Type(265)
	cols["PAGES_NOT_MADE_YOUNG"] = query.Type(265)
	cols["PAGES_MADE_YOUNG_RATE"] = query.Type(1036)
	cols["PAGES_MADE_NOT_YOUNG_RATE"] = query.Type(1036)
	cols["NUMBER_PAGES_READ"] = query.Type(265)
	cols["NUMBER_PAGES_CREATED"] = query.Type(265)
	cols["NUMBER_PAGES_WRITTEN"] = query.Type(265)
	cols["PAGES_READ_RATE"] = query.Type(1036)
	cols["PAGES_CREATE_RATE"] = query.Type(1036)
	cols["PAGES_WRITTEN_RATE"] = query.Type(1036)
	cols["NUMBER_PAGES_GET"] = query.Type(265)
	cols["HIT_RATE"] = query.Type(265)
	cols["YOUNG_MAKE_PER_THOUSAND_GETS"] = query.Type(265)
	cols["NOT_YOUNG_MAKE_PER_THOUSAND_GETS"] = query.Type(265)
	cols["NUMBER_PAGES_READ_AHEAD"] = query.Type(265)
	cols["NUMBER_READ_AHEAD_EVICTED"] = query.Type(265)
	cols["READ_AHEAD_RATE"] = query.Type(1036)
	cols["READ_AHEAD_EVICTED_RATE"] = query.Type(1036)
	cols["LRU_IO_TOTAL"] = query.Type(265)
	cols["LRU_IO_CURRENT"] = query.Type(265)
	cols["UNCOMPRESS_TOTAL"] = query.Type(265)
	cols["UNCOMPRESS_CURRENT"] = query.Type(265)
	...
	cols["FIRST_DOC_ID"] = query.Type(265)
	cols["LAST_DOC_ID"] = query.Type(265)
	cols["DOC_COUNT"] = query.Type(265)
	cols["DOC_ID"] = query.Type(265)
	cols["POSITION"] = query.Type(265)
	...
	cols = map[string]query.Type{}
	cols["requesting_trx_id"] = query.Type(6165)
	cols["requested_lock_id"] = query.Type(6165)
	cols["blocking_trx_id"] = query.Type(6165)
	cols["blocking_lock_id"] = query.Type(6165)
	infSchema["INNODB_LOCK_WAITS"] = cols
	cols = map[string]query.Type{}
	cols["lock_id"] = query.Type(6165)
	cols["lock_trx_id"] = query.Type(6165)
	cols["lock_mode"] = query.Type(6165)
	cols["lock_type"] = query.Type(6165)
	cols["lock_table"] = query.Type(6165)
	cols["lock_index"] = query.Type(6165)
	cols["lock_space"] = query.Type(265)
	cols["lock_page"] = query.Type(265)
	cols["lock_rec"] = query.Type(265)
	cols["lock_data"] = query.Type(6165)
	...
	cols = map[string]query.Type{}
	cols["TABLE_ID"] = query.Type(265)
	cols["NAME"] = query.Type(6165)
	cols["POS"] = query.Type(265)
	...
	cols = map[string]query.Type{}
	cols["INDEX_ID"] = query.Type(265)
	cols["NAME"] = query.Type(6165)
	cols["POS"] = query.Type(263)
	...
	cols["N_COLS"] = query.Type(263)
	cols["SPACE"] = query.Type(263)
	cols["FILE_FORMAT"] = query.Type(6165)
	cols["ROW_FORMAT"] = query.Type(6165)
	cols["ZIP_PAGE_SIZE"] = query.Type(263)
	...
	cols["ZIP_PAGE_SIZE"] = query.Type(263)
	cols["SPACE_TYPE"] = query.Type(6165)
	cols["FS_BLOCK_SIZE"] = query.Type(263)
	cols["FILE_SIZE"] = query.Type(265)
	cols["ALLOCATED_SIZE"] = query.Type(265)
	infSchema["INNODB_SYS_TABLESPACES"] = cols
	cols = map[string]query.Type{}
	cols["TABLE_ID"] = query.Type(265)
	cols["NAME"] = query.Type(6165)
	cols["STATS_INITIALIZED"] = query.Type(6165)
	cols["NUM_ROWS"] = query.Type(265)
	cols["CLUST_INDEX_SIZE"] = query.Type(265)
	cols["OTHER_INDEX_SIZE"] = query.Type(265)
	cols["MODIFIED_COUNTER"] = query.Type(265)
	cols["AUTOINC"] = query.Type(265)
	cols["REF_COUNT"] = query.Type(263)
	infSchema["INNODB_SYS_TABLESTATS"] = cols
	cols = map[string]query.Type{}
	cols["TABLE_ID"] = query.Type(265)
	cols["POS"] = query.Type(263)
	cols["BASE_POS"] = query.Type(263)
	...
	cols["N_COLS"] = query.Type(263)
	cols["SPACE"] = query.Type(263)
	cols["PER_TABLE_TABLESPACE"] = query.Type(6165)
	cols["IS_COMPRESSED"] = query.Type(6165)
	infSchema["INNODB_TEMP_TABLE_INFO"] = cols
	cols = map[string]query.Type{}
	cols["trx_id"] = query.Type(6165)
	...
	cols["trx_weight"] = query.Type(265)
	cols["trx_mysql_thread_id"] = query.Type(265)
	cols["trx_query"] = query.Type(6165)
	cols["trx_operation_state"] = query.Type(6165)
	cols["trx_tables_in_use"] = query.Type(265)
	cols["trx_tables_locked"] = query.Type(265)
	cols["trx_lock_structs"] = query.Type(265)
	cols["trx_lock_memory_bytes"] = query.Type(265)
	cols["trx_rows_locked"] = query.Type(265)
	cols["trx_rows_modified"] = query.Type(265)
	cols["trx_concurrency_tickets"] = query.Type(265)
	...
	cols["trx_adaptive_hash_timeout"] = query.Type(265)
	...
	cols["COLUMN_NAME"] = query.Type(6165)
	cols["ORDINAL_POSITION"] = query.Type(265)
	cols["POSITION_IN_UNIQUE_CONSTRAINT"] = query.Type(265)
	...
	cols = map[string]query.Type{}
	cols["QUERY"] = query.Type(6163)
	cols["TRACE"] = query.Type(6163)
	...
	cols["ORDINAL_POSITION"] = query.Type(263)
	cols["PARAMETER_MODE"] = query.Type(6165)
	cols["PARAMETER_NAME"] = query.Type(6165)
	cols["DATA_TYPE"] = query.Type(6165)
	cols["CHARACTER_MAXIMUM_LENGTH"] = query.Type(263)
	cols["CHARACTER_OCTET_LENGTH"] = query.Type(263)
	cols["NUMERIC_PRECISION"] = query.Type(265)
	cols["NUMERIC_SCALE"] = query.Type(263)
	cols["DATETIME_PRECISION"] = query.Type(265)
	cols["CHARACTER_SET_NAME"] = query.Type(6165)
	cols["COLLATION_NAME"] = query.Type(6165)
	cols["DTD_IDENTIFIER"] = query.Type(6163)
	cols["ROUTINE_TYPE"] = query.Type(6165)
	...
	cols["PARTITION_ORDINAL_POSITION"] = query.Type(265)
	cols["SUBPARTITION_ORDINAL_POSITION"] = query.Type(265)
	cols["PARTITION_METHOD"] = query.Type(6165)
	cols["SUBPARTITION_METHOD"] = query.Type(6165)
	cols["PARTITION_EXPRESSION"] = query.Type(6163)
	cols["SUBPARTITION_EXPRESSION"] = query.Type(6163)
	...
	cols["CHECK_TIME"] = query.Type(2064)
	cols["CHECKSUM"] = query.Type(265)
	cols["PARTITION_COMMENT"] = query.Type(6165)
	...
	cols["PLUGIN_DESCRIPTION"] = query.Type(6163)
	...
	cols["MATCH_OPTION"] = query.Type(6165)
	cols["UPDATE_RULE"] = query.Type(6165)
	cols["DELETE_RULE"] = query.Type(6165)
	cols["TABLE_NAME"] = query.Type(6165)
	cols["REFERENCED_TABLE_NAME"] = query.Type(6165)
	...
	cols["TABLE_SCHEMA"] = query.Type(6165)
	cols["TABLE_NAME"] = query.Type(6165)
	cols["TABLE_TYPE"] = query.Type(6165)
	cols["ENGINE"] = query.Type(6165)
	cols["VERSION"] = query.Type(265)
	cols["ROW_FORMAT"] = query.Type(6165)
	cols["TABLE_ROWS"] = query.Type(265)
	...
	cols["INDEX_LENGTH"] = query.Type(265)
	cols["DATA_FREE"] = query.Type(265)
	cols["AUTO_INCREMENT"] = query.Type(265)
	cols["CREATE_TIME"] = query.Type(2064)
	cols["UPDATE_TIME"] = query.Type(2064)
	cols["CHECK_TIME"] = query.Type(2064)
	...
	cols["TABLE_COMMENT"] = query.Type(6165)
	...
	cols["AUTOEXTEND_SIZE"] = query.Type(265)
	cols["MAXIMUM_SIZE"] = query.Type(265)
	cols["NODEGROUP_ID"] = query.Type(265)
	...
	cols["EVENT_MANIPULATION"] = query.Type(6165)
	cols["EVENT_OBJECT_CATALOG"] = query.Type(6165)
	cols["EVENT_OBJECT_SCHEMA"] = query.Type(6165)
	cols["EVENT_OBJECT_TABLE"] = query.Type(6165)
	cols["ACTION_ORDER"] = query.Type(265)
	cols["ACTION_CONDITION"] = query.Type(6163)
	cols["ACTION_STATEMENT"] = query.Type(6163)
	cols["ACTION_ORIENTATION"] = query.Type(6165)
	cols["ACTION_TIMING"] = query.Type(6165)
	cols["ACTION_REFERENCE_OLD_TABLE"] = query.Type(6165)
	cols["ACTION_REFERENCE_NEW_TABLE"] = query.Type(6165)
	...
	cols["CHECK_OPTION"] = query.Type(6165)
	cols["IS_UPDATABLE"] = query.Type(6165)
	cols["DEFINER"] = query.Type(6165)
	cols["SECURITY_TYPE"] = query.Type(6165)
	cols["CHARACTER_SET_CLIENT"] = query.Type(6165)
	cols["COLLATION_CONNECTION"] = query.Type(6165)
...
// To recreate this information from MySQL, you can run the test in info_schema_gen_test.go
func getInfoSchema80() map[string]map[string]query.Type {
	infSchema := map[string]map[string]query.Type{}
	cols := map[string]query.Type{}
	cols["USER"] = query.Type(6165)
	cols["HOST"] = query.Type(6165)
...
func newSchemaInfo(inner SchemaInformation) SchemaInformation {
	...
	var infoSchema map[string]map[string]query.Type
