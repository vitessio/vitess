// package provides some utilities for logging using glog and
...
// Purge removes any log files that were started more than keepLogs
// ago and that aren't the current log.
func PurgeLogs() {
