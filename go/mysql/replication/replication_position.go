...
// is used. For example:
// - DecodePositionDefaultFlavor("MySQL/16b1039f-22b6-11ed-b765-0a43f95f28a3:1-615", "foo"): "MySQL" explicitly indicated, this is the flavor.
// - DecodePositionDefaultFlavor("16b1039f-22b6-11ed-b765-0a43f95f28a3:1-615", "MySQL"): No flavor indicated in `s`, therefore using "MySQL"
...
// The caller should use the constants MysqlFlavorID, MariadbFlavorID, or FilePosFlavorID when supplying the flavor string.
func (rp *Position) MatchesFlavor(flavor string) bool {
	switch flavor {
	case MysqlFlavorID:
		_, matches := rp.GTIDSet.(MysqlGTIDSet)
		return matches
