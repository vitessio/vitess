...
func main() {
	...
	for _, meta := range allMetadata {
		...
		default:
			unhandled[meta.CollationImpl] = append(unhandled[meta.CollationImpl], meta.Name)
		}
	}
	...
	fmt.Fprintf(&file, "\"vitess.io/vitess/go/mysql/collations/charset\"\n")
	fmt.Fprintf(&file, "\"vitess.io/vitess/go/mysql/collations/uca\"\n")
	fmt.Fprintf(&file, ")\n\n")
	tables.WriteTo(&file)
