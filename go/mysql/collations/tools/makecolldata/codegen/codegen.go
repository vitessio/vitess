...
import (
	...
	"vitess.io/vitess/go/mysql/collations/tools/makecolldata/codegen/format"
)
...
func (g *Generator) WriteToFile(out string) {
	...
	formatted, err := format.Source(file.Bytes(), format.Options{})
	if err != nil {
	...
	log.Printf("written %q (%.02fkb)", out, float64(len(formatted))/1024.0)
}
