...
func (Charset_ucs2) DecodeRune(p []byte) (rune, int, bool) {
	...
	if surr1 <= r && r < surr3 {
		// The decoder rejects a lone surrogate. This is more strict than
		// MySQL, and it is intentional. MySQL accepts a lone surrogate as
		// ucs2 data, and a later conversion to a different character set
