...
func TestQueries(t *testing.T) {
	...
	checkQuery(t, "all types", sConn, cConn, &sqltypes.Result{
		Fields: []*querypb.Field{
			...
			{Name: "Type_TEXT     ", Type: querypb.Type_TEXT, Charset: uint32(collations.Local().DefaultConnectionCharset())},
			{Name: "Type_BLOB     ", Type: querypb.Type_BLOB, Charset: collations.CollationBinaryID, Flags: uint32(querypb.MySqlFlag_BINARY_FLAG)},
			{Name: "Type_VARCHAR  ", Type: querypb.Type_VARCHAR, Charset: uint32(collations.Local().DefaultConnectionCharset())},
			...
			{Name: "Type_CHAR     ", Type: querypb.Type_CHAR, Charset: uint32(collations.Local().DefaultConnectionCharset())},
			...
			{Name: "Type_ENUM     ", Type: querypb.Type_ENUM, Charset: uint32(collations.Local().DefaultConnectionCharset()), Flags: uint32(querypb.MySqlFlag_ENUM_FLAG)},
			{Name: "Type_SET      ", Type: querypb.Type_SET, Charset: uint32(collations.Local().DefaultConnectionCharset()), Flags: uint32(querypb.MySqlFlag_SET_FLAG)},
