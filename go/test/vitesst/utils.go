...
func WaitForKsError(t *testing.T, vtgate *VTGate, ks string) string {
	var errString string
	WaitForVschemaCondition(t, vtgate, ks, func(t *testing.T, keyspace map[string]any) bool {
...
func WaitForTableDeletions(t *testing.T, vtgate *VTGate, ks, tbl string) {
	WaitForVschemaCondition(t, vtgate, ks, func(t *testing.T, keyspace map[string]any) bool {
