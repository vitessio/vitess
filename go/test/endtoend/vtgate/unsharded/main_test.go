...
func TestDDLUnsharded(t *testing.T) {
	...
	expected57 := `[[VARCHAR("allDefaults")] [VARCHAR("t1")]]`
	expected80 := `[[VARBINARY("allDefaults")] [VARBINARY("t1")]]`
	utils.AssertMatchesOneOf(t, conn, "show tables", expected57, expected80)
}
