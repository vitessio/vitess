...
func TestVtGateVExplain(t *testing.T) {
	...
	expected := `[
		...
		[VARCHAR("ks") VARCHAR("-40") VARCHAR("insert into lookup(lookup, id, keyspace_id) values ('apa', 1, X'166B40B44ABA4BD6') on duplicate key update lookup = values(lookup), id = values(id), keyspace_id = values(keyspace_id)")]
		[VARCHAR("ks") VARCHAR("40-80") VARCHAR("begin")]
		[VARCHAR("ks") VARCHAR("40-80") VARCHAR("insert into lookup(lookup, id, keyspace_id) values ('monkey', 3, X'4EB190C9A2FA169C') on duplicate key update lookup = values(lookup), id = values(id), keyspace_id = values(keyspace_id)")]
		[VARCHAR("ks") VARCHAR("-40") VARCHAR("commit")]
		[VARCHAR("ks") VARCHAR("40-80") VARCHAR("commit")]
		[VARCHAR("ks") VARCHAR("40-80") VARCHAR("begin")]
		[VARCHAR("ks") VARCHAR("40-80") VARCHAR("insert into lookup_unique(lookup_unique, keyspace_id) values ('monkey', X'4EB190C9A2FA169C')")]
		[VARCHAR("ks") VARCHAR("-40") VARCHAR("begin")]
		[VARCHAR("ks") VARCHAR("-40") VARCHAR("insert into lookup_unique(lookup_unique, keyspace_id) values ('apa', X'166B40B44ABA4BD6')")]
		[VARCHAR("ks") VARCHAR("40-80") VARCHAR("commit")]
		[VARCHAR("ks") VARCHAR("-40") VARCHAR("commit")]
		[VARCHAR("ks") VARCHAR("40-80") VARCHAR("begin")]
	...
	expected = `[
		[VARCHAR("ks") VARCHAR("-40") VARCHAR("begin")]
		[VARCHAR("ks") VARCHAR("-40") VARCHAR("insert into lookup(lookup, id, keyspace_id) values ('apa', 4, X'D2FD8867D50D2DFE'), ('apa', 5, X'70BB023C810CA87A') on duplicate key update lookup = values(lookup), id = values(id), keyspace_id = values(keyspace_id)")]
		[VARCHAR("ks") VARCHAR("40-80") VARCHAR("begin")]
		[VARCHAR("ks") VARCHAR("40-80") VARCHAR("insert into lookup(lookup, id, keyspace_id) values ('monkey', 6, X'F098480AC4C4BE71') on duplicate key update lookup = values(lookup), id = values(id), keyspace_id = values(keyspace_id)")]
		[VARCHAR("ks") VARCHAR("-40") VARCHAR("commit")]
		[VARCHAR("ks") VARCHAR("40-80") VARCHAR("commit")]
		[VARCHAR("ks") VARCHAR("-40") VARCHAR("begin")]
		[VARCHAR("ks") VARCHAR("-40") VARCHAR("insert into lookup_unique(lookup_unique, keyspace_id) values ('foo', X'D2FD8867D50D2DFE')")]
		[VARCHAR("ks") VARCHAR("80-c0") VARCHAR("begin")]
		[VARCHAR("ks") VARCHAR("80-c0") VARCHAR("insert into lookup_unique(lookup_unique, keyspace_id) values ('bar', X'70BB023C810CA87A')")]
		[VARCHAR("ks") VARCHAR("c0-") VARCHAR("begin")]
		[VARCHAR("ks") VARCHAR("c0-") VARCHAR("insert into lookup_unique(lookup_unique, keyspace_id) values ('nobar', X'F098480AC4C4BE71')")]
		[VARCHAR("ks") VARCHAR("-40") VARCHAR("commit")]
