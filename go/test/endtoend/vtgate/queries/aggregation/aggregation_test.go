...
func TestGroupBy(t *testing.T) {
	...
	utils.AssertMatches(t, mcmp.VtConn, "select /*vt+ PLANNER=gen4 */ id6, id7, count(*) k from t3 group by all order by k", `[[INT64(3) INT64(6) INT64(1)] [INT64(2) INT64(4) INT64(2)] [INT64(1) INT64(2) INT64(3)]]`)
