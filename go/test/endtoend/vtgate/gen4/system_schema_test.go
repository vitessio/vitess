...
func TestFKConstraintUsingInformationSchema(t *testing.T) {
	...
	expected57 := `[[VARCHAR("t7_xxhash") VARCHAR("uid") VARCHAR("t7_uid") VARCHAR("t7_fk_ibfk_1") VARCHAR("CASCADE") VARCHAR("SET NULL")]]`
	expected80 := `[[VARBINARY("t7_xxhash") VARCHAR("uid") VARCHAR("t7_uid") VARCHAR("t7_fk_ibfk_1") BINARY("CASCADE") BINARY("SET NULL")]]`
	utils.AssertMatchesOneOf(t, conn, query, expected57, expected80)
}
