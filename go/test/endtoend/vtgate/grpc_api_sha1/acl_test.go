...
func TestWrongPassword(t *testing.T) {
	...
	vtgateConn, err := cluster.DialVTGate(ctx, t.Name(), vtgateGrpcAddress, "user_with_access", "wrong_password")
	require.NoError(t, err)
	defer vtgateConn.Close()
...
func TestNonExistentUser(t *testing.T) {
	...
	vtgateConn, err := cluster.DialVTGate(ctx, t.Name(), vtgateGrpcAddress, "nonexistent_user", "test_password")
	require.NoError(t, err)
	defer vtgateConn.Close()
