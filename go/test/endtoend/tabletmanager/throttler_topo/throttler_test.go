...
func TestInitialThrottler(t *testing.T) {
	...
	t.Run("enabling throttler with very low threshold", func(t *testing.T) {
		err := throttler.UpdateThrottlerTopoConfig(clusterInstance, true, false, unreasonablyLowThreshold.Seconds(), useDefaultQuery)
	...
	t.Run("disabling throttler", func(t *testing.T) {
		err := throttler.UpdateThrottlerTopoConfig(clusterInstance, false, true, unreasonablyLowThreshold.Seconds(), useDefaultQuery)
		assert.NoError(t, err)
	...
	t.Run("enabling throttler, again", func(t *testing.T) {
		...
		err := throttler.UpdateThrottlerTopoConfig(clusterInstance, true, false, 0, useDefaultQuery)
		assert.NoError(t, err)
	...
	t.Run("setting high threshold", func(t *testing.T) {
		err := throttler.UpdateThrottlerTopoConfig(clusterInstance, false, false, extremelyHighThreshold.Seconds(), useDefaultQuery)
		assert.NoError(t, err)
	...
	t.Run("setting low threshold", func(t *testing.T) {
		err := throttler.UpdateThrottlerTopoConfig(clusterInstance, false, false, throttler.DefaultThreshold.Seconds(), useDefaultQuery)
		assert.NoError(t, err)
...
func TestCustomQuery(t *testing.T) {
	...
	t.Run("enabling throttler with custom query and threshold", func(t *testing.T) {
		err := throttler.UpdateThrottlerTopoConfig(clusterInstance, true, false, customThreshold.Seconds(), customQuery)
		assert.NoError(t, err)
...
func TestRestoreDefaultQuery(t *testing.T) {
	...
	t.Run("enabling throttler with default query and threshold", func(t *testing.T) {
		err := throttler.UpdateThrottlerTopoConfig(clusterInstance, true, false, throttler.DefaultThreshold.Seconds(), useDefaultQuery)
		assert.NoError(t, err)
