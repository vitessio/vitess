...
var dryRunResultsSwitchWritesCustomerShard = []string{
	...
	"Stop writes on keyspace product, tables [Lead,Lead-1,blob_tbl,customer,db_order_test,geom_tbl,json_tbl,reftable,vdiff_order]:",
	...
	"Enable writes on keyspace customer tables [Lead,Lead-1,blob_tbl,customer,db_order_test,geom_tbl,json_tbl,reftable,vdiff_order]",
	"Switch routing from keyspace product to keyspace customer",
	"Routing rules for tables [Lead,Lead-1,blob_tbl,customer,db_order_test,geom_tbl,json_tbl,reftable,vdiff_order] will be updated",
...
var dryRunResultsReadCustomerShard = []string{
	"Lock keyspace product",
	"Switch reads for tables [Lead,Lead-1,blob_tbl,customer,db_order_test,geom_tbl,json_tbl,reftable,vdiff_order] to keyspace customer for tablet types [RDONLY,REPLICA]",
	"Routing rules for tables [Lead,Lead-1,blob_tbl,customer,db_order_test,geom_tbl,json_tbl,reftable,vdiff_order] will be updated",
	"Unlock keyspace product",
}
