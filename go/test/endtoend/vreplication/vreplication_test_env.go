...
var dryRunResultsSwitchWritesCustomerShard = []string{
	...
	"       customer.tenant@rdonly => customer.tenant",
	"       customer.tenant@replica => customer.tenant",
	...
	"       product.tenant@rdonly => customer.tenant",
	"       product.tenant@replica => customer.tenant",
	"       tenant@rdonly => customer.tenant",
	"       tenant@replica => customer.tenant",
	"Following rules will be added:",
	"       customer => customer.customer",
	"       product.customer => customer.customer",
	"       product.tenant => customer.tenant",
...
var dryRunResultsReadCustomerShard = []string{
	"Lock keyspace product",
	"Switch reads for tables customer,tenant to keyspace customer",
	"Unlock keyspace product",
}
...
var dryRunResultsDropSourcesDropCustomerShard = []string{
	...
	"	Keyspace product Shard 0 DbName vt_product Tablet 100 Table tenant RemovalType DROP TABLE",
...
var dryRunResultsDropSourcesRenameCustomerShard = []string{
	...
	"	Keyspace product Shard 0 DbName vt_product Tablet 100 Table tenant RemovalType RENAME TABLE",
	"Blacklisted tables customer,tenant will be removed from:",
	"	Keyspace product Shard 0 Tablet 100",
	"Delete reverse vreplication streams on source:",
	"	Keyspace product Shard 0 Workflow p2c_reverse DbName vt_product Tablet 100",
