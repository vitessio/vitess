...
var dryRunResultsSwitchWritesCustomerShard = []string{
	...
	"Stop writes on keyspace product, tables [Lead,customer]:",
	...
	"Enable writes on keyspace customer tables [Lead,customer]",
	"Switch routing from keyspace product to keyspace customer",
	"Routing rules for tables [Lead,customer] will be updated",
...
var dryRunResultsReadCustomerShard = []string{
	"Lock keyspace product",
	"Switch reads for tables [Lead,customer] to keyspace customer for tablet types [REPLICA,RDONLY]",
	"Routing rules for tables [Lead,customer] will be updated",
	"Unlock keyspace product",
}
...
var dryRunResultsDropSourcesDropCustomerShard = []string{
	...
	"Denied tables [Lead,customer] will be removed from:",
