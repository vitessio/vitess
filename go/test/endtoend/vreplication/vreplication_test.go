...
func testVreplicationWorkflows(t *testing.T, limited bool, binlogRowImage string) {
	...
	t.Run("Test CreateLookupVindex", func(t *testing.T) {
		...
		err = vc.VtctldClient.ExecuteCommand("LookupVindex", "--workflow=customer_name_keyspace_id_vdx", "--target-keyspace=product", "create", "--tablet-types=PRIMARY", createLookupVindexVSchema)
