...
func initializeCluster(t *testing.T) {
	...
	shard.Vttablets = []*cluster.Vttablet{primary, replica1}
	shard0.Vttablets = []*cluster.Vttablet{shard0Primary, shard0Replica1}
	shard1.Vttablets = []*cluster.Vttablet{shard1Primary, shard1Replica1}
