...
_TABLETMANAGER = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='VReplicationCreate',
    full_name='tabletmanagerservice.TabletManager.VReplicationCreate',
    index=29,
    containing_service=None,
    input_type=tabletmanagerdata__pb2._VREPLICATIONCREATEREQUEST,
    output_type=tabletmanagerdata__pb2._VREPLICATIONCREATERESPONSE,
    options=None,
  ),
  _descriptor.MethodDescriptor(
