...
_TABLETMANAGER = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='UpdateBlacklistedTables',
    full_name='tabletmanagerservice.TabletManager.UpdateBlacklistedTables',
    index=9,
    containing_service=None,
    input_type=tabletmanagerdata__pb2._UPDATEBLACKLISTEDTABLESREQUEST,
    output_type=tabletmanagerdata__pb2._UPDATEBLACKLISTEDTABLESRESPONSE,
    serialized_options=None,
  ),
  _descriptor.MethodDescriptor(
    name='RunHealthCheck',
