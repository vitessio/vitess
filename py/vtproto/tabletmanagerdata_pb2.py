...
_HOSTPERMISSION_PRIVILEGESENTRY = _descriptor.Descriptor(
  name='PrivilegesEntry',
  full_name='tabletmanagerdata.HostPermission.PrivilegesEntry',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='tabletmanagerdata.HostPermission.PrivilegesEntry.key', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='value', full_name='tabletmanagerdata.HostPermission.PrivilegesEntry.value', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_HOSTPERMISSION = _descriptor.Descriptor(
  name='HostPermission',
  full_name='tabletmanagerdata.HostPermission',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='host', full_name='tabletmanagerdata.HostPermission.host', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='db', full_name='tabletmanagerdata.HostPermission.db', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='privileges', full_name='tabletmanagerdata.HostPermission.privileges', index=2,
  ...
  nested_types=[_HOSTPERMISSION_PRIVILEGESENTRY, ],
  enum_types=[
  ],
  options=None,
  is_extendable=False,
...
_PERMISSIONS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='host_permissions', full_name='tabletmanagerdata.Permissions.host_permissions', index=2,
      number=3, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_SCRAPREQUEST = _descriptor.Descriptor(
  name='ScrapRequest',
  full_name='tabletmanagerdata.ScrapRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
_SCRAPRESPONSE = _descriptor.Descriptor(
  name='ScrapResponse',
  full_name='tabletmanagerdata.ScrapResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
_RUNHEALTHCHECKREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='tablet_type', full_name='tabletmanagerdata.RunHealthCheckRequest.tablet_type', index=0,
      number=1, type=14, cpp_type=8, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_PREFLIGHTSCHEMAREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='change', full_name='tabletmanagerdata.PreflightSchemaRequest.change', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_PREFLIGHTSCHEMARESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='before_schema', full_name='tabletmanagerdata.PreflightSchemaResponse.before_schema', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='after_schema', full_name='tabletmanagerdata.PreflightSchemaResponse.after_schema', index=1,
...
_EXECUTEFETCHASDBAREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='want_fields', full_name='tabletmanagerdata.ExecuteFetchAsDbaRequest.want_fields', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='disable_binlogs', full_name='tabletmanagerdata.ExecuteFetchAsDbaRequest.disable_binlogs', index=4,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='reload_schema', full_name='tabletmanagerdata.ExecuteFetchAsDbaRequest.reload_schema', index=5,
...
_EXECUTEFETCHASAPPREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='want_fields', full_name='tabletmanagerdata.ExecuteFetchAsAppRequest.want_fields', index=2,
      number=3, type=8, cpp_type=7, label=1,
      has_default_value=False, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_HOSTPERMISSION_PRIVILEGESENTRY.containing_type = _HOSTPERMISSION
_HOSTPERMISSION.fields_by_name['privileges'].message_type = _HOSTPERMISSION_PRIVILEGESENTRY
...
_RUNHEALTHCHECKREQUEST.fields_by_name['tablet_type'].enum_type = topodata__pb2._TABLETTYPE
_PREFLIGHTSCHEMARESPONSE.fields_by_name['before_schema'].message_type = _SCHEMADEFINITION
_PREFLIGHTSCHEMARESPONSE.fields_by_name['after_schema'].message_type = _SCHEMADEFINITION
...
DESCRIPTOR.message_types_by_name['HostPermission'] = _HOSTPERMISSION
...
DESCRIPTOR.message_types_by_name['ScrapResponse'] = _SCRAPRESPONSE
...
HostPermission = _reflection.GeneratedProtocolMessageType('HostPermission', (_message.Message,), dict(

  PrivilegesEntry = _reflection.GeneratedProtocolMessageType('PrivilegesEntry', (_message.Message,), dict(
    DESCRIPTOR = _HOSTPERMISSION_PRIVILEGESENTRY,
    __module__ = 'tabletmanagerdata_pb2'
    # @@protoc_insertion_point(class_scope:tabletmanagerdata.HostPermission.PrivilegesEntry)
    ))
  ,
  DESCRIPTOR = _HOSTPERMISSION,
  __module__ = 'tabletmanagerdata_pb2'
  # @@protoc_insertion_point(class_scope:tabletmanagerdata.HostPermission)
  ))
_sym_db.RegisterMessage(HostPermission)
_sym_db.RegisterMessage(HostPermission.PrivilegesEntry)
...
ScrapRequest = _reflection.GeneratedProtocolMessageType('ScrapRequest', (_message.Message,), dict(
  DESCRIPTOR = _SCRAPREQUEST,
  __module__ = 'tabletmanagerdata_pb2'
  # @@protoc_insertion_point(class_scope:tabletmanagerdata.ScrapRequest)
  ))
_sym_db.RegisterMessage(ScrapRequest)

ScrapResponse = _reflection.GeneratedProtocolMessageType('ScrapResponse', (_message.Message,), dict(
  DESCRIPTOR = _SCRAPRESPONSE,
  __module__ = 'tabletmanagerdata_pb2'
  # @@protoc_insertion_point(class_scope:tabletmanagerdata.ScrapResponse)
  ))
_sym_db.RegisterMessage(ScrapResponse)
...
_USERPERMISSION_PRIVILEGESENTRY._options = _descriptor._ParseOptions(descriptor_pb2.MessageOptions(), b'8\001')
_DBPERMISSION_PRIVILEGESENTRY.has_options = True
_DBPERMISSION_PRIVILEGESENTRY._options = _descriptor._ParseOptions(descriptor_pb2.MessageOptions(), b'8\001')
_HOSTPERMISSION_PRIVILEGESENTRY.has_options = True
_HOSTPERMISSION_PRIVILEGESENTRY._options = _descriptor._ParseOptions(descriptor_pb2.MessageOptions(), b'8\001')
_EXECUTEHOOKREQUEST_EXTRAENVENTRY.has_options = True
_EXECUTEHOOKREQUEST_EXTRAENVENTRY._options = _descriptor._ParseOptions(descriptor_pb2.MessageOptions(), b'8\001')
import abc
