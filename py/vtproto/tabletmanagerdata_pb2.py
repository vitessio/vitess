...
_GETSCHEMAREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='db_name', full_name='tabletmanagerdata.GetSchemaRequest.db_name', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='tables', full_name='tabletmanagerdata.GetSchemaRequest.tables', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='include_views', full_name='tabletmanagerdata.GetSchemaRequest.include_views', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='exclude_tables', full_name='tabletmanagerdata.GetSchemaRequest.exclude_tables', index=3,
      number=3, type=9, cpp_type=9, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
