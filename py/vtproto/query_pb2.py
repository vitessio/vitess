...
_CELL = _descriptor.Descriptor(
  name='Cell',
  full_name='query.Cell',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='value', full_name='query.Cell.value', index=0,
...
_ROW1 = _descriptor.Descriptor(
  name='Row1',
  full_name='query.Row1',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='values', full_name='query.Row1.values', index=0,
...
_RESULT1 = _descriptor.Descriptor(
  name='Result1',
  full_name='query.Result1',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='rows', full_name='query.Result1.rows', index=0,
      number=1, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_ROW2 = _descriptor.Descriptor(
  name='Row2',
  full_name='query.Row2',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='is_null', full_name='query.Row2.is_null', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='values', full_name='query.Row2.values', index=1,
...
_RESULT2 = _descriptor.Descriptor(
  name='Result2',
  full_name='query.Result2',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='rows', full_name='query.Result2.rows', index=0,
      number=1, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_ROW3 = _descriptor.Descriptor(
  name='Row3',
  full_name='query.Row3',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='indexes', full_name='query.Row3.indexes', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='values', full_name='query.Row3.values', index=1,
      number=2, type=12, cpp_type=9, label=1,
      has_default_value=False, default_value=b"",
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_RESULT3 = _descriptor.Descriptor(
  name='Result3',
  full_name='query.Result3',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='rows', full_name='query.Result3.rows', index=0,
      number=1, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_ROW1.fields_by_name['values'].message_type = _CELL
_RESULT1.fields_by_name['rows'].message_type = _ROW1
_RESULT2.fields_by_name['rows'].message_type = _ROW2
_RESULT3.fields_by_name['rows'].message_type = _ROW3
...
DESCRIPTOR.message_types_by_name['Row1'] = _ROW1
DESCRIPTOR.message_types_by_name['Result1'] = _RESULT1
DESCRIPTOR.message_types_by_name['Row2'] = _ROW2
DESCRIPTOR.message_types_by_name['Result2'] = _RESULT2
DESCRIPTOR.message_types_by_name['Row3'] = _ROW3
DESCRIPTOR.message_types_by_name['Result3'] = _RESULT3
...
Cell = _reflection.GeneratedProtocolMessageType('Cell', (_message.Message,), dict(
  DESCRIPTOR = _CELL,
  __module__ = 'query_pb2'
  # @@protoc_insertion_point(class_scope:query.Cell)
  ))
_sym_db.RegisterMessage(Cell)

Row1 = _reflection.GeneratedProtocolMessageType('Row1', (_message.Message,), dict(
  DESCRIPTOR = _ROW1,
  __module__ = 'query_pb2'
  # @@protoc_insertion_point(class_scope:query.Row1)
  ))
_sym_db.RegisterMessage(Row1)

Result1 = _reflection.GeneratedProtocolMessageType('Result1', (_message.Message,), dict(
  DESCRIPTOR = _RESULT1,
  __module__ = 'query_pb2'
  # @@protoc_insertion_point(class_scope:query.Result1)
  ))
_sym_db.RegisterMessage(Result1)

Row2 = _reflection.GeneratedProtocolMessageType('Row2', (_message.Message,), dict(
  DESCRIPTOR = _ROW2,
  __module__ = 'query_pb2'
  # @@protoc_insertion_point(class_scope:query.Row2)
  ))
_sym_db.RegisterMessage(Row2)

Result2 = _reflection.GeneratedProtocolMessageType('Result2', (_message.Message,), dict(
  DESCRIPTOR = _RESULT2,
  __module__ = 'query_pb2'
  # @@protoc_insertion_point(class_scope:query.Result2)
  ))
_sym_db.RegisterMessage(Result2)

Row3 = _reflection.GeneratedProtocolMessageType('Row3', (_message.Message,), dict(
  DESCRIPTOR = _ROW3,
  __module__ = 'query_pb2'
  # @@protoc_insertion_point(class_scope:query.Row3)
  ))
_sym_db.RegisterMessage(Row3)

Result3 = _reflection.GeneratedProtocolMessageType('Result3', (_message.Message,), dict(
  DESCRIPTOR = _RESULT3,
  __module__ = 'query_pb2'
  # @@protoc_insertion_point(class_scope:query.Result3)
  ))
_sym_db.RegisterMessage(Result3)
