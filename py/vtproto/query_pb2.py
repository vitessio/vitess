...
_TYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='Geometry', index=28, number=2076,
      options=None,
      type=None),
  ],
  containing_type=None,
