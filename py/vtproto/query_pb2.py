...
_VITESSMESSAGE = _descriptor.Descriptor(
  name='VitessMessage',
  full_name='query.VitessMessage',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='id', full_name='query.VitessMessage.id', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='vitess_message', full_name='query.VitessMessage.vitess_message', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_MESSAGESTREAMRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='query.MessageStreamResponse.name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='messages', full_name='query.MessageStreamResponse.messages', index=1,
      number=2, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_MESSAGEACKRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='count', full_name='query.MessageAckResponse.count', index=0,
      number=1, type=3, cpp_type=2, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_VITESSMESSAGE.fields_by_name['id'].message_type = _BINDVARIABLE
_VITESSMESSAGE.fields_by_name['vitess_message'].message_type = _BINDVARIABLE
_MESSAGESTREAMRESPONSE.fields_by_name['messages'].message_type = _VITESSMESSAGE
...
VitessMessage = _reflection.GeneratedProtocolMessageType('VitessMessage', (_message.Message,), dict(
  ...
  __module__ = 'query_pb2'
  # @@protoc_insertion_point(class_scope:query.VitessMessage)
  ))
