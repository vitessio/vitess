...
_BEGINEXECUTEREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='also_commit', full_name='query.BeginExecuteRequest.also_commit', index=5,
