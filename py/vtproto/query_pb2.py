...
_EXECUTEBATCHREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='execute_all', full_name='query.ExecuteBatchRequest.execute_all', index=7,
...
_EXECUTEBATCHRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='queryError', full_name='query.ExecuteBatchResponse.queryError', index=1,
      number=2, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_EXECUTEBATCHRESPONSE.fields_by_name['queryError'].message_type = vtrpc__pb2._RPCERROR
