...
def early_adopter_create_MysqlCtl_server(servicer, port, private_key=None, certificate_chain=None):
  ...
  method_service_descriptions = {
    "RunMysqlUpgrade": alpha_utilities.unary_unary_service_description(
    ...
    "Start": alpha_utilities.unary_unary_service_description(
      servicer.Start,
      mysqlctl_pb2.StartRequest.FromString,
      mysqlctl_pb2.StartResponse.SerializeToString,
    ),
  }
  return early_adopter_implementations.server("mysqlctl.MysqlCtl", method_service_descriptions, port, private_key=private_key, certificate_chain=certificate_chain)
def early_adopter_create_MysqlCtl_stub(host, port, metadata_transformer=None, secure=False, root_certificates=None, private_key=None, certificate_chain=None, server_host_override=None):
  ...
  method_invocation_descriptions = {
    "RunMysqlUpgrade": alpha_utilities.unary_unary_invocation_description(
    ...
    "Start": alpha_utilities.unary_unary_invocation_description(
      mysqlctl_pb2.StartRequest.SerializeToString,
      mysqlctl_pb2.StartResponse.FromString,
    ),
  }
  return early_adopter_implementations.stub("mysqlctl.MysqlCtl", method_invocation_descriptions, host, port, metadata_transformer=metadata_transformer, secure=secure, root_certificates=root_certificates, private_key=private_key, certificate_chain=certificate_chain, server_host_override=server_host_override)
