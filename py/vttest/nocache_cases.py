...
cases = [
    ...
    #    'numbers as strings',
    #    ['begin',
    #     Case(sql="insert into vtocc_a(id, eid, foo, name) values (%(id)s, '6', 111, 222)",
    #          bindings={ "id": "1"},
    #          rewritten="insert into vtocc_a(id, eid, foo, name) values ('1', '6', 111, 222) /* _stream vtocc_a (eid id ) (6 1 ); */"),
    #     'commit',
    #     Case(sql='select * from vtocc_a where eid = 6 and id = 1',
    #          result=[(6L, 1L, '222', '111')]),
    #     'begin',
    #     'delete from vtocc_a where eid>1',
    #     'commit']),
    ...
    #    'strings as numbers',
    #    ['begin',
    #     Case(sql="insert into vtocc_c(name, eid, foo) values (%(name)s, '9', 'aaa')",
    #          bindings={"name": "bbb"},
    #          rewritten="insert into vtocc_c(name, eid, foo) values ('bbb', '9', 'aaa') /* _stream vtocc_c (eid name ) (9 'YmJi' ); */"),
    #     'commit',
    #     Case(sql='select * from vtocc_c where eid = 9',
    #          result=[(9, 'bbb', 'aaa')]),
    #     'begin',
    ...
    #    'subquery',
    #    ['begin',
    #     Case(sql="insert /* subquery */ into vtocc_a(eid, id, name, foo) select eid, foo, name, foo from vtocc_c",
    #          rewritten =[
    ...
    #          result=[(10L, 20L, 'abcd', '20'), (11L, 30L, 'bcde', '30')]),
    #     'begin',
    #     Case(sql="insert into vtocc_a(eid, id, name, foo) select eid, foo, name, foo from vtocc_c on duplicate key update foo='bar'",
    #          rewritten=[
    #              'select eid, foo, name, foo from vtocc_c limit 10001',
    ...
    #     'commit',
    #     Case(sql='select * from vtocc_a where eid in (10, 11)',
    #          result=[(10L, 20L, 'abcd', 'bar'), (11L, 30L, 'bcde', 'bar')]),
    #     'begin',
    #     Case(sql="insert into vtocc_a(eid, id, name, foo) select eid, foo, name, foo from vtocc_c limit 1 on duplicate key update id = 21",
    #          rewritten=[
    ...
    #     'commit',
    #     Case(sql='select * from vtocc_a where eid in (10, 11)',
    #          result=[(10L, 21L, 'abcd', 'bar'), (11L, 30, 'bcde', 'bar')]),
    #     'begin',
    #     'delete from vtocc_a where eid>1',
    #     'delete from vtocc_c where eid<10',
    #     'commit']),
