 ...
 */
const Dialog: React.FC<DialogProps> = ({ icon, title, description, children, isOpen, confirmText, cancelText, footer, hideFooter, hideCancel, hideConfirm, onCancel, onConfirm, onClose }) => {
