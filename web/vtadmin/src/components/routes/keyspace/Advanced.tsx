        ...
        {keyspace && (
          <div>
            ...
            <ActionPanel
              description={
                <>
                  Rebuilds the serving data for the <span className="font-bold">{name}</span> keyspace. This command may trigger an update to all connected clients.
                </>
              }
              ...
              body={<>
                ...
                <div className='mt-2'>
                  <div className='flex items-center'>
                    <Toggle className='mr-2' enabled={allowPartial} onChange={() => setAllowPartial(!allowPartial)} />
                    <Label label="Allow Partial" />
                  </div>
                  When set, allows a SNAPSHOT keyspace to serve with an incomplete set of shards. It is ignored for all other keyspace types.
                </div>
              </>}
            />
          </div>
