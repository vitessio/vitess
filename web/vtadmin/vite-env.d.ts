...
// vite/client declares the variables vite itself sets, such as MODE, BASE_URL,
// DEV and PROD. These are vtadmin's own, and are documented in README.md.
...
// Set at runtime by public/config/config.js, which is served alongside the app.
interface Window {
    env: ImportMetaEnv;
}
