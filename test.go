...
var (
	...
	bootstrapVersion = flag.String("bootstrap-version", "54", "the version identifier to use for the docker images")
...
const (
	...
	flavors = "mysql80,mysql84,mysql96,percona80,percona84"
)
