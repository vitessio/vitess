...
class Tablet(object):
  ...
  def _start_prog(self, binary, port=None, auth=False, memcache=False,
                  wait_for_state='SERVING', customrules=None, customrule_manager='file',
    ...
    if customrule_manager:
      args.extend(['-customrule_manager', customrule_manager])
  ...
  def start_vttablet(self, port=None, auth=False, memcache=False,
    ...
    return self._start_prog(binary='vttablet', port=port, auth=auth,
                            ...
                            customrule_manager=customrule_manager,
