  ...
  build:
    ...
    - name: Run cluster endtoend test
      ...
      run: |
        ...
        eatmydata -- go run test.go -docker={{if .Docker}}true -follow -shard {{.Shard}}{{if .PartialKeyspace}} -partial-keyspace=true {{end}} | tee -a output.txt | go-junit-report -set-exit-code > report.xml
