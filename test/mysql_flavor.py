...
class MariaDB(MysqlFlavor):
  ...
  def extra_my_cnf(self):
    return environment.vtroot + "/config/mycnf/master_mariadb100.cnf"
...
class MariaDB103(MariaDB):
  ...
  def extra_my_cnf(self):
    return environment.vtroot + "/config/mycnf/master_mariadb103.cnf"
...
class MySQL80(MySQL56):
  ...
  def extra_my_cnf(self):
    return environment.vtroot + "/config/mycnf/master_mysql80.cnf"
  def change_passwords(self, password_col):
    """set real passwords for all users"""
    return '''
# Set real passwords for all users.
