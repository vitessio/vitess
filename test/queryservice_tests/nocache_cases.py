    ...
    MultiCase(
        ...
        ['begin',
         Case(sql="update /* pk */ vtocc_a set foo='bar' where eid = 1 and id = 1",
              rewritten="update /* pk */ vtocc_a set foo = 'bar' where (eid, id) = (1, 1) /* _stream vtocc_a (eid id ) (1 1 )"),
         'commit',
    ...
    MultiCase(
        ...
        ['begin',
         Case(sql="update /* pk */ vtocc_a set foo='bar' where eid = 1 and id in (1, 2)",
              rewritten="update /* pk */ vtocc_a set foo = 'bar' where (eid, id) = (1, 1) or (eid, id) = (1, 2) /* _stream vtocc_a (eid id ) (1 1 ) (1 2 )"),
         'commit',
         Case(sql='select foo from vtocc_a where id = 1',
              result=[('bar',)]),
         'begin',
        ...
        ['begin',
         Case(sql="update /* pk */ vtocc_a set foo='bar' where eid in (1) and id in (1, 2)",
              rewritten=[
                  ...
                  "update /* pk */ vtocc_a set foo = 'bar' where (eid, id) = (1, 1) or (eid, id) = (1, 2) /* _stream vtocc_a (eid id ) (1 1 ) (1 2 )",]),
         'commit',
         Case(sql='select foo from vtocc_a where id = 1',
              result=[('bar',)]),
         'begin',
  ...
  MultiCase(
      ...
      ['begin',
       Case(sql="update vtocc_a set eid = 2 where eid = 1 and id = 1",
            rewritten="update vtocc_a set eid = 2 where (eid, id) = (1, 1) /* _stream vtocc_a (eid id ) (1 1 ) (2 1 )"),
       'commit',
  ...
  MultiCase(
      ...
      ['begin',
       Case(sql="update vtocc_a set vtocc_a.eid = 2 where eid = 1 and id = 1",
            rewritten="update vtocc_a set vtocc_a.eid = 2 where (eid, id) = (1, 1) /* _stream vtocc_a (eid id ) (1 1 ) (2 1 )"),
       'commit',
       Case(sql='select eid from vtocc_a where id = 1',
            result=[(2L,)]),
       'begin',
      ...
      ['begin',
       Case(sql="update /* pk */ vtocc_a set foo='bar' where id = 1",
            rewritten=[
                ...
                "update /* pk */ vtocc_a set foo = 'bar' where (eid, id) = (1, 1) /* _stream vtocc_a (eid id ) (1 1 )"]),
       'commit',
       Case(sql='select foo from vtocc_a where id = 1',
            result=[('bar',)]),
       'begin',
        ...
        ['begin',
         Case(sql="update /* pk */ vtocc_a set foo='bar' where eid = 1 order by id desc limit 1",
              rewritten=[
                  ...
                  "update /* pk */ vtocc_a set foo = 'bar' where (eid, id) = (1, 2) /* _stream vtocc_a (eid id ) (1 2 )"]),
         'commit',
      ...
      ['begin',
       Case(sql="update vtocc_a set foo='bar'",
            rewritten=[
                ...
                "update vtocc_a set foo = 'bar' where (eid, id) = (1, 1) or (eid, id) = (1, 2) /* _stream vtocc_a (eid id ) (1 1 ) (1 2 )"]),
       'commit',
  ...
  MultiCase(
      ...
      ['begin',
       ...
       Case(sql="delete /* pk */ from vtocc_a where eid = 2 and id = 1",
            rewritten="delete /* pk */ from vtocc_a where (eid, id) = (2, 1) /* _stream vtocc_a (eid id ) (2 1 )"),
       'commit',
  ...
  MultiCase(
      ...
      ['begin',
       ...
       Case(sql="delete /* pk */ from vtocc_a where eid = 2 and id in (1, 2)",
            rewritten="delete /* pk */ from vtocc_a where (eid, id) = (2, 1) or (eid, id) = (2, 2) /* _stream vtocc_a (eid id ) (2 1 ) (2 2 )"),
       'commit',
      ...
      ['begin',
       ...
       Case(sql="delete /* pk */ from vtocc_a where eid in (2) and id in (1, 2)",
            rewritten=[
                ...
                'delete /* pk */ from vtocc_a where (eid, id) = (2, 1) /* _stream vtocc_a (eid id ) (2 1 )',]),
       'commit',
       Case(sql='select * from vtocc_a where eid=2',
            result=[])]),
      ...
      ['begin',
       ...
       Case(sql="delete from vtocc_a where eid = 1+1 and id = 1",
            rewritten=[
                ...
                "delete from vtocc_a where (eid, id) = (2, 1) /* _stream vtocc_a (eid id ) (2 1 )"]),
       'commit',
       Case(sql='select * from vtocc_a where eid=2',
            result=[])]),
