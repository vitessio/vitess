...
class TestTabletManager(unittest.TestCase):
  ...
  def test_multisnapshot_and_restore(self):
  ...
  index by_msg (msg)
    ...
    utils.run_vtctl('CreateKeyspace test_keyspace_new')
    ...
    utils.validate_topology()
    tablet_62344.drop_db('not_vt_test_keyspace')
  ...
  def test_multisnapshot_and_restore_vtctl(self):
    tables = ['vt_insert_test', 'vt_insert_test1']
    create_template = '''create table %s (
  id bigint auto_increment,
  msg varchar(64),
  ...
  def test_multisnapshot_mysqlctl(self):
    populate = sum([[
