...
{{ include "cont-mysql-generallog" (tuple $logtail) | indent 8 }}
{{ include "cont-mysql-errorlog" (tuple $logtail) | indent 8 }}
{{ include "cont-mysql-slowlog" (tuple $logtail) | indent 8 }}
