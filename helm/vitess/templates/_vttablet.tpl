      ...
      command:
        ...
        - |
          ...
          eval exec /vt/bin/vttablet $(cat <<END_OF_COMMAND
            ...
            -restore_from_backup
{{ include "format-flags-all" (tuple $.Values.backupFlags $0.extraFlags .extraFlags) | indent 12 }}
          END_OF_COMMAND
          )
    - name: mysql
      image: {{.image | default $0.image | quote}}
...
{{ include "format-flags-all" (tuple $0.mysqlctlExtraFlags .mysqlctlExtraFlags) | indent 12 }}
          END_OF_COMMAND
          )
      env:
        - name: EXTRA_MY_CNF
