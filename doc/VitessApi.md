...
| <code>shard_references</code> <br>list &lt;[ShardReference](#topodata.shardreference)&gt;| Serving graph information ShardReference is used as a pointer from a SrvKeyspace to a Shard |
