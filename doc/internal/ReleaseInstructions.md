...
2. Creation of the Release Pull Request.
    ...
    2. Run the following command to generate the release notes:
        1. Release Candidate:
            ```shell
            make VERSION="v15.0.0-rc1" FROM="v14.0.3" TO="HEAD" SUMMARY="./changelog/15.0/15.0.0/15_0_0_summary.md" release-notes  
            ```
        2. General Availability:
            ```shell
            make VERSION="v15.0.0-rc1" FROM="v14.0.3" TO="HEAD" SUMMARY="./changelog/15.0/15.0.0/15_0_0_summary.md" release-notes  
       ...
       It will also use the file located in `./changelog/15.0/15.0.0/15_0_0_summary.md` to prefix the release notes with a text that the maintainers wrote before the release.
