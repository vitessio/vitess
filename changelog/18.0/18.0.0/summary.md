...
#### <a id="vtgate-vschema-vindex-unknown-params"/>VTGate VSchema Vindex unknown params

Gauges unknown Vindex params found in the latest VSchema pulled from the topology.