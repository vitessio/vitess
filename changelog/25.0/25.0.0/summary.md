...
- A CRL, or a CA certificate in the CA file, whose name holds a T.61 string with characters beyond ASCII: the TLS configuration fails to build, since such a name cannot be compared with its other encodings. Re-issue it with a UTF8String name.
