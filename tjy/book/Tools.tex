...
\index{vtctl}{\textbf{vtctl}} is the main tool for performing administrative operations. It can be used to track shards, replication graphs and
db categories.
...
One of \index{vttable}{\textbf{vttablet}} 's main function is to be a proxy to MySQL.
...
\index{Vtocc}{\textbf{Vtocc}}  is the previous version of vttablet. It handles query management
...
\index{vtgate}{\textbf{vtgate}}'s goal is to provide a unified view of the entire fleet.
...
\index{vtctld}{\textbf{vtctld}}  is an HTTP server that lets you browse the information stored
in the lockserver.
...
\index{vtworker}{\textbf{vtworker}}  is meant to host long-running processes. It supports a plugin infrastructure, and offers libraries to easily pick tablets to use. We have developped:
