...
class VTGateConnTest extends PHPUnit_Framework_TestCase {
	...
	private static $KEYSPACE_IDS_ECHO = '[8000000000000000 ff000000000000ef]';
	private static $KEY_RANGES; // initialized in setUpBeforeClass()
	private static $KEY_RANGES_ECHO = '[{Start: , End: 8000000000000000} {Start: 8000000000000000, End: }]';
