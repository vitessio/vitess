...
namespace tableacl {
  ...
  class Config extends \DrSlump\Protobuf\Message {
    ...
    public static function descriptor()
    {
      ...
      $f->rule      = \DrSlump\Protobuf::RULE_REPEATED;
      $f->reference = '\tableacl\TableGroupSpec';
      $descriptor->addField($f);
     ...
     *
     * @param \tableacl\TableGroupSpec $value
     * @return \tableacl\Config
     */
    public function setTableGroups(\tableacl\TableGroupSpec $value, $idx = NULL){
     ...
     * @return \tableacl\Config
     */
    public function addTableGroups(\tableacl\TableGroupSpec $value){
