...
namespace Vitess\Proto\Query {
  ...
  class MessageStreamResponse extends \DrSlump\Protobuf\Message {
    ...
    {
      $descriptor = new \DrSlump\Protobuf\Descriptor(__CLASS__, 'query.MessageStreamResponse');
     ...
     * Clear <result> value
     *
     * @return \Vitess\Proto\Query\MessageStreamResponse
     */
