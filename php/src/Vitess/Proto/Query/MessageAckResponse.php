...
namespace Vitess\Proto\Query {
  ...
  class MessageAckResponse extends \DrSlump\Protobuf\Message {
    ...
    {
      $descriptor = new \DrSlump\Protobuf\Descriptor(__CLASS__, 'query.MessageAckResponse');
     ...
     * Clear <result> value
     *
     * @return \Vitess\Proto\Query\MessageAckResponse
     */
