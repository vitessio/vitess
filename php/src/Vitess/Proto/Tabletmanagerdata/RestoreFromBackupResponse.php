...
namespace Vitess\Proto\Tabletmanagerdata {
  ...
  class RestoreFromBackupResponse extends \DrSlump\Protobuf\Message {
    ...
    {
      $descriptor = new \DrSlump\Protobuf\Descriptor(__CLASS__, 'tabletmanagerdata.RestoreFromBackupResponse');
     ...
     * Clear <event> value
     *
     * @return \Vitess\Proto\Tabletmanagerdata\RestoreFromBackupResponse
     */
