...
| 2 | P2-writes-tx | oltp_write_only / read_write / insert: transactions, commit path, tx pool, reserved connections | 30000 | running |
| 2 | P4-vreplication | MoveTables/Reshard copy + catch-up rows/s, VStream CDC throughput | 40000 | running |
| 3 | P3-scatter | cross-shard scatter / aggregation / ORDER BY LIMIT / joins / IN lists | 30000 | pending |
| 3 | P6-runtime | many connections and churn, GC (GOGC/GOMEMLIMIT) vs p99, gRPC and pool settings, mutex/block profiles | 40000 | pending |
